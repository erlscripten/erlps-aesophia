...
erlps__encode__2 [term_0, entrypoint_1] | (H.isEMap term_0) =
  let rop_5 = (erlps__unpack__2 [term_0, entrypoint_1])
  in
    (BIF.erlang__op_append
       [(ErlangCons (ErlangAtom "start_object") ErlangEmptyList),
        rop_5])
...
erlps__encode___2 [term_0@(ErlangCons (ErlangTuple [_, _]) _),
  ...
  in
    (BIF.erlang__op_append
       [(ErlangCons (ErlangAtom "start_object") ErlangEmptyList),
        rop_5])
erlps__encode___2 [term_0, entrypoint_1] | (H.isEList term_0) =
...
erlps__unzip__2 [(ErlangCons (ErlangTuple [k_0, v_1]) rest_2),
  ...
  in
    (BIF.erlang__op_append [(ErlangCons k_0 ErlangEmptyList), rop_7])
...
erlps__unpack__3 [map_0, (ErlangCons k_1 rest_2), entrypoint_3]
  ...
  in
    (BIF.erlang__op_append [(ErlangCons k_1 ErlangEmptyList), rop_7])
erlps__unpack__3 [_, (ErlangEmptyList), _] =
  (ErlangCons (ErlangAtom "end_object") ErlangEmptyList)
erlps__unpack__3 [arg_2, arg_3, arg_4] =
  (EXC.function_clause unit)
