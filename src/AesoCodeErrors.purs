...
erlps__format__1 [(ErlangTuple [(ErlangAtom "missing_init_function"),
  ...
  let   
    arg_1 =
      (H.make_string
         "Missing init function for the contract \'~s\'.\n")
...
erlps__format__1 [(ErlangTuple [(ErlangAtom "missing_definition"),
  ...
  let   
    arg_1 =
      (H.make_string "Missing definition of function \'~s\'.\n")
...
erlps__format__1 [(ErlangTuple [(ErlangAtom "parameterized_state"),
  ...
  let   
    msg_1 =
      (H.make_string "The state type cannot be parameterized.\n")
...
erlps__format__1 [(ErlangTuple [(ErlangAtom "parameterized_event"),
  ...
  let   
    msg_1 =
      (H.make_string "The event type cannot be parameterized.\n")
  in let arg_2 = (erlps__pos__1 [decl_0])
  in (erlps__mk_err__2 [arg_2, msg_1])
    ...
    what_5 =
      case why_0 of
        (ErlangAtom "higher_order") ->
          (H.make_string "higher-order (contains function types)")
        (ErlangAtom "polymorphic") ->
          (H.make_string "polymorphic (contains type variables)")
        something_else -> (EXC.case_clause something_else)
  in let
    things_22 =
      case thing_3 of
        (ErlangTuple [(ErlangAtom "argument"), x_7, t_8]) ->
          let    arg_9 = (H.make_string "argument\n~s\n")
          in let head_11 = (erlps__pp_typed__2 [x_7, t_8])
          in
            (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
               [arg_9, (ErlangCons head_11 ErlangEmptyList)])
        (ErlangTuple [(ErlangAtom "result"), t_15]) ->
          let    arg_16 = (H.make_string "return type\n~s\n")
          in let
            head_18 = (erlps__pp_type__2 [(ErlangInt (DBI.fromInt 2)), t_15])
          in
            (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
...
erlps__format__1 [(ErlangTuple [(ErlangAtom "cant_compare_type_aevm"),
  ...
  in let
    head_14 =
      (erlps__pp_type__2 [(ErlangInt (DBI.fromInt 2)), type_2])
  in let
    msg_22 =
      (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
         [arg_12,
          (ErlangCons head_14
             (ErlangCons op_1
                (ErlangCons stringandtuple_11 ErlangEmptyList)))])
  in let
    cxt_23 =
      (H.make_string
...
erlps__format__1 [(ErlangTuple [(ErlangAtom "invalid_aens_resolve_type"),
  ...
  in let
    head_4 = (erlps__pp_type__2 [(ErlangInt (DBI.fromInt 2)), t_1])
  in let
    msg_8 =
      (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
...
erlps__format__1 [(ErlangTuple [(ErlangAtom "unapplied_contract_call"),
  ...
  in let
    head_3 =
      (erlps__pp_expr__2 [(ErlangInt (DBI.fromInt 2)), contract_0])
  in let
    msg_7 =
      (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
         [arg_1, (ErlangCons head_3 ErlangEmptyList)])
  in let cxt_8 = (H.make_string "Use FATE if you need this.\n")
...
erlps__format__1 [(ErlangTuple [(ErlangAtom "unapplied_builtin"),
  ...
  let   
    arg_1 =
      (H.make_string
         "The AEVM does not support unapplied use of ~s.\n")
  in let
    head_3 = (erlps__pp_expr__2 [(ErlangInt (DBI.fromInt 0)), id_0])
  in let
    msg_7 =
      (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
         [arg_1, (ErlangCons head_3 ErlangEmptyList)])
...
erlps__format__1 [(ErlangTuple [(ErlangAtom "invalid_map_key_type"),
                                why_0, ann_1, type_2])]
  =
  let    arg_3 = (H.make_string "Invalid map key type\n~s\n")
  in let
    head_5 =
      (erlps__pp_type__2 [(ErlangInt (DBI.fromInt 2)), type_2])
  in let
  ...
  in let
    cxt_11 =
      case why_0 of
        ...
        (ErlangAtom "function") ->
          (H.make_string "Map keys cannot be higher-order.\n")
        something_else -> (EXC.case_clause something_else)
...
erlps__format__1 [(ErlangTuple [(ErlangAtom "invalid_oracle_type"),
  ...
  let   
    whys_5 =
      case why_0 of
        (ErlangAtom "higher_order") ->
          (H.make_string "higher-order (contain function types)")
        (ErlangAtom "polymorphic") ->
          (H.make_string "polymorphic (contain type variables)")
        something_else -> (EXC.case_clause something_else)
  in let arg_6 = (H.make_string "Invalid oracle type\n~s\n")
  in let
    head_8 =
      (erlps__pp_type__2 [(ErlangInt (DBI.fromInt 2)), type_3])
  in let
    msg_12 =
      (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
         [arg_6, (ErlangCons head_8 ErlangEmptyList)])
  in let arg_13 = (H.make_string "The ~s type must not be ~s.\n")
  in let
    cxt_19 =
      (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
         [arg_13,
          (ErlangCons what_1 (ErlangCons whys_5 ErlangEmptyList))])
...
erlps__format__1 [(ErlangTuple [(ErlangAtom "higher_order_state"),
                                (ErlangTuple [(ErlangAtom "type_def"), ann_0, _,
                                              _, state_1])])]
  =
  let    arg_2 = (H.make_string "Invalid state type\n~s\n")
  in let
    head_4 =
      (erlps__pp_type__2 [(ErlangInt (DBI.fromInt 2)), state_1])
  in let
    msg_8 =
      (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
         [arg_2, (ErlangCons head_4 ErlangEmptyList)])
...
erlps__format__1 [err_0] =
  ...
  in let arg_5 = (H.make_string "Unknown error: ~p\n")
  in let
    arg_4 =
      (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
...
erlps__pos__1 [ann_0] =
  ...
  in let
    line_8 =
      (BIF.do_remote_fun_call "Aeso.Syntax" "erlps__get_ann__3"
         [(ErlangAtom "line"), ann_0, (ErlangInt (DBI.fromInt 0))])
  in let
    col_12 =
      (BIF.do_remote_fun_call "Aeso.Syntax" "erlps__get_ann__3"
         [(ErlangAtom "col"), ann_0, (ErlangInt (DBI.fromInt 0))])
  in
  ...
  let   
    arg_5 =
      (BIF.erlang__make_fun__3
         [(ErlangAtom "prettypr"), (ErlangAtom "beside"),
...
erlps__pp_expr__1 [e_0] =
  (erlps__pp_expr__2 [(ErlangInt (DBI.fromInt 0)), e_0])
