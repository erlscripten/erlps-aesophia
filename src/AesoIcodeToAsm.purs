...
erlps__is_stateful__1 [(ErlangTuple [fname_0, _, _, _, _])] =
  ...
  in let rop_3 = (H.make_string "init")
...
erlps__is_public__1 [(ErlangTuple [_name_0, attrs_1, _args_2,
  ...
  let
    op_arg_5 =
      (BIF.lists__member__2 [(ErlangAtom "private"), attrs_1])
...
erlps__convert__2 [(ErlangMap map_0), _options_4]
  ...
  let    tup_el_5 = (H.make_string "%main")
  in let tup_el_9 = (H.make_string "arg")
  in let tup_el_10 = (H.make_string "_")
  in let head_8 = (ErlangTuple [tup_el_9, tup_el_10])
  in let tup_el_16 = (H.make_string "arg")
  in let
                ...
                in
                  case cond_24 of
                    (ErlangAtom "true") ->
                      ...
                      in let
                        head_33 =
                          (ErlangTuple [(ErlangAtom "tuple"), tup_el_35])
                      in let
                        tup_el_27 =
                          (ErlangTuple
                             [(ErlangAtom "tuple"),
                      ...
                      in let
                        arg_43 =
                          (BIF.erlang__op_plus
                             [lop_44, (ErlangInt (DBI.fromInt 1))])
                      in let
                        head_41 =
                          (erlps__hack_return_address__2 [fun_22, arg_43])
                      in let
                        tup_el_51 =
                          (ErlangTuple [(ErlangAtom "var_ref"), fname_19])
                      ...
                      in let lc_ret_26 = (ErlangTuple [tup_el_27, tup_el_38])
         ...
         (\ lc_70 ->
            case lc_70 of
              (ErlangTuple [name_65, _attrs_66, args_67, _body_68,
                ...
                in let lc_ret_71 = (ErlangTuple [name_65, tup_el_73, tup_el_75])
    ...
    head_99 =
      (erlps__assemble_expr__4
         [funs_76, ErlangEmptyList, (ErlangAtom "nontail"),
          statetypevalue_83])
  in let head_105 = (erlps__swap__1 [(ErlangInt (DBI.fromInt 1))])
  in let head_108 = (erlps__i__1 [(ErlangInt (DBI.fromInt 89))])
  in let head_111 = (erlps__push__1 [(ErlangInt (DBI.fromInt 0))])
  in let head_114 = (erlps__i__1 [(ErlangInt (DBI.fromInt 81))])
  in let head_117 = (erlps__i__1 [(ErlangInt (DBI.fromInt 89))])
  in let head_120 = (erlps__i__1 [(ErlangInt (DBI.fromInt 82))])
  in let head_123 = (erlps__push__1 [(ErlangInt (DBI.fromInt 0))])
  in let head_126 = (erlps__i__1 [(ErlangInt (DBI.fromInt 82))])
  in let head_129 = (erlps__push__1 [(ErlangInt (DBI.fromInt 0))])
  in let head_132 = (erlps__i__1 [(ErlangInt (DBI.fromInt 243))])
  in let head_135 = (erlps__jumpdest__1 [stoplabel_77])
  in let head_138 = (erlps__push__1 [(ErlangInt (DBI.fromInt 0))])
  in let head_141 = (erlps__dup__1 [(ErlangInt (DBI.fromInt 1))])
  in let head_144 = (erlps__i__1 [(ErlangInt (DBI.fromInt 82))])
  in let head_147 = (erlps__push__1 [(ErlangInt (DBI.fromInt 0))])
  in let head_150 = (erlps__i__1 [(ErlangInt (DBI.fromInt 243))])
  in let
    code_165 =
      (H.flmap
         (\ lc_159 ->
            case lc_159 of
              (ErlangTuple [name_155, _, args_156, body_157, _type_158]) ->
                ...
                in (ErlangCons lc_ret_160 ErlangEmptyList)
              _ -> ErlangEmptyList)
         newfunctions_63)
  in
...
erlps__gen_error__1 [error_0] =
  let
    arg_1 =
      (ErlangTuple
         [(ErlangAtom "code_errors"),
          (ErlangCons error_0 ErlangEmptyList)])
...
erlps__make_args__1 [args_0] =
  let    arg_3 = (BIF.erlang__length__1 [args_0])
  in let
    lc_src_1 =
  ...
  in
    (H.flmap
       (\ lc_6 ->
          let   
            lop_11 =
              (BIF.erlang__op_minus [lc_6, (ErlangInt (DBI.fromInt 1))])
          in let
            head_10 =
              (BIF.erlang__op_plus [lop_11, (ErlangInt (DBI.fromInt 97))])
          in let
            lc_ret_7 =
              (ErlangTuple
    ...
    case match_expr_19 of
      (ErlangBinary bin_c_15) | size_16 <- ((DBI.fromInt 256))
                              , (BIN.Ok hash_18 bin_17) <-
                                  ((BIN.chop_int bin_c_15 size_16 1 BIN.Big
                                      BIN.Unsigned))
                              , (BIN.empty bin_17) ->
...
erlps__hack_return_address__2 [fun_0, n_1] =
  ...
  in
    case case_2 of
      (ErlangAtom "true") ->
        let head_6 = (erlps__i__1 [(ErlangInt (DBI.fromInt 89))])
        in
          (ErlangTuple
             [(ErlangAtom "inline_asm"), (ErlangCons head_6 ErlangEmptyList)])
      (ErlangAtom "false") ->
        let   
          arg_12 = (BIF.erlang__op_plus [n_1, (ErlangInt (DBI.fromInt 2))])
        in let head_11 = (erlps__dup__1 [arg_12])
        in let
          arg_17 = (BIF.erlang__op_plus [n_1, (ErlangInt (DBI.fromInt 1))])
...
erlps__assemble_function__4 [funs_0, name_1, args_2, body_3] =
  ...
  in let head_20 = (erlps__swap__1 [(ErlangInt (DBI.fromInt 1))])
  in let head_23 = (erlps__i__1 [(ErlangInt (DBI.fromInt 86))])
  in
    (ErlangCons head_4
       (ErlangCons head_9
          (ErlangCons head_16
  ...
  let
    case_4 =
      (BIF.lists__keymember__3
         [id_3, (ErlangInt (DBI.fromInt 1)), stack_1])
  in
    case case_4 of
      (ErlangAtom "true") ->
      ...
      (ErlangAtom "false") ->
        ...
        in let head_13 = (erlps__i__1 [(ErlangInt (DBI.fromInt 89))])
        in let head_16 = (erlps__push_label__1 [eta_11])
        in let head_19 = (erlps__dup__1 [(ErlangInt (DBI.fromInt 2))])
        in let head_22 = (erlps__i__1 [(ErlangInt (DBI.fromInt 82))])
        in let head_25 = (erlps__jump__1 [continue_12])
        in let head_28 = (erlps__jumpdest__1 [eta_11])
        in let head_31 = (erlps__pop__1 [(ErlangInt (DBI.fromInt 1))])
...
erlps__assemble_expr__4 [funs_0, stack_1, _,
  ...
  in
    case case_3 of
      (ErlangEmptyList) -> (erlps__i__1 [(ErlangInt (DBI.fromInt 89))])
      (ErlangCons last_6 rest_7) ->
        let   
          head_8 =
            (erlps__assemble_expr__4
               [funs_0, stack_1, (ErlangAtom "nontail"), last_6])
        in let head_14 = (erlps__i__1 [(ErlangInt (DBI.fromInt 89))])
        ...
        in let
          arg_18 =
            (BIF.erlang__op_mult [(ErlangInt (DBI.fromInt 32)), rop_20])
        in let head_17 = (erlps__push__1 [arg_18])
        in let head_25 = (erlps__i__1 [(ErlangInt (DBI.fromInt 1))])
        in let head_28 = (erlps__swap__1 [(ErlangInt (DBI.fromInt 1))])
        in let head_31 = (erlps__dup__1 [(ErlangInt (DBI.fromInt 2))])
        in let head_34 = (erlps__i__1 [(ErlangInt (DBI.fromInt 82))])
        in let
          head_37 =
            (H.flmap
               (\ lc_40 ->
                  let   
                    head_42 = (erlps__push__1 [(ErlangInt (DBI.fromInt 32))])
                  in let
                    head_45 = (erlps__swap__1 [(ErlangInt (DBI.fromInt 1))])
                  in let head_48 = (erlps__i__1 [(ErlangInt (DBI.fromInt 3))])
                  in let
                    head_51 =
                      (erlps__assemble_expr__4
                         [funs_0, (ErlangCons (ErlangAtom "pointer") stack_1),
                          (ErlangAtom "nontail"), lc_40])
                  in let head_59 = (erlps__dup__1 [(ErlangInt (DBI.fromInt 2))])
                  in let head_62 = (erlps__i__1 [(ErlangInt (DBI.fromInt 82))])
                  in
                    (ErlangCons
                       (ErlangCons head_42
                          (ErlangCons head_45
...
erlps__assemble_expr__4 [_funs_0, _stack_1, _,
  ...
  =
  let    head_2 = (erlps__push__1 [(ErlangInt (DBI.fromInt 0))])
  in let head_5 = (erlps__i__1 [(ErlangInt (DBI.fromInt 25))])
...
erlps__assemble_expr__4 [funs_0, stack_1, _,
  ...
  case a_2 of
    ...
    _ ->
      ...
      in let head_28 = (erlps__i__1 [(ErlangInt (DBI.fromInt 21))])
...
erlps__assemble_expr__4 [funs_0, stack_1, _,
  ...
  in let
    head_4 = (erlps__assemble_exprs__3 [funs_0, stack_1, arg_7])
    ...
    head_13 =
      case case_14 of
        (ErlangInt num_16) | ((ErlangInt num_16) ==
          ...
          (erlps__i__1 [(ErlangInt (DBI.fromInt 160))])
        (ErlangInt num_18) | ((ErlangInt num_18) ==
                                (ErlangInt (DBI.fromInt 1))) ->
          (erlps__i__1 [(ErlangInt (DBI.fromInt 161))])
        (ErlangInt num_20) | ((ErlangInt num_20) ==
                                (ErlangInt (DBI.fromInt 2))) ->
          (erlps__i__1 [(ErlangInt (DBI.fromInt 162))])
        (ErlangInt num_22) | ((ErlangInt num_22) ==
                                (ErlangInt (DBI.fromInt 3))) ->
          (erlps__i__1 [(ErlangInt (DBI.fromInt 163))])
        (ErlangInt num_24) | ((ErlangInt num_24) ==
                                (ErlangInt (DBI.fromInt 4))) ->
          (erlps__i__1 [(ErlangInt (DBI.fromInt 164))])
        something_else -> (EXC.case_clause something_else)
  in let head_27 = (erlps__i__1 [(ErlangInt (DBI.fromInt 89))])
  in
    (ErlangCons head_4
...
erlps__assemble_expr__4 [funs_0, stack_1, _,
  ...
  in let
    arg_8 = (ErlangTuple [(ErlangAtom "lambda"), args_2, body_3])
  in let freevars_12 = (erlps__free_vars__1 [arg_8])
  in let tup_el_20 = (H.make_string "_")
  in let
    head_18 = (ErlangTuple [(ErlangAtom "var_ref"), tup_el_20])
  in let
    arg_15 =
      (ErlangTuple
         [(ErlangAtom "tuple"), (ErlangCons head_18 freevars_12)])
  in let
    match_expr_24 =
    ...
    case match_expr_24 of
      (ErlangTuple [newvars_22, matchingcode_23]) ->
                    ...
                    tup_el_38 =
                      case lc_32 of
                        (ErlangTuple arr_41) | (DM.Just field_40) <-
                          ...
                          field_40
                        _ -> (EXC.badrecord (ErlangAtom "arg"))
                  in let lc_ret_33 = (ErlangTuple [tup_el_34, tup_el_38])
        ...
        in let
          arg_49 =
            (ErlangTuple
               [(ErlangAtom "tuple"), (ErlangCons head_52 freevars_12)])
        in let
          head_45 =
            (erlps__assemble_expr__4
        ...
        in let head_77 = (erlps__swap__1 [(ErlangInt (DBI.fromInt 1))])
        in let head_80 = (erlps__i__1 [(ErlangInt (DBI.fromInt 86))])
        in let head_83 = (erlps__jumpdest__1 [nomatch_7])
        in let head_86 = (erlps__push__1 [(ErlangInt (DBI.fromInt 0))])
        in let head_89 = (erlps__i__1 [(ErlangInt (DBI.fromInt 25))])
        in let head_92 = (erlps__i__1 [(ErlangInt (DBI.fromInt 81))])
        in let head_95 = (erlps__i__1 [(ErlangInt (DBI.fromInt 0))])
  ...
  in
    case args_3 of
        ...
        in let
          head_9 =
            (erlps__assemble_function__3
               [funs_0, (ErlangCons (ErlangAtom "return_address") stack_1),
                fun_2])
        in let head_16 = (erlps__i__1 [(ErlangInt (DBI.fromInt 86))])
      ...
      _ ->
        ...
        in let
          arg_22 =
            (BIF.erlang__op_minus [lop_23, (ErlangInt (DBI.fromInt 1))])
        in let
          match_expr_29 =
                ...
                lop_47 =
                  (H.flmap
                     (\ lc_49 ->
                        case lc_49 of
                          _ ->
                            (ErlangCons (ErlangAtom "dummy") ErlangEmptyList))
                     args_3)
              in let
                arg_46 =
                  (BIF.erlang__op_append
                     [lop_47,
                      (ErlangCons (ErlangAtom "return_address") stack_1)])
              in let
                head_44 = (erlps__assemble_function__3 [funs_0, arg_46, fun_2])
              in let head_56 = (erlps__i__1 [(ErlangInt (DBI.fromInt 86))])
...
erlps__assemble_expr__4 [funs_0, stack_1, (ErlangAtom "tail"),
  ...
  =
  let   
    istoplevel_6 = (erlps__is_top_level_fun__2 [stack_1, fun_2])
  ...
  in let
    arg_21 = (BIF.erlang__op_neg [(ErlangInt (DBI.fromInt 1))])
  in let
    lop_17 =
      (BIF.do_remote_fun_call "Lists" "erlps__seq__3"
         [arg_18, (ErlangInt (DBI.fromInt 1)), arg_21])
  in let
    rop_23 =
      (H.flmap
         (\ lc_25 ->
  ...
  in let
    head_34 =
      case (ErlangAtom "true") of
        _ | ((ErlangAtom "true") ==
               (H.falsifyErrors (\ _ -> istoplevel_6))) ->
          (erlps__assemble_function__3 [funs_0, ErlangEmptyList, fun_2])
        _ ->
          let    head_38 = (erlps__dup__1 [(ErlangInt (DBI.fromInt 1))])
          in let head_41 = (erlps__i__1 [(ErlangInt (DBI.fromInt 81))])
          in (ErlangCons head_38 (ErlangCons head_41 ErlangEmptyList))
  in let head_45 = (erlps__i__1 [(ErlangInt (DBI.fromInt 86))])
  in
...
erlps__assemble_expr__4 [_funs_0, _stack_1, _tail_2,
  ...
  =
  let    head_3 = (erlps__push__1 [(ErlangInt (DBI.fromInt 0))])
  in let head_6 = (erlps__i__1 [(ErlangInt (DBI.fromInt 81))])
...
erlps__assemble_expr__4 [funs_0, stack_1, _tail_2,
  ...
  in let head_10 = (erlps__push__1 [(ErlangInt (DBI.fromInt 0))])
  in let head_13 = (erlps__i__1 [(ErlangInt (DBI.fromInt 82))])
  in let head_16 = (erlps__i__1 [(ErlangInt (DBI.fromInt 89))])
  in
    (ErlangCons head_4
       (ErlangCons head_10
...
erlps__assemble_expr__4 [_funs_0, _stack_1, _tail_2,
  ...
  =
  let head_3 = (erlps__i__1 [(ErlangInt (DBI.fromInt 48))])
  in (ErlangCons head_3 ErlangEmptyList)
erlps__assemble_expr__4 [_funs_0, _stack_1, _tail_2,
                         (ErlangAtom "prim_contract_creator")]
  =
  let head_3 = (erlps__i__1 [(ErlangInt (DBI.fromInt 47))])
  in (ErlangCons head_3 ErlangEmptyList)
erlps__assemble_expr__4 [_funs_0, _stack_1, _tail_2,
                         (ErlangAtom "prim_call_origin")]
  =
  let head_3 = (erlps__i__1 [(ErlangInt (DBI.fromInt 50))])
  in (ErlangCons head_3 ErlangEmptyList)
erlps__assemble_expr__4 [_funs_0, _stack_1, _tail_2,
                         (ErlangAtom "prim_caller")]
  =
  let head_3 = (erlps__i__1 [(ErlangInt (DBI.fromInt 51))])
  in (ErlangCons head_3 ErlangEmptyList)
erlps__assemble_expr__4 [_funs_0, _stack_1, _tail_2,
                         (ErlangAtom "prim_call_value")]
  =
  let head_3 = (erlps__i__1 [(ErlangInt (DBI.fromInt 52))])
  in (ErlangCons head_3 ErlangEmptyList)
erlps__assemble_expr__4 [_funs_0, _stack_1, _tail_2,
                         (ErlangAtom "prim_gas_price")]
  =
  let head_3 = (erlps__i__1 [(ErlangInt (DBI.fromInt 58))])
  in (ErlangCons head_3 ErlangEmptyList)
erlps__assemble_expr__4 [_funs_0, _stack_1, _tail_2,
                         (ErlangAtom "prim_gas_left")]
  =
  let head_3 = (erlps__i__1 [(ErlangInt (DBI.fromInt 90))])
  in (ErlangCons head_3 ErlangEmptyList)
erlps__assemble_expr__4 [_funs_0, _stack_1, _tail_2,
                         (ErlangAtom "prim_coinbase")]
  =
  let head_3 = (erlps__i__1 [(ErlangInt (DBI.fromInt 65))])
  in (ErlangCons head_3 ErlangEmptyList)
erlps__assemble_expr__4 [_funs_0, _stack_1, _tail_2,
                         (ErlangAtom "prim_timestamp")]
  =
  let head_3 = (erlps__i__1 [(ErlangInt (DBI.fromInt 66))])
  in (ErlangCons head_3 ErlangEmptyList)
erlps__assemble_expr__4 [_funs_0, _stack_1, _tail_2,
                         (ErlangAtom "prim_block_height")]
  =
  let head_3 = (erlps__i__1 [(ErlangInt (DBI.fromInt 67))])
  in (ErlangCons head_3 ErlangEmptyList)
erlps__assemble_expr__4 [_funs_0, _stack_1, _tail_2,
                         (ErlangAtom "prim_difficulty")]
  =
  let head_3 = (erlps__i__1 [(ErlangInt (DBI.fromInt 68))])
  in (ErlangCons head_3 ErlangEmptyList)
erlps__assemble_expr__4 [_funs_0, _stack_1, _tail_2,
                         (ErlangAtom "prim_gas_limit")]
  =
  let head_3 = (erlps__i__1 [(ErlangInt (DBI.fromInt 69))])
  in (ErlangCons head_3 ErlangEmptyList)
erlps__assemble_expr__4 [funs_0, stack_1, _tail_2,
  ...
  in let head_10 = (erlps__i__1 [(ErlangInt (DBI.fromInt 49))])
  in (ErlangCons head_4 (ErlangCons head_10 ErlangEmptyList))
erlps__assemble_expr__4 [funs_0, stack_1, _tail_2,
  ...
  in let head_10 = (erlps__i__1 [(ErlangInt (DBI.fromInt 64))])
  in (ErlangCons head_4 (ErlangCons head_10 ErlangEmptyList))
erlps__assemble_expr__4 [funs_0, stack_1, _tail_2,
             ...
             (ErlangCons head_16
                (ErlangCons typehash_7
                   (ErlangCons arg_6
                      (ErlangCons value_5
                         (ErlangCons to_4
                            (ErlangCons gas_3 ErlangEmptyList)))))))])
  in let head_31 = (erlps__i__1 [(ErlangInt (DBI.fromInt 241))])
...
erlps__assemble_cases__5 [_funs_0, _stack_1, _tail_2, _close_3,
                          (ErlangEmptyList)]
  =
  let    head_4 = (erlps__push__1 [(ErlangInt (DBI.fromInt 1))])
  in let head_7 = (erlps__i__1 [(ErlangInt (DBI.fromInt 25))])
  in let head_10 = (erlps__i__1 [(ErlangInt (DBI.fromInt 81))])
  in let head_13 = (erlps__i__1 [(ErlangInt (DBI.fromInt 0))])
  in
    (ErlangCons head_4
       (ErlangCons head_7
      ...
      (ErlangTuple [newvars_12, matchingcode_13]) ->
        ...
        in let
          head_15 =
            case cond_16 of
              (ErlangAtom "true") ->
                let lc_ret_19 = (erlps__dup__1 [(ErlangInt (DBI.fromInt 1))])
              ...
              (ErlangAtom "true") ->
                let
                  lc_ret_31 =
                    case newvars_12 of
                      (ErlangEmptyList) ->
                        (erlps__pop__1 [(ErlangInt (DBI.fromInt 1))])
                      (ErlangCons _ (ErlangEmptyList)) ->
                        (erlps__pop_args__1 [(ErlangInt (DBI.fromInt 1))])
                      _ ->
...
erlps__assemble_pattern__3 [succeed_0, fail_1,
  ...
  in let head_8 = (erlps__i__1 [(ErlangInt (DBI.fromInt 20))])
...
erlps__assemble_pattern__3 [succeed_0, _fail_1,
  ...
  let    head_5 = (erlps__i__1 [(ErlangInt (DBI.fromInt 80))])
...
erlps__assemble_pattern__3 [succeed_0, _fail_1,
                            (ErlangTuple [(ErlangAtom "tuple"),
                                          (ErlangEmptyList)])]
  =
  let    head_4 = (erlps__pop__1 [(ErlangInt (DBI.fromInt 1))])
...
erlps__assemble_pattern__3 [succeed_0, fail_1,
  ...
  let
    match_expr_8 =
      (erlps__assemble_pattern__3 [succeed_0, fail_1, a_2])
  in
    case match_expr_8 of
      (ErlangTuple [avars_6, acode_7]) ->
        let head_11 = (erlps__i__1 [(ErlangInt (DBI.fromInt 81))])
        in
          (ErlangTuple
             [avars_6,
        ...
        in
          case match_expr_20 of
            (ErlangTuple [bvars_18, bcode_19]) ->
              ...
              in let head_26 = (erlps__dup__1 [(ErlangInt (DBI.fromInt 1))])
              in let head_29 = (erlps__i__1 [(ErlangInt (DBI.fromInt 81))])
              ...
              in let head_41 = (erlps__push__1 [(ErlangInt (DBI.fromInt 32))])
              in let head_44 = (erlps__i__1 [(ErlangInt (DBI.fromInt 1))])
              in let
                head_49 =
                  case avars_10 of
                    (ErlangEmptyList) ->
                      ...
                      in let
                        head_54 = (erlps__pop__1 [(ErlangInt (DBI.fromInt 1))])
                      ...
                      in let
                        arg_68 =
                          (BIF.erlang__op_minus
                             [lop_69, (ErlangInt (DBI.fromInt 1))])
                      in let head_67 = (erlps__pop__1 [arg_68])
                      in let
                        head_73 =
                          (ErlangTuple [(ErlangAtom "JUMPDEST"), pop1fail_5])
                      in let
                        head_77 = (erlps__pop__1 [(ErlangInt (DBI.fromInt 1))])
                      in let
                        head_80 =
                          (ErlangTuple [(ErlangAtom "push_label"), fail_1])
                      in
                        (ErlangCons head_63
                           (ErlangCons head_67
                              (ErlangCons head_73
...
erlps__assemble_pattern__3 [succeed_0, fail_1,
  ...
  =
  let    head_4 = (erlps__push__1 [(ErlangInt (DBI.fromInt 1))])
  in let head_7 = (erlps__i__1 [(ErlangInt (DBI.fromInt 1))])
...
erlps__assemble_pattern__3 [succeed_0, fail_1,
  ...
  in let
    arg_6 =
      (ErlangTuple
         [(ErlangAtom "binop"), (ErlangAtom "::"), a_2, tup_el_10])
  ...
  in
    case match_expr_16 of
      (ErlangTuple [vars_14, code_15]) ->
        let    head_19 = (erlps__dup__1 [(ErlangInt (DBI.fromInt 1))])
        in let head_22 = (erlps__push__1 [(ErlangInt (DBI.fromInt 1))])
        in let head_25 = (erlps__i__1 [(ErlangInt (DBI.fromInt 1))])
...
erlps__assemble_prefix__1 [(ErlangAtom "sha3")] =
  let    head_0 = (erlps__i__1 [(ErlangInt (DBI.fromInt 128))])
  in let head_3 = (erlps__i__1 [(ErlangInt (DBI.fromInt 81))])
  in let head_6 = (erlps__i__1 [(ErlangInt (DBI.fromInt 144))])
  in let head_9 = (erlps__push__1 [(ErlangInt (DBI.fromInt 32))])
  in let head_12 = (erlps__i__1 [(ErlangInt (DBI.fromInt 1))])
  in let head_15 = (erlps__i__1 [(ErlangInt (DBI.fromInt 32))])
  in
    (ErlangCons head_0
       (ErlangCons head_3
          (ErlangCons head_6
...
erlps__assemble_prefix__1 [(ErlangAtom "-")] =
  let    head_0 = (erlps__push__1 [(ErlangInt (DBI.fromInt 0))])
  in let head_3 = (erlps__i__1 [(ErlangInt (DBI.fromInt 3))])
  in (ErlangCons head_0 (ErlangCons head_3 ErlangEmptyList))
erlps__assemble_prefix__1 [(ErlangAtom "bnot")] =
  (erlps__i__1 [(ErlangInt (DBI.fromInt 25))])
...
erlps__assemble_infix__1 [(ErlangAtom "+")] =
  (erlps__i__1 [(ErlangInt (DBI.fromInt 1))])
erlps__assemble_infix__1 [(ErlangAtom "-")] =
  (erlps__i__1 [(ErlangInt (DBI.fromInt 3))])
erlps__assemble_infix__1 [(ErlangAtom "*")] =
  (erlps__i__1 [(ErlangInt (DBI.fromInt 2))])
erlps__assemble_infix__1 [(ErlangAtom "/")] =
  (erlps__i__1 [(ErlangInt (DBI.fromInt 5))])
erlps__assemble_infix__1 [(ErlangAtom "div")] =
  (erlps__i__1 [(ErlangInt (DBI.fromInt 4))])
erlps__assemble_infix__1 [(ErlangAtom "mod")] =
  (erlps__i__1 [(ErlangInt (DBI.fromInt 6))])
erlps__assemble_infix__1 [(ErlangAtom "^")] =
  (erlps__i__1 [(ErlangInt (DBI.fromInt 10))])
erlps__assemble_infix__1 [(ErlangAtom "bor")] =
  (erlps__i__1 [(ErlangInt (DBI.fromInt 23))])
erlps__assemble_infix__1 [(ErlangAtom "band")] =
  (erlps__i__1 [(ErlangInt (DBI.fromInt 22))])
erlps__assemble_infix__1 [(ErlangAtom "bxor")] =
  (erlps__i__1 [(ErlangInt (DBI.fromInt 24))])
erlps__assemble_infix__1 [(ErlangAtom "bsl")] =
  (erlps__i__1 [(ErlangInt (DBI.fromInt 27))])
erlps__assemble_infix__1 [(ErlangAtom "bsr")] =
  (erlps__i__1 [(ErlangInt (DBI.fromInt 28))])
erlps__assemble_infix__1 [(ErlangAtom "<")] =
  (erlps__i__1 [(ErlangInt (DBI.fromInt 18))])
erlps__assemble_infix__1 [(ErlangAtom ">")] =
  (erlps__i__1 [(ErlangInt (DBI.fromInt 19))])
erlps__assemble_infix__1 [(ErlangAtom "==")] =
  (erlps__i__1 [(ErlangInt (DBI.fromInt 20))])
erlps__assemble_infix__1 [(ErlangAtom "<=")] =
  let    head_0 = (erlps__i__1 [(ErlangInt (DBI.fromInt 19))])
  in let head_3 = (erlps__i__1 [(ErlangInt (DBI.fromInt 21))])
  in (ErlangCons head_0 (ErlangCons head_3 ErlangEmptyList))
erlps__assemble_infix__1 [(ErlangAtom "=<")] =
  let    head_0 = (erlps__i__1 [(ErlangInt (DBI.fromInt 19))])
  in let head_3 = (erlps__i__1 [(ErlangInt (DBI.fromInt 21))])
  in (ErlangCons head_0 (ErlangCons head_3 ErlangEmptyList))
erlps__assemble_infix__1 [(ErlangAtom ">=")] =
  let    head_0 = (erlps__i__1 [(ErlangInt (DBI.fromInt 18))])
  in let head_3 = (erlps__i__1 [(ErlangInt (DBI.fromInt 21))])
  in (ErlangCons head_0 (ErlangCons head_3 ErlangEmptyList))
erlps__assemble_infix__1 [(ErlangAtom "!=")] =
  let    head_0 = (erlps__i__1 [(ErlangInt (DBI.fromInt 20))])
  in let head_3 = (erlps__i__1 [(ErlangInt (DBI.fromInt 21))])
  in (ErlangCons head_0 (ErlangCons head_3 ErlangEmptyList))
erlps__assemble_infix__1 [(ErlangAtom "!")] =
  let    head_0 = (erlps__i__1 [(ErlangInt (DBI.fromInt 1))])
  in let head_3 = (erlps__i__1 [(ErlangInt (DBI.fromInt 81))])
  in (ErlangCons head_0 (ErlangCons head_3 ErlangEmptyList))
erlps__assemble_infix__1 [(ErlangAtom "byte")] =
  (erlps__i__1 [(ErlangInt (DBI.fromInt 26))])
  ...
  in
    case case_3 of
      ...
      (ErlangAtom "false") ->
        ...
        in let head_18 = (erlps__dup__1 [(ErlangInt (DBI.fromInt 1))])
        in let head_21 = (erlps__i__1 [(ErlangInt (DBI.fromInt 81))])
        in
          (ErlangCons head_12
         ...
         (\ lc_9 ->
            case lc_9 of
              (ErlangTuple [pattern_7, body_8]) ->
                ...
                in let lc_ret_10 = (BIF.erlang__op_unAppend [lop_11, rop_13])
                in (ErlangCons lc_ret_10 ErlangEmptyList)
              _ -> ErlangEmptyList)
         cases_1)
  in let
    arg_4 =
      (BIF.do_remote_fun_call "Lists" "erlps__umerge__1" [arg_5])
  in
            ...
            let   
              tup_el_10 =
                case lc_7 of
                  ...
                  _ -> (EXC.badrecord (ErlangAtom "arg"))
            in let
              lc_ret_8 = (ErlangTuple [(ErlangAtom "var_ref"), tup_el_10])
...
erlps__shuffle_stack__1 [(ErlangCons (ErlangAtom "discard") stack_0)]
  =
  let    head_1 = (erlps__i__1 [(ErlangInt (DBI.fromInt 80))])
    ...
    case case_2 of
      (ErlangInt num_8) | ((ErlangInt num_8) ==
        ...
        in let
          correctstack_15 =
            (BIF.do_remote_fun_call "Lists" "erlps__seq__3"
               [arg_9, (ErlangInt (DBI.fromInt 1)), arg_13])
        in
          case stack_1 of
      ...
      moveby_18 ->
        let   
          arg_19 =
            (BIF.erlang__op_minus [moveby_18, (ErlangInt (DBI.fromInt 1))])
        in let
          match_expr_25 =
            (BIF.do_remote_fun_call "Lists" "erlps__split__2"
               [arg_19, stack_1])
        in
          case match_expr_25 of
            (ErlangTuple [pref_23, (ErlangCons _ suff_24)]) ->
              ...
              in let
                tail_28 =
                  (erlps__shuffle_stack__1 [(ErlangCons head_30 tail_33)])
  ...
  in
    case case_2 of
      ...
      (ErlangEmptyList) ->
        let
          arg_12 =
            (ErlangTuple [(ErlangAtom "undefined_function"), name_1])
        in (erlps__gen_error__1 [arg_12])
      something_else -> (EXC.case_clause something_else)
erlps__lookup_fun__2 [arg_15, arg_16] =
  (EXC.function_clause unit)
...
erlps__is_top_level_fun__2 [stack_0,
  ...
  let
    op_arg_2 =
      (BIF.lists__keymember__3
         [id_1, (ErlangInt (DBI.fromInt 1)), stack_0])
...
erlps__lookup_var__2 [id_0, stack_1] =
  (erlps__lookup_var__3
     [(ErlangInt (DBI.fromInt 1)), id_0, stack_1])
...
erlps__lookup_var__3 [n_0, id_1, (ErlangCons _ stack_2)] =
  let
    arg_3 = (BIF.erlang__op_plus [n_0, (ErlangInt (DBI.fromInt 1))])
...
erlps__dup__1 [n_0]
  | ((weakLeq (ErlangInt (DBI.fromInt 1)) n_0) &&
...
erlps__push__1 [n_0] =
  ...
  in let
    match_expr_6 =
      (BIF.erlang__op_lesserEq [lop_3, (ErlangInt (DBI.fromInt 32))])
  in
    case match_expr_6 of
      (ErlangAtom "true") ->
        let    rop_11 = (BIF.erlang__size__1 [bytes_2])
        in let
          lop_9 =
            (BIF.erlang__op_plus [(ErlangInt (DBI.fromInt 96)), rop_11])
        in let
          arg_8 =
  ...
  in
    (H.flmap
       (\ lc_4 ->
          case lc_4 of
            _ ->
              let lc_ret_5 = (erlps__i__1 [(ErlangInt (DBI.fromInt 80))])
...
erlps__jumpdest__1 [label_0] =
  let tup_el_1 = (erlps__i__1 [(ErlangInt (DBI.fromInt 91))])
...
erlps__jump__1 [label_0] =
  ...
  in let head_4 = (erlps__i__1 [(ErlangInt (DBI.fromInt 86))])
...
erlps__jump_if__1 [label_0] =
  let    head_1 = (erlps__push_label__1 [label_0])
  in let head_4 = (erlps__i__1 [(ErlangInt (DBI.fromInt 87))])
  in (ErlangCons head_1 (ErlangCons head_4 ErlangEmptyList))
...
erlps__resolve_references__1 [code_0] =
  ...
  in let
    labels_12 =
      (erlps__define_labels__2 [(ErlangInt (DBI.fromInt 0)), instrs_9])
  in let
    arg_13 =
      (H.flmap
         (\ lc_16 ->
            let lc_ret_17 = (erlps__use_labels__2 [labels_12, lc_16])
            in (ErlangCons lc_ret_17 ErlangEmptyList))
         instrs_9)
  in (BIF.do_remote_fun_call "Lists" "erlps__flatten__1" [arg_13])
erlps__resolve_references__1 [arg_20] =
  (EXC.function_clause unit)
...
erlps__define_labels__2 [addr_0,
  ...
  in let
    arg_7 =
      (BIF.erlang__op_plus [addr_0, (ErlangInt (DBI.fromInt 1))])
...
erlps__define_labels__2 [addr_0,
  ...
  let
    arg_2 =
      (BIF.erlang__op_plus [addr_0, (ErlangInt (DBI.fromInt 4))])
...
erlps__define_labels__2 [arg_0, arg_1] =
  (EXC.function_clause unit)
...
erlps__use_labels__2 [labels_0,
  ...
  in
    case case_2 of
      ...
      addr_8 | (H.isEInt addr_8) ->
        let    head_9 = (erlps__i__1 [(ErlangInt (DBI.fromInt 98))])
        in let
          head_12 =
            (BIF.erlang__op_div_strict
               [addr_8, (ErlangInt (DBI.fromInt 65536))])
        in let
          lop_17 =
            (BIF.erlang__op_div_strict
               [addr_8, (ErlangInt (DBI.fromInt 256))])
        in let
          head_16 =
            (BIF.erlang__op_rem_strict
               [lop_17, (ErlangInt (DBI.fromInt 256))])
        in let
          head_22 =
            (BIF.erlang__op_rem_strict
               [addr_8, (ErlangInt (DBI.fromInt 256))])
...
erlps__peep_hole_backwards__1 [arg_4] =
  (EXC.function_clause unit)
...
erlps__peep_hole_backwards1__1 [(ErlangEmptyList)] =
  ErlangEmptyList
erlps__peep_hole_backwards1__1 [arg_0] =
  (EXC.function_clause unit)
...
erlps__optimize_jumps__1 [code_0] =
  ...
  in let
    shortcircuited_9 =
      (H.flmap
         (\ lc_5 ->
            let lc_ret_6 = (erlps__short_circuit_jumps__2 [jjs_2, lc_5])
            in (ErlangCons lc_ret_6 ErlangEmptyList))
         code_0)
  in let
    nodeadcode_11 =
      (erlps__eliminate_dead_code__1 [shortcircuited_9])
...
erlps__eliminate_dead_code__1 [arg_11] =
  (EXC.function_clause unit)
...
erlps__moveable_blocks__1 [(ErlangCons i_0 more_1)] =
  let match_expr_5 = (erlps__moveable_blocks__1 [more_1])
  in
...
erlps__merge_blocks__1 [blocks_0] =
  let   
    blocksandtargets_6 =
      (H.flmap
         (\ lc_3 ->
            let lc_ret_4 = (erlps__label_and_jump__1 [lc_3])
            in (ErlangCons lc_ret_4 ErlangEmptyList))
         blocks_0)
  in let lc_src_7 = (erlps__merge_after__1 [blocksandtargets_6])
  in
    (H.flmap
       (\ lc_12 ->
          case lc_12 of
            (ErlangTuple [pref_9, body_10, suff_11]) ->
              ...
              in let lc_src_13 = (BIF.erlang__op_append [pref_9, rop_15])
              in
                (H.flmap (\ lc_19 -> (ErlangCons lc_19 ErlangEmptyList))
                   lc_src_13)
            _ -> ErlangEmptyList)
       lc_src_7)
            ...
            case lc_10 of
              (ErlangTuple [(ErlangCons (ErlangTuple [(ErlangAtom "JUMPDEST"),
                ...
                in
                  case cond_11 of
                    (ErlangAtom "true") ->
                      let lc_ret_14 = (ErlangTuple [b_8, j_9])
  ...
  in
    case case_5 of
      (ErlangCons (ErlangTuple [b_17, j_18]) _) ->
        let   
          head_26 = (ErlangTuple [(ErlangAtom "JUMPDEST"), target_2])
        in let
          rop_24 =
            (BIF.erlang__op_append
               [(ErlangCons head_26 ErlangEmptyList), b_17])
        in let tup_el_22 = (BIF.erlang__op_append [body_1, rop_24])
        in let head_20 = (ErlangTuple [label_0, tup_el_22, j_18])
        in let
          head_35 = (ErlangTuple [(ErlangAtom "JUMPDEST"), target_2])
        in let
          arg_33 =
            ...
            case lc_10 of
              (ErlangTuple [l_7, b_8,
                ...
                in
                  case cond_11 of
                    (ErlangAtom "true") ->
                      let lc_ret_14 = (ErlangTuple [l_7, b_8, t_9])
                      in (ErlangCons lc_ret_14 ErlangEmptyList)
                    _ -> ErlangEmptyList
              _ -> ErlangEmptyList)
         blocksandtargets_4)
