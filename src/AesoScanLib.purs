     ...
     (\ lc_4 ->
        case lc_4 of
          (ErlangTuple [s_2, spec_3]) ->
            ...
            in let lc_ret_5 = (ErlangTuple [s_2, tup_el_7])
...
erlps__compile_spec__1 [tokenspecs_0] =
  let    arg_3 = (BIF.erlang__length__1 [tokenspecs_0])
  in let
    arg_1 =
  ...
  in let head_10 = (erlps__name__1 [(ErlangInt (DBI.fromInt 0))])
  in let
    arg_14 =
      (H.flmap
         (\ lc_18 ->
    ...
    case match_expr_34 of
      (ErlangTuple [(ErlangAtom "ok"), regex_33]) ->
        ...
        in
          (ErlangFun 2
             let
               lambda_40 [(ErlangEmptyList), _pos_43] =
                 (ErlangAtom "end_of_file")
               lambda_40 [s_44, pos_45] =
                 let   
                   head_50 =
                     (ErlangTuple
                        [(ErlangAtom "capture"), (ErlangAtom "all_names")])
                 in let
                   case_46 =
                   ...
                   case case_46 of
                     (ErlangTuple [(ErlangAtom "match"),
                       ...
                       in let
                         index_68 =
                           (BIF.erlang__op_plus
                              [(ErlangInt (DBI.fromInt 1)), rop_58])
                       in let
                         action_71 =
                       ...
                       in
                         case match_expr_76 of
                           (ErlangTuple [toks_74, rest_75]) ->
                             ...
                             in let
                               tup_el_84 =
                                 (erlps__next_pos__2 [toks_74, pos_45])
                             in
                               (ErlangTuple
                                  [(ErlangAtom "ok"), tok_80, rest_75,
                                   tup_el_84])
       ...
       lambda_1 [s_4, p_5] =
         ...
         in
           case match_expr_10 of
             (ErlangTuple [res_9, _]) ->
               (ErlangTuple [res_9, (ErlangAtom "pop")])
               ...
               let
                 lambda_15 [s_18, p_19] =
                   let   
                     head_24 =
                       (ErlangTuple
                          [(ErlangAtom "capture"), (ErlangAtom "none")])
                   in let
                     case_20 =
                       (BIF.do_remote_fun_call "Re" "erlps__run__3"
                          [s_18, compiled_11,
                     ...
                     case case_20 of
                       (ErlangAtom "match") ->
                         (BIF.erlang__apply__2
                            [action2_3,
                             (ErlangCons s_18
                                (ErlangCons p_19 ErlangEmptyList))])
                       (ErlangAtom "nomatch") ->
                         (BIF.erlang__apply__2
                            [action1_1,
                             (ErlangCons s_18
...
erlps__string__5 [lexers_0, (ErlangCons state_1 stack_2),
  ...
  in let
    case_11 =
      (BIF.erlang__apply__2
         [lexer_10,
          (ErlangCons line_3 (ErlangCons pos_5 ErlangEmptyList))])
  in
    case case_11 of
...
erlps__name__1 [i_0] =
  let arg_1 = (H.make_string "?<A~3.10.0b>")
  in
...
erlps__next_pos__2 [(ErlangCons (ErlangInt num_0) s_1),
  ...
  let   
    tup_el_5 =
      (BIF.erlang__op_plus [l_2, (ErlangInt (DBI.fromInt 1))])
  in let
    arg_4 = (ErlangTuple [tup_el_5, (ErlangInt (DBI.fromInt 1))])
  in (erlps__next_pos__2 [s_1, arg_4])
erlps__next_pos__2 [(ErlangCons (ErlangInt num_0) s_1),
                    (ErlangTuple [l_2, c_3])]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 9))) =
  let   
    lop_11 = (BIF.erlang__op_plus [c_3, (ErlangInt (DBI.fromInt 8))])
  in let
    lop_10 =
      (BIF.erlang__op_minus [lop_11, (ErlangInt (DBI.fromInt 1))])
  in let
    lop_9 =
      (BIF.erlang__op_div_strict [lop_10, (ErlangInt (DBI.fromInt 8))])
  in let
    lop_8 =
      (BIF.erlang__op_mult [lop_9, (ErlangInt (DBI.fromInt 8))])
  in let
    tup_el_7 =
...
erlps__next_pos__2 [(ErlangCons _ s_0), (ErlangTuple [l_1, c_2])]
  ...
  let   
    tup_el_6 =
      (BIF.erlang__op_plus [c_2, (ErlangInt (DBI.fromInt 1))])
