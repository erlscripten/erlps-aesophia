...
erlps__to_term__2 [source_0, config_1] | (H.isEList config_1) =
  let   
    arg_6 =
...
erlps__parse_config__1 [config_0] =
  let
    arg_2 =
      (ErlangTuple
         [(ErlangAtom "config"), (ErlangAtom "binary"),
          (ErlangAtom "false")])
...
erlps__parse_config__2 [(ErlangCons (ErlangTuple [(ErlangAtom "labels"),
  ...
  | ((ErlangAtom "true") ==
       (H.falsifyErrors
          (\ _ ->
             let   
               lop_11 = (BIF.erlang__op_eq [val_0, (ErlangAtom "binary")])
             in let
               lop_10 =
                 case lop_11 of
  ...
  let
    arg_4 =
      case config_2 of
        (ErlangTuple [(ErlangAtom "config"), labels_7, return_maps_8]) ->
          (ErlangTuple
             [(ErlangAtom "config"), labels_7, (ErlangAtom "true")])
        _ -> (EXC.badrecord (ErlangAtom "config"))
  in (erlps__parse_config__2 [rest_1, arg_4])
  ...
  let
    arg_3 =
      case config_1 of
        (ErlangTuple [(ErlangAtom "config"), labels_6, return_maps_7]) ->
          (ErlangTuple
             [(ErlangAtom "config"), labels_6, (ErlangAtom "true")])
        _ -> (EXC.badrecord (ErlangAtom "config"))
  in (erlps__parse_config__2 [rest_0, arg_3])
...
erlps__handle_event__2 [arg_4, arg_5] =
  (EXC.function_clause unit)
...
erlps__format_key__2 [key_0, config_1] =
  ...
  in
    case case_2 of
      ...
      something_else -> (EXC.case_clause something_else)
erlps__format_key__2 [arg_16, arg_17] =
  (EXC.function_clause unit)
...
erlps__start_term__1 [config_0] | (H.isEList config_0) =
...
erlps__start_array__1 [(ErlangTuple [stack_0, config_1])] =
  let   
    head_4 = (ErlangTuple [(ErlangAtom "array"), ErlangEmptyList])
  in let
    tup_el_2 =
      (BIF.erlang__op_append
         [(ErlangCons head_4 ErlangEmptyList), stack_0])
...
erlps__finish__1 [(ErlangTuple [(ErlangCons (ErlangTuple [(ErlangAtom "object"),
  ...
  in
    (erlps__insert__2 [(ErlangCons head_3 ErlangEmptyList), arg_5])
erlps__finish__1 [(ErlangTuple [(ErlangCons (ErlangTuple [(ErlangAtom "object"),
...
erlps__insert__2 [key_0,
  ...
  =
  let   
    head_6 = (ErlangTuple [(ErlangAtom "object"), key_0, map_1])
  in let
    tup_el_4 =
      (BIF.erlang__op_append
...
erlps__insert__2 [key_0,
  ...
  =
  let   
    head_6 = (ErlangTuple [(ErlangAtom "object"), key_0, pairs_1])
  in let
    tup_el_4 =
      (BIF.erlang__op_append
         [(ErlangCons head_6 ErlangEmptyList), rest_2])
