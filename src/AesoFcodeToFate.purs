...
erlps__debug__3 [arg_7, arg_8, arg_9] =
...
erlps__compile__2 [fcode_0, options_1] =
  case fcode_0 of
    (ErlangMap map_2) | (DM.Just functions_4) <-
      ...
      in let
        sfuns1_12 = (erlps__optimize_scode__2 [sfuns_9, options_1])
...
erlps__functions_to_scode__3 [contractname_0, functions_1,
  ...
  in let lc_src_6 = (BIF.maps__to_list__1 [functions_1])
  in let
    arg_5 =
      (H.flmap
         (\ lc_14 ->
            case lc_14 of
              (ErlangTuple [name_8, (ErlangMap map_9)]) | (DM.Just type_13) <-
                ...
                in let lc_ret_15 = (ErlangTuple [tup_el_16, tup_el_18])
...
erlps__function_to_scode__8 [contractname_0, functions_1, name_2,
  ...
  =
  let
    match_expr_12 = (erlps__typesig_to_scode__2 [args_4, restype_6])
  in
    case match_expr_12 of
      (ErlangTuple [argtypes_10, restype1_11]) ->
        ...
        in let
          arg_18 =
            (erlps__init_env__4
               [contractname_0, functions_1, name_2, args_4])
...
erlps__typesig_to_scode__2 [args_0, res_1] =
  let    tup_el_5 = (ErlangMap Map.empty)
  in let
    arg_3 = (ErlangTuple [(ErlangInt (DBI.fromInt 0)), tup_el_5])
    ...
    tup_el_6 =
      (H.flmap
         (\ lc_9 ->
            case lc_9 of
              (ErlangTuple [_, t_8]) ->
                let lc_ret_10 = (erlps__type_to_scode__1 [t_8])
...
erlps__type_to_scode__1 [(ErlangAtom "name")] =
  (ErlangAtom "name")
erlps__type_to_scode__1 [(ErlangAtom "channel")] =
  (ErlangAtom "channel")
erlps__type_to_scode__1 [(ErlangAtom "bits")] =
  (ErlangAtom "bits")
    ...
    tup_el_2 =
      (H.flmap
         (\ lc_5 ->
            ...
            in let lc_ret_6 = (ErlangTuple [(ErlangAtom "tuple"), tup_el_8])
...
erlps__type_to_scode__1 [(ErlangTuple [(ErlangAtom "tvar"),
                                       x_0])]
  =
  let match_expr_4 = (BIF.erlang__get__1 [(ErlangAtom "$tvars")])
  in
        ...
        in
          case case_5 of
            (ErlangAtom "false") ->
              let   
                tup_el_11 =
                  (BIF.erlang__op_plus [i_2, (ErlangInt (DBI.fromInt 1))])
              in let map_ext_18 = (ErlangMap (Map.singleton x_0 i_2))
              in let tup_el_14 = (BIF.maps__merge__2 [vars_3, map_ext_18])
...
erlps__init_env__4 [contractname_0, funnames_1, name_2, args_3] =
  let    lc_src_7 = (erlps__with_ixs__1 [args_3])
  in let
    tup_el_6 =
      (H.flmap
         (\ lc_11 ->
            case lc_11 of
              (ErlangTuple [i_9, (ErlangTuple [x_10, _])]) ->
                ...
                in let lc_ret_12 = (ErlangTuple [x_10, tup_el_14])
                in (ErlangCons lc_ret_12 ErlangEmptyList)
              _ -> ErlangEmptyList)
         lc_src_7)
  in
    (ErlangTuple
       [(ErlangAtom "env"), contractname_0, tup_el_6, funnames_1,
        name_2, (ErlangAtom "true")])
...
erlps__next_var__1 [(ErlangTuple [(ErlangAtom "env"), _, vars_0,
  ...
  =
  let   
    head_4 = (BIF.erlang__op_neg [(ErlangInt (DBI.fromInt 1))])
  in let
    tail_6 =
      (H.flmap
         (\ lc_9 ->
  ...
  in (BIF.erlang__op_plus [(ErlangInt (DBI.fromInt 1)), rop_2])
...
erlps__bind_local__2 [arg_11, arg_12] =
  (EXC.function_clause unit)
  ...
  let
    case_2 =
      (BIF.lists__keyfind__3
         [x_1, (ErlangInt (DBI.fromInt 1)), vars_0])
  in
    case case_2 of
      ...
      (ErlangAtom "false") ->
        let
          arg_7 =
            (ErlangTuple [(ErlangAtom "unbound_variable"), x_1, vars_0])
        in (erlps__code_error__1 [arg_7])
      something_else -> (EXC.case_clause something_else)
erlps__lookup_var__2 [arg_11, arg_12] =
  (EXC.function_clause unit)
...
erlps__term_to_fate__2 [env_0,
  ...
  let   
    arg_3 =
      (H.flmap
         (\ lc_6 ->
            let lc_ret_7 = (erlps__term_to_fate__2 [env_0, lc_6])
...
erlps__term_to_fate__2 [_env_0,
                        (ErlangTuple [(ErlangAtom "builtin"),
                                      ...
                                      (ErlangEmptyList)])]
  =
  let arg_1 = (BIF.erlang__op_neg [(ErlangInt (DBI.fromInt 1))])
  in
...
erlps__term_to_fate__2 [_env_0,
  ...
  =
  let match_expr_5 = (erlps__term_to_fate__1 [b_1])
  in
    case match_expr_5 of
      (ErlangTuple [(ErlangAtom "bits"), n_4]) ->
        let    j_7 = (erlps__term_to_fate__1 [i_2])
        in let
          rop_11 = (BIF.erlang__bsl__2 [(ErlangInt (DBI.fromInt 1)), j_7])
  ...
  in
    case match_expr_5 of
      (ErlangTuple [(ErlangAtom "bits"), n_4]) ->
        ...
        in let
          op_arg_12 =
            (BIF.erlang__bsl__2 [(ErlangInt (DBI.fromInt 1)), j_7])
...
erlps__term_to_fate__2 [env_0,
  ...
  in let map_ext_9 = (ErlangMap (Map.singleton x_1 val_6))
  in let env1_11 = (BIF.maps__merge__2 [env_0, map_ext_9])
...
erlps__term_to_fate__2 [env_0,
  ...
  in let map_ext_14 = (ErlangMap (Map.singleton key_8 val_11))
  in (BIF.maps__merge__2 [map_6, map_ext_14])
erlps__term_to_fate__2 [_env_0, _] =
  (BIF.erlang__throw__1 [(ErlangAtom "not_a_fate_value")])
erlps__term_to_fate__2 [arg_2, arg_3] =
  (EXC.function_clause unit)
    ...
    head_6 =
      (H.flmap
         (\ lc_9 ->
            ...
            in let lc_ret_10 = (erlps__to_scode__2 [arg_11, lc_9])
            in (ErlangCons lc_ret_10 ErlangEmptyList))
         as_3)
  in let
    arg_16 =
    ...
    head_4 =
      (H.flmap
         (\ lc_7 ->
            ...
            in let lc_ret_8 = (erlps__to_scode__2 [arg_9, lc_7])
...
erlps__to_scode1__2 [env_0,
  ...
  =
  let match_expr_8 = (erlps__bind_local__2 [x_1, env_0])
  in
      ...
      (ErlangFun 2
         let
           lambda_5 [arg_8, (ErlangTuple [is_9, acc_10, env1_11])] =
             let    arg_12 = (H.make_string "_")
             in let match_expr_16 = (erlps__bind_local__2 [arg_12, env1_11])
             in
               case match_expr_16 of
                 (ErlangTuple [i_14, env2_15]) ->
                   ...
                   in let
                     arg_29 =
                       (ErlangTuple
                          [(ErlangAtom "stack"), (ErlangInt (DBI.fromInt 0))])
                   in let
                     head_25 =
                       (BIF.do_remote_fun_call "Aeb.Fate.Ops" "erlps__store__2"
                          [arg_26, arg_29])
  ...
  in
    case match_expr_47 of
      (ErlangTuple [vars_44, code_45, _env_46]) ->
        let    lop_55 = (BIF.erlang__length__1 [vars_44])
        in let
          arg_54 =
            (BIF.erlang__op_minus [lop_55, (ErlangInt (DBI.fromInt 1))])
        in let
          arg_52 =
            (BIF.do_remote_fun_call "Lists" "erlps__seq__2"
               [(ErlangInt (DBI.fromInt 0)), arg_54])
        in let
          arg_58 =
    ...
    arg_10 =
      (H.flmap
         (\ lc_13 ->
            ...
            in let lc_ret_14 = (ErlangTuple [tup_el_15, lc_13])
            in (ErlangCons lc_ret_14 ErlangEmptyList))
         argst_1)
  in let
    match_expr_20 = (erlps__typesig_to_scode__2 [arg_10, rett_2])
  in
          ...
          case gas_5 of
            (ErlangTuple [(ErlangAtom "builtin"),
              ...
              in
                (erlps__call_to_scode__3
                   [env_0, call_41,
                    (ErlangCons ct_3 (ErlangCons value_6 args_7))])
            _ ->
              let   
                arg_49 =
                  (ErlangTuple
...
erlps__to_scode1__2 [env_0,
  ...
  in let
    head_5 =
      (ErlangTuple [(ErlangAtom "STORE"), tup_el_7, tup_el_10])
  in let head_14 = (erlps__tuple__1 [(ErlangInt (DBI.fromInt 0))])
  in
    (erlps__call_to_scode__3
...
erlps__to_scode1__2 [env_0,
  ...
  in let
    tup_el_9 = (ErlangTuple [(ErlangAtom "string"), tup_el_11])
          ...
          (\ _ ->
             case env_0 of
               (ErlangTuple arr_5) | (DM.Just field_4) <- ((arr_5 DA.!! 5)) ->
                 field_4
               _ -> (EXC.badrecord (ErlangAtom "env"))))) =
  (BIF.do_remote_fun_call "Aeb.Fate.Ops" "erlps__call_t__1"
     [fun_1])
...
erlps__split_to_scode__2 [env_0,
  ...
  =
  let
    match_expr_8 = (erlps__catchall_to_scode__3 [env_0, x_1, alts_2])
  in
    case match_expr_8 of
               ...
               (\ lc_16 ->
                  case lc_16 of
                    (ErlangTuple [(ErlangAtom "case"),
                                  ...
                                  split_15]) ->
                      let lc_ret_17 = (ErlangTuple [xs_14, split_15])
          ...
          alt_34 =
            case case_12 of
              ...
              (ErlangCons (ErlangTuple [xs_20, s_21]) _) ->
                let
                  match_expr_27 = (erlps__match_tuple__3 [env_0, arg_11, xs_20])
                in
              ...
              something_else -> (EXC.case_clause something_else)
        in let
          lop_36 = (BIF.erlang__op_eq [def_6, (ErlangAtom "missing")])
        in let
          case_35 =
            case lop_36 of
               ...
               let
                 lambda_9 [b_11] =
                   ...
                   in let
                     case_12 =
                       (BIF.lists__keyfind__3
                          [arg_13, (ErlangInt (DBI.fromInt 2)), alts1_7])
                   in
                     case case_12 of
                          ...
                          (\ lc_19 ->
                             case lc_19 of
                               c_18@(ErlangTuple [(ErlangAtom "case"), pat_17,
                                                  _]) ->
                                 let   
                                   lop_21 = (BIF.erlang__op_eq [pat_17, p_14])
                                 in let
                                   cond_20 =
                                     case lop_21 of
                                       (ErlangAtom "true") ->
                   ...
                   in
                     case case_15 of
                       ...
                       (ErlangCons (ErlangTuple [(ErlangAtom "case"),
                                                 ...
                                                 s_36]) _) ->
                         let
                           match_expr_41 = (erlps__bind_local__2 [y_34, env_0])
                         in
          ...
          head_79 =
            (ErlangTuple
               [(ErlangAtom "switch"), tup_el_81, (ErlangAtom "boolean"),
                (ErlangCons head_64 (ErlangCons head_68 ErlangEmptyList)),
                def_6])
...
erlps__split_to_scode__2 [env_0,
  ...
  let
    match_expr_9 = (erlps__catchall_to_scode__3 [env_0, x_2, alts_3])
  in
      ...
      (ErlangTuple [def_7, alts1_8]) ->
                               ...
                               (ErlangTuple [(ErlangAtom "case"),
                                 ...
                                 in
                                   case cond_22 of
                                     (ErlangAtom "true") ->
                                       let
                                         lc_ret_25 = (ErlangTuple [xs_19, s_20])
        ...
        in let
          tup_el_44 =
            (H.flmap
               (\ lc_47 ->
                  let lc_ret_48 = (BIF.erlang__length__1 [lc_47])
                  in (ErlangCons lc_ret_48 ErlangEmptyList))
               cons_1)
        in let
          stype_50 = (ErlangTuple [(ErlangAtom "variant"), tup_el_44])
        in let lop_56 = (BIF.erlang__length__1 [cons_1])
        in let
          arg_55 =
            (BIF.erlang__op_minus [lop_56, (ErlangInt (DBI.fromInt 1))])
        in let
          lc_src_53 =
            (BIF.do_remote_fun_call "Lists" "erlps__seq__2"
               [(ErlangInt (DBI.fromInt 0)), arg_55])
        in let
          tup_el_52 =
            (H.flmap
               (\ lc_60 ->
    ...
    head_31 =
      (ErlangTuple
         [(ErlangAtom "switch"), tup_el_33, (ErlangAtom "boolean"),
          (ErlangCons false_16 (ErlangCons true_9 ErlangEmptyList)),
          def_6])
...
erlps__catchall_to_scode__3 [env_0, x_1, alts_2] =
  (erlps__catchall_to_scode__4
     [env_0, x_1, alts_2, ErlangEmptyList])
  ...
  let
    arg_5 =
      (BIF.erlang__make_fun__3
         [(ErlangAtom "aeb_fate_ops"), (ErlangAtom "element_op"),
          (ErlangInt (DBI.fromInt 3))])
  in
    (erlps__match_tuple__5
       [env_0, (ErlangInt (DBI.fromInt 0)), arg_5, arg_1, xs_2])
...
erlps__match_tuple__5 [env_0, i_1, elem_2, arg_3,
  ...
  | ((ErlangInt num_4) == (ErlangInt (DBI.fromInt 95))) =
  let
    arg_7 = (BIF.erlang__op_plus [i_1, (ErlangInt (DBI.fromInt 1))])
  in (erlps__match_tuple__5 [env_0, arg_7, elem_2, arg_3, xs_5])
erlps__match_tuple__5 [env_0, i_1, elem_2, arg_3,
                       (ErlangCons x_4 xs_5)]
  =
  let match_expr_10 = (erlps__bind_local__2 [x_4, env_0])
  in
                ...
                head_22 =
                  (BIF.erlang__apply__2
                     [elem_2,
                      (ErlangCons arg_23
                         (ErlangCons arg_26
                            (ErlangCons arg_3 ErlangEmptyList)))])
              in
                (ErlangTuple
  ...
  in let
    head_4 =
      (BIF.do_remote_fun_call "Aeb.Fate.Ops" "erlps__spend__2"
         [arg_5, arg_8])
  in let head_12 = (erlps__tuple__1 [(ErlangInt (DBI.fromInt 0))])
  in
    (erlps__call_to_scode__3
...
erlps__builtin_to_scode__3 [_env_0,
  ...
  in let
    head_1 =
      (BIF.do_remote_fun_call "Aeb.Fate.Ops" "erlps__balance__1"
         [arg_2])
  in (ErlangCons head_1 ErlangEmptyList)
erlps__builtin_to_scode__3 [_env_0,
  ...
  in let
    head_1 =
      (BIF.do_remote_fun_call "Aeb.Fate.Ops" "erlps__address__1"
         [arg_2])
  in (ErlangCons head_1 ErlangEmptyList)
erlps__builtin_to_scode__3 [_env_0,
...
erlps__builtin_to_scode__3 [_env_0, (ErlangAtom "call_origin"),
  ...
  in let
    head_1 =
      (BIF.do_remote_fun_call "Aeb.Fate.Ops" "erlps__origin__1"
         [arg_2])
  in (ErlangCons head_1 ErlangEmptyList)
erlps__builtin_to_scode__3 [_env_0, (ErlangAtom "call_caller"),
  ...
  in let
    head_1 =
      (BIF.do_remote_fun_call "Aeb.Fate.Ops" "erlps__caller__1"
         [arg_2])
  in (ErlangCons head_1 ErlangEmptyList)
...
erlps__builtin_to_scode__3 [env_0, (ErlangAtom "oracle_respond"),
  ...
  in let head_30 = (erlps__tuple__1 [(ErlangInt (DBI.fromInt 0))])
  in
    (erlps__call_to_scode__3
       [env_0,
        (ErlangCons head_10 (ErlangCons head_30 ErlangEmptyList)),
        args_7])
  ...
  in let
    head_7 =
      (BIF.do_remote_fun_call "Aeb.Fate.Ops" "erlps__oracle_extend__3"
         [arg_8, arg_11, arg_14])
  in let head_18 = (erlps__tuple__1 [(ErlangInt (DBI.fromInt 0))])
  in
    (erlps__call_to_scode__3
...
erlps__builtin_to_scode__3 [env_0, (ErlangAtom "aens_claim"),
  ...
  in let head_26 = (erlps__tuple__1 [(ErlangInt (DBI.fromInt 0))])
  in
    (erlps__call_to_scode__3
...
erlps__builtin_to_scode__3 [env_0, (ErlangAtom "aens_transfer"),
  ...
  in let head_22 = (erlps__tuple__1 [(ErlangInt (DBI.fromInt 0))])
  in
    (erlps__call_to_scode__3
  ...
  let
    arg_2 =
      (ErlangFun 2
         ...
         in lambda_3)
  in
    (BIF.do_remote_fun_call "Maps" "erlps__map__2" [arg_2, funs_0])
...
erlps__flatten__1 [(ErlangAtom "missing")] =
  (ErlangAtom "missing")
...
erlps__flatten_s__1 [(ErlangTuple [(ErlangAtom "switch"), arg_0,
  ...
  let   
    tup_el_7 =
      (H.flmap
         (\ lc_10 ->
            let lc_ret_11 = (erlps__flatten__1 [lc_10])
  ...
  in let
    arg_10 =
      (ErlangFun 0
         let
           lambda_11 [] =
             let arg_12 = (H.make_string "Optimizing ~s\n")
             in
               (BIF.do_remote_fun_call "Erlang.Io" "erlps__format__2"
         ...
         in lambda_11)
  in let
    _ = (erlps__debug__3 [(ErlangAtom "opt"), options_5, arg_10])
  in let
    code1_19 =
      (erlps__simpl_loop__3
         [(ErlangInt (DBI.fromInt 0)), code0_7, options_5])
...
erlps__simpl_loop__3 [n_0, code_1, options_2]
  | (weakGeq n_0 (ErlangInt (DBI.fromInt 10))) =
  let   
    arg_5 =
      (ErlangFun 0
         let
           lambda_6 [] =
             let
               arg_7 =
                 (H.make_string
                    "  No simpl_loop fixed_point after ~p iterations.\n\n")
             in
               (BIF.do_remote_fun_call "Erlang.Io" "erlps__format__2"
         ...
         in lambda_6)
  in let
    _ = (erlps__debug__3 [(ErlangAtom "opt"), options_2, arg_5])
  in code_1
erlps__simpl_loop__3 [n_0, code_1, options_2] =
  let    acode_4 = (erlps__annotate_code__1 [code_1])
  in let
    cond_5 = (BIF.erlang__op_eq [n_0, (ErlangInt (DBI.fromInt 0))])
  in let
    _ =
      case cond_5 of
        (ErlangAtom "true") ->
          let   
            arg_11 =
              (ErlangFun 0
                 let
                   lambda_12 [] =
                     let    arg_13 = (H.make_string "  annotated:\n~s\n")
          ...
          in let
            lc_ret_8 =
              (erlps__debug__3 [(ErlangAtom "opt"), options_2, arg_11])
          in (ErlangCons lc_ret_8 ErlangEmptyList)
        _ -> ErlangEmptyList
    ...
    _ =
      case cond_22 of
        (ErlangAtom "true") ->
          let   
            arg_28 =
              (ErlangFun 0
                 let
                   lambda_29 [] =
                     let    arg_30 = (H.make_string "  optimized:\n~s\n")
          ...
          in let
            lc_ret_25 =
              (erlps__debug__3 [(ErlangAtom "opt"), options_2, arg_28])
          in (ErlangCons lc_ret_25 ErlangEmptyList)
        _ -> ErlangEmptyList
        ...
        let   
          arg_43 =
            (ErlangFun 0
                   ...
                   in let
                     head_49 =
                       case (ErlangAtom "true") of
                         _ | (weakNEq n_0 (ErlangInt (DBI.fromInt 1))) ->
                           (H.make_string "s")
                         _ -> (H.make_string "")
                   in
                     (BIF.do_remote_fun_call "Erlang.Io" "erlps__format__2"
               ...
               in lambda_44)
        in let
          _ = (erlps__debug__3 [(ErlangAtom "opt"), options_2, arg_43])
        in code2_37
      (ErlangAtom "false") ->
        let
          arg_51 = (BIF.erlang__op_plus [n_0, (ErlangInt (DBI.fromInt 1))])
...
erlps__pp_ann__2 [ind_0,
  ...
  let   
    tags_26 =
      case type_2 of
        (ErlangAtom "boolean") ->
          let    head_7 = (H.make_string "FALSE")
          in let head_9 = (H.make_string "TRUE")
          in (ErlangCons head_7 (ErlangCons head_9 ErlangEmptyList))
        (ErlangAtom "tuple") ->
          let head_11 = (H.make_string "(_)")
          in (ErlangCons head_11 ErlangEmptyList)
        (ErlangTuple [(ErlangAtom "variant"), ar_13]) ->
          let    lop_17 = (BIF.erlang__length__1 [ar_13])
          in let
            arg_16 =
  ...
  in let
    head_42 =
      (H.flmap
         (\ lc_48 ->
            case lc_48 of
              (ErlangTuple [tag_46, alt_47]) ->
                let
                  cond_49 =
                    (BIF.erlang__op_neq [alt_47, (ErlangAtom "missing")])
                in
                  case cond_49 of
                    (ErlangAtom "true") ->
                      let    head_57 = (H.make_string " =>\n")
         ...
         lc_src_43)
  in let
    cond_65 = (BIF.erlang__op_neq [def_4, (ErlangAtom "missing")])
  in let
    head_64 =
      case cond_65 of
        (ErlangAtom "true") ->
          let    head_71 = (H.make_string "_ =>\n")
...
erlps__pp_ann__2 [ind_0,
  ...
  let   
    fmt_17 =
      (ErlangFun 1
         let
           lambda_6 [(ErlangEmptyList)] = (H.make_string "()")
           lambda_6 [xs_8] =
             let   
               arg_9 =
                 (H.flmap
  ...
  in let
    ann_43 =
      case cond_25 of
        (ErlangAtom "true") ->
          let    head_31 = (H.make_string "   % ")
          in let
            head_33 =
              (BIF.erlang__apply__2
                 [fmt_17, (ErlangCons in_2 ErlangEmptyList)])
          in let head_37 = (H.make_string " -> ")
          in let
            head_39 =
              (BIF.erlang__apply__2
                 [fmt_17, (ErlangCons out_3 ErlangEmptyList)])
          in
            (ErlangCons
               (ErlangCons head_31
                  (ErlangCons head_33
               ...
               ErlangEmptyList)
        _ -> ErlangEmptyList
  in let arg_45 = (H.make_string "~-40s~s\n")
  in let
    head_44 =
...
erlps__pp_op__1 [(ErlangAtom "switch_body")] =
  (H.make_string "SWITCH-BODY")
erlps__pp_op__1 [(ErlangAtom "loop")] = (H.make_string "LOOP")
erlps__pp_op__1 [i_0] =
...
erlps__annotate_code__1 [code_0] =
  (erlps__annotate_code__3
     [(ErlangInt (DBI.fromInt 5)), ErlangEmptyList, code_0])
      ...
      (ErlangTuple [code1_6, livein_7]) ->
        ...
        in
          case case_9 of
            ...
            (ErlangAtom "false") | (weakLeq fuel_0
                                      (ErlangInt (DBI.fromInt 0))) ->
              (erlps__code_error__1
                 [(ErlangAtom "liveness_analysis_out_of_fuel")])
            (ErlangAtom "false") ->
              let
                arg_13 =
                  (BIF.erlang__op_minus [fuel_0, (ErlangInt (DBI.fromInt 1))])
...
erlps__ann_live__3 [livetop_0, (ErlangCons i_1 is_2), liveout_3]
  =
  let
    match_expr_9 = (erlps__ann_live__3 [livetop_0, is_2, liveout_3])
  in
    case match_expr_9 of
      (ErlangTuple [is1_7, livemid_8]) ->
        let
          match_expr_15 = (erlps__ann_live1__3 [livetop_0, i_1, livemid_8])
        in
...
erlps__ann_live1__3 [_livetop_0, (ErlangAtom "switch_body"),
  ...
  let   
    ann_6 =
      (ErlangMap
         (Map.fromFoldable
            [(Tup.Tuple (ErlangAtom "live_in") liveout_1),
             (Tup.Tuple (ErlangAtom "live_out") liveout_1)]))
  in let
    tup_el_7 =
      (ErlangTuple
         [(ErlangAtom "i"), ann_6, (ErlangAtom "switch_body")])
...
erlps__ann_live1__3 [livetop_0, (ErlangAtom "loop"), _liveout_1]
  ...
  let   
    ann_6 =
      (ErlangMap
         (Map.fromFoldable
            [(Tup.Tuple (ErlangAtom "live_in") livetop_0),
             (Tup.Tuple (ErlangAtom "live_out") ErlangEmptyList)]))
  in let
    tup_el_7 =
      (ErlangTuple [(ErlangAtom "i"), ann_6, (ErlangAtom "loop")])
  ...
  in let
    arg_10 =
      (H.flmap
         (\ lc_13 ->
            let
              lc_ret_14 = (erlps__ann_live__3 [livetop_0, lc_13, liveout_5])
            in (ErlangCons lc_ret_14 ErlangEmptyList))
         alts_3)
  in let
    match_expr_20 =
  ...
  in
    case match_expr_20 of
      (ErlangTuple [alts1_18, livealts_19]) ->
        let
          match_expr_26 =
            (erlps__ann_live__3 [livetop_0, def_4, liveout_5])
        in
...
erlps__ann_live1__3 [_livetop_0, i_1, liveout_2] =
  let match_expr_7 = (erlps__attributes__1 [i_1])
  in
      ...
      (ErlangMap map_4) | (DM.Just w_6) <-
        ...
        in let
          ann_22 =
            (ErlangMap
               (Map.fromFoldable
                  [(Tup.Tuple (ErlangAtom "live_in") livein_17),
                   (Tup.Tuple (ErlangAtom "live_out") liveout_2)]))
         ...
         let
           lambda_10 [w_14, r_15, p_16] =
             let
               val_20 =
                 (BIF.erlang__apply__2
                    [set_9, (ErlangCons r_15 ErlangEmptyList)])
             in
               (ErlangMap
                  (Map.fromFoldable
                     [(Tup.Tuple (ErlangAtom "read") val_20),
                      (Tup.Tuple (ErlangAtom "write") w_14),
                      (Tup.Tuple (ErlangAtom "pure") p_16)]))
    ...
    case i_0 of
      ...
      (ErlangTuple [(ErlangAtom "RETURNR"), a_56]) ->
        (BIF.erlang__apply__2
           [impure_45,
            (ErlangCons (ErlangAtom "pc")
               (ErlangCons a_56 ErlangEmptyList))])
      ...
      (ErlangTuple [(ErlangAtom "CALL_T"), a_105]) ->
        (BIF.erlang__apply__2
           [impure_45,
            (ErlangCons (ErlangAtom "pc")
               (ErlangCons (ErlangCons a_105 ErlangEmptyList)
                  ErlangEmptyList))])
      ...
      (ErlangTuple [(ErlangAtom "JUMPIF"), a_118, _]) ->
        (BIF.erlang__apply__2
           [impure_45,
            (ErlangCons (ErlangAtom "pc")
               (ErlangCons a_118 ErlangEmptyList))])
      (ErlangTuple [(ErlangAtom "SWITCH_V2"), a_122, _, _]) ->
        (BIF.erlang__apply__2
           [impure_45,
            (ErlangCons (ErlangAtom "pc")
               (ErlangCons a_122 ErlangEmptyList))])
      (ErlangTuple [(ErlangAtom "SWITCH_V3"), a_126, _, _, _]) ->
        (BIF.erlang__apply__2
           [impure_45,
            (ErlangCons (ErlangAtom "pc")
               (ErlangCons a_126 ErlangEmptyList))])
      (ErlangTuple [(ErlangAtom "SWITCH_VN"), a_130, _]) ->
        (BIF.erlang__apply__2
           [impure_45,
            (ErlangCons (ErlangAtom "pc")
               (ErlangCons a_130 ErlangEmptyList))])
      (ErlangTuple [(ErlangAtom "PUSH"), a_134]) ->
        ...
        in
          (BIF.erlang__apply__2
             [pure_35,
              (ErlangCons arg_135 (ErlangCons a_134 ErlangEmptyList))])
      (ErlangAtom "DUPA") ->
        let   
          arg_140 =
            (ErlangTuple [(ErlangAtom "stack"), (ErlangInt (DBI.fromInt 0))])
      ...
      (ErlangTuple [(ErlangAtom "DUP"), a_147]) ->
        ...
        in
          (BIF.erlang__apply__2
             [pure_35,
              (ErlangCons arg_148 (ErlangCons a_147 ErlangEmptyList))])
      (ErlangTuple [(ErlangAtom "POP"), a_153]) ->
        ...
        in
          (BIF.erlang__apply__2
             [pure_35,
              (ErlangCons a_153 (ErlangCons arg_155 ErlangEmptyList))])
      ...
      (ErlangTuple [(ErlangAtom "TUPLE"), a_331, n_332]) ->
        let   
          cond_335 =
            (BIF.erlang__op_greater [n_332, (ErlangInt (DBI.fromInt 0))])
        in let
          arg_334 =
            case cond_335 of
              (ErlangAtom "true") ->
                let
                  lc_ret_338 =
                    (ErlangTuple
                       [(ErlangAtom "stack"), (ErlangInt (DBI.fromInt 0))])
                in (ErlangCons lc_ret_338 ErlangEmptyList)
              _ -> ErlangEmptyList
        in
          (BIF.erlang__apply__2
             [pure_35,
              (ErlangCons a_331 (ErlangCons arg_334 ErlangEmptyList))])
              ...
              (ErlangCons a_519
                 (ErlangCons
                    (ErlangCons head_525
                       (ErlangCons b_520
                          (ErlangCons c_521
                             (ErlangCons d_522 ErlangEmptyList))))
                    ErlangEmptyList))])
      ...
      (ErlangTuple [(ErlangAtom "SHA3"), a_644, b_645]) ->
        (BIF.erlang__apply__2
           [pure_35,
            (ErlangCons a_644
               (ErlangCons (ErlangCons b_645 ErlangEmptyList)
                  ErlangEmptyList))])
      (ErlangTuple [(ErlangAtom "SHA256"), a_651, b_652]) ->
        (BIF.erlang__apply__2
           [pure_35,
            (ErlangCons a_651
               (ErlangCons (ErlangCons b_652 ErlangEmptyList)
                  ErlangEmptyList))])
      (ErlangTuple [(ErlangAtom "BLAKE2B"), a_658, b_659]) ->
        (BIF.erlang__apply__2
           [pure_35,
            (ErlangCons a_658
               (ErlangCons (ErlangCons b_659 ErlangEmptyList)
                  ErlangEmptyList))])
      ...
      (ErlangTuple [(ErlangAtom "CONTRACT_TO_ADDRESS"), a_714,
        ...
        (BIF.erlang__apply__2
           [pure_35,
            (ErlangCons a_714
               (ErlangCons (ErlangCons b_715 ErlangEmptyList)
                  ErlangEmptyList))])
      (ErlangTuple [(ErlangAtom "ADDRESS_TO_CONTRACT"), a_721,
        ...
        (BIF.erlang__apply__2
           [pure_35,
            (ErlangCons a_721
               (ErlangCons (ErlangCons b_722 ErlangEmptyList)
                  ErlangEmptyList))])
      ...
      (ErlangTuple [(ErlangAtom "BYTES_TO_INT"), a_732, b_733]) ->
        (BIF.erlang__apply__2
           [pure_35,
            (ErlangCons a_732
               (ErlangCons (ErlangCons b_733 ErlangEmptyList)
                  ErlangEmptyList))])
      (ErlangTuple [(ErlangAtom "BYTES_TO_STR"), a_739, b_740]) ->
        (BIF.erlang__apply__2
           [pure_35,
            (ErlangCons a_739
               (ErlangCons (ErlangCons b_740 ErlangEmptyList)
                  ErlangEmptyList))])
      ...
      (ErlangTuple [(ErlangAtom "IS_ORACLE"), a_795, b_796]) ->
        (BIF.erlang__apply__2
           [pure_35,
            (ErlangCons a_795
               (ErlangCons (ErlangCons b_796 ErlangEmptyList)
                  ErlangEmptyList))])
      (ErlangTuple [(ErlangAtom "IS_CONTRACT"), a_802, b_803]) ->
        (BIF.erlang__apply__2
           [pure_35,
            (ErlangCons a_802
               (ErlangCons (ErlangCons b_803 ErlangEmptyList)
                  ErlangEmptyList))])
      (ErlangTuple [(ErlangAtom "IS_PAYABLE"), a_809, b_810]) ->
        (BIF.erlang__apply__2
           [pure_35,
            (ErlangCons a_809
               (ErlangCons (ErlangCons b_810 ErlangEmptyList)
                  ErlangEmptyList))])
      ...
      (ErlangTuple [(ErlangAtom "BALANCE_OTHER"), a_828, b_829]) ->
        (BIF.erlang__apply__2
           [pure_35,
            (ErlangCons a_828
               (ErlangCons (ErlangCons b_829 ErlangEmptyList)
                  ErlangEmptyList))])
      ...
      (ErlangTuple [(ErlangAtom "BLOCKHASH"), a_847, b_848]) ->
        (BIF.erlang__apply__2
           [pure_35,
            (ErlangCons a_847
               (ErlangCons (ErlangCons b_848 ErlangEmptyList)
                  ErlangEmptyList))])
      ...
      (ErlangTuple [(ErlangAtom "LOG0"), a_882]) ->
        (BIF.erlang__apply__2
           [impure_45,
            (ErlangCons (ErlangAtom "none")
               (ErlangCons (ErlangCons a_882 ErlangEmptyList)
                  ErlangEmptyList))])
            ...
            (ErlangCons a_1034
               (ErlangCons
                  (ErlangCons b_1035
                     (ErlangCons c_1036
                        (ErlangCons d_1037
                           (ErlangCons e_1038 ErlangEmptyList))))
                  ErlangEmptyList))])
            ...
            (ErlangCons a_1050
               (ErlangCons
                  (ErlangCons b_1051
                     (ErlangCons c_1052
                        (ErlangCons d_1053
                           (ErlangCons e_1054 ErlangEmptyList))))
                  ErlangEmptyList))])
      (ErlangTuple [(ErlangAtom "ORACLE_QUERY_FEE"), a_1066,
        ...
        (BIF.erlang__apply__2
           [pure_35,
            (ErlangCons a_1066
               (ErlangCons (ErlangCons b_1067 ErlangEmptyList)
                  ErlangEmptyList))])
            ...
            (ErlangCons (ErlangAtom "none")
               (ErlangCons
                  (ErlangCons a_1119
                     (ErlangCons b_1120
                        (ErlangCons c_1121
                           (ErlangCons d_1122 ErlangEmptyList))))
                  ErlangEmptyList))])
      ...
      (ErlangTuple [(ErlangAtom "ABORT"), a_1146]) ->
        (BIF.erlang__apply__2
           [impure_45,
            (ErlangCons (ErlangAtom "pc")
               (ErlangCons a_1146 ErlangEmptyList))])
      (ErlangTuple [(ErlangAtom "EXIT"), a_1150]) ->
        (BIF.erlang__apply__2
           [impure_45,
            (ErlangCons (ErlangAtom "pc")
               (ErlangCons a_1150 ErlangEmptyList))])
      (ErlangAtom "NOP") ->
        (BIF.erlang__apply__2
           [pure_35,
            (ErlangCons (ErlangAtom "none")
...
erlps__var_writes__1 [i_0] =
  let match_expr_4 = (erlps__attributes__1 [i_0])
  in
    case match_expr_4 of
...
erlps__independent__2 [(ErlangTuple [(ErlangAtom "i"), _, i_0]),
  ...
  =
  let match_expr_7 = (erlps__attributes__1 [i_0])
  in
    case match_expr_7 of
      (ErlangMap map_3) | (DM.Just purei_6) <-
        ...
        let match_expr_13 = (erlps__attributes__1 [j_1])
        in
          case match_expr_13 of
            (ErlangMap map_9) | (DM.Just purej_12) <-
              ...
              in let
                stacki_20 =
                  (BIF.lists__member__2 [arg_14, (ErlangCons wi_4 ri_5)])
              in let
                arg_21 =
                  (ErlangTuple
                     [(ErlangAtom "stack"), (ErlangInt (DBI.fromInt 0))])
      ...
      _ -> (EXC.badmatch match_expr_7)
erlps__independent__2 [arg_45, arg_46] =
  (EXC.function_clause unit)
...
erlps__merge_ann__2 [(ErlangMap map_0), (ErlangMap map_2)]
  | (DM.Just livein_1) <-
      ((Map.lookup (ErlangAtom "live_in") map_0))
  , (DM.Just liveout_3) <-
      ((Map.lookup (ErlangAtom "live_out") map_2)) =
  (ErlangMap
     (Map.fromFoldable
        [(Tup.Tuple (ErlangAtom "live_in") livein_1),
         (Tup.Tuple (ErlangAtom "live_out") liveout_3)]))
...
erlps__swap_instrs__2 [(ErlangTuple [(ErlangAtom "i"),
  ...
  | (DM.Just live1_1) <-
      ((Map.lookup (ErlangAtom "live_in") map_0))
  , (DM.Just live3_5) <-
      ((Map.lookup (ErlangAtom "live_out") map_3))
  , (DM.Just live2_4) <-
  ...
  let   
    writesi_9 =
      (BIF.do_remote_fun_call "Ordsets" "erlps__subtract__2"
         [live2_4, live1_1])
  in let match_expr_13 = (erlps__attributes__1 [i_2])
  in
    case match_expr_13 of
      (ErlangMap map_11) | (DM.Just readsi_12) <-
        ...
        in let
          tup_el_33 =
            (ErlangMap
               (Map.fromFoldable
                  [(Tup.Tuple (ErlangAtom "live_in") live1_1),
                   (Tup.Tuple (ErlangAtom "live_out") live2__30)]))
        in let
          tup_el_31 = (ErlangTuple [(ErlangAtom "i"), tup_el_33, j_6])
        in let
          tup_el_41 =
            (ErlangMap
               (Map.fromFoldable
                  [(Tup.Tuple (ErlangAtom "live_in") live2__30),
                   (Tup.Tuple (ErlangAtom "live_out") live3_5)]))
        in let
          tup_el_39 = (ErlangTuple [(ErlangAtom "i"), tup_el_41, i_2])
        in (ErlangTuple [tup_el_31, tup_el_39])
      _ -> (EXC.badmatch match_expr_13)
erlps__swap_instrs__2 [arg_47, arg_48] =
  (EXC.function_clause unit)
...
erlps__simpl_s__2 [(ErlangTuple [(ErlangAtom "switch"), arg_0,
  ...
  let   
    tup_el_8 =
      (H.flmap
         (\ lc_11 ->
            let lc_ret_12 = (erlps__simplify__2 [lc_11, options_4])
            in (ErlangCons lc_ret_12 ErlangEmptyList))
         alts_2)
...
erlps__simpl_top__3 [i_0, code_1, options_2] =
  (erlps__simpl_top__4
     [(ErlangInt (DBI.fromInt 5000)), i_0, code_1, options_2])
...
erlps__simpl_top__4 [fuel_0, i_1, code_2, options_3] =
  ...
  in
    (erlps__apply_rules__5 [fuel_0, arg_5, i_1, code_2, options_3])
  ...
  in
    case case_17 of
      ...
      (ErlangTuple [rname_23, new_24, rest_25]) ->
        let   
          case_26 =
            (erlps__is_debug__2 [(ErlangAtom "opt_rules"), options_4])
        in let
          _ =
            case case_26 of
              (ErlangAtom "true") ->
                ...
                in let
                  match_expr_37 =
                    (erlps__drop_common_suffix__2
                       [(ErlangCons i_2 code_3), arg_32])
                in
                               ...
                               lambda_41 [] =
                                 let   
                                   arg_42 =
                                     (H.make_string
                                        "  Applied ~p:\n~s  ==>\n~s\n")
                                 in let arg_47 = (H.make_string "    ")
                                 in let
                                   head_46 =
                                     (erlps__pp_ann__2 [arg_47, oldcode_35])
                                 in let arg_51 = (H.make_string "    ")
                                 in let
                                   head_50 =
...
erlps__rules__0 [] =
  ...
  in let
    head_2 = (ErlangTuple [(ErlangAtom "r_swap_push"), tup_el_4])
  in let tup_el_8 = (ErlangFun 2 erlps__r_swap_pop__2)
  in let
    head_6 = (ErlangTuple [(ErlangAtom "r_swap_pop"), tup_el_8])
  ...
  in let
    head_18 =
      (ErlangTuple
         [(ErlangAtom "r_prune_impossible_branches"), tup_el_20])
  in let
    tup_el_24 = (ErlangFun 2 erlps__r_single_successful_branch__2)
  in let
    head_22 =
      (ErlangTuple
         [(ErlangAtom "r_single_successful_branch"), tup_el_24])
  in let tup_el_28 = (ErlangFun 2 erlps__r_inline_store__2)
  in let
    head_26 =
      (ErlangTuple [(ErlangAtom "r_inline_store"), tup_el_28])
...
erlps__r_push_consume__2 [(ErlangTuple [(ErlangAtom "i"), ann1_0,
  ...
  (erlps__inline_push__5
     [ann1_0, a_2, (ErlangInt (DBI.fromInt 0)), code_3,
      ErlangEmptyList])
erlps__r_push_consume__2 [(ErlangTuple [(ErlangAtom "i"), ann1_0,
                                        i_1]),
...
erlps__inline_push__5 [ann_0, arg_1, stack_2,
  ...
  in let match_expr_18 = (erlps__swap_instrs__2 [arg_6, ai_3])
  in
    ...
    case case_8 of
      (ErlangTuple [op_10, r_11, as_12]) ->
        ...
        in
          case case_31 of
            (ErlangAtom "true") ->
              let match_expr_38 = (erlps__split_stack_arg__2 [stack_2, as_12])
              in
            ...
            (ErlangAtom "false") | (weakNEq arg_1 r_11) ->
              ...
              in let
                tup_el_62 =
                  (ErlangTuple [(ErlangAtom "STORE"), tup_el_64, arg_1])
              in let
                arg_59 = (ErlangTuple [(ErlangAtom "i"), ann1_0, tup_el_62])
              in let match_expr_71 = (erlps__swap_instrs__2 [arg_59, ai_5])
              in
  ...
  let
    n1_10 =
      case (ErlangAtom "true") of
        ...
        _ -> n_0
  in
    (erlps__split_stack_arg__3 [n1_10, as_2, (ErlangCons a_1 acc_3)])
  ...
  in
    case case_4 of
      (ErlangTuple [_,
                    ...
                    _]) | ((ErlangInt num_6) == (ErlangInt (DBI.fromInt 0))) ->
        let case_7 = (erlps__independent__2 [push_1, i_2])
        in
          case case_7 of
            (ErlangAtom "true") ->
              let match_expr_14 = (erlps__swap_instrs__2 [push_1, i_2])
              in
                case match_expr_14 of
                  (ErlangTuple [i1_12, push1_13]) ->
                    (ErlangTuple
                       [(ErlangCons i1_12
                           (ErlangCons push1_13 ErlangEmptyList)),
                        code_3])
            ...
            (ErlangTuple [(ErlangTuple [_, ir_13, ias_14]),
              ...
              in
                case case_35 of
                  (ErlangAtom "false") -> (ErlangAtom "false")
                  (ErlangAtom "true") ->
                    let match_expr_41 = (erlps__swap_instrs__2 [ia_1, ja_3])
                    in
                      case match_expr_41 of
  ...
  in
    case case_3 of
      (ErlangTuple [(ErlangCons _ (ErlangEmptyList)),
                    (ErlangAtom "true")]) ->
        let match_expr_13 = (erlps__swap_instrs__2 [i_0, j_1])
        in
          case match_expr_13 of
...
erlps__r_swap_write__2 [arg_0, arg_1] =
  (EXC.function_clause unit)
...
erlps__r_swap_write__3 [pre_0, i_1,
  ...
  =
  let match_expr_8 = (erlps__swap_instrs__2 [i_1, j_2])
  in
    case match_expr_8 of
...
erlps__r_swap_write__3 [pre_0, i_1,
  ...
  in let
    case_5 = (erlps__apply_rules_once__3 [arg_6, i_1, code0_4])
  in
    case case_5 of
      ...
      (ErlangAtom "false") ->
        ...
        in
          case case_17 of
            (ErlangAtom "false") -> (ErlangAtom "false")
            (ErlangAtom "true") ->
              let match_expr_24 = (erlps__swap_instrs__2 [i_1, j_2])
              in
...
erlps__r_constant_propagation__2 [cons_4@(ErlangTuple [(ErlangAtom "i"),
  ...
  in let
    store_17 = (ErlangTuple [(ErlangAtom "i"), ann_5, tup_el_11])
  in let
    cons1_29 =
      case r_1 of
        (ErlangTuple [(ErlangAtom "stack"),
          ...
          let   
            tup_el_24 =
              (ErlangTuple
                 [(ErlangAtom "var"), (ErlangInt (DBI.fromInt 9999))])
          in let
            tup_el_22 =
              (ErlangTuple [(ErlangAtom "CONS"), tup_el_24, x_2, xs_3])
...
erlps__r_constant_propagation__2 [nil_2@(ErlangTuple [(ErlangAtom "i"),
  ...
  in let
    store_15 = (ErlangTuple [(ErlangAtom "i"), ann_3, tup_el_9])
  in let
    nil1_25 =
      case r_1 of
        (ErlangTuple [(ErlangAtom "stack"),
              ...
              in
                case case_18 of
                  ...
                  v_21 ->
                    ...
                    in let
                      head_23 =
                        (ErlangTuple [(ErlangAtom "i"), ann_0, tup_el_26])
                    in
                      (ErlangTuple
                         [(ErlangCons head_23 ErlangEmptyList), code_2])
            something_else -> (EXC.case_clause something_else)
      something_else -> (EXC.case_clause something_else)
...
erlps__eval_op__2 [(ErlangAtom "DIV"),
                   (ErlangCons x_0 (ErlangCons y_1 (ErlangEmptyList)))]
  | (((H.isEInt x_0) && (H.isEInt y_1)) &&
       (weakNEq y_1 (ErlangInt (DBI.fromInt 0)))) =
...
erlps__r_prune_impossible_branches__2 [(ErlangTuple [(ErlangAtom "switch"),
  ...
  let   
    head_6 =
      case (ErlangAtom "true") of
        _ | ((ErlangAtom "true") == (H.falsifyErrors (\ _ -> v_0))) ->
          (ErlangAtom "missing")
        _ -> false_1
  in let
    head_8 =
      ...
      (ErlangTuple [_, alt_36]) ->
        ...
        in
          case case_37 of
            ...
            something_else -> (EXC.case_clause something_else)
      something_else -> (EXC.case_clause something_else)
erlps__r_prune_impossible_branches__2 [_, _] =
  (ErlangAtom "false")
    ...
    case case_5 of
      ...
      (ErlangTuple [(ErlangCons def1_9 alts1_10), pushedout_11]) ->
        let
          head_13 =
            (ErlangTuple
               [(ErlangAtom "switch"), r_0, type_1, alts1_10, def1_9])
        in (ErlangTuple [(ErlangCons head_13 pushedout_11), code_4])
      something_else -> (EXC.case_clause something_else)
erlps__r_single_successful_branch__2 [_, _] =
  (ErlangAtom "false")
...
erlps__push_code_out_of_switch__1 [(ErlangCons alt_0 alts_1)] =
  let match_expr_5 = (erlps__push_code_out_of_alt__1 [alt_0])
  in
    case match_expr_5 of
      (ErlangTuple [alt1_3, pushedalt_4]) ->
        let match_expr_9 = (erlps__push_code_out_of_switch__1 [alts_1])
        in
          case match_expr_9 of
...
erlps__push_code_out_of_alt__1 [(ErlangCons body_0@(ErlangTuple [(ErlangAtom "i"),
  ...
  in
    case case_2 of
      ...
      (ErlangAtom "false") ->
        (ErlangTuple
           [(ErlangCons body_0 ErlangEmptyList),
            (ErlangCons body_0 code_1)])
      something_else -> (EXC.case_clause something_else)
    ...
    case match_expr_10 of
      (ErlangTuple [(ErlangCons def1_7 alts1_8), pushed_9]) ->
        let
          head_12 =
            (ErlangTuple
               [(ErlangAtom "switch"), r_0, type_1, alts1_8, def1_7])
...
erlps__push_code_out_of_alt__1 [arg_3] =
  (EXC.function_clause unit)
...
erlps__does_abort__1 [(ErlangTuple [(ErlangAtom "i"), _,
  ...
  =
  (ErlangAtom "true")
erlps__does_abort__1 [(ErlangAtom "missing")] =
  (ErlangAtom "true")
...
erlps__r_inline_switch_target__2 [(ErlangTuple [(ErlangAtom "i"),
  ...
  in let
    ann1_20 =
      case case_8 of
        (ErlangAtom "true") ->
          let   
            arg_14 = (BIF.maps__get__2 [(ErlangAtom "live_out"), ann_0])
          in let
            val_12 =
          ...
          in
            case (H.findMissingKey ann_0 [(ErlangAtom "live_out")]) of
              (DM.Nothing) -> (BIF.maps__merge__2 [ann_0, map_ext_17])
  ...
  in
    case r_1 of
      ...
      (ErlangTuple [(ErlangAtom "stack"),
                    (ErlangInt num_36)]) | ((ErlangInt num_36) ==
                                              (ErlangInt (DBI.fromInt 0))) ->
...
erlps__r_float_switch_body__2 [i_0@(ErlangTuple [(ErlangAtom "i"),
  ...
  =
  let match_expr_7 = (erlps__swap_instrs__2 [i_0, j_1])
  in
    case match_expr_7 of
...
erlps__r_inline_store__2 [i_2@(ErlangTuple [(ErlangAtom "i"), _,
  ...
  let
    inline_5 =
      case a_1 of
        ...
        (ErlangTuple [(ErlangAtom "immediate"), _]) ->
          (ErlangAtom "true")
  ...
  in
    case (ErlangAtom "true") of
      _ | ((ErlangAtom "true") ==
             (H.falsifyErrors (\ _ -> inline_5))) ->
        (erlps__r_inline_store__5
           [(ErlangCons i_2 ErlangEmptyList), (ErlangAtom "false"), r_0,
            a_1, code_3])
      _ -> (ErlangAtom "false")
...
erlps__r_inline_store__5 [acc_0, progress_1, r_2, a_3,
                          (ErlangCons (ErlangTuple [(ErlangAtom "i"), ann_4,
                                                    i_5]) code_6)]
  =
  let match_expr_10 = (erlps__attributes__1 [i_5])
  in
    case match_expr_10 of
              ...
              in
                case match_expr_40 of
                  (ErlangTuple [i1_38, progress1_39]) ->
                    let   
                      head_41 = (ErlangTuple [(ErlangAtom "i"), ann_4, i1_38])
                    in let
                      case_47 =
                        (BIF.lists__member__2
                           [w_9,
                            (ErlangCons r_2 (ErlangCons a_3 ErlangEmptyList))])
                    in
                      case case_47 of
                        (ErlangAtom "true") | ((ErlangAtom "true") ==
                                                 (H.falsifyErrors
                        ...
                        (ErlangAtom "false") ->
                          (erlps__r_inline_store__5
                             [(ErlangCons head_41 acc_0), progress1_39, r_2,
                              a_3, code_6])
                        something_else -> (EXC.case_clause something_else)
    ...
    case case_5 of
      (ErlangTuple [op_7, r_8@(ErlangTuple [(ErlangAtom "var"), _]),
        ...
        let   
          copy_15 =
            case j_3 of
              (ErlangTuple [(ErlangAtom "STORE"), s_11, r_12]) | (r_12 ==
                                                                    r_8) ->
...
erlps__r_write_to_dead_var__2 [(ErlangTuple [(ErlangAtom "i"), _,
                                             (ErlangTuple [(ErlangAtom "STORE"),
                                                           ...
                                                           (ErlangTuple [(ErlangAtom "stack"),
                                                                         (ErlangInt num_1)])])]),
                               _]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 9999)))
  , ((ErlangInt num_1) == (ErlangInt (DBI.fromInt 0))) =
  (ErlangAtom "false")
erlps__r_write_to_dead_var__2 [(ErlangTuple [(ErlangAtom "i"),
                               ...
                               code_2]
  =
  let match_expr_6 = (erlps__attributes__1 [i_1])
  in
                                ...
                                rop_26 =
                                  (ErlangTuple
                                     [(ErlangAtom "stack"),
                                      (ErlangInt (DBI.fromInt 0))])
                              in let
                                cond_24 = (BIF.erlang__op_eq [lc_23, rop_26])
                              in
                                case cond_24 of
                                  (ErlangAtom "true") ->
                                    let   
...
erlps__op_view__1 [t_0] | (H.isETuple t_0) =
  let match_expr_5 = (BIF.erlang__tuple_to_list__1 [t_0])
  in
    case match_expr_5 of
            ...
            (ErlangFun 2
               let
                 lambda_6 [rs_9, x_10] =
                   ...
                   in let
                     case_11 = (BIF.erlang__op_eq [ErlangEmptyList, rop_13])
                   in
                     case case_11 of
          ...
          case case_21 of
            ...
            (ErlangMap map_39) | (DM.Just rs_40) <-
              ...
              let
                arg_42 =
                  (ErlangTuple
                     [op_2, (ErlangAtom "none"), (ErlangCons r_3 as_4)])
              in
                (BIF.erlang__apply__2
                   [checkreads_20,
...
erlps__unannotate__1 [(ErlangTuple [(ErlangAtom "switch"), arg_0,
  ...
  let   
    tup_el_8 =
      (H.flmap
         (\ lc_11 ->
            let lc_ret_12 = (erlps__unannotate__1 [lc_11])
            in (ErlangCons lc_ret_12 ErlangEmptyList))
         alts_2)
...
erlps__unannotate__1 [(ErlangAtom "missing")] =
  (ErlangAtom "missing")
erlps__unannotate__1 [code_0] | (H.isEList code_0) =
...
erlps__desugar__1 [(ErlangTuple [(ErlangAtom "ADD"),
  ...
  let
    head_3 =
      (BIF.do_remote_fun_call "Aeb.Fate.Ops" "erlps__inc__0" [])
...
erlps__desugar__1 [(ErlangTuple [(ErlangAtom "SUB"),
  ...
  let
    head_3 =
      (BIF.do_remote_fun_call "Aeb.Fate.Ops" "erlps__dec__0" [])
  in (ErlangCons head_3 ErlangEmptyList)
...
erlps__desugar__1 [(ErlangTuple [(ErlangAtom "switch"), arg_0,
  ...
  in let
    tup_el_9 =
      (H.flmap
         (\ lc_12 ->
            let lc_ret_13 = (erlps__desugar__1 [lc_12])
            in (ErlangCons lc_ret_13 ErlangEmptyList))
         alts_2)
  ...
  in (ErlangCons head_4 ErlangEmptyList)
erlps__desugar__1 [(ErlangAtom "missing")] =
  (ErlangAtom "missing")
erlps__desugar__1 [code_0] | (H.isEList code_0) =
...
erlps__desugar_args__1 [i_0] | (H.isETuple i_0) =
  let match_expr_4 = (BIF.erlang__tuple_to_list__1 [i_0])
  in
    case match_expr_4 of
...
erlps__bb__2 [_name_0, code_1] =
  ...
  in let
    blocks_8 =
      (BIF.do_remote_fun_call "Lists" "erlps__flatmap__2"
         [arg_6, blocks1_5])
  in let lc_src_10 = (erlps__with_ixs__1 [blocks_8])
  in let
    arg_9 =
      (H.flmap
         (\ lc_14 ->
            case lc_14 of
              (ErlangTuple [i_12, (ErlangTuple [ref_13, _])]) ->
                let lc_ret_15 = (ErlangTuple [ref_13, i_12])
                in (ErlangCons lc_ret_15 ErlangEmptyList)
              _ -> ErlangEmptyList)
         lc_src_10)
  ...
  in let
    bbs_25 =
      (H.flmap
         (\ lc_21 ->
            let lc_ret_22 = (erlps__set_labels__2 [labels_18, lc_21])
            in (ErlangCons lc_ret_22 ErlangEmptyList))
         blocks_8)
...
erlps__blocks__1 [code_0] =
  ...
  in let
    head_3 =
      (ErlangTuple
         [(ErlangAtom "blk"), top_1, code_0, (ErlangAtom "none")])
  in
    (erlps__blocks__2
    ...
    arg_5 =
      case blk_1 of
        (ErlangTuple [(ErlangAtom "blk"), ref_9, code_10,
                      catchall_11]) ->
          (ErlangTuple
             [(ErlangAtom "blk"), ref_9, code_0, (ErlangAtom "none")])
    ...
    case match_expr_30 of
      (ErlangTuple [restref_28, restblk_29]) ->
        let
          match_expr_72 =
            case default_3 of
              (ErlangAtom "missing") | (weakEq catchall_5
                                          (ErlangAtom "none")) ->
                let   
                  tup_el_36 =
                    (ErlangBinary
                       (BIN.concat
                          [(BIN.from_int (ErlangInt (DBI.fromInt 73))
                           ...
                           (BIN.from_int (ErlangInt (DBI.fromInt 115))
                              (ErlangInt (DBI.fromInt 8)) 1 BIN.Big)]))
                in let
                  arg_34 = (ErlangTuple [(ErlangAtom "immediate"), tup_el_36])
                in let
                  head_33 =
              ...
              _ ->
                ...
                in
                  (BIF.erlang__apply__2
                     [freshblk_24,
                      (ErlangCons arg_61
                         (ErlangCons catchall_5 ErlangEmptyList))])
        in
                ...
                pop_83 =
                  case cond_73 of
                    (ErlangAtom "true") ->
                      ...
                      in let
                        lc_ret_78 =
                          (ErlangTuple [(ErlangAtom "POP"), tup_el_80])
                      in (ErlangCons lc_ret_78 ErlangEmptyList)
                    _ -> ErlangEmptyList
              in let
                match_expr_294 =
                  case type_1 of
                        ...
                        case case_236 of
                          (ErlangAtom "true") ->
                            ...
                            in let
                              record_updt_244 =
                                (BIF.erlang__op_append
                                   [pop_83,
                                    (ErlangCons head_247 ErlangEmptyList)])
                            in let
                              tup_el_242 =
                                case blk_6 of
                          ...
                          (ErlangAtom "false") ->
                            ...
                            in let
                              match_expr_276 =
                                (BIF.do_remote_fun_call "Lists"
                                   "erlps__unzip__1" [arg_271])
                            in
                              case match_expr_276 of
                                  ...
                                  in
                                    (ErlangTuple
                                       [tup_el_277,
                                        ...
                                        tup_el_289])
                                _ -> (EXC.badmatch match_expr_276)
                          something_else -> (EXC.case_clause something_else)
                    something_else -> (EXC.case_clause something_else)
              in
                case match_expr_294 of
                  (ErlangTuple [blk1_291, code1_292, altblks_293]) ->
                      ...
                      blk2_300 =
                        case blk1_291 of
                          (ErlangTuple [(ErlangAtom "blk"), ref_297, code_298,
                                        catchall_299]) ->
                            (ErlangTuple
                               [(ErlangAtom "blk"), ref_297, code_298,
                                defref_70])
                          _ -> (EXC.badrecord (ErlangAtom "blk"))
                    ...
                    in let
                      rop_307 = (BIF.erlang__op_append [restblk_29, rop_309])
                    in let
                      arg_305 = (BIF.erlang__op_append [defblk_71, rop_307])
                    in
                      (erlps__block__4 [blk2_300, arg_302, arg_305, blockacc_9])
                  _ -> (EXC.badmatch match_expr_294)
                     ...
                     (ErlangTuple [ref_5, code_6]) ->
                       let   
                         tup_el_10 =
                           (BIF.do_remote_fun_call "Lists" "erlps__reverse__1"
                              [code_6])
                       in let lc_ret_8 = (ErlangTuple [ref_5, tup_el_10])
                       in (ErlangCons lc_ret_8 ErlangEmptyList)
                     _ -> ErlangEmptyList)
                bs_3)
           lambda_1 [arg_2] = (EXC.function_clause unit)
         ...
         (\ lc_24 ->
            case lc_24 of
              (ErlangTuple [ref_22, code_23]) ->
                ...
                in let lc_ret_25 = (ErlangTuple [ref_22, tup_el_27])
                in (ErlangCons lc_ret_25 ErlangEmptyList)
              _ -> ErlangEmptyList)
         rblocks1_20)
  in let
    rblocks3_33 = (erlps__shortcut_jump_chains__1 [rblocks2_31])
         ...
         (\ lc_39 ->
            case lc_39 of
              (ErlangTuple [ref_37, code_38]) ->
                ...
                in let lc_ret_40 = (ErlangTuple [ref_37, tup_el_42])
                     ...
                     (\ _ ->
                        ...
                        in
                          (BIF.erlang__op_lesser
                             [lop_10, (ErlangInt (DBI.fromInt 3))])))) ->
           ...
           lambda_2 [(ErlangTuple [l1_5,
             ...
             let   
               val_10 =
                 (BIF.do_remote_fun_call "Maps" "erlps__get__3"
                    [l2_6, sub_7, l2_6])
             in let map_ext_14 = (ErlangMap (Map.singleton l1_5 val_10))
             in (BIF.maps__merge__2 [sub_7, map_ext_14])
       ...
       (\ lc_23 ->
          case lc_23 of
            (ErlangTuple [ref_21, code_22]) ->
              ...
              in let lc_ret_24 = (ErlangTuple [ref_21, tup_el_26])
...
erlps__update_labels__2 [sub_0, ref_1]
  | ((ErlangAtom "true") ==
       (H.falsifyErrors
          (\ _ -> (BIF.erlang__is_reference__1 [ref_1])))) =
  (BIF.do_remote_fun_call "Maps" "erlps__get__3"
     [ref_1, sub_0, ref_1])
erlps__update_labels__2 [sub_0, l_1] | (H.isEList l_1) =
  let
    arg_2 =
      (ErlangFun 1
         let
...
erlps__update_labels__2 [sub_0, t_1] | (H.isETuple t_1) =
...
erlps__update_labels__2 [arg_1, arg_2] =
  (EXC.function_clause unit)
    ...
    (H.flmap
       (\ lc_13 ->
          case lc_13 of
            ...
            _ -> ErlangEmptyList)
       blocks_1)
erlps__remove_dead_blocks__1 [arg_18] =
  (EXC.function_clause unit)
...
erlps__chase_labels__3 [(ErlangCons l_0 ls_1), map_2, live_3] =
  ...
  in let
    map_ext_42 = (ErlangMap (Map.singleton l_0 (ErlangAtom "true")))
  in let arg_38 = (BIF.maps__merge__2 [live_3, map_ext_42])
  ...
  | ((ErlangAtom "true") ==
       (H.falsifyErrors
          (\ _ ->
             let   
               lop_19 =
                 (BIF.erlang__element__2 [(ErlangInt (DBI.fromInt 1)), i_1])
...
erlps__set_labels__2 [labels_0, (ErlangTuple [ref_1, code_2])]
  ...
  in let
    tup_el_6 =
      (H.flmap
         (\ lc_9 ->
            let lc_ret_10 = (erlps__set_labels__2 [labels_0, lc_9])
            in (ErlangCons lc_ret_10 ErlangEmptyList))
         code_2)
  in (ErlangTuple [tup_el_3, tup_el_6])
erlps__set_labels__2 [_labels_0, (ErlangAtom "loop")] =
  (BIF.do_remote_fun_call "Aeb.Fate.Ops" "erlps__jump__1"
     [(ErlangInt (DBI.fromInt 0))])
erlps__set_labels__2 [labels_0,
  ...
  in
    (BIF.do_remote_fun_call "Aeb.Fate.Ops" "erlps__jump__1" [arg_2])
erlps__set_labels__2 [labels_0,
...
erlps__set_labels__2 [labels_0,
  ...
  let
    case_3 =
      (H.flmap
         (\ lc_6 ->
            let lc_ret_7 = (BIF.maps__get__2 [lc_6, labels_0])
            in (ErlangCons lc_ret_7 ErlangEmptyList))
         refs_2)
  in
    case case_3 of
...
erlps__with_ixs__1 [xs_0] =
  let    lop_4 = (BIF.erlang__length__1 [xs_0])
  in let
    arg_3 =
