...
erlps__parse_config__1 [config_0] =
  let
    arg_2 =
      (ErlangTuple
         [(ErlangAtom "config"), (ErlangAtom "false"),
    ...
    arg_3 =
      case config_1 of
        (ErlangTuple [(ErlangAtom "config"), dirty_strings_6,
                      ...
                      incomplete_handler_20]) ->
          (ErlangTuple
             [(ErlangAtom "config"), dirty_strings_6,
              escaped_forward_slashes_7, (ErlangAtom "true"), multi_term_9,
        ...
        (ErlangTuple [(ErlangAtom "config"), dirty_strings_6,
          ...
          (ErlangTuple
             [(ErlangAtom "config"), dirty_strings_6,
              ...
              strict_comments_10, strict_commas_11, strict_utf8_12,
              strict_single_quotes_13, strict_escapes_14, stream_15,
              return_tail_16, uescape_17, (ErlangAtom "true"),
              error_handler_19, incomplete_handler_20])
        _ -> (EXC.badrecord (ErlangAtom "config"))
  in (erlps__parse_config__2 [rest_0, arg_3])
      ...
      case config_1 of
        (ErlangTuple [(ErlangAtom "config"), dirty_strings_6,
          ...
          (ErlangTuple
             [(ErlangAtom "config"), dirty_strings_6,
              escaped_forward_slashes_7, escaped_strings_8,
              (ErlangAtom "true"), strict_comments_10, strict_commas_11,
              strict_utf8_12, strict_single_quotes_13, strict_escapes_14,
              stream_15, return_tail_16, uescape_17, unescaped_jsonp_18,
              error_handler_19, incomplete_handler_20])
        _ -> (EXC.badrecord (ErlangAtom "config"))
  in (erlps__parse_config__2 [rest_0, arg_3])
        ...
        (ErlangTuple [(ErlangAtom "config"), dirty_strings_6,
          ...
          (ErlangTuple
             [(ErlangAtom "config"), dirty_strings_6,
              ...
              strict_comments_10, strict_commas_11, strict_utf8_12,
              strict_single_quotes_13, strict_escapes_14, stream_15,
              (ErlangAtom "true"), uescape_17, unescaped_jsonp_18,
              error_handler_19, incomplete_handler_20])
        _ -> (EXC.badrecord (ErlangAtom "config"))
  in (erlps__parse_config__2 [rest_0, arg_3])
        ...
        (ErlangTuple [(ErlangAtom "config"), dirty_strings_6,
          ...
          (ErlangTuple
             [(ErlangAtom "config"), dirty_strings_6,
              ...
              strict_comments_10, strict_commas_11, strict_utf8_12,
              strict_single_quotes_13, strict_escapes_14, stream_15,
              return_tail_16, (ErlangAtom "true"), unescaped_jsonp_18,
              error_handler_19, incomplete_handler_20])
        _ -> (EXC.badrecord (ErlangAtom "config"))
  in (erlps__parse_config__2 [rest_0, arg_3])
        ...
        (ErlangTuple [(ErlangAtom "config"), dirty_strings_10,
          ...
          (ErlangTuple
             [(ErlangAtom "config"), dirty_strings_10,
              ...
              (ErlangAtom "true"), (ErlangAtom "true"), stream_19,
              return_tail_20, uescape_21, unescaped_jsonp_22, error_handler_23,
              incomplete_handler_24])
        _ -> (EXC.badrecord (ErlangAtom "config"))
  in (erlps__parse_config__2 [rest_0, arg_3])
        ...
        (ErlangTuple [(ErlangAtom "config"), dirty_strings_6,
          ...
          (ErlangTuple
             [(ErlangAtom "config"), dirty_strings_6,
              escaped_forward_slashes_7, escaped_strings_8, multi_term_9,
              strict_comments_10, strict_commas_11, strict_utf8_12,
              strict_single_quotes_13, strict_escapes_14, (ErlangAtom "true"),
              return_tail_16, uescape_17, unescaped_jsonp_18, error_handler_19,
              incomplete_handler_20])
        _ -> (EXC.badrecord (ErlangAtom "config"))
  in (erlps__parse_config__2 [rest_0, arg_3])
erlps__parse_config__2__p2 [options_2@(ErlangCons (ErlangTuple [(ErlangAtom "error_handler"),
                            ...
                            config_3]
  | (H.isEFunA errorhandler_0 (ErlangInt (DBI.fromInt 3))) =
  let
    case_4 =
      case config_3 of
...
erlps__parse_config__2__p2 [options_2@(ErlangCons (ErlangTuple [(ErlangAtom "incomplete_handler"),
                            ...
                            config_3]
  | (H.isEFunA incompletehandler_0 (ErlangInt (DBI.fromInt 3))) =
  let
    case_4 =
      case config_3 of
    ...
    arg_5 =
      case config_2 of
        (ErlangTuple [(ErlangAtom "config"), dirty_strings_8,
          ...
          (ErlangTuple
             [(ErlangAtom "config"), dirty_strings_8,
              escaped_forward_slashes_9, escaped_strings_10, multi_term_11,
              (ErlangAtom "true"), strict_commas_13, strict_utf8_14,
              strict_single_quotes_15, strict_escapes_16, stream_17,
              return_tail_18, uescape_19, unescaped_jsonp_20, error_handler_21,
              incomplete_handler_22])
        _ -> (EXC.badrecord (ErlangAtom "config"))
      ...
      case config_2 of
        (ErlangTuple [(ErlangAtom "config"), dirty_strings_8,
          ...
          (ErlangTuple
             [(ErlangAtom "config"), dirty_strings_8,
              escaped_forward_slashes_9, escaped_strings_10, multi_term_11,
              strict_comments_12, (ErlangAtom "true"), strict_utf8_14,
              strict_single_quotes_15, strict_escapes_16, stream_17,
              return_tail_18, uescape_19, unescaped_jsonp_20, error_handler_21,
              incomplete_handler_22])
        _ -> (EXC.badrecord (ErlangAtom "config"))
      ...
      case config_2 of
        (ErlangTuple [(ErlangAtom "config"), dirty_strings_8,
          ...
          (ErlangTuple
             [(ErlangAtom "config"), dirty_strings_8,
              escaped_forward_slashes_9, escaped_strings_10, multi_term_11,
              strict_comments_12, strict_commas_13, (ErlangAtom "true"),
              strict_single_quotes_15, strict_escapes_16, stream_17,
              return_tail_18, uescape_19, unescaped_jsonp_20, error_handler_21,
              incomplete_handler_22])
        _ -> (EXC.badrecord (ErlangAtom "config"))
      ...
      case config_2 of
        (ErlangTuple [(ErlangAtom "config"), dirty_strings_8,
          ...
          (ErlangTuple
             [(ErlangAtom "config"), dirty_strings_8,
              escaped_forward_slashes_9, escaped_strings_10, multi_term_11,
              strict_comments_12, strict_commas_13, strict_utf8_14,
              (ErlangAtom "true"), strict_escapes_16, stream_17,
              return_tail_18, uescape_19, unescaped_jsonp_20, error_handler_21,
              incomplete_handler_22])
        _ -> (EXC.badrecord (ErlangAtom "config"))
  in (erlps__parse_strict__3 [strict_0, rest_1, arg_5])
        ...
        (ErlangTuple [(ErlangAtom "config"), dirty_strings_8,
          ...
          (ErlangTuple
             [(ErlangAtom "config"), dirty_strings_8,
              escaped_forward_slashes_9, escaped_strings_10, multi_term_11,
              strict_comments_12, strict_commas_13, strict_utf8_14,
              strict_single_quotes_15, (ErlangAtom "true"), stream_17,
              return_tail_18, uescape_19, unescaped_jsonp_20, error_handler_21,
              incomplete_handler_22])
        _ -> (EXC.badrecord (ErlangAtom "config"))
  in (erlps__parse_strict__3 [strict_0, rest_1, arg_5])
    ...
    case case_4 of
      (ErlangAtom "true") ->
        ...
        in let
          arg_8 =
            (BIF.erlang__op_append
               [(ErlangCons head_10 ErlangEmptyList), acc_3])
