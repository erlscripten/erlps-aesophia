...
erlps__new__2 [type_0, msg_1] =
  ...
  in let arg_3 = erlps__pos__2 [arg_4, arg_5]
...
erlps__throw__1 [errs_0] | isEList errs_0 =
  let   
    arg_1 =
      ErlangFun 2
        (let
  ...
  in let arg_17 = ErlangTuple [ErlangAtom "error", sortederrs_16]
...
erlps__pp_pos__1 [(ErlangTuple [(ErlangAtom "pos"),
                                (ErlangAtom "no_file"), l_0, c_1])]
  =
  let arg_2 = toErl " at line ~p, col ~p"
  in
    BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
      [arg_2, ErlangCons l_0 (ErlangCons c_1 ErlangEmptyList)]
erlps__pp_pos__1 [(ErlangTuple [(ErlangAtom "pos"), f_0, l_1,
                                c_2])]
  =
  let arg_3 = toErl " in \'~s\' at line ~p, col ~p"
  in
    BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
      [arg_3,
       ErlangCons f_0 (ErlangCons l_1 (ErlangCons c_2 ErlangEmptyList))]
...
erlps__to_json__1 [(ErlangTuple [(ErlangAtom "err"), pos_0,
  ...
  in let
    val_9 = BIF.erlang__atom_to_binary__2 [type_1, ErlangAtom "utf8"]
  in let val_12 = BIF.erlang__iolist_to_binary__1 [msg_2]
  in let
    json_14 =
      ErlangMap
        (Map.fromFoldable
           [DT.Tuple (ErlangAtom "pos") val_7,
            DT.Tuple (ErlangAtom "type") val_9,
            DT.Tuple (ErlangAtom "message") val_12])
  in
    case cxt_3 of
...
erlps__pos_to_json__1 [(ErlangTuple [(ErlangAtom "pos"), file_0,
  ...
  let
    json_7 =
      ErlangMap
        (Map.fromFoldable
           [DT.Tuple (ErlangAtom "line") line_1,
            DT.Tuple (ErlangAtom "col") col_2])
  in
    case file_0 of
      ...
      _ ->
        ...
        in let
          mapExt_13 = ErlangMap (Map.singleton (ErlangAtom "file") val_11)
