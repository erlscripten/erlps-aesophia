...
erlps__fold__4 [alg_3@(ErlangTuple [(ErlangAtom "alg"), zero_0,
      ...
      case x_6 of
        (ErlangCons a_67 as_68) ->
          let   
            arg_69 =
              (BIF.erlang__apply__2
                 [same_21, (ErlangCons a_67 ErlangEmptyList)])
          in let
            arg_72 =
              (BIF.erlang__apply__2
                 [same_21, (ErlangCons as_68 ErlangEmptyList)])
          in
            (BIF.erlang__apply__2
               [scoped_2,
                (ErlangCons arg_69 (ErlangCons arg_72 ErlangEmptyList))])
        (ErlangTuple [(ErlangAtom "contract"), _, _, ds_76]) ->
          (BIF.erlang__apply__2
             [decl_29, (ErlangCons ds_76 ErlangEmptyList)])
        (ErlangTuple [(ErlangAtom "namespace"), _, _, ds_79]) ->
          (BIF.erlang__apply__2
             [decl_29, (ErlangCons ds_79 ErlangEmptyList)])
        (ErlangTuple [(ErlangAtom "type_def"), _, i_82, _, d_83]) ->
          ...
          in let
            arg_87 =
              (BIF.erlang__apply__2
                 [decl_29, (ErlangCons d_83 ErlangEmptyList)])
          in
            (BIF.erlang__apply__2
               [plus_1,
                (ErlangCons arg_84 (ErlangCons arg_87 ErlangEmptyList))])
        (ErlangTuple [(ErlangAtom "fun_decl"), _, _, t_91]) ->
          (BIF.erlang__apply__2
             [type_37, (ErlangCons t_91 ErlangEmptyList)])
        (ErlangTuple [(ErlangAtom "letval"), _, p_94, e_95]) ->
          ...
          in let
            arg_99 =
              (BIF.erlang__apply__2
                 [expr_45, (ErlangCons e_95 ErlangEmptyList)])
          in
            (BIF.erlang__apply__2
               [scoped_2,
                (ErlangCons arg_96 (ErlangCons arg_99 ErlangEmptyList))])
        (ErlangTuple [(ErlangAtom "letfun"), _, f_103, xs_104, t_105,
          ...
          in let
            head_112 =
              (BIF.erlang__apply__2
                 [type_37, (ErlangCons t_105 ErlangEmptyList)])
          in let
            arg_117 =
              (BIF.erlang__op_append
                 [xs_104, (ErlangCons e_106 ErlangEmptyList)])
          in let
            head_116 =
              (BIF.erlang__apply__2
            ...
            (BIF.erlang__apply__2
               [sum_13,
                (ErlangCons
                   (ErlangCons head_108
                      (ErlangCons head_112
                         (ErlangCons head_116 ErlangEmptyList)))
                   ErlangEmptyList)])
        (ErlangTuple [(ErlangAtom "fun_clauses"), _, _, t_125,
          ...
          let   
            head_128 =
              (BIF.erlang__apply__2
                 [type_37, (ErlangCons t_125 ErlangEmptyList)])
          in let
            tail_131 =
              (H.flmap
                 (\ lc_134 ->
                    ...
                    in (ErlangCons lc_ret_135 ErlangEmptyList))
                 cs_126)
          in
            (BIF.erlang__apply__2
               [sum_13,
        ...
        (ErlangTuple [(ErlangAtom "alias_t"), t_139]) ->
          (BIF.erlang__apply__2
             [type_37, (ErlangCons t_139 ErlangEmptyList)])
        (ErlangTuple [(ErlangAtom "record_t"), fs_142]) ->
          (BIF.erlang__apply__2
             [type_37, (ErlangCons fs_142 ErlangEmptyList)])
        (ErlangTuple [(ErlangAtom "variant_t"), cs_145]) ->
          (BIF.erlang__apply__2
             [type_37, (ErlangCons cs_145 ErlangEmptyList)])
        (ErlangTuple [(ErlangAtom "field_t"), _, _, t_148]) ->
          (BIF.erlang__apply__2
             [type_37, (ErlangCons t_148 ErlangEmptyList)])
        (ErlangTuple [(ErlangAtom "constr_t"), _, _, ts_151]) ->
          (BIF.erlang__apply__2
             [type_37, (ErlangCons ts_151 ErlangEmptyList)])
        ...
        (ErlangTuple [(ErlangAtom "app_t"), _, t_165, ts_166]) ->
          (BIF.erlang__apply__2
             [type_37,
              (ErlangCons (ErlangCons t_165 ts_166) ErlangEmptyList)])
        (ErlangTuple [(ErlangAtom "tuple_t"), _, ts_171]) ->
          (BIF.erlang__apply__2
             [type_37, (ErlangCons ts_171 ErlangEmptyList)])
        (ErlangTuple [(ErlangAtom "named_arg_t"), _, _, t_174, e_175]) ->
          let   
            arg_176 =
              (BIF.erlang__apply__2
                 [type_37, (ErlangCons t_174 ErlangEmptyList)])
          in let
            arg_179 =
              (BIF.erlang__apply__2
                 [expr_45, (ErlangCons e_175 ErlangEmptyList)])
          in
            (BIF.erlang__apply__2
               [plus_1,
                (ErlangCons arg_176 (ErlangCons arg_179 ErlangEmptyList))])
        (ErlangTuple [(ErlangAtom "lam"), _, args_183, e_184]) ->
          ...
          in let
            arg_188 =
              (BIF.erlang__apply__2
                 [expr_45, (ErlangCons e_184 ErlangEmptyList)])
          in
            (BIF.erlang__apply__2
               [scoped_2,
        ...
        (ErlangTuple [(ErlangAtom "app"), _, a_211, as_212]) ->
          (BIF.erlang__apply__2
             [expr_45,
              (ErlangCons (ErlangCons a_211 as_212) ErlangEmptyList)])
        (ErlangTuple [(ErlangAtom "proj"), _, e_217, _]) ->
          (BIF.erlang__apply__2
             [expr_45, (ErlangCons e_217 ErlangEmptyList)])
        (ErlangTuple [(ErlangAtom "tuple"), _, as_220]) ->
          (BIF.erlang__apply__2
             [expr_45, (ErlangCons as_220 ErlangEmptyList)])
        (ErlangTuple [(ErlangAtom "list"), _, as_223]) ->
          (BIF.erlang__apply__2
             [expr_45, (ErlangCons as_223 ErlangEmptyList)])
        (ErlangTuple [(ErlangAtom "list_comp"), _, y_226,
                      (ErlangEmptyList)]) ->
          (BIF.erlang__apply__2
             [expr_45, (ErlangCons y_226 ErlangEmptyList)])
        (ErlangTuple [(ErlangAtom "list_comp"), a_229, y_230,
          ...
          let   
            arg_234 =
              (BIF.erlang__apply__2
                 [expr_45, (ErlangCons e_232 ErlangEmptyList)])
          in let
            arg_238 =
              (BIF.erlang__apply__2
          ...
          in
            (BIF.erlang__apply__2
               [plus_1,
                (ErlangCons arg_234 (ErlangCons arg_237 ErlangEmptyList))])
        (ErlangTuple [(ErlangAtom "list_comp"), a_250, y_251,
          ...
          let   
            arg_254 =
              (BIF.erlang__apply__2
                 [expr_45, (ErlangCons e_252 ErlangEmptyList)])
          in let
            arg_258 =
          ...
          in
            (BIF.erlang__apply__2
               [plus_1,
                (ErlangCons arg_254 (ErlangCons arg_257 ErlangEmptyList))])
        (ErlangTuple [(ErlangAtom "list_comp"), a_265, y_266,
          ...
          let   
            arg_270 =
              (BIF.erlang__apply__2
                 [decl_29, (ErlangCons d_268 ErlangEmptyList)])
          in let
            arg_274 =
              (BIF.erlang__apply__2
          ...
          in
            (BIF.erlang__apply__2
               [plus_1,
                (ErlangCons arg_270 (ErlangCons arg_273 ErlangEmptyList))])
        (ErlangTuple [(ErlangAtom "list_comp"), a_286, y_287,
          ...
          let   
            arg_291 =
              (BIF.erlang__apply__2
                 [decl_29, (ErlangCons d_289 ErlangEmptyList)])
          in let
            arg_295 =
              (BIF.erlang__apply__2
          ...
          in
            (BIF.erlang__apply__2
               [plus_1,
                (ErlangCons arg_291 (ErlangCons arg_294 ErlangEmptyList))])
        (ErlangTuple [(ErlangAtom "typed"), _, e_307, t_308]) ->
          let   
            arg_309 =
              (BIF.erlang__apply__2
                 [expr_45, (ErlangCons e_307 ErlangEmptyList)])
          in let
            arg_312 =
              (BIF.erlang__apply__2
                 [type_37, (ErlangCons t_308 ErlangEmptyList)])
          in
            (BIF.erlang__apply__2
               [plus_1,
                (ErlangCons arg_309 (ErlangCons arg_312 ErlangEmptyList))])
        (ErlangTuple [(ErlangAtom "record"), _, fs_316]) ->
          (BIF.erlang__apply__2
             [expr_45, (ErlangCons fs_316 ErlangEmptyList)])
        (ErlangTuple [(ErlangAtom "record"), _, e_319, fs_320]) ->
          (BIF.erlang__apply__2
             [expr_45,
              (ErlangCons (ErlangCons e_319 fs_320) ErlangEmptyList)])
        (ErlangTuple [(ErlangAtom "map"), _, e_325, fs_326]) ->
          (BIF.erlang__apply__2
             [expr_45,
              (ErlangCons (ErlangCons e_325 fs_326) ErlangEmptyList)])
                            ...
                            (BIF.erlang__apply__2
                               [expr_45,
                                (ErlangCons
                                   ...
                                   ErlangEmptyList)])
                        in (ErlangCons lc_ret_337 ErlangEmptyList)
                      _ -> ErlangEmptyList)
                 kvs_331)
          in
            (BIF.erlang__apply__2
               [sum_13, (ErlangCons arg_332 ErlangEmptyList)])
        ...
        (ErlangTuple [(ErlangAtom "block"), _, ss_364]) ->
          (BIF.erlang__apply__2
             [expr_45, (ErlangCons ss_364 ErlangEmptyList)])
        (ErlangTuple [(ErlangAtom "field"), _, lv_367, e_368]) ->
          (BIF.erlang__apply__2
             [expr_45,
              (ErlangCons
                 (ErlangCons lv_367 (ErlangCons e_368 ErlangEmptyList))
                 ErlangEmptyList)])
        (ErlangTuple [(ErlangAtom "field"), _, lv_375, _, e_376]) ->
          (BIF.erlang__apply__2
             [expr_45,
              (ErlangCons
                 (ErlangCons lv_375 (ErlangCons e_376 ErlangEmptyList))
                 ErlangEmptyList)])
        (ErlangTuple [(ErlangAtom "arg"), _, y_383, t_384]) ->
          ...
          in let
            arg_388 =
              (BIF.erlang__apply__2
                 [type_37, (ErlangCons t_384 ErlangEmptyList)])
          in
            (BIF.erlang__apply__2
               [plus_1,
                (ErlangCons arg_385 (ErlangCons arg_388 ErlangEmptyList))])
        (ErlangTuple [(ErlangAtom "case"), _, p_392, e_393]) ->
          ...
          in let
            arg_397 =
              (BIF.erlang__apply__2
                 [expr_45, (ErlangCons e_393 ErlangEmptyList)])
          in
            (BIF.erlang__apply__2
               [scoped_2,
        ...
        (ErlangTuple [(ErlangAtom "map_get"), _, e_401]) ->
          (BIF.erlang__apply__2
             [expr_45, (ErlangCons e_401 ErlangEmptyList)])
        (ErlangTuple [(ErlangAtom "named_arg"), _, _, e_404]) ->
          (BIF.erlang__apply__2
             [expr_45, (ErlangCons e_404 ErlangEmptyList)])
        _ ->
          case alg_3 of
  ...
  in
    (BIF.erlang__apply__2
       [fun_413,
        (ErlangCons top_65 (ErlangCons rec_410 ErlangEmptyList))])
...
erlps__used_ids__1 [e_0] =
  let lc_src_1 = (erlps__used__1 [e_0])
  in
    (H.flmap
       (\ lc_4 ->
          case lc_4 of
...
erlps__used_types__2 [_currentns_1@(ErlangCons top_0 (ErlangEmptyList)),
  ...
  in
    (BIF.do_remote_fun_call "Lists" "erlps__flatmap__2"
       [f_12, arg_14])
erlps__used_types__2 [arg_16, arg_17] =
  (EXC.function_clause unit)
      ...
      (ErlangFun 2
         let
           lambda_21 [xs_24, ys_25] =
             let    lc_src_26 = (BIF.maps__keys__1 [xs_24])
             in let
               bound_34 =
                 (H.flmap
                    (\ lc_29 ->
                         ...
                         (ErlangTuple [tag_36, x_37]) ->
                           let   
                             tup_el_40 =
                               (BIF.erlang__apply__2
                                  [unbind_12,
                                   (ErlangCons tag_36 ErlangEmptyList)])
                           in let lc_ret_39 = (ErlangTuple [tup_el_40, x_37])
  ...
  in let
    tup_el_57 =
      (BIF.erlang__make_fun__3
         [(ErlangAtom "maps"), (ErlangAtom "merge"),
          (ErlangInt (DBI.fromInt 2))])
  in
    (ErlangTuple
       [(ErlangAtom "alg"), tup_el_56, tup_el_57, scoped_54])
...
erlps__used__1 [d_0] =
             ...
             let
               op_arg_14 =
                 (BIF.lists__member__2
                    [tag_13,
                     (ErlangCons (ErlangAtom "bound_term")
                        (ErlangCons (ErlangAtom "bound_type")
                           ErlangEmptyList))])
         ...
         let
           lambda_25 [k_28, (ErlangTuple [(ErlangAtom "id"), ann_29, x_30])]
             ...
             let   
               tup_el_32 =
                 (BIF.erlang__apply__2
                    [kind_3, (ErlangCons k_28 ErlangEmptyList)])
             in let
               key_31 =
                 (ErlangTuple [tup_el_32, (ErlangCons x_30 ErlangEmptyList)])
           ...
           lambda_25 [k_39,
             ...
             let   
               tup_el_43 =
                 (BIF.erlang__apply__2
                    [kind_3, (ErlangCons k_39 ErlangEmptyList)])
             in let key_42 = (ErlangTuple [tup_el_43, xs_41])
             in let
               key_47 =
                 (BIF.erlang__apply__2
                    [ns_10, (ErlangCons xs_41 ErlangEmptyList)])
             in
               (ErlangMap
                  (Map.fromFoldable
                     [(Tup.Tuple key_42 ann_40), (Tup.Tuple key_47 ann_40)]))
           lambda_25 [k_52,
             ...
             let   
               tup_el_56 =
                 (BIF.erlang__apply__2
                    [kind_3, (ErlangCons k_52 ErlangEmptyList)])
             in let
               key_55 =
                 (ErlangTuple [tup_el_56, (ErlangCons x_54 ErlangEmptyList)])
           ...
           lambda_25 [k_63,
             ...
             let   
               tup_el_67 =
                 (BIF.erlang__apply__2
                    [kind_3, (ErlangCons k_63 ErlangEmptyList)])
             in let key_66 = (ErlangTuple [tup_el_67, xs_65])
             in let
               key_71 =
                 (BIF.erlang__apply__2
                    [ns_10, (ErlangCons xs_65 ErlangEmptyList)])
             in
               (ErlangMap
                  (Map.fromFoldable
                     [(Tup.Tuple key_66 ann_64), (Tup.Tuple key_71 ann_64)]))
  ...
  in let
    arg_22 =
      (erlps__fold__4 [arg_23, arg_24, (ErlangAtom "decl"), d_0])
