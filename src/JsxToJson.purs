...
erlps__to_json__2 [source_0, config_1] | (H.isEList config_1) =
  let   
    arg_7 =
...
erlps__parse_config__1 [config_0] =
  let
    arg_2 =
      (ErlangTuple
         [(ErlangAtom "config"), (ErlangInt (DBI.fromInt 0)),
...
erlps__parse_config__2 [(ErlangCons (ErlangTuple [(ErlangAtom "space"),
                        ...
                        config_2]
  | ((H.isEInt val_0) &&
       (weakGt val_0 (ErlangInt (DBI.fromInt 0)))) =
  let
    arg_4 =
      case config_2 of
    ...
    arg_3 =
      case config_1 of
        (ErlangTuple [(ErlangAtom "config"), space_6, indent_7,
                      depth_8]) ->
          (ErlangTuple
             [(ErlangAtom "config"), (ErlangInt (DBI.fromInt 1)), indent_7,
              depth_8])
        _ -> (EXC.badrecord (ErlangAtom "config"))
    ...
    arg_3 =
      case config_1 of
        (ErlangTuple [(ErlangAtom "config"), space_6, indent_7,
                      depth_8]) ->
          (ErlangTuple
             [(ErlangAtom "config"), space_6, (ErlangInt (DBI.fromInt 1)),
              depth_8])
        _ -> (EXC.badrecord (ErlangAtom "config"))
  in (erlps__parse_config__2 [rest_0, arg_3])
...
erlps__handle_event__2 [arg_9, arg_10] =
  (EXC.function_clause unit)
...
erlps__encode__3 [arg_6, arg_7, arg_8] =
  (EXC.function_clause unit)
...
erlps__space__1 [config_0] =
  ...
  in
    case case_1 of
      ...
      x_6 | (weakGt x_6 (ErlangInt (DBI.fromInt 0))) ->
        let
          arg_7 =
            (ErlangBinary
...
erlps__start_json__1 [config_0] | (H.isEList config_0) =
  let tup_el_2 = (erlps__parse_config__1 [config_0])
  in (ErlangTuple [ErlangEmptyList, tup_el_2])
...
erlps__start_object__1 [(ErlangTuple [stack_0,
  ...
  let   
    tup_el_7 =
      (ErlangBinary
         (BIN.from_int (ErlangInt (DBI.fromInt 123))
            (ErlangInt (DBI.fromInt 8)) 1 BIN.Big))
  ...
  in let
    record_updt_13 =
      (BIF.erlang__op_plus [depth_1, (ErlangInt (DBI.fromInt 1))])
  in let
    tup_el_11 =
      case config_2 of
...
erlps__start_array__1 [(ErlangTuple [stack_0,
  ...
  let   
    tup_el_7 =
      (ErlangBinary
         (BIN.from_int (ErlangInt (DBI.fromInt 91))
            (ErlangInt (DBI.fromInt 8)) 1 BIN.Big))
...
erlps__finish__1 [(ErlangTuple [stack_0,
  ...
  let   
    record_updt_4 =
      (BIF.erlang__op_minus [depth_1, (ErlangInt (DBI.fromInt 1))])
  in let
    newconfig_10 =
      case config_2 of
        (ErlangTuple [(ErlangAtom "config"), space_7, indent_8,
...
erlps__finish___1 [(ErlangTuple [(ErlangCons (ErlangTuple [(ErlangAtom "object"),
                                                           (ErlangBinary bin_c_0)]) (ErlangEmptyList)),
                                 config_4])]
    ...
    tup_el_5 =
      (ErlangBinary
         (BIN.concat
            [(BIN.from_int (ErlangInt (DBI.fromInt 91))
                (ErlangInt (DBI.fromInt 8)) 1 BIN.Big),
             (BIN.from_int (ErlangInt (DBI.fromInt 93))
                (ErlangInt (DBI.fromInt 8)) 1 BIN.Big)]))
  in (ErlangTuple [tup_el_5, config_4])
erlps__finish___1 [(ErlangTuple [(ErlangCons (ErlangTuple [(ErlangAtom "object"),
                                                           (ErlangBinary bin_c_0)]) rest_4),
                                 config_5])]
  | size_1 <- ((DBI.fromInt 8))
  , (BIN.Ok (ErlangInt num_3) bin_2) <-
      ((BIN.chop_int bin_c_0 size_1 1 BIN.Big BIN.Unsigned))
...
erlps__insert__2 [key_0,
  ...
  in let
    tup_el_4 =
      (BIF.erlang__op_append
         [(ErlangCons head_6 ErlangEmptyList), rest_2])
  in (ErlangTuple [tup_el_4, config_3])
erlps__insert__2 [value_0,
                  (ErlangTuple [(ErlangCons (ErlangTuple [(ErlangAtom "object"),
                                                          key_1,
                                                          (ErlangBinary bin_c_2)]) rest_6),
                                config_7])]
  | size_3 <- ((DBI.fromInt 8))
  , (BIN.Ok (ErlangInt num_5) bin_4) <-
      ((BIN.chop_int bin_c_2 size_3 1 BIN.Big BIN.Unsigned))
  , ((ErlangInt num_5) == (ErlangInt (DBI.fromInt 123)))
  , (BIN.empty bin_4) =
  let   
    head_13 =
      (ErlangBinary
...
erlps__insert__2 [value_0,
  ...
  let   
    head_12 =
      (ErlangBinary
         (BIN.from_int (ErlangInt (DBI.fromInt 44))
            (ErlangInt (DBI.fromInt 8)) 1 BIN.Big))
...
erlps__insert__2 [value_0,
  ...
  in let
    tup_el_7 =
      (BIF.erlang__op_append
         [(ErlangCons head_9 ErlangEmptyList), rest_5])
