      ...
      (ErlangFun 1
         let
           lambda_5 [x_7] =
             ...
             in
               (BIF.erlang__apply__2 [k_2, (ErlangCons arg_8 ErlangEmptyList)])
           lambda_5 [arg_6] = (EXC.function_clause unit)
           lambda_5 args = (EXC.badarity (ErlangFun 1 lambda_5) args)
         in lambda_5)
...
erlps__apply_p__2 [(ErlangAtom "aeso_parse_layout"), k_0] =
  let   
    tup_el_5 =
      (ErlangTuple
         [(ErlangAtom "expected"), (ErlangAtom "layout_block")])
  ...
  let
    arg_4 =
      (ErlangFun 1
         ...
         in lambda_5)
  in (erlps__apply_p__2 [p_0, arg_4])
erlps__apply_p__2 [t_0, k_1] | (H.isETuple t_0) =
      ...
      (ErlangFun 1
         let
           lambda_5 [xs_7] =
             ...
             in
               (BIF.erlang__apply__2 [k_1, (ErlangCons arg_8 ErlangEmptyList)])
           lambda_5 [arg_6] = (EXC.function_clause unit)
           lambda_5 args = (EXC.badarity (ErlangFun 1 lambda_5) args)
         in lambda_5)
  in (erlps__apply_p__2 [arg_2, arg_4])
erlps__apply_p__2 [m_0, k_1] | (H.isEMap m_0) =
...
erlps__choice__2 [(ErlangTuple [(ErlangAtom "aeso_parse_choice"),
  ...
  =
  (ErlangTuple
     [(ErlangAtom "aeso_parse_choice"), (ErlangCons q_1 ps_0)])
erlps__choice__2 [p_0,
                  (ErlangTuple [(ErlangAtom "aeso_parse_choice"), qs_1])]
  =
  (ErlangTuple
     [(ErlangAtom "aeso_parse_choice"), (ErlangCons p_0 qs_1)])
...
erlps__flatten_error__1 [(ErlangAtom "no_error")] =
  (H.make_string "Unspecified error")
...
erlps__build_infixl__2 [arg_9, arg_10] =
...
erlps__build_infixr__2 [arg_9, arg_10] =
  (EXC.function_clause unit)
...
erlps__tag__1 [t_0] | (H.isETuple t_0) =
...
erlps__pos__1 [t_0] | (H.isETuple t_0) =
  (BIF.erlang__element__2 [(ErlangInt (DBI.fromInt 2)), t_0])
...
erlps__line__1 [t_0] | (H.isETuple t_0) =
  let arg_2 = (erlps__pos__1 [t_0])
  in (BIF.erlang__element__2 [(ErlangInt (DBI.fromInt 1)), arg_2])
...
erlps__col__1 [t_0] | (H.isETuple t_0) =
  let arg_2 = (erlps__pos__1 [t_0])
  in (BIF.erlang__element__2 [(ErlangInt (DBI.fromInt 2)), arg_2])
          ...
          case case_8 of
              ...
              in
                case case_13 of
                  ...
                  f_23 ->
                    ...
                    in let
                      vclose_27 =
                        (ErlangTuple [(ErlangAtom "vclose"), tup_el_25])
                    in let
                      arg_29 =
                        case ts_1 of
            ...
            f_43 ->
              let
                arg_44 =
                  (BIF.erlang__apply__2
                     [f_43, (ErlangCons t_6 ErlangEmptyList)])
              in (erlps__parse1__4 [arg_44, ts1_7, acc_2, err_3])
      (ErlangAtom "false") ->
        let   
          arg_54 =
            (H.make_string "Unexpected end of file. Expected one of ~p.")
...
erlps__parse1__4 [(ErlangTuple [(ErlangAtom "layout"), f_0,
  ...
  in
    case case_5 of
      ...
      (ErlangAtom "false") ->
        let    arg_20 = (H.make_string "Expected layout block.")
  ...
  in let
    fix_23 =
      case case_10 of
        ...
        (ErlangCons t_18 _) ->
          let arg_19 = (H.make_string " Did you forget a ~p?")
          in
            (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
               [arg_19, (ErlangCons t_18 ErlangEmptyList)])
        something_else -> (EXC.case_clause something_else)
  in let arg_24 = (H.make_string "Unexpected indentation.~s")
  in let
    msg_28 =
      (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
...
erlps__unexpected_token_error__3 [ts_0, expect_1, t_2] =
  let   
    expectcon_5 =
      (BIF.lists__member__2 [(ErlangAtom "con"), expect_1])
  in let
      ...
      case t_2 of
                                                           ...
                                                           (\ _ ->
                                                              case expectcon_5 of
                                                                ...
                                                                _ ->
                                                                  (EXC.badarg1
                                                                     expectcon_5)))) ->
          let    arg_15 = (H.make_string " Did you mean ~s?")
        ...
        (ErlangTuple [(ErlangAtom "con"), _, x_20]) | ((ErlangAtom
                                                         ...
                                                         (H.falsifyErrors
                                                            (\ _ ->
                                                               expectid_8))) ->
          let    arg_21 = (H.make_string " Did you mean ~s?")
        ...
        (ErlangTuple [(ErlangAtom "qcon"), _, xs_26]) | ((ErlangAtom
                                                           ...
                                                           (H.falsifyErrors
                                                              (\ _ ->
                                                                 expectcon_5))) ->
          let    arg_27 = (H.make_string " Did you mean ~s?")
          in let
            head_29 =
              (BIF.do_remote_fun_call "Lists" "erlps__last__1" [xs_26])
          in
            (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
        ...
        (ErlangTuple [(ErlangAtom "qid"), _, xs_32]) | ((ErlangAtom
                                                          ...
                                                          (H.falsifyErrors
                                                             (\ _ ->
                                                                expectid_8))) ->
          let    arg_33 = (H.make_string " Did you mean ~s?")
          in let
            head_35 =
              (BIF.do_remote_fun_call "Lists" "erlps__last__1" [xs_32])
          in
            (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
               [arg_33, (ErlangCons head_35 ErlangEmptyList)])
        _ -> (H.make_string "")
  in let arg_41 = (H.make_string "Unexpected ~s.~s")
  in let head_43 = (erlps__describe__1 [t_2])
  in let
    arg_40 =
      (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
         [arg_41,
          (ErlangCons head_43 (ErlangCons fix_38 ErlangEmptyList))])
...
erlps__describe__1 [(ErlangTuple [(ErlangAtom "id"), _, x_0])] =
  let arg_1 = (H.make_string "identifier ~s")
  in
    (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
...
erlps__describe__1 [(ErlangTuple [(ErlangAtom "qid"), _, xs_0])]
  =
  let    arg_1 = (H.make_string "qualified identifier ~s")
          ...
          arg_9 =
            case ts1_5 of
              (ErlangTuple [(ErlangAtom "ts"), layout_13, last_14, inserted_15,
                            tokens_16]) ->
                (ErlangTuple
                   [(ErlangAtom "ts"), layout_13, l_3, ls_4, tokens_16])
              _ -> (EXC.badrecord (ErlangAtom "ts"))
          ...
          tup_el_22 =
            case ts_3 of
              (ErlangTuple [(ErlangAtom "ts"), layout_31, last_32, inserted_33,
                            tokens_34]) ->
                (ErlangTuple
                   [(ErlangAtom "ts"), (ErlangCons col_5 layout_0),
                    record_updt_27, inserted_33, tokens_34])
              _ -> (EXC.badrecord (ErlangAtom "ts"))
  ...
  in
    case (ErlangAtom "true") of
      ...
      _ | (weakLt col_7 n_0) ->
        ...
        in let
          vclose_33 = (ErlangTuple [(ErlangAtom "vclose"), tup_el_31])
        in
          (erlps__insert_layout_tokens__4
...
erlps__end_pos__1 [(ErlangTuple [l_0, _])] =
  let
    tup_el_1 =
      (BIF.erlang__op_plus [l_0, (ErlangInt (DBI.fromInt 1))])
  in (ErlangTuple [tup_el_1, (ErlangInt (DBI.fromInt 1))])
