  ...
  let
    case_2 =
      (BIF.lists__keyfind__3
         [(ErlangAtom "src_file"), (ErlangInt (DBI.fromInt 1)), opts_1])
  in
    case case_2 of
      (ErlangTuple [(ErlangAtom "src_file"), file_6]) ->
        let   
          arg_10 = (BIF.do_remote_fun_call "Sets" "erlps__new__0" [])
        in let
          arg_8 =
...
erlps__mk_error__1 [(ErlangTuple [pos_0,
  ...
  =
  let    arg_4 = (H.make_string "Lexical error on input: ~s\n")
  in let
    arg_3 =
...
erlps__mk_error__1 [(ErlangTuple [pos_0,
  ...
  =
  let    arg_2 = (H.make_string "Ambiguous parse result: ~p\n")
  in let
    msg_6 =
      (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
...
erlps__mk_error__1 [(ErlangTuple [pos_0,
  ...
  =
  let   
    arg_2 = (H.make_string "Couldn\'t find include file \'~s\'\n")
  in let
    msg_6 =
      (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
      ...
      (ErlangFun 0
         let
           lambda_1 [] =
                 ...
                 (ErlangFun 1
                    let
                      lambda_5 [(ErlangTuple [_1_7, _2_8, _3_9, _4_10])] =
                        (ErlangTuple
                           [(ErlangAtom "contract"), _1_7, _2_8, _4_10])
             ...
             in let
               arg_15 =
                 (ErlangTuple [tup_el_16, tup_el_18, tup_el_19, tup_el_21])
             in let
               head_3 =
               ...
               arg_25 =
                 (ErlangFun 1
                    let
                      ...
                      lambda_26 args =
                        (EXC.badarity (ErlangFun 1 lambda_26) args)
                    in lambda_26)
               ...
               arg_53 =
                 (ErlangFun 1
                    let
                      ...
                      lambda_54 args =
                        (EXC.badarity (ErlangFun 1 lambda_54) args)
                    in lambda_54)
             ...
             in let
               arg_64 =
                 (ErlangTuple [tup_el_65, tup_el_67, tup_el_68, tup_el_70])
             in let
               head_52 =
                 (BIF.do_remote_fun_call "Aeso.Parse.Lib" "erlps__map__2"
                    [arg_53, arg_64])
                 ...
                 (ErlangFun 1
                    let
                      lambda_75 [(ErlangTuple [_1_77, _2_78])] =
                        ...
                        in
                          (ErlangTuple
                             [(ErlangAtom "include"), tup_el_80, _2_78])
                      lambda_75 [arg_76] = (EXC.function_clause unit)
                      lambda_75 args =
                        (EXC.badarity (ErlangFun 1 lambda_75) args)
                    in lambda_75)
               ...
               arg_91 =
                 (ErlangFun 1
                    let
                      ...
                      lambda_92 args =
                        (EXC.badarity (ErlangFun 1 lambda_92) args)
                    in lambda_92)
             ...
             in let
               arg_116 = (ErlangTuple [tup_el_117, tup_el_119, tup_el_120])
             in let
               head_105 =
                 (BIF.do_remote_fun_call "Aeso.Parse.Lib" "erlps__map__2"
                    [arg_106, arg_116])
             ...
             in let
               arg_158 =
                 (ErlangTuple
                    [tup_el_159, tup_el_161, tup_el_162, tup_el_163,
                     tup_el_165])
             in let
               head_144 =
                 (BIF.do_remote_fun_call "Aeso.Parse.Lib" "erlps__map__2"
             ...
             in let
               arg_204 =
                 (ErlangTuple
                    [tup_el_205, tup_el_207, tup_el_208, tup_el_209,
                     tup_el_211])
             in let
               head_190 =
                 (BIF.do_remote_fun_call "Aeso.Parse.Lib" "erlps__map__2"
             ...
             in let
               arg_250 =
                 (ErlangTuple
                    [tup_el_251, tup_el_253, tup_el_254, tup_el_255,
                     tup_el_257])
             in let
               head_236 =
                 (BIF.do_remote_fun_call "Aeso.Parse.Lib" "erlps__map__2"
             ...
             in let
               arg_270 = (ErlangTuple [tup_el_271, tup_el_272, tup_el_273])
             in let
               head_260 =
                 (BIF.do_remote_fun_call "Aeso.Parse.Lib" "erlps__map__2"
                    [arg_261, arg_270])
...
erlps__fun_block__3 [mods_0, kind_1, decls_2] =
  ...
  in let
    tup_el_6 =
      (H.flmap
         (\ lc_9 ->
            let lc_ret_10 = (erlps__add_modifiers__3 [mods_0, kind_1, lc_9])
...
erlps__pragma__0 [] =
  let   
    arg_0 =
      (H.flmap
         (\ lc_13 ->
            let lc_ret_14 = (erlps__token__1 [lc_13])
      ...
      (ErlangFun 1
         let
           lambda_18 [(ErlangTuple [_1_20, _2_21, _3_22, _4_23])] =
             ...
             in let
               tup_el_29 =
                 (BIF.erlang__element__2 [(ErlangInt (DBI.fromInt 1)), _3_22])
             in let
               tup_el_27 =
                 (ErlangTuple [(ErlangAtom "compiler"), tup_el_29, _4_23])
  ...
  in let
    tup_el_34 =
      (BIF.do_remote_fun_call "Aeso.Parse.Lib" "erlps__tok__1"
         [(ErlangAtom "@")])
  in let arg_37 = (H.make_string "compiler")
...
erlps__version__0 [] =
  ...
  in let
    tup_el_10 =
      (BIF.do_remote_fun_call "Aeso.Parse.Lib" "erlps__many__1"
         [arg_11])
  ...
  in let
    arg_12 =
      (ErlangFun 1
         let
           lambda_13 [_1_15] =
             (ErlangTuple [(ErlangAtom "entrypoint"), _1_15])
      ...
      (ErlangFun 1
         let
           lambda_13 [(ErlangTuple [_1_15, _2_16])] =
             ...
             in
               (ErlangTuple [(ErlangAtom "constr_t"), tup_el_18, _1_15, _2_16])
           lambda_13 [arg_14] = (EXC.function_clause unit)
           lambda_13 args = (EXC.badarity (ErlangFun 1 lambda_13) args)
         in lambda_13)
      ...
      (ErlangFun 1
         let
           lambda_3 [(ErlangTuple [_1_5, _2_6])] =
             (erlps__set_ann__3
                [(ErlangAtom "indexed"), (ErlangAtom "true"), _2_6])
           lambda_3 [arg_4] = (EXC.function_clause unit)
           lambda_3 args = (EXC.badarity (ErlangFun 1 lambda_3) args)
         in lambda_3)
    ...
    arg_0 =
      (ErlangFun 1
         let
           lambda_1 [(ErlangTuple [_1_3, _2_4, _3_5])] =
             (ErlangTuple
                [(ErlangAtom "letval"), ErlangEmptyList, _1_3, _3_5])
           lambda_1 [arg_2] = (EXC.function_clause unit)
           lambda_1 args = (EXC.badarity (ErlangFun 1 lambda_1) args)
         in lambda_1)
...
erlps__fundef__0 [] =
      ...
      (ErlangFun 1
         let
           lambda_3 [(ErlangTuple [_1_5, _2_6, _3_7, _4_8])] =
             ...
             in
               (ErlangTuple
                  [(ErlangAtom "letfun"), tup_el_10, _1_5, _2_6, tup_el_14,
                   _4_8])
           lambda_3 [arg_4] = (EXC.function_clause unit)
           lambda_3 args = (EXC.badarity (ErlangFun 1 lambda_3) args)
         in lambda_3)
  ...
  in let
    arg_18 =
      (ErlangTuple [tup_el_19, tup_el_20, tup_el_21, tup_el_23])
  in let
    head_1 =
      (BIF.do_remote_fun_call "Aeso.Parse.Lib" "erlps__map__2"
         [arg_2, arg_18])
      ...
      (ErlangFun 1
         let
           lambda_27 [(ErlangTuple [_1_29, _2_30, _3_31, _4_32, _5_33,
             ...
             in
               (ErlangTuple
                  [(ErlangAtom "letfun"), tup_el_36, _1_29, _2_30, _4_32,
                   _6_34])
           ...
           lambda_3 [(ErlangTuple [_1_5, _2_6])] =
             case _2_6 of
               ...
               (ErlangTuple [(ErlangAtom "ok"), args_8]) ->
                 let tup_el_10 = (erlps__get_ann__1 [_1_5])
                 in
                   (ErlangTuple [(ErlangAtom "app_t"), tup_el_10, _1_5, args_8])
               something_else -> (EXC.case_clause something_else)
           lambda_3 [arg_4] = (EXC.function_clause unit)
           lambda_3 args = (EXC.badarity (ErlangFun 1 lambda_3) args)
         in lambda_3)
      ...
      (ErlangFun 1
         let
           lambda_21 [(ErlangTuple [_1_23, _2_24])] =
             ...
             in let
               tup_el_28 =
                 (BIF.erlang__element__2 [(ErlangInt (DBI.fromInt 3)), _2_24])
         ...
         in lambda_21)
  in let arg_33 = (H.make_string "bytes")
         ...
         let
           lambda_1 [] =
             ...
             in let
               head_16 =
                 (ErlangTuple
                    [(ErlangAtom "if"), tup_el_18, tup_el_20, tup_el_22])
             ...
             in let
               head_32 =
                 (ErlangTuple [(ErlangAtom "else"), tup_el_34, tup_el_36])
             in
               (BIF.do_remote_fun_call "Aeso.Parse.Lib" "erlps__choice__1"
                  [(ErlangCons head_3
                      (ErlangCons head_5
           ...
           lambda_38 [(ErlangTuple [_1_40, _2_41])] =
             case _2_41 of
               ...
               (ErlangTuple [(ErlangAtom "ok"), type_43]) ->
                 ...
                 in
                   (ErlangTuple
                      [(ErlangAtom "typed"), tup_el_45, _1_40, type_43])
               something_else -> (EXC.case_clause something_else)
         ...
         let
           lambda_1 [] =
                        ...
                        let
                          arg_35 =
                            (BIF.erlang__setelement__3
                               [(ErlangInt (DBI.fromInt 1)), _1_32,
                                (ErlangAtom "int")])
                        in
                          (erlps__set_ann__3
                             [(ErlangAtom "format"), (ErlangAtom "hex"),
                              arg_35])
                      lambda_30 [arg_31] = (EXC.function_clause unit)
                      lambda_30 args =
                        (EXC.badarity (ErlangFun 1 lambda_30) args)
                    in lambda_30)
             ...
             in let
               head_42 =
                 (ErlangTuple
                    [(ErlangAtom "bool"), tup_el_44, (ErlangAtom "true")])
             in let tup_el_50 = (erlps__keyword__1 [(ErlangAtom "false")])
             in let
               head_48 =
                 (ErlangTuple
                    [(ErlangAtom "bool"), tup_el_50, (ErlangAtom "false")])
             in let
               arg_57 =
                 (ErlangFun 0
                    let
                      ...
                      lambda_58 args =
                        (EXC.badarity (ErlangFun 0 lambda_58) args)
                    in lambda_58)
             in let
               arg_56 =
                 (BIF.do_remote_fun_call "Aeso.Parse.Lib" "erlps__lazy__1"
               ...
               arg_59 =
                 (ErlangFun 1
                    let
                      ...
                      lambda_60 args =
                        (EXC.badarity (ErlangFun 1 lambda_60) args)
                    in lambda_60)
             in let
               head_54 =
                 (BIF.do_remote_fun_call "Aeso.Parse.Lib" "erlps__bind__2"
               ...
               arg_72 =
                 (ErlangFun 1
                    let
                      ...
                      lambda_73 args =
                        (EXC.badarity (ErlangFun 1 lambda_73) args)
                    in lambda_73)
                    ...
                    let
                      lambda_96 [(ErlangTuple [_1_98, _2_99, _3_100, _4_101,
                        ...
                        (BIF.erlang__apply__2
                           [_3_100,
                            (ErlangCons _2_99
                               (ErlangCons _4_101 ErlangEmptyList))])
                      lambda_96 [arg_97] = (EXC.function_clause unit)
                      lambda_96 args =
                        (EXC.badarity (ErlangFun 1 lambda_96) args)
                    in lambda_96)
             in let
               tup_el_107 =
                 (BIF.do_remote_fun_call "Aeso.Parse.Lib" "erlps__tok__1"
             ...
             in let
               tup_el_130 =
                 (BIF.do_remote_fun_call "Aeso.Parse.Lib" "erlps__tok__1"
                    [(ErlangAtom ")")])
             in let
               arg_125 = (ErlangTuple [tup_el_126, tup_el_128, tup_el_130])
             in let
               head_116 =
                 (BIF.do_remote_fun_call "Aeso.Parse.Lib" "erlps__map__2"
                    [arg_117, arg_125])
                 ...
                 (ErlangFun 1
                    let
                      lambda_5 [(ErlangTuple [_1_7, _2_8, _3_9])] =
                        (ErlangTuple
                           [(ErlangAtom "named_arg"), ErlangEmptyList, _1_7,
                            _3_9])
                      lambda_5 [arg_6] = (EXC.function_clause unit)
                      lambda_5 args = (EXC.badarity (ErlangFun 1 lambda_5) args)
                    in lambda_5)
               ...
               arg_10 =
                 (ErlangFun 1
                    let
                      lambda_11 [_1_13] =
                        (ErlangTuple
                           [(ErlangAtom "app"), ErlangEmptyList, _1_13])
...
erlps__elim__2 [e_0,
  ...
  =
  let
    arg_4 = (ErlangTuple [(ErlangAtom "map_get"), ann_1, e_0, key_2])
  in (erlps__elim__2 [arg_4, es_3])
erlps__elim__2 [e_0,
...
erlps__record__1 [(ErlangEmptyList)] =
  (ErlangTuple
     [(ErlangAtom "map"), ErlangEmptyList, ErlangEmptyList])
    ...
    case case_1 of
            ...
            (ErlangFun 1
               let
                 ...
                 lambda_3 [(ErlangTuple [(ErlangAtom "field"), ann_6, lv_7,
                   ...
                   let   
                     arg_9 =
                       (H.make_string "Cannot use \'@\' in record construction")
                   in let
                 ...
                 lambda_3 [(ErlangTuple [(ErlangAtom "field"), ann_19, lv_20,
                   ...
                   in let
                     arg_22 =
                       (ErlangTuple [(ErlangAtom "lvalue"), ann_19, lv_20])
      ...
      (ErlangAtom "map") ->
        ...
        in let
          arg_35 =
            (BIF.erlang__op_append
               [fs_0, (ErlangCons head_38 ErlangEmptyList)])
            ...
            (ErlangFun 1
               let
                 ...
                 lambda_43 [(ErlangTuple [(ErlangAtom "field"), fann_49, lv_50,
                   ...
                   let   
                     arg_52 =
                       (H.make_string "Cannot use \'@\' in map construction")
                   in let
                     arg_54 =
                       (ErlangTuple [(ErlangAtom "lvalue"), fann_49, lv_50])
                 ...
                 lambda_43 [(ErlangTuple [(ErlangAtom "field"), fann_62, lv_63,
                   ...
                   in let
                     arg_65 =
                       (ErlangTuple [(ErlangAtom "lvalue"), fann_62, lv_63])
      ...
      (ErlangAtom "record_or_map_error") ->
        ...
        in
          (ErlangTuple
             [(ErlangAtom "record_or_map_error"), tup_el_76, fs_0])
      something_else -> (EXC.case_clause something_else)
...
erlps__record_or_map__1 [fields_0] =
      ...
      (ErlangFun 1
         let
           lambda_1 [fld_3] =
             let
               case_4 =
                 (BIF.erlang__element__2 [(ErlangInt (DBI.fromInt 3)), fld_3])
             in
               case case_4 of
  ...
  in let
    case_8 =
      (BIF.do_remote_fun_call "Lists" "erlps__usort__1" [arg_9])
  in
    case case_8 of
...
erlps__field_assignment__0 [] =
  ...
  in let
    arg_12 =
      (ErlangTuple [tup_el_13, tup_el_14, tup_el_19, tup_el_21])
  in
    (BIF.do_remote_fun_call "Aeso.Parse.Lib" "erlps__map__2"
       [arg_0, arg_12])
...
erlps__lvalue__1 [e_0] =
  (erlps__lvalue__2 [e_0, ErlangEmptyList])
...
erlps__lvalue__2 [(ErlangTuple [(ErlangAtom "map_key"), k_0]),
  ...
  in let
    head_2 = (ErlangTuple [(ErlangAtom "map_get"), tup_el_4, k_0])
...
erlps__lvalue__2 [(ErlangTuple [(ErlangAtom "map_key"), k_0,
  ...
  in let
    head_3 =
      (ErlangTuple [(ErlangAtom "map_get"), tup_el_5, k_0, v_1])
  in (ErlangCons head_3 lv_2)
...
erlps__lvalue__2 [(ErlangTuple [(ErlangAtom "map_get"), ann_0,
  ...
  =
  let
    head_7 = (ErlangTuple [(ErlangAtom "map_get"), ann_0, k_2, v_3])
  in (erlps__lvalue__2 [e_1, (ErlangCons head_7 lv_4)])
erlps__lvalue__2 [e_0, _] =
  let arg_1 = (H.make_string "Not a valid lvalue")
...
erlps__binop__1 [op_0] | (H.isEAtom op_0) =
...
erlps__binop__1 [ops_0] =
  ...
  in let
    arg_14 =
      (H.flmap
         (\ lc_17 ->
            let lc_ret_18 = (erlps__token__1 [lc_17])
         ...
         let
           lambda_3 [y_7@(ErlangTuple [(ErlangAtom "id"), a_5, x_6])] =
             case (ErlangAtom "true") of
               ...
               _ ->
                 let    lop_11 = (H.make_string "expected \'")
...
erlps__parse_addr_literal__1 [id_2@(ErlangTuple [(ErlangAtom "id"),
  ...
  let   
    arg_4 =
      (BIF.do_remote_fun_call "Lists" "erlps__sublist__2"
         [name_1, (ErlangInt (DBI.fromInt 3))])
  in let head_8 = (H.make_string "ak_")
  in let head_10 = (H.make_string "ok_")
  in let head_12 = (H.make_string "oq_")
  in let head_14 = (H.make_string "ct_")
  in let
    case_3 =
  ...
  in
    case case_3 of
      ...
      something_else -> (EXC.case_clause something_else)
erlps__parse_addr_literal__1 [arg_26] =
  (EXC.function_clause unit)
...
erlps__get_ann__1 [node_0] =
  ...
  in
    case case_1 of
      (ErlangTuple [line_4, col_5]) | ((H.isEInt line_4) &&
                                         (H.isEInt col_5)) ->
  ...
  in let
    arg_7 =
      (BIF.do_remote_fun_call "Lists" "erlps__keystore__4"
         [key_0, (ErlangInt (DBI.fromInt 1)), ann_4, arg_11])
  in
    (BIF.erlang__setelement__3
       [(ErlangInt (DBI.fromInt 2)), node_2, arg_7])
  ...
  let   
    tup_el_1 =
      (BIF.do_remote_fun_call "Aeso.Parse.Lib" "erlps__current_file__0"
         [])
  in let
    tup_el_2 = (erlps__get_ann__2 [(ErlangAtom "line"), node_0])
  in let
    tup_el_5 = (erlps__get_ann__2 [(ErlangAtom "col"), node_0])
...
erlps__set_pos__2 [(ErlangTuple [f_0, l_1, c_2]), node_3] =
  let   
    arg_9 = (erlps__set_ann__3 [(ErlangAtom "col"), c_2, node_3])
  in let
    arg_6 = (erlps__set_ann__3 [(ErlangAtom "line"), l_1, arg_9])
...
erlps__type_wildcard__1 [ann_0] =
  ...
  in let tup_el_7 = (H.make_string "_")
  in
    (ErlangTuple
       [(ErlangAtom "id"), (ErlangCons head_3 ann_0), tup_el_7])
  ...
  in
    case match_expr_3 of
      (ErlangCons stmt_2 _) ->
        ...
        in (ErlangTuple [(ErlangAtom "block"), tup_el_6, match_expr_3])
...
erlps__group_ifs__2 [(ErlangCons (ErlangTuple [(ErlangAtom "if"),
  ...
  let
    match_expr_9 =
      (erlps__else_branches__2 [stmts_3, ErlangEmptyList])
  in
    case match_expr_9 of
      (ErlangTuple [elses_7, rest_8]) ->
        let
          head_12 = (erlps__build_if__4 [ann_0, cond_1, then_2, elses_7])
...
erlps__group_ifs__2 [(ErlangCons (ErlangTuple [(ErlangAtom "else"),
  ...
  =
  let   
    tup_el_3 = (H.make_string "No matching \'if\' for \'else\'")
...
erlps__group_ifs__2 [(ErlangCons (ErlangTuple [(ErlangAtom "elif"),
  ...
  =
  let   
    tup_el_3 = (H.make_string "No matching \'if\' for \'elif\'")
  in let arg_1 = (ErlangTuple [ann_0, tup_el_3])
  in
    (BIF.do_remote_fun_call "Aeso.Parse.Lib" "erlps__fail__1"
       [arg_1])
...
erlps__build_if__4 [ann_0, cond_1, then_2,
  ...
  in
    (ErlangTuple
       [(ErlangAtom "if"), ann_0, cond_1, then_2, tup_el_11])
erlps__build_if__4 [ann_0, cond_1, then_2,
...
erlps__build_if__4 [ann_0, cond_1, then_2, (ErlangEmptyList)] =
  ...
  in
    (ErlangTuple
       [(ErlangAtom "if"), ann_0, cond_1, then_2, tup_el_7])
...
erlps__else_branches__2 [arg_5, arg_6] =
  (EXC.function_clause unit)
...
erlps__parse_pattern__1 [e_0] =
  let arg_1 = (H.make_string "Not a valid pattern")
  in (erlps__bad_expr_err__2 [arg_1, e_0])
...
erlps__parse_field_pattern__1 [arg_8] =
  (EXC.function_clause unit)
  ...
  in let
    head_11 =
      (BIF.do_remote_fun_call "Prettypr" "erlps__nest__2"
         [(ErlangInt (DBI.fromInt 2)), arg_13])
  in let
    arg_4 =
      ...
      (H.flmap
         (\ lc_13 ->
            let   
              tup_el_17 =
                (ErlangTuple
                   [(ErlangAtom "string"), (ErlangCons head_3 ErlangEmptyList),
                    lc_13])
            in let
              lc_ret_14 =
                (ErlangTuple
    ...
    case case_7 of
      (ErlangTuple [(ErlangAtom "ok"), code_11]) ->
        ...
        in
          case case_15 of
            (ErlangAtom "false") ->
              let    arg_21 = (ErlangTuple [(ErlangAtom "src_file"), file_2])
              in let
                opts1_24 =
                  (BIF.do_remote_fun_call "Lists" "erlps__keystore__4"
                     [(ErlangAtom "src_file"), (ErlangInt (DBI.fromInt 1)),
                      opts_6, arg_21])
              in let
                included1_27 =
                  (BIF.do_remote_fun_call "Sets" "erlps__add_element__2"
              ...
              in
                case match_expr_43 of
                  (ErlangTuple [(ErlangAtom "ok"), sections_42]) ->
                    ...
                    in let
                      filename_57 = (BIF.erlang__binary_to_list__1 [arg_47])
                    in let
                      head_61 =
                        (ErlangTuple
        ...
        in
          case case_11 of
            (ErlangAtom "true") ->
              ...
              in let
                lop_20 =
                  (H.make_string "Illegal redefinition of standard library ")
...
erlps__hash_include__2 [file_0, code_1]
  | ((ErlangAtom "true") ==
       (H.falsifyErrors (\ _ -> (BIF.erlang__is_binary__1 [file_0])))) =
  let arg_2 = (BIF.erlang__binary_to_list__1 [file_0])
  in (erlps__hash_include__2 [arg_2, code_1])
erlps__hash_include__2 [file_0, code_1] | (H.isEList file_0) =
  let   
    tup_el_2 =
      (BIF.do_remote_fun_call "Filename" "erlps__basename__1" [file_0])
  in let
...
erlps__hash_include__2 [arg_7, arg_8] =
  (EXC.function_clause unit)
