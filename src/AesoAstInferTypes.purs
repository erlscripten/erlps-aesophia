...
erlps__push_scope__3 [kind_0, con_1, env_2] =
  ...
  in let
    new_14 =
      (BIF.erlang__op_append
         [lop_7, (ErlangCons name_6 ErlangEmptyList)])
  in let
    map_18 =
      case env_2 of
  ...
  in let map_ext_30 = (ErlangMap (Map.singleton new_14 val_23))
  in let record_updt_17 = (BIF.maps__merge__2 [map_18, map_ext_30])
  in
    case env_2 of
  ...
  in let
    val_11 =
      (BIF.erlang__apply__2
         [fun_3, (ErlangCons scope_6 ErlangEmptyList)])
  in let map_ext_14 = (ErlangMap (Map.singleton ns_1 val_11))
  in let
    record_updt_8 = (BIF.maps__merge__2 [scopes_0, map_ext_14])
  in
    case env_2 of
    ...
    arg_5 =
      (ErlangFun 2
         let
           lambda_6 [_, scope_9] =
             (BIF.erlang__apply__2
                [fun_2, (ErlangCons scope_9 ErlangEmptyList)])
      ...
      (ErlangTuple [(ErlangAtom "env"), scopes_8, vars_9, typevars_10,
        ...
        (ErlangTuple
           [(ErlangAtom "env"), scopes_8, vars_9, record_updt_3, fields_11,
            ...
            what_16])
      _ -> (EXC.badrecord (ErlangAtom "env"))
erlps__bind_tvars__2 [arg_17, arg_18] =
  (EXC.function_clause unit)
...
erlps__check_tvar__2 [(ErlangTuple [(ErlangAtom "env"), _, _,
  ...
  let   
    lop_4 =
      (BIF.erlang__op_eq [tvars_0, (ErlangAtom "unrestricted")])
  in let
    case_3 =
      case lop_4 of
  ...
  in t_2
erlps__check_tvar__2 [arg_12, arg_13] =
  (EXC.function_clause unit)
...
erlps__force_bind_fun__3 [x_0, type_1,
  ...
  in let
    nocode_8 =
      (erlps__get_option__2
         [(ErlangAtom "no_code"), (ErlangAtom "false")])
  in let
    entry_24 =
             ...
             in
               case scope_30 of
                 (ErlangTuple [(ErlangAtom "scope"), funs_37, types_38,
                   ...
                   (ErlangTuple
                      [(ErlangAtom "scope"), (ErlangCons head_33 funs_29),
                       types_38, access_39, kind_40, ann_41])
             ...
             in
               case scope_9 of
                 (ErlangTuple [(ErlangAtom "scope"), funs_18, types_19,
                   ...
                   (ErlangTuple
                      [(ErlangAtom "scope"), funs_18,
                       (ErlangCons head_12 types_8), access_20, kind_21,
                       ann_22])
                 _ -> (EXC.badrecord (ErlangAtom "scope"))
    ...
    unit_9 =
      (ErlangTuple
         [(ErlangAtom "tuple_t"), (ErlangCons head_1 ErlangEmptyList),
          ErlangEmptyList])
  in let tup_el_15 = (H.make_string "state")
  in let
    arg_12 =
      (ErlangTuple
         [(ErlangAtom "id"), (ErlangCons head_1 ErlangEmptyList),
          tup_el_15])
  ...
  in let
    state_20 =
      case case_10 of
        ...
        something_else -> (EXC.case_clause something_else)
  in let tup_el_23 = (H.make_string "state")
  in let head_22 = (ErlangTuple [tup_el_23, state_20])
  in let tup_el_27 = (H.make_string "put")
  in let
    tup_el_28 =
      (ErlangTuple
         [(ErlangAtom "type_sig"),
    ...
    env1_41 =
      (erlps__bind_funs__2
         [(ErlangCons head_22 (ErlangCons head_26 ErlangEmptyList)),
          env_0])
  in let tup_el_47 = (H.make_string "event")
  in let
    arg_44 =
      (ErlangTuple
         [(ErlangAtom "id"), (ErlangCons head_1 ErlangEmptyList),
  ...
  in
    case case_42 of
      (ErlangTuple [e_48, _]) ->
        ...
        in let arg_54 = (H.make_string "event")
        in let
          arg_55 =
            (ErlangTuple
               [(ErlangAtom "fun_t"), (ErlangCons head_1 ErlangEmptyList),
                ErlangEmptyList, (ErlangCons event_52 ErlangEmptyList), unit_9])
        in let tup_el_68 = (H.make_string "Chain")
        in let
          arg_65 =
            (ErlangTuple
               [(ErlangAtom "con"), (ErlangCons head_1 ErlangEmptyList),
                tup_el_68])
        in let
          arg_63 =
            (erlps__push_scope__3
               [(ErlangAtom "namespace"), arg_65, env1_41])
...
erlps__bind_fields__2 [arg_9, arg_10] =
  (EXC.function_clause unit)
...
erlps__contract_call_type__1 [(ErlangTuple [(ErlangAtom "fun_t"),
  ...
  let   
    id_9 =
      (ErlangFun 1
         ...
         in lambda_3)
  in let arg_10 = (H.make_string "int")
  in let
    int_12 =
      (BIF.erlang__apply__2
         [id_9, (ErlangCons arg_10 ErlangEmptyList)])
  in let
    typed_22 =
      (ErlangFun 2
         let
  ...
  in let
    named_35 =
      (ErlangFun 2
         let
           lambda_23 [name_26, default_27] =
             let
               tup_el_30 =
                 (BIF.erlang__apply__2
                    [id_9, (ErlangCons name_26 ErlangEmptyList)])
             in
               (ErlangTuple
         ...
         in lambda_23)
  in let arg_40 = (H.make_string "gas")
  in let head_50 = (H.make_string "Call")
  in let head_52 = (H.make_string "gas_left")
  in let
    arg_46 =
      (ErlangTuple
  ...
  in let
    tup_el_45 =
      (BIF.erlang__apply__2
         [typed_22,
          (ErlangCons arg_46 (ErlangCons arg_54 ErlangEmptyList))])
  in let
    arg_42 =
      (ErlangTuple
         [(ErlangAtom "app"), ann_0, tup_el_45, ErlangEmptyList])
  in let
    arg_41 =
      (BIF.erlang__apply__2
         [typed_22,
          (ErlangCons arg_42 (ErlangCons int_12 ErlangEmptyList))])
  in let
    head_39 =
      (BIF.erlang__apply__2
         [named_35,
          (ErlangCons arg_40 (ErlangCons arg_41 ErlangEmptyList))])
  in let arg_67 = (H.make_string "value")
  in let
    arg_69 =
      (ErlangTuple
         [(ErlangAtom "int"), ann_0, (ErlangInt (DBI.fromInt 0))])
  in let
    arg_68 =
      (BIF.erlang__apply__2
         [typed_22,
          (ErlangCons arg_69 (ErlangCons int_12 ErlangEmptyList))])
  in let
    head_66 =
      (BIF.erlang__apply__2
         [named_35,
          (ErlangCons arg_67 (ErlangCons arg_68 ErlangEmptyList))])
  in
    (ErlangTuple
       [(ErlangAtom "fun_t"), ann_0,
        (ErlangCons head_39 (ErlangCons head_66 ErlangEmptyList)),
        args_1, ret_2])
erlps__contract_call_type__1 [arg_79] =
  (EXC.function_clause unit)
            ...
            case lc_16 of
              (ErlangTuple [(ErlangAtom "fun_decl"), annf_13, entrypoint_14,
                ...
                in let
                  lc_ret_17 =
                    (ErlangTuple
                       [(ErlangAtom "field_t"), annf_13, entrypoint_14,
                        tup_el_21])
                in (ErlangCons lc_ret_17 ErlangEmptyList)
              _ -> ErlangEmptyList)
         contents_2)
  in let tup_el_30 = (H.make_string "address")
  in let
    tup_el_27 =
      (ErlangTuple
         [(ErlangAtom "id"), (ErlangCons head_6 ErlangEmptyList),
          tup_el_30])
  in let tup_el_34 = (H.make_string "address")
  in let
    tup_el_31 =
      (ErlangTuple
         [(ErlangAtom "id"), (ErlangCons head_6 ErlangEmptyList),
                  ...
                  tup_el_44 =
                    (ErlangTuple
                       [(ErlangAtom "field_info"), fieldann_38, type_40, id_1,
                        (ErlangAtom "contract")])
                in let lc_ret_42 = (ErlangTuple [entrypoint_39, tup_el_44])
          ...
          let   
            lop_11 =
              (BIF.do_remote_fun_call "Lists" "erlps__sublist__2"
                 [current_0, lc_9])
          in let lc_ret_10 = (BIF.erlang__op_append [lop_11, qual_3])
...
erlps__lookup_type__2 [env_0, id_1] =
  ...
  in
    (erlps__lookup_env__4 [env_0, (ErlangAtom "type"), arg_4, arg_6])
...
erlps__lookup_env__4 [env_0, kind_1, ann_2, name_3] =
  ...
  in
    case var_12 of
      ...
      (ErlangAtom "false") ->
        let    lc_src_20 = (erlps__possible_scopes__2 [env_0, name_3])
        in let
          names_31 =
            (H.flmap
               (\ lc_24 ->
                  ...
                  in (ErlangCons lc_ret_25 ErlangEmptyList))
               lc_src_20)
        in let
          case_32 =
            (H.flmap
               (\ lc_35 ->
                  let
                    head_37 =
                      (erlps__lookup_env1__4 [env_0, kind_1, ann_2, lc_35])
                  in
                    (H.flmap
                       (\ lc_44 ->
                          let
        ...
        in
          case case_32 of
            ...
            many_50 ->
              ...
              in let
                arg_51 =
                  (ErlangTuple [(ErlangAtom "ambiguous_name"), tup_el_53])
          ...
          case case_20 of
            ...
            (ErlangTuple [(ErlangAtom "reserved_init"), ann1_24, type_25]) ->
              let   
                arg_26 =
                  (ErlangTuple
                     [(ErlangAtom "cannot_call_init_function"), ann_3])
            ...
            (ErlangTuple [(ErlangAtom "contract_fun"), ann1_33, type_34]) ->
              let   
                arg_35 =
                  (ErlangTuple
                     [(ErlangAtom "contract_treated_as_namespace"), ann_3,
                      qname_4])
...
erlps__lookup_record_field__3 [env_0, fieldname_1, kind_2] =
  let
    lc_src_3 = (erlps__lookup_record_field__2 [env_0, fieldname_1])
  in
    (H.flmap
       (\ lc_8 ->
          case lc_8 of
            fld_7@(ErlangTuple [(ErlangAtom "field_info"), _, _, _, k_6]) ->
              let   
                lop_10 = (BIF.erlang__op_eq [kind_2, (ErlangAtom "project")])
              in let
                cond_9 =
                  case lop_10 of
                    (ErlangAtom "true") -> (ErlangAtom "true")
...
erlps__global_env__0 [] =
  let   
    head_0 =
      (ErlangTuple [(ErlangAtom "origin"), (ErlangAtom "system")])
  in let tup_el_7 = (H.make_string "int")
  in let
    int_8 =
      (ErlangTuple
         [(ErlangAtom "id"), (ErlangCons head_0 ErlangEmptyList),
          tup_el_7])
  in let tup_el_11 = (H.make_string "bool")
  in let
    bool_12 =
      (ErlangTuple
         [(ErlangAtom "id"), (ErlangCons head_0 ErlangEmptyList),
          tup_el_11])
  in let tup_el_15 = (H.make_string "string")
  in let
    string_16 =
      (ErlangTuple
         [(ErlangAtom "id"), (ErlangCons head_0 ErlangEmptyList),
          tup_el_15])
  in let tup_el_19 = (H.make_string "address")
  in let
    address_20 =
      (ErlangTuple
         [(ErlangAtom "id"), (ErlangCons head_0 ErlangEmptyList),
          tup_el_19])
  in let tup_el_23 = (H.make_string "hash")
  in let
    hash_24 =
      (ErlangTuple
         [(ErlangAtom "id"), (ErlangCons head_0 ErlangEmptyList),
          tup_el_23])
  in let tup_el_27 = (H.make_string "bits")
  in let
    bits_28 =
      (ErlangTuple
         [(ErlangAtom "id"), (ErlangCons head_0 ErlangEmptyList),
    ...
    bytes_35 =
      (ErlangFun 1
         let
           lambda_29 [len_31] =
             (ErlangTuple
                [(ErlangAtom "bytes_t"), (ErlangCons head_0 ErlangEmptyList),
                 len_31])
  ...
  in let
    oracle_52 =
      (ErlangFun 2
         let
           lambda_36 [q_39, r_40] =
             let    tup_el_46 = (H.make_string "oracle")
             in let
               tup_el_43 =
                 (ErlangTuple
                    [(ErlangAtom "id"), (ErlangCons head_0 ErlangEmptyList),
             ...
             in
               (ErlangTuple
                  [(ErlangAtom "app_t"), (ErlangCons head_0 ErlangEmptyList),
                   tup_el_43,
                   (ErlangCons q_39 (ErlangCons r_40 ErlangEmptyList))])
  ...
  in let
    query_69 =
      (ErlangFun 2
         let
           lambda_53 [q_56, r_57] =
             let    tup_el_63 = (H.make_string "oracle_query")
             in let
               tup_el_60 =
                 (ErlangTuple
                    [(ErlangAtom "id"), (ErlangCons head_0 ErlangEmptyList),
             ...
             in
               (ErlangTuple
                  [(ErlangAtom "app_t"), (ErlangCons head_0 ErlangEmptyList),
                   tup_el_60,
                   (ErlangCons q_56 (ErlangCons r_57 ErlangEmptyList))])
  ...
  in let
    list_86 =
      (ErlangFun 1
         let
           lambda_74 [t_76] =
             let    tup_el_82 = (H.make_string "list")
             in let
               tup_el_79 =
                 (ErlangTuple
                    [(ErlangAtom "id"), (ErlangCons head_0 ErlangEmptyList),
  ...
  in let
    option_99 =
      (ErlangFun 1
         let
           lambda_87 [t_89] =
             let    tup_el_95 = (H.make_string "option")
             in let
               tup_el_92 =
                 (ErlangTuple
                    [(ErlangAtom "id"), (ErlangCons head_0 ErlangEmptyList),
      ...
      (ErlangFun 2
         let
           lambda_100 [a_103, b_104] =
             let    tup_el_110 = (H.make_string "map")
             in let
               tup_el_107 =
                 (ErlangTuple
                    [(ErlangAtom "id"), (ErlangCons head_0 ErlangEmptyList),
      ...
      (ErlangFun 3
         let
           lambda_130 [c_134, ts_135, t_136] =
             (ErlangTuple
                [(ErlangAtom "type_sig"), (ErlangCons head_0 ErlangEmptyList),
                 c_134, ErlangEmptyList, ts_135, t_136])
           lambda_130 [arg_131, arg_132, arg_133] =
             (EXC.function_clause unit)
  ...
  in let
    tvar_187 =
      (ErlangFun 1
         ...
         in lambda_179)
  in let tup_el_190 = (H.make_string "signature")
  in let
    signid_191 =
      (ErlangTuple
         [(ErlangAtom "id"), (ErlangCons head_0 ErlangEmptyList),
    ...
    tup_el_194 =
      (ErlangBinary
         (BIN.from_int (ErlangInt (DBI.fromInt 0))
            (ErlangInt (DBI.fromInt 64)) 8 BIN.Big))
  in let
    signdef_196 =
      (ErlangTuple
             ...
             (ErlangTuple
                [(ErlangAtom "type_sig"),
                 (ErlangCons (ErlangAtom "stateful")
                    (ErlangCons head_0 ErlangEmptyList)),
                 (ErlangAtom "none"),
                 (ErlangCons signature_206 ErlangEmptyList), ts_210, t_211])
           lambda_207 [arg_208, arg_209] = (EXC.function_clause unit)
           lambda_207 args = (EXC.badarity (ErlangFun 2 lambda_207) args)
         in lambda_207)
  in let head_226 = (H.make_string "Chain")
  in let head_228 = (H.make_string "ttl")
  in let
    ttl_230 =
      (ErlangTuple
         [(ErlangAtom "qid"), (ErlangCons head_0 ErlangEmptyList),
          (ErlangCons head_226 (ErlangCons head_228 ErlangEmptyList))])
  in let head_234 = (H.make_string "a")
  in let head_236 = (H.make_string "q")
  in let head_238 = (H.make_string "r")
  in let head_240 = (H.make_string "k")
  in let head_242 = (H.make_string "v")
  in let
    match_expr_249 =
         ...
         [tvar_187,
          (ErlangCons head_234
             (ErlangCons head_236
                (ErlangCons head_238
                   (ErlangCons head_240
                      (ErlangCons head_242 ErlangEmptyList)))))])
  in
    case match_expr_249 of
      (ErlangCons a_244 (ErlangCons q_245 (ErlangCons r_246 (ErlangCons k_247 (ErlangCons v_248 (ErlangEmptyList)))))) ->
        ...
        in let
          tup_el_276 =
            (BIF.erlang__apply__2
               [fun1_164,
                (ErlangCons a_244 (ErlangCons arg_278 ErlangEmptyList))])
        in let head_274 = (ErlangTuple [tup_el_275, tup_el_276])
        in let tup_el_284 = (H.make_string "RelativeTTL")
        in let
          tup_el_285 =
            (BIF.erlang__apply__2
               [fun1_164,
        ...
        in let tup_el_291 = (H.make_string "FixedTTL")
        in let
          tup_el_292 =
            (BIF.erlang__apply__2
               [fun1_164,
        ...
        in let tup_el_298 = (H.make_string "abort")
        in let
          tup_el_299 =
            (BIF.erlang__apply__2
               [fun1_164,
        ...
        in let tup_el_305 = (H.make_string "require")
        in let
          tup_el_306 =
            (BIF.erlang__apply__2
               [fun_153,
            ...
            (BIF.erlang__apply__2
               [mkdefs_264,
                (ErlangCons
                   ...
                   ErlangEmptyList)])
        in let tup_el_319 = (H.make_string "int")
        in let
          head_318 =
            (ErlangTuple [tup_el_319, (ErlangInt (DBI.fromInt 0))])
        in let tup_el_323 = (H.make_string "bool")
        in let
          head_322 =
            (ErlangTuple [tup_el_323, (ErlangInt (DBI.fromInt 0))])
        in let tup_el_327 = (H.make_string "char")
        in let
          head_326 =
            (ErlangTuple [tup_el_327, (ErlangInt (DBI.fromInt 0))])
        in let tup_el_331 = (H.make_string "string")
        in let
          head_330 =
            (ErlangTuple [tup_el_331, (ErlangInt (DBI.fromInt 0))])
        in let tup_el_335 = (H.make_string "address")
        in let
          head_334 =
            (ErlangTuple [tup_el_335, (ErlangInt (DBI.fromInt 0))])
        in let tup_el_339 = (H.make_string "unit")
        in let
          tup_el_342 = (ErlangTuple [(ErlangAtom "alias_t"), unit_73])
        in let tup_el_340 = (ErlangTuple [ErlangEmptyList, tup_el_342])
        in let head_338 = (ErlangTuple [tup_el_339, tup_el_340])
        in let tup_el_347 = (H.make_string "hash")
        in let
          tup_el_352 =
            (BIF.erlang__apply__2
               [bytes_35,
        ...
        in let tup_el_357 = (H.make_string "signature")
        in let
          tup_el_362 =
            (BIF.erlang__apply__2
               [bytes_35,
                (ErlangCons (ErlangInt (DBI.fromInt 64)) ErlangEmptyList)])
        in let
        ...
        in let tup_el_367 = (H.make_string "bits")
        in let
          head_366 =
            (ErlangTuple [tup_el_367, (ErlangInt (DBI.fromInt 0))])
        in let tup_el_371 = (H.make_string "option")
        in let
          head_370 =
            (ErlangTuple [tup_el_371, (ErlangInt (DBI.fromInt 1))])
        in let tup_el_375 = (H.make_string "list")
        in let
          head_374 =
            (ErlangTuple [tup_el_375, (ErlangInt (DBI.fromInt 1))])
        in let tup_el_379 = (H.make_string "map")
        in let
          head_378 =
            (ErlangTuple [tup_el_379, (ErlangInt (DBI.fromInt 2))])
        in let tup_el_383 = (H.make_string "oracle")
        in let
          head_382 =
            (ErlangTuple [tup_el_383, (ErlangInt (DBI.fromInt 2))])
        in let tup_el_387 = (H.make_string "oracle_query")
        in let
          head_386 =
            (ErlangTuple [tup_el_387, (ErlangInt (DBI.fromInt 2))])
        in let
          tup_el_316 =
            (BIF.erlang__apply__2
               [mkdefs_264,
        ...
        in let
          topscope_398 =
            (ErlangTuple
               [(ErlangAtom "scope"), tup_el_266, tup_el_316,
                (ErlangAtom "public"), (ErlangAtom "namespace"),
                (ErlangCons head_394 ErlangEmptyList)])
        in let tup_el_403 = (H.make_string "spend")
        in let
          tup_el_404 =
            (BIF.erlang__apply__2
               [statefun_178,
        ...
        in let tup_el_414 = (H.make_string "balance")
        in let
          tup_el_415 =
            (BIF.erlang__apply__2
               [fun1_164,
        ...
        in let tup_el_421 = (H.make_string "block_hash")
        in let
          arg_424 =
            (BIF.erlang__apply__2
        ...
        in let
          tup_el_422 =
            (BIF.erlang__apply__2
               [fun1_164,
                (ErlangCons int_8 (ErlangCons arg_424 ErlangEmptyList))])
        in let head_420 = (ErlangTuple [tup_el_421, tup_el_422])
        in let tup_el_430 = (H.make_string "coinbase")
        in let head_429 = (ErlangTuple [tup_el_430, address_20])
        in let tup_el_434 = (H.make_string "timestamp")
        in let head_433 = (ErlangTuple [tup_el_434, int_8])
        in let tup_el_438 = (H.make_string "block_height")
        in let head_437 = (ErlangTuple [tup_el_438, int_8])
        in let tup_el_442 = (H.make_string "difficulty")
        in let head_441 = (ErlangTuple [tup_el_442, int_8])
        in let tup_el_446 = (H.make_string "gas_limit")
                                  ...
                                  (ErlangCons head_437
                                     (ErlangCons head_441
                                        (ErlangCons head_445
                                           ErlangEmptyList))))))))
                   ErlangEmptyList)])
        in let tup_el_453 = (H.make_string "ttl")
        in let
          head_452 =
            (ErlangTuple [tup_el_453, (ErlangInt (DBI.fromInt 0))])
        in let
          tup_el_450 =
            (BIF.erlang__apply__2
               [mkdefs_264,
                (ErlangCons (ErlangCons head_452 ErlangEmptyList)
                   ErlangEmptyList)])
        in let
          head_460 =
            (ErlangTuple [(ErlangAtom "origin"), (ErlangAtom "system")])
        in let
          chainscope_464 =
            (ErlangTuple
               [(ErlangAtom "scope"), tup_el_400, tup_el_450,
                (ErlangAtom "public"), (ErlangAtom "namespace"),
                (ErlangCons head_460 ErlangEmptyList)])
        in let tup_el_469 = (H.make_string "address")
        in let head_468 = (ErlangTuple [tup_el_469, address_20])
        in let tup_el_473 = (H.make_string "creator")
        in let head_472 = (ErlangTuple [tup_el_473, address_20])
        in let tup_el_477 = (H.make_string "balance")
            ...
            (BIF.erlang__apply__2
               [mkdefs_264,
                (ErlangCons
                   (ErlangCons head_468
                      (ErlangCons head_472
                         (ErlangCons head_476 ErlangEmptyList)))
                   ErlangEmptyList)])
        in let
          head_485 =
            (ErlangTuple [(ErlangAtom "origin"), (ErlangAtom "system")])
        ...
        in let tup_el_494 = (H.make_string "origin")
        in let head_493 = (ErlangTuple [tup_el_494, address_20])
        in let tup_el_498 = (H.make_string "caller")
        in let head_497 = (ErlangTuple [tup_el_498, address_20])
        in let tup_el_502 = (H.make_string "value")
        in let head_501 = (ErlangTuple [tup_el_502, int_8])
        in let tup_el_506 = (H.make_string "gas_price")
        in let head_505 = (ErlangTuple [tup_el_506, int_8])
        in let tup_el_510 = (H.make_string "gas_left")
        in let
          tup_el_511 =
            (BIF.erlang__apply__2
               [fun_153,
        ...
        in let tup_el_530 = (H.make_string "register")
        in let
          arg_539 =
            (BIF.erlang__apply__2
               [oracle_52,
                (ErlangCons q_245 (ErlangCons r_246 ErlangEmptyList))])
        in let
          tup_el_531 =
            (BIF.erlang__apply__2
               [signfun_222,
        ...
        in let tup_el_546 = (H.make_string "query_fee")
        in let
          head_549 =
            (BIF.erlang__apply__2
               [oracle_52,
        ...
        in let tup_el_558 = (H.make_string "query")
        in let
          head_561 =
            (BIF.erlang__apply__2
               [oracle_52,
        ...
        in let tup_el_581 = (H.make_string "get_question")
        in let
          head_584 =
            (BIF.erlang__apply__2
               [oracle_52,
        ...
        in let tup_el_598 = (H.make_string "respond")
        in let
          head_601 =
            (BIF.erlang__apply__2
               [oracle_52,
        ...
        in let tup_el_617 = (H.make_string "extend")
        in let
          head_620 =
            (BIF.erlang__apply__2
               [oracle_52,
        ...
        in let tup_el_631 = (H.make_string "get_answer")
        in let
          head_634 =
            (BIF.erlang__apply__2
               [oracle_52,
        ...
        in let tup_el_650 = (H.make_string "check")
        in let
          head_653 =
            (BIF.erlang__apply__2
               [oracle_52,
        ...
        in let tup_el_662 = (H.make_string "check_query")
        in let
          head_665 =
            (BIF.erlang__apply__2
               [oracle_52,
        ...
        in let tup_el_692 = (H.make_string "resolve")
        in let
          arg_699 =
        ...
        in let tup_el_705 = (H.make_string "preclaim")
        in let
          tup_el_706 =
            (BIF.erlang__apply__2
               [signfun_222,
        ...
        in let tup_el_716 = (H.make_string "claim")
        in let
          tup_el_717 =
            (BIF.erlang__apply__2
               [signfun_222,
        ...
        in let tup_el_731 = (H.make_string "transfer")
        in let
          tup_el_732 =
            (BIF.erlang__apply__2
               [signfun_222,
        ...
        in let tup_el_744 = (H.make_string "revoke")
        in let
          tup_el_745 =
            (BIF.erlang__apply__2
               [signfun_222,
        ...
        in let tup_el_768 = (H.make_string "from_list")
        in let
          arg_771 =
            (BIF.erlang__apply__2
               [pair_129,
                (ErlangCons k_247 (ErlangCons v_248 ErlangEmptyList))])
        in let
          arg_770 =
            (BIF.erlang__apply__2
        ...
        in let tup_el_783 = (H.make_string "to_list")
        in let
          arg_785 =
            (BIF.erlang__apply__2
               [map_116, (ErlangCons k_247 (ErlangCons v_248 ErlangEmptyList))])
        ...
        in let tup_el_798 = (H.make_string "lookup")
        in let
          head_803 =
            (BIF.erlang__apply__2
               [map_116, (ErlangCons k_247 (ErlangCons v_248 ErlangEmptyList))])
        ...
        in let tup_el_814 = (H.make_string "lookup_default")
        in let
          head_819 =
            (BIF.erlang__apply__2
               [map_116, (ErlangCons k_247 (ErlangCons v_248 ErlangEmptyList))])
        ...
        in let tup_el_830 = (H.make_string "delete")
        in let
          head_835 =
            (BIF.erlang__apply__2
               [map_116, (ErlangCons k_247 (ErlangCons v_248 ErlangEmptyList))])
        ...
        in let tup_el_847 = (H.make_string "member")
        in let
          head_852 =
            (BIF.erlang__apply__2
               [map_116, (ErlangCons k_247 (ErlangCons v_248 ErlangEmptyList))])
        ...
        in let tup_el_861 = (H.make_string "size")
        in let
          arg_863 =
            (BIF.erlang__apply__2
               [map_116, (ErlangCons k_247 (ErlangCons v_248 ErlangEmptyList))])
        in let
          tup_el_862 =
            (BIF.erlang__apply__2
               [fun1_164,
                (ErlangCons arg_863 (ErlangCons int_8 ErlangEmptyList))])
        ...
        in let tup_el_884 = (H.make_string "verify_sig")
        in let
          tup_el_885 =
            (BIF.erlang__apply__2
               [fun_153,
        ...
        in let tup_el_897 = (H.make_string "verify_sig_secp256k1")
        in let
          head_902 =
            (BIF.erlang__apply__2
               [bytes_35,
        ...
        in let tup_el_912 = (H.make_string "ecverify_secp256k1")
        in let
          head_917 =
            (BIF.erlang__apply__2
               [bytes_35,
                (ErlangCons (ErlangInt (DBI.fromInt 20)) ErlangEmptyList)])
        in let
          head_921 =
            (BIF.erlang__apply__2
               [bytes_35,
                (ErlangCons (ErlangInt (DBI.fromInt 65)) ErlangEmptyList)])
        in let
          tup_el_913 =
            (BIF.erlang__apply__2
               [fun_153,
                (ErlangCons
                   (ErlangCons hash_24
                      (ErlangCons head_917
                         (ErlangCons head_921 ErlangEmptyList)))
                   (ErlangCons bool_12 ErlangEmptyList))])
        in let head_911 = (ErlangTuple [tup_el_912, tup_el_913])
        in let tup_el_929 = (H.make_string "ecrecover_secp256k1")
        in let
          head_934 =
            (BIF.erlang__apply__2
               [bytes_35,
        ...
        in let tup_el_946 = (H.make_string "sha3")
        in let
          tup_el_947 =
            (BIF.erlang__apply__2
               [fun1_164,
                (ErlangCons a_244 (ErlangCons hash_24 ErlangEmptyList))])
        in let head_945 = (ErlangTuple [tup_el_946, tup_el_947])
        in let tup_el_953 = (H.make_string "sha256")
        in let
          tup_el_954 =
            (BIF.erlang__apply__2
               [fun1_164,
        ...
        in let tup_el_960 = (H.make_string "blake2b")
        in let
          tup_el_961 =
            (BIF.erlang__apply__2
               [fun1_164,
        ...
        in let tup_el_980 = (H.make_string "tx_hash")
        in let
          tup_el_981 =
            (BIF.erlang__apply__2
               [option_99, (ErlangCons hash_24 ErlangEmptyList)])
        ...
        in let
          tup_el_977 =
            (BIF.erlang__apply__2
               [mkdefs_264,
                (ErlangCons (ErlangCons head_979 ErlangEmptyList)
                   ErlangEmptyList)])
        in let
          head_990 =
            (ErlangTuple [(ErlangAtom "origin"), (ErlangAtom "system")])
        ...
        in let tup_el_999 = (H.make_string "length")
        in let
          tup_el_1000 =
            (BIF.erlang__apply__2
               [fun1_164,
        ...
        in let tup_el_1006 = (H.make_string "concat")
        in let
          tup_el_1007 =
            (BIF.erlang__apply__2
               [fun_153,
        ...
        in let tup_el_1017 = (H.make_string "sha3")
        in let
          tup_el_1018 =
            (BIF.erlang__apply__2
               [fun1_164,
        ...
        in let tup_el_1024 = (H.make_string "sha256")
        in let
          tup_el_1025 =
            (BIF.erlang__apply__2
               [fun1_164,
        ...
        in let tup_el_1031 = (H.make_string "blake2b")
        in let
          tup_el_1032 =
            (BIF.erlang__apply__2
               [fun1_164,
        ...
        in let tup_el_1051 = (H.make_string "set")
        in let
          tup_el_1052 =
            (BIF.erlang__apply__2
               [fun_153,
        ...
        in let tup_el_1062 = (H.make_string "clear")
        in let
          tup_el_1063 =
            (BIF.erlang__apply__2
               [fun_153,
        ...
        in let tup_el_1073 = (H.make_string "test")
        in let
          tup_el_1074 =
            (BIF.erlang__apply__2
               [fun_153,
        ...
        in let tup_el_1084 = (H.make_string "sum")
        in let
          tup_el_1085 =
            (BIF.erlang__apply__2
               [fun1_164,
        ...
        in let tup_el_1091 = (H.make_string "intersection")
        in let
          tup_el_1092 =
            (BIF.erlang__apply__2
               [fun_153,
        ...
        in let tup_el_1102 = (H.make_string "union")
        in let
          tup_el_1103 =
            (BIF.erlang__apply__2
               [fun_153,
        ...
        in let tup_el_1113 = (H.make_string "difference")
        in let
          tup_el_1114 =
            (BIF.erlang__apply__2
               [fun_153,
        ...
        in let tup_el_1124 = (H.make_string "none")
        in let head_1123 = (ErlangTuple [tup_el_1124, bits_28])
        in let tup_el_1128 = (H.make_string "all")
        ...
        in let tup_el_1145 = (H.make_string "to_int")
        in let
          arg_1147 =
            (BIF.erlang__apply__2
        ...
        in let tup_el_1154 = (H.make_string "to_str")
        in let
          arg_1156 =
            (BIF.erlang__apply__2
               [bytes_35, (ErlangCons (ErlangAtom "any") ErlangEmptyList)])
        ...
        in let tup_el_1163 = (H.make_string "concat")
        in let
          head_1167 =
            (BIF.erlang__apply__2
               [bytes_35, (ErlangCons (ErlangAtom "any") ErlangEmptyList)])
        ...
        in let tup_el_1181 = (H.make_string "split")
        in let
          head_1185 =
            (BIF.erlang__apply__2
               [bytes_35, (ErlangCons (ErlangAtom "any") ErlangEmptyList)])
        ...
        in let tup_el_1213 = (H.make_string "to_str")
        in let
          tup_el_1214 =
            (BIF.erlang__apply__2
               [fun1_164,
        ...
        in let tup_el_1233 = (H.make_string "to_str")
        in let
          tup_el_1234 =
            (BIF.erlang__apply__2
               [fun1_164,
        ...
        in let tup_el_1240 = (H.make_string "to_contract")
        in let
          tup_el_1241 =
            (BIF.erlang__apply__2
               [func_143,
        ...
        in let tup_el_1250 = (H.make_string "is_oracle")
        in let
          tup_el_1251 =
            (BIF.erlang__apply__2
               [fun1_164,
        ...
        in let tup_el_1257 = (H.make_string "is_contract")
        in let
          tup_el_1258 =
            (BIF.erlang__apply__2
               [fun1_164,
        ...
        in let tup_el_1264 = (H.make_string "is_payable")
        in let
          tup_el_1265 =
            (BIF.erlang__apply__2
               [fun1_164,
        ...
        in let head_1284 = (H.make_string "Chain")
        in let head_1287 = (H.make_string "Contract")
        in let head_1290 = (H.make_string "Call")
        in let head_1293 = (H.make_string "Oracle")
        in let head_1296 = (H.make_string "AENS")
        in let head_1299 = (H.make_string "Map")
        in let head_1302 = (H.make_string "Auth")
        in let head_1305 = (H.make_string "Crypto")
        in let head_1308 = (H.make_string "String")
        in let head_1311 = (H.make_string "Bits")
        in let head_1314 = (H.make_string "Bytes")
        in let head_1317 = (H.make_string "Int")
        in let head_1320 = (H.make_string "Address")
        in let
          tup_el_1281 =
            (ErlangMap
               (Map.fromFoldable
                  [(Tup.Tuple ErlangEmptyList topscope_398),
                   (Tup.Tuple (ErlangCons head_1284 ErlangEmptyList)
                      chainscope_464),
                   (Tup.Tuple (ErlangCons head_1287 ErlangEmptyList)
                      contractscope_489),
                   (Tup.Tuple (ErlangCons head_1290 ErlangEmptyList)
                      callscope_525),
                   (Tup.Tuple (ErlangCons head_1293 ErlangEmptyList)
                      oraclescope_687),
                   (Tup.Tuple (ErlangCons head_1296 ErlangEmptyList)
                      aensscope_763),
                   (Tup.Tuple (ErlangCons head_1299 ErlangEmptyList)
                      mapscope_879),
                   (Tup.Tuple (ErlangCons head_1302 ErlangEmptyList)
                      authscope_994),
                   (Tup.Tuple (ErlangCons head_1305 ErlangEmptyList)
                      cryptoscope_975),
                   (Tup.Tuple (ErlangCons head_1308 ErlangEmptyList)
                      stringscope_1046),
                   (Tup.Tuple (ErlangCons head_1311 ErlangEmptyList)
                      bitsscope_1140),
                   (Tup.Tuple (ErlangCons head_1314 ErlangEmptyList)
                      bytesscope_1208),
                   (Tup.Tuple (ErlangCons head_1317 ErlangEmptyList)
                      intscope_1228),
                   (Tup.Tuple (ErlangCons head_1320 ErlangEmptyList)
                      addressscope_1279)]))
...
erlps__option_t__2 [as_0, t_1] =
  let    tup_el_7 = (H.make_string "option")
  in let
    tup_el_4 = (ErlangTuple [(ErlangAtom "id"), as_0, tup_el_7])
  in
    (ErlangTuple
...
erlps__map_t__3 [as_0, k_1, v_2] =
  let    tup_el_8 = (H.make_string "map")
  in let
    tup_el_5 = (ErlangTuple [(ErlangAtom "id"), as_0, tup_el_8])
  in
    (ErlangTuple
    ...
    (EXC.tryCatchFinally
       (\ _ ->
          ...
          in let
            match_expr_17 =
              (erlps__infer1__4
                 [env_3, contracts_0, ErlangEmptyList, options_1])
          in
            case match_expr_17 of
              (ErlangTuple [env1_15, decls_16]) ->
                let   
                  case_18 =
                    (BIF.do_remote_fun_call "Proplists" "erlps__get_value__3"
                       [(ErlangAtom "dont_unfold"), options_1,
                        (ErlangAtom "false")])
                in let
                  match_expr_41 =
                    case case_18 of
...
erlps__infer1__4 [env_0,
  ...
  in let
    what_10 =
      case (ErlangAtom "true") of
        _ | (weakEq rest_4 ErlangEmptyList) ->
          (ErlangAtom "main_contract")
        _ -> (ErlangAtom "contract")
  in let
    arg_11 =
      (erlps__push_scope__3
         [(ErlangAtom "contract"), conname_2, env_0])
  in let
    match_expr_20 =
      (erlps__infer_contract_top__4
         [arg_11, what_10, code_3, options_6])
  in
    case match_expr_20 of
      (ErlangTuple [env1_18, code1_19]) ->
        let   
          contract1_25 =
            (ErlangTuple
               [(ErlangAtom "contract"), ann_1, conname_2, code1_19])
        in let env2_27 = (erlps__pop_scope__1 [env1_18])
        in let
          env3_30 = (erlps__bind_contract__2 [contract1_25, env2_27])
        in
          (erlps__infer1__4
...
erlps__infer_contract_top__4 [env_0, kind_1, defs0_2, options_3]
  =
  let defs_5 = (erlps__desugar__1 [defs0_2])
  in (erlps__infer_contract__4 [env_0, kind_1, defs_5, options_3])
erlps__infer_contract_top__4 [arg_10, arg_11, arg_12, arg_13] =
  (EXC.function_clause unit)
...
erlps__infer_contract__4 [env0_0, what_1, defs0_2, options_3] =
  ...
  in let
    match_expr_47 = (erlps__check_typedefs__2 [env_24, arg_42])
  in
      ...
      (ErlangTuple [env1_45, typedefs_46]) ->
        ...
        in let
          arg_54 =
            (H.flmap
               (\ lc_59 ->
                  let lc_ret_60 = (erlps__check_fundecl__2 [env1_45, lc_59])
                  in (ErlangCons lc_ret_60 ErlangEmptyList))
               lc_src_55)
        in let
          match_expr_65 =
            ...
            (ErlangTuple [protosigs_63, decls_64]) ->
              ...
              in let
                functions_71 =
                  (BIF.erlang__apply__2
                     [get_40,
                      (ErlangCons (ErlangAtom "function") ErlangEmptyList)])
              in let
                funbind_88 =
                  (ErlangFun 1
                     let
                       ...
                       lambda_89 [def_91] =
                         let
                           match_expr_95 =
                             (BIF.erlang__apply__2
                                [funbind_88,
                                 (ErlangCons def_91 ErlangEmptyList)])
                         in
                           case match_expr_95 of
                             (ErlangTuple [name_94, _]) -> name_94
                             _ -> (EXC.badmatch match_expr_95)
                ...
                arg_100 =
                  (ErlangTuple
                     [(ErlangAtom "env"), tup_el_102, ErlangEmptyList,
                      ...
                      (ErlangAtom "false"), (ErlangAtom "false"),
                      (ErlangAtom "none"), (ErlangAtom "top")])
              in let match_expr_123 = (erlps__bind_funs__2 [arg_97, arg_100])
              in let
                arg_124 =
                  (H.flmap
                     (\ lc_127 ->
                        let   
                          tup_el_129 =
                            (BIF.erlang__apply__2
                               [funname_96,
                                (ErlangCons lc_127 ErlangEmptyList)])
                        in let lc_ret_128 = (ErlangTuple [tup_el_129, lc_127])
                        in (ErlangCons lc_ret_128 ErlangEmptyList))
                     functions_71)
              ...
              in
                case match_expr_151 of
                  (ErlangTuple [env4_149, defs1_150]) ->
                    let   
                      _ =
                        (erlps__check_state_dependencies__2
                           [env4_149, defs1_150])
                    in let
                      _ = (erlps__destroy_and_report_type_errors__1 [env4_149])
                    in let
                      rop_158 = (BIF.erlang__op_append [decls_64, defs1_150])
                    in let
                      tup_el_156 =
                        (BIF.erlang__op_append [typedefs_46, rop_158])
                    in (ErlangTuple [env4_149, tup_el_156])
                  _ -> (EXC.badmatch match_expr_151)
                  ...
                  (H.flmap
                     (\ lc_26 ->
                        let   
                          arg_28 =
                            (ErlangTuple
                               [(ErlangAtom "mismatched_decl_in_funblock"),
                                name_14, lc_26])
                        in let lc_ret_27 = (erlps__type_error__1 [arg_28])
                        ...
                        let   
                          arg_55 =
                            (ErlangTuple
                               [(ErlangAtom "mismatched_decl_in_funblock"),
                                name_40, lc_53])
                        in let lc_ret_54 = (erlps__type_error__1 [arg_55])
                        in (ErlangCons lc_ret_54 ErlangEmptyList))
                     rest_49)
              in let
                head_66 =
                  (ErlangTuple [(ErlangAtom "origin"), (ErlangAtom "system")])
              in let tup_el_70 = (H.make_string "_")
              in let
                tup_el_63 =
                  (ErlangTuple
                     [(ErlangAtom "id"), (ErlangCons head_66 ann1_39),
                      tup_el_70])
              in let
                head_59 =
                  (ErlangTuple
...
erlps__expose_internals__2 [defs_0, what_1] =
  (H.flmap
     (\ lc_4 ->
        let   
          ann_8 =
            (BIF.erlang__element__2 [(ErlangInt (DBI.fromInt 2)), lc_4])
        in let
          newann_26 =
            case what_1 of
                ...
                (H.flmap
                   (\ lc_12 ->
                      let   
                        rop_15 =
                          (ErlangTuple
                             [(ErlangAtom "private"), (ErlangAtom "true")])
              ...
              (ErlangAtom "main_contract") ->
                let
                  head_22 =
                    (ErlangTuple
                       [(ErlangAtom "entrypoint"), (ErlangAtom "true")])
        ...
        in let
          def1_30 =
            (BIF.erlang__setelement__3
               [(ErlangInt (DBI.fromInt 2)), lc_4, newann_26])
        in let
          lc_ret_5 =
            case def1_30 of
              (ErlangTuple [(ErlangAtom "fun_clauses"), ans_32, id_33, t_34,
                            clauses_35]) ->
                let
                  tup_el_40 = (erlps__expose_internals__2 [clauses_35, what_1])
                in
                  (ErlangTuple
                     [(ErlangAtom "fun_clauses"), ans_32, id_33, t_34,
                      tup_el_40])
              _ -> def1_30
    ...
    arg_7 =
      (H.flmap
         (\ lc_10 ->
            ...
            in let lc_ret_11 = (ErlangTuple [tup_el_12, lc_10])
    ...
    arg_17 =
      (ErlangFun 2
         let
           lambda_18 [_, def_21] =
             (BIF.do_remote_fun_call "Aeso.Syntax.Utils"
                "erlps__used_types__2" [ns_0, def_21])
    ...
    case case_5 of
      ...
      (ErlangTuple [(ErlangAtom "type_def"), ann_13, d_14, xs_15,
        ...
        in let
          head_26 =
            (ErlangTuple
               [(ErlangAtom "type_def"), ann_13, d_14, xs_15, def_25])
                ...
                contype_78 =
                  (ErlangFun 1
                     let
                       ...
                       lambda_69 [args_71] =
                         (ErlangTuple
                            [(ErlangAtom "type_sig"), ann_13,
                             (ErlangAtom "none"), ErlangEmptyList, args_71,
                             target_68])
                        ...
                        case lc_81 of
                          (ErlangTuple [(ErlangAtom "constr_t"), _,
                            ...
                            let
                              ...
                              lc_ret_82 = (ErlangTuple [con_83, tup_el_87])
                            in (ErlangCons lc_ret_82 ErlangEmptyList)
                     ...
                     (\ lc_95 ->
                        case lc_95 of
                          (ErlangTuple [(ErlangAtom "constr_t"), _, con_93,
                            ...
                            in let lc_ret_96 = (ErlangTuple [con_93, tup_el_98])
                            in (ErlangCons lc_ret_96 ErlangEmptyList)
                          _ -> ErlangEmptyList)
                     cons_62)
                     ...
                     (\ lc_103 ->
                        case lc_103 of
                          (ErlangTuple [(ErlangAtom "constr_t"), _, con_102,
                            ...
                            in (ErlangCons lc_ret_104 ErlangEmptyList)
                          _ -> ErlangEmptyList)
                     cons_62)
  ...
  let   
    id_12 =
      (ErlangFun 1
         let
           lambda_5 [x_7] =
             let match_expr_11 = (BIF.maps__get__2 [x_7, typemap_1])
             in
            ...
            case lc_8 of
              (ErlangTuple [(ErlangAtom "field_t"), ann_5, id_6, type_7]) ->
                ...
                in let
                  lc_ret_9 =
                    (ErlangTuple
                       [(ErlangAtom "field_t"), ann_5, id_6, tup_el_13])
              ...
              (ErlangTuple [(ErlangAtom "constr_t"), ann_5, con_6, args_7]) ->
                let   
                  tup_el_13 =
                    (H.flmap
                       (\ lc_16 ->
                          let lc_ret_17 = (erlps__check_type__2 [env_0, lc_16])
                          in (ErlangCons lc_ret_17 ErlangEmptyList))
                       args_7)
                in let
                  lc_ret_9 =
                    (ErlangTuple
                       [(ErlangAtom "constr_t"), ann_5, con_6, tup_el_13])
                in (ErlangCons lc_ret_9 ErlangEmptyList)
              _ -> ErlangEmptyList)
         cons_1)
...
erlps__check_unexpected__1 [xs_0] =
  (H.flmap
     (\ lc_3 ->
        let lc_ret_4 = (erlps__type_error__1 [lc_3])
...
erlps__check_modifiers___2 [env_0,
  ...
  in let
    _ =
      (erlps__check_modifiers1__2 [(ErlangAtom "contract"), decls_2])
  in let
    tup_el_10 =
      (BIF.lists__keymember__3
         [(ErlangAtom "letfun"), (ErlangInt (DBI.fromInt 1)), decls_2])
  in let
    tup_el_14 =
      (H.flmap
         (\ lc_17 ->
  ...
  in let
    _ =
      case case_9 of
        ...
        _ | ((ErlangAtom "true") ==
               (H.falsifyErrors (\ _ -> (BIF.erlang__not__1 [ismain_6])))) ->
          let
            case_27 =
              (H.flmap
                 (\ lc_31 ->
                    case lc_31 of
                      (ErlangTuple [(ErlangAtom "letfun"), ann_29, id_30, _, _,
                                    _]) ->
                        let lc_ret_32 = (ErlangTuple [ann_29, id_30])
...
erlps__check_modifiers___2 [env_0,
  ...
  let
    _ =
      (erlps__check_modifiers1__2 [(ErlangAtom "namespace"), decls_1])
    ...
    case case_4 of
      (ErlangTuple [(ErlangAtom "error"), err_5]) ->
        let
          arg_6 =
            (ErlangTuple
               [(ErlangAtom "failed_to_get_compiler_version"), err_5])
      ...
      (ErlangTuple [(ErlangAtom "ok"), version_9]) ->
        ...
        in let
          head_31 =
            (BIF.erlang__apply__2
               [strip_22, (ErlangCons ver_3 ErlangEmptyList)])
        in let
          case_23 =
          ...
          case case_23 of
            ...
            (ErlangAtom "false") ->
              let
                arg_35 =
                  (ErlangTuple
                     [(ErlangAtom "compiler_version_mismatch"), ann_1,
                      version_9, op_2, ver_3])
...
erlps__check_modifiers1__2 [what_0, decls_1]
  | (H.isEList decls_1) =
  let
    match_expr_8 =
      (H.flmap
         (\ lc_4 ->
            let lc_ret_5 = (erlps__check_modifiers1__2 [what_0, lc_4])
            in (ErlangCons lc_ret_5 ErlangEmptyList))
         decls_1)
  in (ErlangAtom "ok")
erlps__check_modifiers1__2 [what_0, decl_1]
  | ((ErlangAtom "true") ==
       (H.falsifyErrors
          (\ _ ->
             let   
               lop_106 =
                 (BIF.erlang__element__2 [(ErlangInt (DBI.fromInt 1)), decl_1])
             in let
               lop_105 = (BIF.erlang__op_eq [lop_106, (ErlangAtom "letfun")])
             in
               case lop_105 of
                 (ErlangAtom "true") -> (ErlangAtom "true")
                 (ErlangAtom "false") ->
                   let
                     lop_110 =
                       (BIF.erlang__element__2
                          [(ErlangInt (DBI.fromInt 1)), decl_1])
  ...
  in let
    fundecl_22 =
      (BIF.erlang__op_eq [lop_18, (ErlangAtom "fun_decl")])
  in let
    match_expr_26 =
      (BIF.erlang__element__2 [(ErlangInt (DBI.fromInt 3)), decl_1])
  in
    case match_expr_26 of
      (ErlangTuple [(ErlangAtom "id"), _, name_25]) ->
        let    rop_29 = (H.make_string "init")
                ...
                let
                  cond_34 =
                    case private_9 of
                      (ErlangAtom "true") -> (ErlangAtom "true")
                      (ErlangAtom "false") ->
                        (BIF.erlang__not__1 [entrypoint_17])
                              ...
                              arg_41 =
                                (ErlangTuple
                                   [(ErlangAtom "proto_must_be_entrypoint"),
                                    decl_1])
                            in let lc_ret_40 = (erlps__type_error__1 [arg_41])
          ...
          match_expr_53 =
            case fundecl_22 of
              (ErlangAtom "true") ->
                let
                  cond_46 =
                    (BIF.erlang__op_eq [what_0, (ErlangAtom "namespace")])
                in
                  case cond_46 of
                    (ErlangAtom "true") ->
                      let   
                        arg_50 =
                          (ErlangTuple
                             [(ErlangAtom "proto_in_namespace"), decl_1])
                      in let lc_ret_49 = (erlps__type_error__1 [arg_50])
                      in (ErlangCons lc_ret_49 ErlangEmptyList)
                    _ -> ErlangEmptyList
              _ -> ErlangEmptyList
              ...
              (ErlangAtom "true") ->
                case isinit_32 of
                  (ErlangAtom "true") ->
                    ...
                    in let lc_ret_57 = (erlps__type_error__1 [arg_58])
              ...
              (ErlangAtom "true") ->
                case isinit_32 of
                  (ErlangAtom "true") ->
                    ...
                    in let lc_ret_64 = (erlps__type_error__1 [arg_65])
                                    ...
                                    arg_78 =
                                      (ErlangTuple
                                         [(ErlangAtom
                                          ...
                                          decl_1])
                                  in let
                                    lc_ret_77 = (erlps__type_error__1 [arg_78])
                ...
                in
                  case cond_83 of
                    (ErlangAtom "true") ->
                      ...
                      in let lc_ret_86 = (erlps__type_error__1 [arg_87])
                      in (ErlangCons lc_ret_86 ErlangEmptyList)
                    _ -> ErlangEmptyList
              _ -> ErlangEmptyList
        in let
          match_expr_97 =
                ...
                case entrypoint_17 of
                  (ErlangAtom "true") ->
                    let   
                      arg_94 =
                        (ErlangTuple
                           [(ErlangAtom "private_entrypoint"), decl_1])
                    in let lc_ret_93 = (erlps__type_error__1 [arg_94])
                    in (ErlangCons lc_ret_93 ErlangEmptyList)
                  _ -> ErlangEmptyList
              _ -> ErlangEmptyList
        in let
          match_expr_104 =
                ...
                case public_5 of
                  (ErlangAtom "true") ->
                    let   
                      arg_101 =
                        (ErlangTuple
                           [(ErlangAtom "private_and_public"), decl_1])
                    in let lc_ret_100 = (erlps__type_error__1 [arg_101])
                    in (ErlangCons lc_ret_100 ErlangEmptyList)
                  _ -> ErlangEmptyList
              _ -> ErlangEmptyList
        in (ErlangAtom "ok")
...
erlps__check_type__2 [env_0, t_1] =
  (erlps__check_type__3 [env_0, t_1, (ErlangInt (DBI.fromInt 0))])
...
erlps__check_type__3 [env_0,
  ...
  let   
    cond_3 =
      (BIF.erlang__op_neq [arity_2, (ErlangInt (DBI.fromInt 0))])
  in let
    _ =
      case cond_3 of
        (ErlangAtom "true") ->
          ...
          in let lc_ret_6 = (erlps__type_error__1 [arg_7])
...
erlps__check_type__3 [_env_0,
                      ...
                      arity_4]
  | ((ErlangInt num_2) == (ErlangInt (DBI.fromInt 95))) =
                  ...
                  arg_18 =
                    (ErlangTuple
                       [(ErlangAtom "wrong_type_arguments"), x_2, arity_3,
                        arity1_13])
                in let lc_ret_17 = (erlps__type_error__1 [arg_18])
                in (ErlangCons lc_ret_17 ErlangEmptyList)
              _ -> ErlangEmptyList
            ...
            let
              lc_ret_13 =
                (erlps__check_type__3
                   [env_0, lc_12, (ErlangInt (DBI.fromInt 0))])
...
erlps__check_type__3 [env_0,
      ...
      (H.flmap
         (\ lc_7 ->
            let
              lc_ret_8 =
                (erlps__check_type__3
                   [env_0, lc_7, (ErlangInt (DBI.fromInt 0))])
  ...
  in
    (ErlangTuple [(ErlangAtom "app_t"), ann_1, type1_19, types1_12])
erlps__check_type__3 [env_0,
  ...
  in let
    namedargs1_15 =
      (H.flmap
         (\ lc_11 ->
            let lc_ret_12 = (erlps__check_named_arg__2 [env_0, lc_11])
      ...
      (H.flmap
         (\ lc_18 ->
            let
              lc_ret_19 =
                (erlps__check_type__3
                   [env_0, lc_18, (ErlangInt (DBI.fromInt 0))])
            in (ErlangCons lc_ret_19 ErlangEmptyList))
         args_3)
  in let
    ret1_27 =
      (erlps__check_type__3
         [env_0, ret_4, (ErlangInt (DBI.fromInt 0))])
  in
    (ErlangTuple
...
erlps__check_type__3 [_env_0,
  ...
  let   
    arg_3 =
      (ErlangTuple [(ErlangAtom "new_tuple_syntax"), ann_1, ts_2])
  in let _ = (erlps__type_error__1 [arg_3])
...
erlps__ensure_base_type__2 [type_0, arity_1] =
  let   
    cond_2 =
      (BIF.erlang__op_neq [arity_1, (ErlangInt (DBI.fromInt 0))])
  in let
    _ =
      case cond_2 of
        (ErlangAtom "true") ->
          let   
            arg_6 =
              (ErlangTuple
                 [(ErlangAtom "wrong_type_arguments"), type_0, arity_1,
                  (ErlangInt (DBI.fromInt 0))])
          in let lc_ret_5 = (erlps__type_error__1 [arg_6])
          in (ErlangCons lc_ret_5 ErlangEmptyList)
        _ -> ErlangEmptyList
  in (ErlangAtom "ok")
...
erlps__check_named_arg__2 [env_0,
  ...
  in let
    match_expr_12 =
      (erlps__check_expr__3 [env_0, default_4, type1_7])
  in
...
erlps__check_fields__4 [env_0, typemap_1, recty_2,
  ...
  in
    (erlps__check_fields__4 [env1_16, typemap_1, recty_2, fields_6])
...
erlps__check_event__4 [env_0,
  ...
  , ((ErlangInt num_2) == (ErlangInt (DBI.fromInt 118)))
    ...
    (ErlangTuple [(ErlangAtom "variant_t"), cons_9]) ->
      let
        tup_el_11 =
          (H.flmap
             (\ lc_14 ->
                let lc_ret_15 = (erlps__check_event_con__2 [env_0, lc_14])
...
erlps__check_event_con__2 [env_0,
               ...
               case case_10 of
                 ...
                 (ErlangTuple [(ErlangAtom "false"), (ErlangAtom "false"),
                   ...
                   let   
                     arg_23 =
                       (ErlangTuple
                          [(ErlangAtom "event_arg_type_word_or_string"), t_6,
                           t1_9])
    ...
    indexed_40 =
      (H.flmap
         (\ lc_33 ->
            ...
            in let
              cond_34 = (BIF.erlang__op_eq [lop_35, (ErlangAtom "indexed")])
            in
              case cond_34 of
                (ErlangAtom "true") -> (ErlangCons lc_33 ErlangEmptyList)
                _ -> ErlangEmptyList)
  ...
  in let
    cond_44 =
      (BIF.erlang__op_greater [lop_45, (ErlangInt (DBI.fromInt 3))])
  in let
    _ =
      case cond_44 of
        (ErlangAtom "true") ->
          ...
          in let lc_ret_48 = (erlps__type_error__1 [arg_49])
          in (ErlangCons lc_ret_48 ErlangEmptyList)
        _ -> ErlangEmptyList
  in let lop_53 = (BIF.erlang__length__1 [nonindexed_43])
  in let
    cond_52 =
      (BIF.erlang__op_greater [lop_53, (ErlangInt (DBI.fromInt 1))])
  in let
    _ =
      case cond_52 of
        (ErlangAtom "true") ->
          ...
          in let lc_ret_56 = (erlps__type_error__1 [arg_57])
          in (ErlangCons lc_ret_56 ErlangEmptyList)
        _ -> ErlangEmptyList
  in let
    head_62 = (ErlangTuple [(ErlangAtom "indices"), indices_30])
  in
    (ErlangTuple
       [(ErlangAtom "constr_t"), (ErlangCons head_62 ann_1), con_2,
        args_3])
...
erlps__is_word_type__1 [(ErlangTuple [(ErlangAtom "id"), _,
                                      name_0])]
  =
  let    head_3 = (H.make_string "int")
  in let head_5 = (H.make_string "address")
  in let head_7 = (H.make_string "hash")
  in let head_9 = (H.make_string "bits")
  in let head_11 = (H.make_string "bool")
  in
...
erlps__is_word_type__1 [(ErlangTuple [(ErlangAtom "app_t"), _,
  ...
  =
  let    head_3 = (H.make_string "oracle")
  in let head_5 = (H.make_string "oracle_query")
  in
    (BIF.lists__member__2
       [name_0,
...
erlps__is_word_type__1 [(ErlangTuple [(ErlangAtom "bytes_t"), _,
                                      n_0])]
  =
  (BIF.erlang__op_lesserEq [n_0, (ErlangInt (DBI.fromInt 32))])
...
erlps__is_string_type__1 [(ErlangTuple [(ErlangAtom "bytes_t"),
                                        _, n_0])]
  =
  (BIF.erlang__op_greater [n_0, (ErlangInt (DBI.fromInt 32))])
...
erlps__check_constructor_overlap__3 [env_0,
  ...
  let
    case_5 =
      (erlps__lookup_env__4
         [env_0, (ErlangAtom "term"), ann_1, name_2])
  in
    case case_5 of
      (ErlangAtom "false") -> (ErlangAtom "ok")
        ...
        let   
          oldtype_14 =
            case type_11 of
              ...
              _ -> type_11
        in let
          oldcon_18 = (ErlangTuple [(ErlangAtom "con"), ann_1, name_2])
             ...
             let   
               tup_el_16 =
                 (H.flmap
                    (\ lc_20 ->
                       case lc_20 of
                         ct_19@(ErlangTuple [(ErlangTuple [(ErlangAtom "con"),
                                                           _, c_18]),
                                             _]) ->
      ...
      (H.flmap
         (\ lc_28 ->
            let
              lc_ret_29 =
                (BIF.erlang__apply__2
                   [fail_25, (ErlangCons lc_28 ErlangEmptyList)])
...
erlps__check_sccs__4 [env_0@(ErlangTuple [(ErlangAtom "env"), _,
  ...
  in
    case case_5 of
      ...
      def_13 ->
        let match_expr_18 = (erlps__infer_nonrec__2 [env_0, def_13])
        in
...
erlps__check_sccs__4 [env_0@(ErlangTuple [(ErlangAtom "env"), _,
  ...
  let   
    defs_11 =
      (H.flmap
         (\ lc_7 ->
            let lc_ret_8 = (BIF.maps__get__2 [lc_7, funs_1])
            in (ErlangCons lc_ret_8 ErlangEmptyList))
         xs_2)
  in let match_expr_16 = (erlps__infer_letrec__2 [env_0, defs_11])
  in
...
erlps__check_reserved_entrypoints__1 [funs_0] =
  ...
  in let lc_src_4 = (BIF.maps__to_list__1 [funs_0])
  in let
    match_expr_17 =
      (H.flmap
         (\ lc_8 ->
                  ...
                  case cond_9 of
                    (ErlangAtom "true") ->
                      let   
                        arg_13 =
                          (ErlangTuple
                             [(ErlangAtom "reserved_entrypoint"), name_6,
                              def_7])
                      in let lc_ret_12 = (erlps__type_error__1 [arg_13])
                      in (ErlangCons lc_ret_12 ErlangEmptyList)
                    _ -> ErlangEmptyList
              _ -> ErlangEmptyList)
         lc_src_4)
...
erlps__check_fundecl__2 [env_0,
                         (ErlangTuple [(ErlangAtom "fun_decl"), ann_1,
                                       ...
                                       type_4@(ErlangTuple [(ErlangAtom "fun_t"),
                                                            _, _, _, _])])]
  =
  let match_expr_10 = (erlps__check_type__2 [env_0, type_4])
  in
    case match_expr_10 of
      (ErlangTuple [(ErlangAtom "fun_t"), _, named_7, args_8,
        ...
        in let
          tup_el_21 =
            (ErlangTuple
               [(ErlangAtom "fun_decl"), ann_1, id_3, match_expr_10])
...
erlps__infer_nonrec__2 [env_0, letfun_1] =
  ...
  in let match_expr_10 = (erlps__instantiate__1 [newletfun_4])
  in
    case match_expr_10 of
...
erlps__check_special_funs__2 [env_0,
  ...
  case type_5 of
    (ErlangTuple [(ErlangAtom "type_sig"), ann_6, _constr_7,
      ...
      let    tup_el_17 = (H.make_string "state")
      in let
        arg_14 =
          ...
          case case_12 of
            (ErlangAtom "false") ->
              ...
              in
                (ErlangTuple
                   [(ErlangAtom "tuple_t"),
                    (ErlangCons head_20 ErlangEmptyList), ErlangEmptyList])
            (ErlangTuple [s_25, _]) ->
...
erlps__typesig_to_fun_t__1 [(ErlangTuple [(ErlangAtom "type_sig"),
  ...
  =
  (ErlangTuple
     [(ErlangAtom "fun_t"), ann_0, named_2, args_3, res_4])
...
erlps__infer_letrec__2 [env_0, defs_1] =
  ...
  in let
    inferred_55 =
      (H.flmap
         (\ lc_22 ->
            let
              match_expr_28 = (erlps__infer_letfun__2 [extendenv_19, lc_22])
            in
              case match_expr_28 of
                (ErlangTuple [(ErlangTuple [name_26, typesig_27]), _]) ->
                  ...
                  in let
                    arg_38 =
                      (ErlangTuple
                         [(ErlangAtom "check_typesig"), name_26, got_32,
                          expect_34])
                  in let
                    _ = (erlps__unify__4 [env_0, got_32, expect_34, arg_38])
                  ...
                  in let
                    arg_45 =
                      (ErlangFun 0
                         let
                           lambda_46 [] =
                             let    arg_47 = (H.make_string "Checked ~s : ~s\n")
                             in let
                               arg_52 = (erlps__dereference_deep__1 [got_32])
                  ...
                  in let
                    _ =
                      (erlps__when_option__2 [(ErlangAtom "pp_types"), arg_45])
                  in (ErlangCons match_expr_28 ErlangEmptyList)
  ...
  in let
    _ =
      (H.flmap
         (\ lc_71 ->
            let lc_ret_72 = (erlps__print_typesig__1 [lc_71])
            in (ErlangCons lc_ret_72 ErlangEmptyList))
         typesigs_62)
...
erlps__infer_letfun__2 [env_0,
  ...
  in let
    arg_9 =
      (H.flmap
         (\ lc_12 ->
            let lc_ret_13 = (erlps__infer_letfun1__2 [env_0, lc_12])
            in (ErlangCons lc_ret_13 ErlangEmptyList))
         clauses_5)
  in let
    match_expr_18 =
                  ...
                  (H.flmap
                     (\ lc_25 ->
                        ...
                        in let
                          arg_32 =
                            (ErlangTuple
                               [(ErlangAtom "check_typesig"), name_2,
                                clauset_28, type1_8])
                          lc_ret_26 =
                            (erlps__unify__4
                               [env_0, clauset_28, type1_8, arg_32])
              ...
              in let
                tup_el_41 =
                  (erlps__desugar_clauses__4
                     [ann_1, fun_3, sig_20, clauses1_17])
...
erlps__infer_letfun__2 [env_0,
                        letfun_3@(ErlangTuple [(ErlangAtom "letfun"), ann_1,
                                               fun_2, _, _, _])]
  =
  let match_expr_9 = (erlps__infer_letfun1__2 [env_0, letfun_3])
  in
...
erlps__infer_letfun1__2 [env0_0,
  ...
  in let
    arg_25 =
      (ErlangTuple
         [(ErlangAtom "tuple"), (ErlangCons head_28 nameattrib_2),
          args_5])
  in let match_expr_36 = (erlps__infer_pattern__2 [env_23, arg_25])
  in
        ...
        in
          case match_expr_46 of
            (ErlangTuple [(ErlangAtom "typed"), _, _, resulttype_45]) ->
              ...
              in let
                tup_el_62 =
                  (ErlangTuple [(ErlangAtom "id"), nameattrib_2, name_3])
              in let
                tup_el_59 =
                  (ErlangTuple
                     [(ErlangAtom "letfun"), attrib_1, tup_el_62, typedargs_34,
                      resulttype_45, match_expr_46])
  ...
  in
    case needdesugar_11 of
      ...
      (ErlangAtom "true") ->
        ...
        in let
          lc_src_20 =
            (erlps__indexed__2 [(ErlangInt (DBI.fromInt 1)), argtypes_2])
        in let
          args_37 =
            (H.flmap
               (\ lc_25 ->
                  case lc_25 of
                    (ErlangTuple [i_23, type_24]) ->
                      let    lop_33 = (H.make_string "x#")
                      in let rop_34 = (BIF.erlang__integer_to_list__1 [i_23])
                      in let
                        tup_el_32 = (BIF.erlang__op_append [lop_33, rop_34])
                      in let
                        tup_el_29 =
                          (ErlangTuple
                             [(ErlangAtom "id"),
                              (ErlangCons head_15 ErlangEmptyList), tup_el_32])
                      in let
                        lc_ret_26 =
                          (ErlangTuple
                             [(ErlangAtom "typed"),
               ...
               let
                 ...
                 lambda_38 [as_41] =
                   ...
                   in
                     (ErlangTuple
                        [(ErlangAtom "typed"),
                         (ErlangCons head_15 ErlangEmptyList), tup_el_44,
                         tup_el_48])
        ...
        in let
          tup_el_67 =
            (H.flmap
               (\ lc_72 ->
                  case lc_72 of
                    (ErlangTuple [(ErlangAtom "letfun"), annc_69, _, argsc_70,
                                  _, body_71]) ->
                      let   
                        tup_el_76 =
                          (BIF.erlang__apply__2
  ...
  let
    arg_3 =
      (ErlangFun 0
         let
           lambda_4 [] =
             let    arg_5 = (H.make_string "Inferred ~s : ~s\n")
             in let head_9 = (erlps__pp__1 [typesig_1])
             in
               (BIF.do_remote_fun_call "Erlang.Io" "erlps__format__2"
                  [arg_5,
                   (ErlangCons name_0 (ErlangCons head_9 ErlangEmptyList))])
...
erlps__arg_type__2 [argann_0,
  ...
  let
    tup_el_7 =
      (H.flmap
         (\ lc_10 ->
            let lc_ret_11 = (erlps__arg_type__2 [argann_0, lc_10])
            in (ErlangCons lc_ret_11 ErlangEmptyList))
         args_3)
  in
    (ErlangTuple [(ErlangAtom "app_t"), attrs_1, name_2, tup_el_7])
...
erlps__app_t__3 [arg_7, arg_8, arg_9] =
  (EXC.function_clause unit)
...
erlps__lookup_name__4 [env_0, as_1, id_2, options_3] =
  ...
  in
    case case_4 of
      (ErlangAtom "false") ->
        let   
          arg_10 = (ErlangTuple [(ErlangAtom "unbound_variable"), id_2])
...
erlps__check_stateful_named_arg__3 [(ErlangTuple [(ErlangAtom "env"),
  ...
  , ((ErlangInt num_4) == (ErlangInt (DBI.fromInt 117)))
    ...
    top_5 =
      case env_0 of
        (ErlangTuple arr_4) | (DM.Just field_3) <- ((arr_4 DA.!! 5)) ->
          field_3
        _ -> (EXC.badrecord (ErlangAtom "env"))
  in let head_8 = (H.make_string "state")
  in let
    getstate_10 =
      (BIF.erlang__op_append
         [top_5, (ErlangCons head_8 ErlangEmptyList)])
  in let head_13 = (H.make_string "put")
  in let
    setstate_15 =
      (BIF.erlang__op_append
         [top_5, (ErlangCons head_13 ErlangEmptyList)])
  in let head_18 = (H.make_string "init")
  in let
    init_20 =
      (BIF.erlang__op_append
         [top_5, (ErlangCons head_18 ErlangEmptyList)])
  in let
    usednames_32 =
      (ErlangFun 1
         let
                  ...
                  (\ lc_28 ->
                     case lc_28 of
                       (ErlangTuple [(ErlangTuple [(ErlangAtom "term"), xs_26]),
                                     ann_27]) ->
                         let lc_ret_29 = (ErlangTuple [xs_26, ann_27])
                         in (ErlangCons lc_ret_29 ErlangEmptyList)
                       _ -> ErlangEmptyList)
                  lc_src_24)
         ...
         (\ lc_39 ->
            case lc_39 of
              fun_38@(ErlangTuple [(ErlangAtom "letfun"), _,
                ...
                in let lc_ret_40 = (ErlangTuple [tup_el_41, fun_38])
                in (ErlangCons lc_ret_40 ErlangEmptyList)
              _ -> ErlangEmptyList)
         defs_1)
  in let
         ...
         (\ lc_52 ->
            case lc_52 of
              (ErlangTuple [name_50, def_51]) ->
                ...
                in let lc_ret_53 = (ErlangTuple [name_50, tup_el_55])
            ...
            (H.flmap
               (\ lc_68 ->
                  let   
                    arg_70 =
                      (ErlangTuple
                         [(ErlangAtom "init_depends_on_state"),
                          (ErlangAtom "state"), lc_68])
                  in let lc_ret_69 = (erlps__type_error__1 [arg_70])
                  in (ErlangCons lc_ret_69 ErlangEmptyList))
               lc_src_63)
        in let
          lc_src_74 =
               ...
               (\ lc_79 ->
                  let   
                    arg_81 =
                      (ErlangTuple
                         [(ErlangAtom "init_depends_on_state"),
                          (ErlangAtom "put"), lc_79])
                  in let lc_ret_80 = (erlps__type_error__1 [arg_81])
                  in (ErlangCons lc_ret_80 ErlangEmptyList))
               lc_src_74)
        in (ErlangAtom "ok")
...
erlps__get_call_chains__3 [graph_0, start_1, stop_2] =
  ...
  in let
    head_7 =
      (ErlangTuple [start_1, ErlangEmptyList, ErlangEmptyList])
  in let
    arg_5 =
...
erlps__get_call_chains__5 [graph_0, visited_1, queue_2, stop_3,
  ...
  let
    case_5 =
      (BIF.do_remote_fun_call "Queue" "erlps__out__1" [queue_2])
  in
    case case_5 of
      ...
      (ErlangTuple [(ErlangTuple [(ErlangAtom "value"),
        ...
        in
          (erlps__get_call_chains__5
             [graph_0, visited_1, queue1_11, stop_3,
              (ErlangCons head_17 acc_4)])
      (ErlangTuple [(ErlangTuple [(ErlangAtom "value"),
        ...
        in
          case case_28 of
            ...
            (ErlangAtom "false") ->
              ...
              in let arg_55 = (BIF.maps__merge__2 [visited_1, map_ext_59])
              in let
                arg_61 =
...
erlps__check_expr__3 [env_0, expr_1, type_2] =
  let match_expr_8 = (erlps__infer_expr__2 [env_0, expr_1])
  in
    case match_expr_8 of
      (ErlangTuple [(ErlangAtom "typed"), ann_5, expr1_6, type1_7]) ->
        let   
          arg_12 =
            (ErlangTuple
               [(ErlangAtom "check_expr"), expr_1, type1_7, type_2])
...
erlps__infer_expr__2 [_env_0,
  ...
  =
  let    tup_el_9 = (H.make_string "bool")
  in let
    tup_el_6 = (ErlangTuple [(ErlangAtom "id"), as_1, tup_el_9])
  in (ErlangTuple [(ErlangAtom "typed"), as_1, body_2, tup_el_6])
erlps__infer_expr__2 [_env_0,
                      body_2@(ErlangTuple [(ErlangAtom "int"), as_1, _])]
  =
  let    tup_el_9 = (H.make_string "int")
  in let
    tup_el_6 = (ErlangTuple [(ErlangAtom "id"), as_1, tup_el_9])
  in (ErlangTuple [(ErlangAtom "typed"), as_1, body_2, tup_el_6])
erlps__infer_expr__2 [_env_0,
  ...
  =
  let    tup_el_9 = (H.make_string "char")
  in let
    tup_el_6 = (ErlangTuple [(ErlangAtom "id"), as_1, tup_el_9])
  in (ErlangTuple [(ErlangAtom "typed"), as_1, body_2, tup_el_6])
erlps__infer_expr__2 [_env_0,
  ...
  =
  let    tup_el_9 = (H.make_string "string")
  in let
    tup_el_6 = (ErlangTuple [(ErlangAtom "id"), as_1, tup_el_9])
  in (ErlangTuple [(ErlangAtom "typed"), as_1, body_2, tup_el_6])
erlps__infer_expr__2 [_env_0,
...
erlps__infer_expr__2 [_env_0,
  ...
  in let tup_el_16 = (H.make_string "oracle")
  in let
    tup_el_13 = (ErlangTuple [(ErlangAtom "id"), as_1, tup_el_16])
  in let
    tup_el_10 =
      (ErlangTuple
...
erlps__infer_expr__2 [_env_0,
  ...
  let    q_4 = (erlps__fresh_uvar__1 [as_1])
  in let r_6 = (erlps__fresh_uvar__1 [as_1])
  in let tup_el_16 = (H.make_string "oracle_query")
  in let
    tup_el_13 = (ErlangTuple [(ErlangAtom "id"), as_1, tup_el_16])
  in let
    tup_el_10 =
...
erlps__infer_expr__2 [_env_0,
  ...
  in let
    tup_el_9 =
      (ErlangTuple [(ErlangAtom "contract_literal"), body_2])
  in let
    head_6 =
      (ErlangTuple
...
erlps__infer_expr__2 [env_0, id_3@(ErlangTuple [tag_1, as_2, _])]
  ...
  let match_expr_9 = (erlps__lookup_name__3 [env_0, as_2, id_3])
  in
    case match_expr_9 of
...
erlps__infer_expr__2 [env_0,
  ...
  let   
    newcpts_9 =
      (H.flmap
         (\ lc_5 ->
            let lc_ret_6 = (erlps__infer_expr__2 [env_0, lc_5])
            in (ErlangCons lc_ret_6 ErlangEmptyList))
         cpts_2)
  in let
    cpttypes_14 =
  ...
  in let
    tup_el_21 =
      (ErlangTuple [(ErlangAtom "tuple_t"), as_1, cpttypes_14])
  in
    (ErlangTuple [(ErlangAtom "typed"), as_1, tup_el_17, tup_el_21])
erlps__infer_expr__2 [env_0,
  ...
  in let
    newelems_12 =
      (H.flmap
         (\ lc_7 ->
            let lc_ret_8 = (erlps__check_expr__3 [env_0, lc_7, elemtype_4])
            in (ErlangCons lc_ret_8 ErlangEmptyList))
         elems_2)
  in let
    tup_el_15 =
      (ErlangTuple [(ErlangAtom "list"), as_1, newelems_12])
  in let tup_el_25 = (H.make_string "list")
  in let
    tup_el_22 = (ErlangTuple [(ErlangAtom "id"), as_1, tup_el_25])
  in let
    tup_el_19 =
      (ErlangTuple
  ...
  in
    (ErlangTuple [(ErlangAtom "typed"), as_1, tup_el_15, tup_el_19])
erlps__infer_expr__2 [env_0,
  ...
  in
    case typedyield_5 of
      (ErlangTuple [(ErlangAtom "typed"), _, _, type_6]) ->
        ...
        in let tup_el_21 = (H.make_string "list")
        in let
          tup_el_18 = (ErlangTuple [(ErlangAtom "id"), as_1, tup_el_21])
        in let
          tup_el_15 =
            (ErlangTuple
        ...
        in
          (ErlangTuple [(ErlangAtom "typed"), as_1, tup_el_10, tup_el_15])
...
erlps__infer_expr__2 [env_0,
                      (ErlangTuple [(ErlangAtom "list_comp"), as_1, yield_2,
                                    (ErlangCons (ErlangTuple [(ErlangAtom "comprehension_bind"),
                                                              ...
                                                              bexpr_4]) rest_5)])]
  =
  let match_expr_10 = (erlps__infer_expr__2 [env_0, bexpr_4])
  in
    case match_expr_10 of
      (ErlangTuple [(ErlangAtom "typed"), as2_8, _, typebexpr_9]) ->
        let match_expr_17 = (erlps__infer_pattern__2 [env_0, pat_3])
        in
          case match_expr_17 of
            (ErlangTuple [newe_14,
                          typedpat_16@(ErlangTuple [(ErlangAtom "typed"), _, _,
                                                    pattype_15])]) ->
              let    tup_el_26 = (H.make_string "list")
              in let
                tup_el_23 = (ErlangTuple [(ErlangAtom "id"), as_1, tup_el_26])
              in let
                arg_20 =
                  (ErlangTuple
                     [(ErlangAtom "app_t"), as_1, tup_el_23,
                      (ErlangCons pattype_15 ErlangEmptyList)])
              in let tup_el_40 = (H.make_string "list")
              in let
                tup_el_37 = (ErlangTuple [(ErlangAtom "id"), as_1, tup_el_40])
              in let
                tup_el_34 =
                  (ErlangTuple
              ...
              in let
                arg_30 =
                  (ErlangTuple
                     [(ErlangAtom "list_comp"), match_expr_10, typebexpr_9,
                      tup_el_34])
              in let _ = (erlps__unify__4 [env_0, typebexpr_9, arg_20, arg_30])
              in let
                arg_45 =
                  (ErlangTuple
                     [(ErlangAtom "list_comp"), as_1, yield_2, rest_5])
              in let match_expr_53 = (erlps__infer_expr__2 [newe_14, arg_45])
              in
...
erlps__infer_expr__2 [env_0,
                      (ErlangTuple [(ErlangAtom "list_comp"), attrsl_1, yield_2,
                                    (ErlangCons (ErlangTuple [(ErlangAtom "comprehension_if"),
                                                              ...
                                                              cond_4]) rest_5)])]
  =
  let    tup_el_11 = (H.make_string "bool")
  in let
  ...
  in let
    arg_14 =
      (ErlangTuple
         [(ErlangAtom "list_comp"), attrsl_1, yield_2, rest_5])
  in let match_expr_22 = (erlps__infer_expr__2 [env_0, arg_14])
  in
    case match_expr_22 of
      (ErlangTuple [(ErlangAtom "typed"), _,
        ...
        in
          (ErlangTuple
             [(ErlangAtom "typed"), attrsl_1, tup_el_25, restype_21])
      _ -> (EXC.badmatch match_expr_22)
erlps__infer_expr__2 [env_0,
                      (ErlangTuple [(ErlangAtom "list_comp"), aslc_1, yield_2,
                                    (ErlangCons (ErlangTuple [(ErlangAtom "letval"),
                                                              ...
                                                              e_5]) rest_6)])]
  =
  let match_expr_10 = (erlps__infer_expr__2 [env_0, e_5])
  in
    case match_expr_10 of
...
erlps__infer_expr__2 [env_0,
                      (ErlangTuple [(ErlangAtom "list_comp"), aslc_1, yield_2,
                                    (ErlangCons def_4@(ErlangTuple [(ErlangAtom "letfun"),
                                                                    ...
                                                                    _]) rest_5)])]
  =
  let match_expr_11 = (erlps__infer_letfun__2 [env_0, def_4])
  in
    case match_expr_11 of
      (ErlangTuple [(ErlangTuple [name_8, typesig_9]), letfun_10]) ->
        ...
        in let match_expr_30 = (erlps__infer_expr__2 [newe_20, arg_22])
        in
...
erlps__infer_expr__2 [env_0,
  ...
  in let
    match_expr_12 = (erlps__check_expr__3 [env_0, body_2, type1_6])
  in
    case match_expr_12 of
      (ErlangTuple [(ErlangAtom "typed"), _, newbody_10,
                    newtype_11]) ->
        (ErlangTuple
           [(ErlangAtom "typed"), as_1, newbody_10, newtype_11])
      _ -> (EXC.badmatch match_expr_12)
erlps__infer_expr__2 [env_0,
                  ...
                  let
                    lc_ret_30 =
                      (erlps__infer_named_arg__3
                         [env_0, namedargsvar_26, lc_29])
                  in (ErlangCons lc_ret_30 ErlangEmptyList))
               namedargs_8)
        in let match_expr_38 = (erlps__infer_expr__2 [env_0, fun_2])
        in
            ...
            (ErlangTuple [(ErlangAtom "typed"), _, _, funtype_37]) ->
              let   
                newargs_46 =
                  (H.flmap
                     (\ lc_42 ->
                        let lc_ret_43 = (erlps__infer_expr__2 [env_0, lc_42])
              ...
              in let
                tup_el_70 =
                  (ErlangTuple
                     [(ErlangAtom "app"), ann_1, match_expr_38, tup_el_74])
              in let tup_el_77 = (erlps__dereference__1 [resulttype_53])
              in
                (ErlangTuple
                   [(ErlangAtom "typed"), ann_1, tup_el_70, tup_el_77])
            _ -> (EXC.badmatch match_expr_38)
erlps__infer_expr__2 [env_0,
                      (ErlangTuple [(ErlangAtom "if"), attrs_1, cond_2, then_3,
                                    else_4])]
  =
  let    tup_el_10 = (H.make_string "bool")
  in let
    arg_7 = (ErlangTuple [(ErlangAtom "id"), attrs_1, tup_el_10])
  in let newcond_11 = (erlps__check_expr__3 [env_0, cond_2, arg_7])
  in let match_expr_15 = (erlps__infer_expr__2 [env_0, then_3])
  in
    case match_expr_15 of
      (ErlangTuple [(ErlangAtom "typed"), _, _, thentype_14]) ->
        let match_expr_20 = (erlps__infer_expr__2 [env_0, else_4])
        in
          case match_expr_20 of
            (ErlangTuple [(ErlangAtom "typed"), _, _, elsetype_19]) ->
              ...
              in let
                tup_el_33 =
                  (ErlangTuple
                     [(ErlangAtom "if"), attrs_1, newcond_11, match_expr_15,
                      match_expr_20])
              in
                (ErlangTuple
...
erlps__infer_expr__2 [env_0,
                      (ErlangTuple [(ErlangAtom "switch"), attrs_1, expr_2,
                                    cases_3])]
  =
  let match_expr_7 = (erlps__infer_expr__2 [env_0, expr_2])
  in
    case match_expr_7 of
      (ErlangTuple [(ErlangAtom "typed"), _, _, exprtype_6]) ->
        ...
        in let
          tup_el_26 =
            (ErlangTuple
               [(ErlangAtom "switch"), attrs_1, match_expr_7, newcases_23])
        in
          (ErlangTuple
            ...
            case lc_9 of
              (ErlangTuple [(ErlangAtom "field"), a_6, fieldname_7, expr_8]) ->
                ...
                in let
                  lc_ret_10 =
                    (ErlangTuple
                       [(ErlangAtom "field"), a_6, fieldname_7, tup_el_14])
                in (ErlangCons lc_ret_10 ErlangEmptyList)
              _ -> ErlangEmptyList)
         fields_2)
  in let
            ...
            lc_ret_28 =
              (ErlangTuple
                 [(ErlangAtom "record_create_constraint"), recordtype1_20,
                  tup_el_31, attrs_1])
          in (ErlangCons lc_ret_28 ErlangEmptyList)
        _ -> ErlangEmptyList
  in let
    lc_src_38 =
...
erlps__infer_expr__2 [env_0,
                      (ErlangTuple [(ErlangAtom "record"), attrs_1, record_2,
                                    update_3])]
  =
  let match_expr_7 = (erlps__infer_expr__2 [env_0, record_2])
  in
    case match_expr_7 of
          ...
          newupdate_16 =
            (H.flmap
               (\ lc_11 ->
                  let
                    lc_ret_12 =
                      (erlps__check_record_update__3
                         [env_0, recordtype_6, lc_11])
                  in (ErlangCons lc_ret_12 ErlangEmptyList))
               update_3)
        in let
          tup_el_19 =
            (ErlangTuple
               [(ErlangAtom "record"), attrs_1, match_expr_7, newupdate_16])
        in
          (ErlangTuple
  ...
  in
    case match_expr_7 of
      (ErlangTuple [(ErlangAtom "typed"), _, _, recordtype_6]) ->
        ...
        in let
          tup_el_14 =
            (erlps__unfold_types_in_type__2 [env_0, recordtype_6])
        in let
          tup_el_20 =
            (ErlangTuple
               [(ErlangAtom "proj"), attrs_1, record_2, fieldname_3])
        in let
          head_12 =
            (ErlangTuple
        ...
        in let
          tup_el_28 =
            (ErlangTuple
               [(ErlangAtom "proj"), attrs_1, match_expr_7, fieldname_3])
        in
          (ErlangTuple
...
erlps__infer_expr__2 [env_0,
  ...
  in let
    map1_15 = (erlps__check_expr__3 [env_0, map_2, maptype_11])
  ...
  in
    (ErlangTuple
       [(ErlangAtom "typed"), attrs_1, tup_el_22, valtype_7])
erlps__infer_expr__2 [env_0,
                      (ErlangTuple [(ErlangAtom "map_get"), attrs_1, map_2,
                                    key_3, val_4])]
  =
  ...
  in let
    map1_16 = (erlps__check_expr__3 [env_0, map_2, maptype_12])
  ...
  in
    (ErlangTuple
       [(ErlangAtom "typed"), attrs_1, tup_el_27, valtype_8])
erlps__infer_expr__2 [env_0,
      ...
      (H.flmap
         (\ lc_10 ->
            case lc_10 of
              (ErlangTuple [k_8, v_9]) ->
                let   
                  tup_el_12 = (erlps__check_expr__3 [env_0, k_8, keytype_4])
                in let
                  tup_el_16 = (erlps__check_expr__3 [env_0, v_9, valtype_6])
                in let lc_ret_11 = (ErlangTuple [tup_el_12, tup_el_16])
                in (ErlangCons lc_ret_11 ErlangEmptyList)
              _ -> ErlangEmptyList)
         kvs_2)
  in let
  ...
  in
    (ErlangTuple
       [(ErlangAtom "typed"), attrs_1, tup_el_23, tup_el_27])
erlps__infer_expr__2 [env_0,
    ...
    updates1_24 =
      (H.flmap
         (\ lc_18 ->
            let
              lc_ret_19 =
                (erlps__check_map_update__4
                   [env_0, lc_18, keytype_5, valtype_7])
            in (ErlangCons lc_ret_19 ErlangEmptyList))
         updates_3)
  in let
    tup_el_27 =
  ...
  in
    (ErlangTuple
       [(ErlangAtom "typed"), attrs_1, tup_el_27, maptype_11])
erlps__infer_expr__2 [env_0,
  ...
  in let
    tup_el_12 =
      (ErlangTuple [(ErlangAtom "block"), attrs_1, newstmts_9])
  in
    (ErlangTuple
       [(ErlangAtom "typed"), attrs_1, tup_el_12, blocktype_4])
erlps__infer_expr__2 [_env_0,
  ...
  in let
    arg_3 =
      (ErlangTuple [(ErlangAtom "mixed_record_and_map"), tup_el_5])
  in let _ = (erlps__type_error__1 [arg_3])
  ...
  in
    (ErlangTuple [(ErlangAtom "typed"), attrs_1, tup_el_13, type_10])
erlps__infer_expr__2 [env_0,
                      (ErlangTuple [(ErlangAtom "record_or_map_error"), attrs_1,
  ...
  in let
    arg_3 =
      (ErlangTuple
         [(ErlangAtom "empty_record_or_map_update"), tup_el_5])
  in let _ = (erlps__type_error__1 [arg_3])
...
erlps__infer_expr__2 [env_0,
  ...
  in let
    arg_4 =
      (ErlangTuple [(ErlangAtom "mixed_record_and_map"), tup_el_6])
...
erlps__infer_expr__2 [env_0,
         ...
         (\ lc_6 ->
            case lc_6 of
              (ErlangTuple [(ErlangAtom "arg"), as_5, _, _]) ->
                let lc_ret_7 = (erlps__fresh_uvar__1 [as_5])
            ...
            case lc_14 of
              (ErlangTuple [(ErlangAtom "arg"), as_11, pat_12, t_13]) ->
                ...
                in let
                  lc_ret_15 =
                    (ErlangTuple
                       [(ErlangAtom "typed"), as_11, pat_12, tup_el_19])
                in (ErlangCons lc_ret_15 ErlangEmptyList)
              _ -> ErlangEmptyList)
         args_2)
  ...
  in let
    arg_31 =
      (ErlangTuple [(ErlangAtom "tuple_t"), attrs_1, argtypes_9])
  in let
    match_expr_39 =
      (erlps__infer_case__6
    ...
    case match_expr_39 of
      (ErlangTuple [(ErlangAtom "case"), _,
        ...
        in let
          tup_el_53 =
            (ErlangTuple
               [(ErlangAtom "lam"), attrs_1, newargs_50, newbody_38])
        in let
          tup_el_58 =
            (ErlangTuple
        ...
        in
          (ErlangTuple
             [(ErlangAtom "typed"), attrs_1, tup_el_53, tup_el_58])
...
erlps__infer_expr__2 [env_0,
  ...
  let   
    arg_3 =
      (ErlangTuple [(ErlangAtom "missing_body_for_let"), attrs_1])
  in let _ = (erlps__type_error__1 [arg_3])
  in let arg_15 = (H.make_string "missing body")
    ...
    arg_7 =
      (ErlangTuple
         [(ErlangAtom "block"), attrs_1,
          (ErlangCons let_2 (ErlangCons head_13 ErlangEmptyList))])
  in (erlps__infer_expr__2 [env_0, arg_7])
erlps__infer_expr__2 [arg_17, arg_18] =
  (EXC.function_clause unit)
...
erlps__infer_named_arg__3 [env_0, namedargs_1,
                           (ErlangTuple [(ErlangAtom "named_arg"), ann_2, id_3,
                                         e_4])]
  =
  let match_expr_8 = (erlps__infer_expr__2 [env_0, e_4])
  in
    case match_expr_8 of
      (ErlangTuple [(ErlangAtom "typed"), _, _, argtype_7]) ->
        let   
          _ = (erlps__check_stateful_named_arg__3 [env_0, id_3, e_4])
        in let
          arg_13 =
            (ErlangTuple
        ...
        in
          (ErlangTuple
             [(ErlangAtom "named_arg"), ann_2, id_3, match_expr_8])
      _ -> (EXC.badmatch match_expr_8)
...
erlps__check_map_update__4 [env_0,
  ...
  in
    (ErlangTuple
       [(ErlangAtom "field"), ann_1,
        (ErlangCons head_18 ErlangEmptyList), val1_14])
erlps__check_map_update__4 [_env_0,
  ...
  let
    arg_9 =
      (ErlangTuple
         [(ErlangAtom "unnamed_map_update_with_default"), upd_6])
  in (erlps__type_error__1 [arg_9])
erlps__check_map_update__4 [env_0,
                            (ErlangTuple [(ErlangAtom "field"), ann_1,
                                          (ErlangCons (ErlangTuple [(ErlangAtom "map_get"),
  ...
  in let
    head_25 =
      (ErlangTuple [(ErlangAtom "arg"), ann1_2, id_4, valtype_7])
  in let
    arg_21 =
      (ErlangTuple
         [(ErlangAtom "lam"), ann1_2,
          (ErlangCons head_25 ErlangEmptyList), val_5])
  in let
    fun_33 = (erlps__check_expr__3 [env_0, arg_21, funtype_15])
  in let
...
erlps__check_map_update__4 [env_0,
  ...
  in let
    head_30 =
      (ErlangTuple [(ErlangAtom "arg"), ann1_2, id_5, valtype_8])
  in let
    arg_26 =
      (ErlangTuple
         [(ErlangAtom "lam"), ann1_2,
          (ErlangCons head_30 ErlangEmptyList), val_6])
  in let
    fun_38 = (erlps__check_expr__3 [env_0, arg_26, funtype_16])
  in let
    head_42 =
...
erlps__check_map_update__4 [_,
  ...
  let
    arg_2 =
      (ErlangTuple
         [(ErlangAtom "nested_map_updates_not_implemented"), ann_0,
          flds_1])
...
erlps__check_record_update__3 [env_0, recordtype_1, fld_2] =
  let match_expr_9 = (BIF.erlang__tuple_to_list__1 [fld_2])
  in
    case match_expr_9 of
          ...
          fld1_49 =
            case val_8 of
              ...
              (ErlangCons id_21 (ErlangCons expr_22 (ErlangEmptyList))) ->
                ...
                in
                  (ErlangTuple
                     [(ErlangAtom "field_upd"), ann_4, lv_7, tup_el_45])
              something_else -> (EXC.case_clause something_else)
        in let
          tup_el_53 =
            (erlps__unfold_types_in_type__2 [env_0, recordtype_1])
        in let
          head_51 =
            (ErlangTuple
...
erlps__infer_op__5 [env_0, as_1, op_2, args_3, inferop_4] =
  let   
    typedargs_11 =
      (H.flmap
         (\ lc_7 ->
            let lc_ret_8 = (erlps__infer_expr__2 [env_0, lc_7])
            in (ErlangCons lc_ret_8 ErlangEmptyList))
         args_3)
  in let
    argtypes_16 =
  ...
  in let
    match_expr_21 =
      (BIF.erlang__apply__2
         [inferop_4, (ErlangCons op_2 ErlangEmptyList)])
  in
    case match_expr_21 of
      (ErlangTuple [(ErlangAtom "fun_t"), _, _, operandtypes_19,
        ...
        let   
          arg_26 =
            (ErlangTuple
               [(ErlangAtom "infer_app"), op_2, args_3, match_expr_21,
                argtypes_16])
        in let
          _ =
            (erlps__unify__4 [env_0, argtypes_16, operandtypes_19, arg_26])
        in let
          tup_el_34 =
            (ErlangTuple [(ErlangAtom "app"), as_1, op_2, typedargs_11])
        in
          (ErlangTuple
             [(ErlangAtom "typed"), as_1, tup_el_34, resulttype_20])
...
erlps__infer_pattern__2 [env_0, pattern_1] =
         ...
         (\ lc_26 ->
            case lc_26 of
              var_25@(ErlangTuple [(ErlangAtom "id"), ann1_24, _]) ->
                ...
                in let lc_ret_27 = (ErlangTuple [var_25, tup_el_29])
                in (ErlangCons lc_ret_27 ErlangEmptyList)
              _ -> ErlangEmptyList)
         vars_3)
  in let
  ...
  in let
    record_updt_49 =
      case env_0 of
        (ErlangTuple arr_52) | (DM.Just field_51) <-
                                 ((arr_52 DA.!! 6)) ->
          field_51
        _ -> (EXC.badrecord (ErlangAtom "env"))
  in let
...
erlps__infer_case__6 [env_0, attrs_1, pattern_2, exprtype_3,
  ...
  =
  let match_expr_11 = (erlps__infer_pattern__2 [env_0, pattern_2])
  in
    case match_expr_11 of
      (ErlangTuple [newenv_8,
          ...
          arg_12 =
            case newenv_8 of
              (ErlangTuple [(ErlangAtom "env"), scopes_15, vars_16,
                            ...
                            stateful_21, current_function_22, what_23]) ->
                (ErlangTuple
                   [(ErlangAtom "env"), scopes_15, vars_16, typevars_17,
                    fields_18, namespace_19, (ErlangAtom "false"), stateful_21,
                    current_function_22, what_23])
              _ -> (EXC.badrecord (ErlangAtom "env"))
        in let
          newbranch_26 =
        ...
        in let
          _ = (erlps__unify__4 [env_0, pattype_9, exprtype_3, arg_30])
        in
          (ErlangTuple
...
erlps__infer_block__4 [env_0, attrs_1,
                       ...
                       blocktype_5]
  =
  let match_expr_11 = (erlps__infer_letfun__2 [env_0, def_3])
  in
    case match_expr_11 of
      (ErlangTuple [(ErlangTuple [name_8, typesig_9]), letfun_10]) ->
        let    funt_13 = (erlps__typesig_to_fun_t__1 [typesig_9])
...
erlps__infer_block__4 [env_0, _,
                       ...
                       blocktype_5]
  =
  let match_expr_9 = (erlps__infer_expr__2 [env_0, e_3])
  in
    case match_expr_9 of
      (ErlangTuple [(ErlangAtom "typed"), _, _, pattype_8]) ->
        let   
          arg_15 = (ErlangTuple [(ErlangAtom "block"), attrs_1, rest_4])
        in let
          match_expr_22 =
            (erlps__infer_case__6
          ...
          case match_expr_22 of
            (ErlangTuple [(ErlangAtom "case"), _, newpattern_20,
              ...
              let
                head_23 =
                  (ErlangTuple
                     [(ErlangAtom "letval"), attrs_1, newpattern_20,
                      match_expr_9])
...
erlps__infer_infix__1 [(ErlangTuple [boolop_0, as_1])]
  | ((ErlangAtom "true") ==
       (H.falsifyErrors
          (\ _ ->
             let
               lop_15 = (BIF.erlang__op_exactEq [boolop_0, (ErlangAtom "&&")])
             in
               case lop_15 of
                 (ErlangAtom "true") -> (ErlangAtom "true")
                 (ErlangAtom "false") ->
  ...
  let    tup_el_4 = (H.make_string "bool")
          ...
          (\ _ ->
             ...
             in
               case lop_15 of
                 ...
                 _ -> (EXC.badarg1 lop_15)))) =
  let    tup_el_4 = (H.make_string "int")
...
erlps__infer_infix__1 [(ErlangTuple [relop_0, as_1])]
  ...
  in let tup_el_6 = (H.make_string "bool")
...
erlps__infer_infix__1 [(ErlangTuple [(ErlangAtom ".."), as_0])] =
  let    tup_el_3 = (H.make_string "int")
  in let int_4 = (ErlangTuple [(ErlangAtom "id"), as_0, tup_el_3])
  in let tup_el_19 = (H.make_string "list")
  in let
    tup_el_16 = (ErlangTuple [(ErlangAtom "id"), as_0, tup_el_19])
  in let
    tup_el_13 =
      (ErlangTuple
  ...
  in
    (ErlangTuple
       [(ErlangAtom "fun_t"), as_0, ErlangEmptyList,
        (ErlangCons int_4 (ErlangCons int_4 ErlangEmptyList)),
        tup_el_13])
erlps__infer_infix__1 [(ErlangTuple [(ErlangAtom "::"), as_0])] =
  let    elemtype_2 = (erlps__fresh_uvar__1 [as_0])
  in let tup_el_8 = (H.make_string "list")
  in let
    tup_el_5 = (ErlangTuple [(ErlangAtom "id"), as_0, tup_el_8])
  in let
    listtype_12 =
...
erlps__infer_infix__1 [(ErlangTuple [(ErlangAtom "++"), as_0])] =
  ...
  in
    (ErlangTuple
       [(ErlangAtom "fun_t"), as_0, ErlangEmptyList,
        (ErlangCons listtype_12
           (ErlangCons listtype_12 ErlangEmptyList)),
        listtype_12])
...
erlps__infer_prefix__1 [(ErlangTuple [(ErlangAtom "!"), as_0])] =
  let    tup_el_3 = (H.make_string "bool")
...
erlps__abort_expr__2 [ann_0, str_1] =
  let    tup_el_7 = (H.make_string "abort")
  in let
    tup_el_4 = (ErlangTuple [(ErlangAtom "id"), ann_0, tup_el_7])
  in let
    head_9 = (ErlangTuple [(ErlangAtom "string"), ann_0, str_1])
  in
    (ErlangTuple
       [(ErlangAtom "app"), ann_0, tup_el_4,
        (ErlangCons head_9 ErlangEmptyList)])
erlps__abort_expr__2 [arg_14, arg_15] =
  (EXC.function_clause unit)
...
erlps__free_vars__1 [l_0] | (H.isEList l_0) =
  (H.flmap
     (\ lc_3 ->
        let lc_src_4 = (erlps__free_vars__1 [lc_3])
        in
          (H.flmap (\ lc_7 -> (ErlangCons lc_7 ErlangEmptyList)) lc_src_4))
     l_0)
...
erlps__clean_up_ets__0 [] =
  let    lc_src_0 = (erlps__ets_tables__0 [])
  in let
    _ =
      (H.flmap
         (\ lc_2 ->
...
erlps__ets_init__0 [] =
  ...
  in
    (BIF.erlang__put__2 [(ErlangAtom "aeso_ast_infer_types"), arg_1])
...
erlps__ets_new__2 [name_0, opts_1] =
  let   
    arg_3 =
      (BIF.erlang__op_unAppend
         [opts_1,
          (ErlangCons (ErlangAtom "named_table") ErlangEmptyList)])
  in let
    tabid_8 =
  ...
  in let
    tabs_10 =
      (BIF.erlang__get__1 [(ErlangAtom "aeso_ast_infer_types")])
  in let map_ext_16 = (ErlangMap (Map.singleton name_0 tabid_8))
  in let arg_12 = (BIF.maps__merge__2 [tabs_10, map_ext_16])
  in let
    _ =
      (BIF.erlang__put__2
         [(ErlangAtom "aeso_ast_infer_types"), arg_12])
  in name_0
  ...
  in
    case tabs_2 of
      (ErlangMap map_3) | (DM.Just tabid_4) <-
        ...
        in let
          _ =
            (BIF.erlang__put__2 [(ErlangAtom "aeso_ast_infer_types"), arg_7])
...
erlps__create_options__1 [options_0] =
  ...
  in let
    tup_11 =
      (ErlangFun 1
         let
           lambda_5 [opt_7] | (H.isEAtom opt_7) =
             (ErlangTuple [opt_7, (ErlangAtom "true")])
           lambda_5 [opt_10] | (H.isETuple opt_10) = opt_10
           lambda_5 [arg_6] = (EXC.function_clause unit)
           lambda_5 args = (EXC.badarity (ErlangFun 1 lambda_5) args)
         in lambda_5)
  in let
...
erlps__get_option__2 [key_0, default_1] =
  let
    case_2 = (erlps__ets_lookup__2 [(ErlangAtom "options"), key_0])
  in
    case case_2 of
...
erlps__solve_named_argument_constraints__2 [env_0,
                                            constraints0_1]
  =
  let lc_src_2 = (erlps__dereference_deep__1 [constraints0_1])
  in
    (H.flmap
       (\ lc_5 ->
          let   
          ...
          in let
            cond_6 = (BIF.erlang__op_eq [(ErlangAtom "unsolved"), rop_8])
          in
            case cond_6 of
    ...
    _ =
      (H.flmap
         (\ lc_6 ->
            ...
            in let lc_ret_7 = (erlps__type_error__1 [arg_8])
            in (ErlangCons lc_ret_7 ErlangEmptyList))
         unsolved_3)
...
erlps__get_bytes_constraints__0 [] =
  (erlps__ets_tab2list__1 [(ErlangAtom "bytes_constraints")])
...
erlps__add_bytes_constraint__1 [arg_3] =
  (EXC.function_clause unit)
...
erlps__solve_bytes_constraints__1 [env_0] =
  let    lc_src_1 = (erlps__get_bytes_constraints__0 [])
  in let
    _ =
      (H.flmap
         (\ lc_3 ->
            let lc_ret_4 = (erlps__solve_bytes_constraint__2 [env_0, lc_3])
            in (ErlangCons lc_ret_4 ErlangEmptyList))
         lc_src_1)
  in (ErlangAtom "ok")
                ...
                (H.flmap
                   (\ lc_15 ->
                      ...
                      in
                        case cond_16 of
                          (ErlangAtom "true") ->
                            (ErlangCons lc_15 ErlangEmptyList)
                          _ -> ErlangEmptyList)
                   (ErlangCons a_3
      ...
      (H.flmap
         (\ lc_31 ->
            let   
              op_arg_33 =
                (BIF.erlang__apply__2
                   [skip_28, (ErlangCons lc_31 ErlangEmptyList)])
            ...
            in
              case cond_32 of
                (ErlangAtom "true") ->
                  let
                    lc_ret_36 =
                      (erlps__check_bytes_constraint__2 [env_0, lc_31])
  ...
  in
    case type1_5 of
      ...
      _ ->
        let
          arg_7 =
            (ErlangTuple [(ErlangAtom "unknown_byte_length"), type_1])
        in (erlps__type_error__1 [arg_7])
erlps__check_bytes_constraint__2 [env_0,
                                  (ErlangTuple [(ErlangAtom "add_bytes"), ann_1,
    ...
    case case_18 of
      ...
      _ ->
        let
          arg_25 =
            (ErlangTuple
               [(ErlangAtom "unsolved_bytes_constraint"), ann_1, fun_2, a_9,
                b_13, c_17])
...
erlps__get_field_constraints__0 [] =
  (erlps__ets_tab2list__1 [(ErlangAtom "field_constraints")])
                      ...
                      case case_31 of
                        ...
                        missing_34 ->
                          let
                            arg_35 =
                              (ErlangTuple
                                 [(ErlangAtom "missing_fields"), when_5,
                                  type1_10, missing_34])
                          in (erlps__type_error__1 [arg_35])
                  _ -> (ErlangAtom "ok"))
             (\ ex_15 ->
          ...
          case case_10 of
            ...
            _ ->
              let
                arg_15 =
                  (ErlangTuple
                     [(ErlangAtom "not_a_contract_type"), type1_9, cxt_4])
  ...
  in
    case (ErlangAtom "true") of
      ...
      _ ->
        let
          case_11 =
            (erlps__solve_unknown_record_types__2 [env_0, unknown_4])
        in
          case case_11 of
            (ErlangAtom "true") ->
              (erlps__solve_ambiguous_field_constraints__2 [env_0, unknown_4])
            ...
            let   
              arg_14 =
                (H.flmap
                   ...
                   unknown_1)
            in let
              lc_ret_11 = (erlps__solve_for_uvar__3 [env_0, lc_10, arg_14])
            in (ErlangCons lc_ret_11 ErlangEmptyList))
         uvars_7)
  in let
    case_29 =
      (BIF.lists__member__2 [(ErlangAtom "true"), solutions_28])
  in
    case case_29 of
      (ErlangAtom "true") -> (ErlangAtom "true")
              ...
              c_4@(ErlangTuple [(ErlangAtom "field_constraint"), recordtype_3,
                ...
                in let
                  lc_ret_6 =
                    case c_4 of
                      (ErlangTuple [(ErlangAtom "field_constraint"),
                                    record_t_10, field_11, field_t_12, kind_13,
                                    context_14]) ->
                        (ErlangTuple
      ...
      (H.flmap
         (\ lc_18 ->
            ...
            in let
              cond_19 =
                case case_20 of
                  (ErlangTuple [(ErlangAtom "uvar"), _, _]) ->
                    (ErlangAtom "false")
                  _ -> (ErlangAtom "true")
            in
              case cond_19 of
                (ErlangAtom "true") ->
                  case lc_18 of
                    (ErlangTuple [(ErlangAtom "field_constraint"), rectype_25,
                      ...
                      let   
                        recid_31 = (erlps__record_type_name__1 [rectype_25])
                      in let
                        attrs_33 =
                              ...
                              let
                                fieldtypes_53 =
                                  (H.flmap
                                     (\ lc_49 ->
                                        case lc_49 of
                                          (ErlangTuple [(ErlangAtom "field_t"),
                                                        _,
                                                        (ErlangTuple [(ErlangAtom "id"),
                                                                      _,
                                                                      name_47]),
                      ...
                      in
                        case case_18 of
                          ...
                          errors_21 ->
                            (H.flmap
                               (\ lc_24 ->
                                  let lc_ret_25 = (erlps__type_error__1 [lc_24])
                                  in (ErlangCons lc_ret_25 ErlangEmptyList))
                               errors_21)
              in let
                _ =
  ...
  | ((ErlangAtom "true") ==
       (H.falsifyErrors
          (\ _ ->
             let   
               lop_4 =
                 (BIF.erlang__element__2 [(ErlangInt (DBI.fromInt 1)), recid_1])
             in let
               lop_3 = (BIF.erlang__op_exactEq [lop_4, (ErlangAtom "id")])
             in
               case lop_3 of
                 (ErlangAtom "true") -> (ErlangAtom "true")
                 (ErlangAtom "false") ->
                   let   
                     lop_9 =
                       (BIF.erlang__element__2
                          [(ErlangInt (DBI.fromInt 1)), recid_1])
                   in let
                     lop_8 =
                       (BIF.erlang__op_exactEq [lop_9, (ErlangAtom "qid")])
                   in
                     case lop_8 of
                       (ErlangAtom "true") -> (ErlangAtom "true")
                       (ErlangAtom "false") ->
  ...
  | ((ErlangAtom "true") ==
       (H.falsifyErrors
          (\ _ ->
             let   
               lop_2 =
                 (BIF.erlang__element__2 [(ErlangInt (DBI.fromInt 1)), recid_0])
             in let
               lop_1 = (BIF.erlang__op_exactEq [lop_2, (ErlangAtom "id")])
             in
               case lop_1 of
                 (ErlangAtom "true") -> (ErlangAtom "true")
                 (ErlangAtom "false") ->
                   let   
                     lop_7 =
                       (BIF.erlang__element__2
                          [(ErlangInt (DBI.fromInt 1)), recid_0])
                   in let
                     lop_6 =
                       (BIF.erlang__op_exactEq [lop_7, (ErlangAtom "qid")])
                   in
                     case lop_6 of
                       (ErlangAtom "true") -> (ErlangAtom "true")
                       (ErlangAtom "false") ->
...
erlps__record_type_name__1 [_other_0] =
  let   
    head_3 =
      (ErlangTuple [(ErlangAtom "origin"), (ErlangAtom "system")])
  in let tup_el_7 = (H.make_string "not_a_record_type")
  in
    (ErlangTuple
       [(ErlangAtom "id"), (ErlangCons head_3 ErlangEmptyList),
        tup_el_7])
         ...
         (\ lc_7 ->
            case lc_7 of
              (ErlangTuple [kind_5, _, fld_6]) ->
                let lc_ret_8 = (ErlangTuple [kind_5, fld_6])
                in (ErlangCons lc_ret_8 ErlangEmptyList)
              _ -> ErlangEmptyList)
         fields0_3)
  in
    case fields0_3 of
      (ErlangCons (ErlangTuple [_, when_12, _]) _) ->
        ...
        in let
          lc_src_28 = (erlps__lookup_record_field__2 [env_0, arg_30])
        in let
          candidates_35 =
            (H.flmap
               (\ lc_33 ->
                  ...
                  in let
                    lc_ret_39 =
                      case case_40 of
                        ...
                        (ErlangAtom "false") ->
                          let   
                            tup_el_60 = (erlps__record_type_name__1 [lc_38])
                          in let
                            arg_58 =
                              (ErlangTuple
                      ...
                      in
                        case cond_70 of
                          (ErlangAtom "true") ->
                            ...
                            in let
                              lc_ret_75 = (ErlangTuple [rectype_67, tup_el_77])
                            in (ErlangCons lc_ret_75 ErlangEmptyList)
                          _ -> ErlangEmptyList
                    _ -> ErlangEmptyList)
               typesandfields_64)
        in let
        ...
        in let
          solutions_85 =
            (H.flmap
               ...
               partialsolutions_80)
        in let
          case_86 = (ErlangTuple [solutions_85, partialsolutions_80])
        in
          case case_86 of
            (ErlangTuple [(ErlangEmptyList), (ErlangEmptyList)]) ->
              (ErlangTuple
                 [(ErlangAtom "no_records_with_all_fields"), fields_11])
            ...
            (ErlangTuple [(ErlangCons rectype_98 (ErlangEmptyList)), _]) ->
              ...
              in let
                match_expr_105 = (erlps__lookup_type__2 [env_0, recname_100])
              in
                case match_expr_105 of
                  (ErlangTuple [_,
                                (ErlangTuple [_,
                    ...
                    in (ErlangAtom "true")
                  _ -> (EXC.badmatch match_expr_105)
            (ErlangTuple [stillpossible_118, _]) ->
              (ErlangTuple
                 [(ErlangAtom "ambiguous_record"), fields_11,
                  stillpossible_118])
            something_else -> (EXC.case_clause something_else)
...
erlps__unfold_types__3 [env_0,
  ...
  =
  let   
    tup_el_7 = (erlps__unfold_types__3 [env_0, e_2, options_4])
  in let
    tup_el_11 =
      (erlps__unfold_types_in_type__3 [env_0, type_3, options_4])
  in
    (ErlangTuple [(ErlangAtom "typed"), attr_1, tup_el_7, tup_el_11])
erlps__unfold_types__3 [env_0,
...
erlps__unfold_types__3 [env_0,
  ...
  =
  let
    tup_el_8 = (erlps__unfold_types__3 [env_0, type_3, options_4])
  in
    (ErlangTuple [(ErlangAtom "fun_decl"), ann_1, name_2, tup_el_8])
erlps__unfold_types__3 [env_0,
  ...
  in
    (ErlangTuple
       [(ErlangAtom "letfun"), ann_1, name_2, tup_el_10, tup_el_14,
        tup_el_18])
erlps__unfold_types__3 [env_0, t_1, options_2]
  | (H.isETuple t_1) =
          ...
          _ =
            case cond_15 of
              (ErlangAtom "true") ->
                let   
                  arg_18 =
                    (ErlangTuple [(ErlangAtom "map_in_map_key"), keytype0_6])
                in let lc_ret_17 = (erlps__type_error__1 [arg_18])
                in (ErlangCons lc_ret_17 ErlangEmptyList)
              _ -> ErlangEmptyList
        in
          (ErlangTuple [(ErlangAtom "app_t"), ann_1, id_5, match_expr_13])
...
erlps__unfold_types_in_type__3 [env_0,
  ...
  | ((ErlangAtom "true") ==
       (H.falsifyErrors
          (\ _ ->
             let   
               lop_69 =
                 (BIF.erlang__element__2 [(ErlangInt (DBI.fromInt 1)), id_2])
             in let
               lop_68 = (BIF.erlang__op_exactEq [lop_69, (ErlangAtom "id")])
             in
               case lop_68 of
                 (ErlangAtom "true") -> (ErlangAtom "true")
                 (ErlangAtom "false") ->
                   let   
                     lop_74 =
                       (BIF.erlang__element__2
                          [(ErlangInt (DBI.fromInt 1)), id_2])
                   in let
                     lop_73 =
                       (BIF.erlang__op_exactEq [lop_74, (ErlangAtom "qid")])
                   in
                     case lop_73 of
                       (ErlangAtom "true") -> (ErlangAtom "true")
                       (ErlangAtom "false") ->
  ...
  let   
    unfoldrecords_8 =
      (BIF.do_remote_fun_call "Proplists" "erlps__get_value__3"
         [(ErlangAtom "unfold_record_types"), options_4,
          (ErlangAtom "false")])
  in let
    unfoldvariants_12 =
      (BIF.do_remote_fun_call "Proplists" "erlps__get_value__3"
...
erlps__unfold_types_in_type__3 [env_0, id_1, options_2]
  | ((ErlangAtom "true") ==
       (H.falsifyErrors
          (\ _ ->
             let   
               lop_31 =
                 (BIF.erlang__element__2 [(ErlangInt (DBI.fromInt 1)), id_1])
             in let
               lop_30 = (BIF.erlang__op_exactEq [lop_31, (ErlangAtom "id")])
             in
               case lop_30 of
                 (ErlangAtom "true") -> (ErlangAtom "true")
                 (ErlangAtom "false") ->
                   let   
                     lop_36 =
                       (BIF.erlang__element__2
                          [(ErlangInt (DBI.fromInt 1)), id_1])
                   in let
                     lop_35 =
                       (BIF.erlang__op_exactEq [lop_36, (ErlangAtom "qid")])
                   in
                     case lop_35 of
                       (ErlangAtom "true") -> (ErlangAtom "true")
                       (ErlangAtom "false") ->
  ...
  let   
    unfoldrecords_6 =
      (BIF.do_remote_fun_call "Proplists" "erlps__get_value__3"
         [(ErlangAtom "unfold_record_types"), options_2,
          (ErlangAtom "false")])
  in let
    unfoldvariants_10 =
      (BIF.do_remote_fun_call "Proplists" "erlps__get_value__3"
...
erlps__unfold_types_in_type__3 [env_0,
  ...
  let
    tup_el_8 =
      (erlps__unfold_types_in_type__3 [env_0, type_3, options_4])
  in
    (ErlangTuple [(ErlangAtom "field_t"), attr_1, name_2, tup_el_8])
erlps__unfold_types_in_type__3 [env_0,
  ...
  in
    (ErlangTuple [(ErlangAtom "constr_t"), ann_1, con_2, tup_el_8])
erlps__unfold_types_in_type__3 [env_0,
                                (ErlangTuple [(ErlangAtom "named_arg_t"), ann_1,
...
erlps__unfold_types_in_type__3 [env_0, t_1, options_2]
  ...
  in let
    arg_3 =
      (erlps__unfold_types_in_type__3 [env_0, arg_5, options_2])
  in (BIF.erlang__list_to_tuple__1 [arg_3])
         ...
         (\ lc_6 ->
            case lc_6 of
              (ErlangTuple [(ErlangTuple [(ErlangAtom "tvar"), _, v_4]),
                            t_5]) ->
                let lc_ret_7 = (ErlangTuple [v_4, t_5])
                in (ErlangCons lc_ret_7 ErlangEmptyList)
              _ -> ErlangEmptyList)
         env_0)
  in (erlps__subst_tvars1__2 [arg_2, type_1])
erlps__subst_tvars__2 [arg_11, arg_12] =
  (EXC.function_clause unit)
...
erlps__subst_tvars1__2 [env_0, type_1] | (H.isETuple type_1) =
...
erlps__subst_tvars1__2 [arg_2, arg_3] =
  (EXC.function_clause unit)
  ...
  in
    case case_5 of
      ...
      (ErlangAtom "false") ->
        ...
        in let
          _ = (erlps__ets_insert__2 [(ErlangAtom "type_vars"), arg_15])
        in (ErlangAtom "true")
      something_else -> (EXC.case_clause something_else)
...
erlps__unify1__4 [env_0, (ErlangCons a_1 b_2),
  ...
  in
    case lop_6 of
      (ErlangAtom "false") -> (ErlangAtom "false")
      (ErlangAtom "true") ->
        (erlps__unify__4 [env_0, b_2, d_4, when_5])
      _ -> (EXC.badarg1 lop_6)
...
erlps__dereference__1 [t_1@(ErlangTuple [(ErlangAtom "uvar"), _,
  ...
  =
  let
    case_2 = (erlps__ets_lookup__2 [(ErlangAtom "type_vars"), r_0])
  in
    case case_2 of
      (ErlangEmptyList) -> t_1
...
erlps__occurs_check__2 [arg_5, arg_6] =
  (EXC.function_clause unit)
...
erlps__occurs_check1__2 [_, (ErlangEmptyList)] =
  (ErlangAtom "false")
erlps__occurs_check1__2 [arg_0, arg_1] =
  (EXC.function_clause unit)
...
erlps__freshen_type__2 [ann_0, type_1] =
  ...
  in let _ = (erlps__destroy_freshen_tvars__0 [])
  in type1_4
erlps__freshen_type__2 [arg_5, arg_6] =
  (EXC.function_clause unit)
...
erlps__freshen__2 [ann_0,
  ...
  in x_2
erlps__freshen__2 [ann_0, t_1] | (H.isETuple t_1) =
...
erlps__freshen_type_sig__2 [ann_0,
  ...
  in let
    _ =
      (erlps__apply_typesig_constraint__3 [ann_0, constr_1, funt_6])
  in funt_6
...
erlps__apply_typesig_constraint__3 [ann_0,
  ...
  let   
    tup_el_6 =
      (ErlangTuple [(ErlangAtom "address_to_contract"), ann_0])
  in let
    head_3 =
      (ErlangTuple
...
erlps__apply_typesig_constraint__3 [ann_0,
  ...
  let
    arg_4 =
      (ErlangTuple
         [(ErlangAtom "add_bytes"), ann_0, (ErlangAtom "concat"), a_1,
          b_2, c_3])
...
erlps__instantiate1__1 [(ErlangTuple [(ErlangAtom "uvar"),
  ...
  let   
    arg_3 =
      (erlps__ets_lookup__2
         [(ErlangAtom "type_vars"), (ErlangAtom "next")])
  in let
    next_7 =
      (BIF.do_remote_fun_call "Proplists" "erlps__get_value__3"
         [(ErlangAtom "next"), arg_3, (ErlangInt (DBI.fromInt 0))])
  in let lop_11 = (H.make_string "\'")
  ...
  in let
    tup_el_19 =
      (BIF.erlang__op_plus [next_7, (ErlangInt (DBI.fromInt 1))])
...
erlps__instantiate1__1 [t_0] | (H.isETuple t_0) =
...
erlps__integer_to_tvar__1 [x_0]
  | (weakLt x_0 (ErlangInt (DBI.fromInt 26))) =
  let
    head_1 =
      (BIF.erlang__op_plus [(ErlangInt (DBI.fromInt 97)), x_0])
  in (ErlangCons head_1 ErlangEmptyList)
erlps__integer_to_tvar__1 [x_0] =
  let   
    arg_3 =
      (BIF.erlang__op_div_strict [x_0, (ErlangInt (DBI.fromInt 26))])
  in let head_2 = (erlps__integer_to_tvar__1 [arg_3])
  in let
    rop_10 =
      (BIF.erlang__op_rem_strict [x_0, (ErlangInt (DBI.fromInt 26))])
  in let
    head_8 =
      (BIF.erlang__op_plus [(ErlangInt (DBI.fromInt 97)), rop_10])
  in
    (BIF.erlang__op_append
...
erlps__cannot_unify__3 [a_0, b_1, when_2] =
  let
    arg_3 =
      (ErlangTuple [(ErlangAtom "cannot_unify"), a_0, b_1, when_2])
...
erlps__destroy_and_report_type_errors__1 [env_0] =
  let   
    arg_1 = (erlps__ets_tab2list__1 [(ErlangAtom "type_errors")])
  in let
    errors0_3 =
    ...
    errors_12 =
      (H.flmap
         (\ lc_7 ->
            ...
            in let lc_ret_8 = (erlps__mk_error__1 [arg_9])
            in (ErlangCons lc_ret_8 ErlangEmptyList))
         errors0_3)
  in
...
erlps__unqualify__2 [env_0, t_1] | (H.isETuple t_1) =
  let    arg_4 = (BIF.erlang__tuple_to_list__1 [t_1])
  ...
  (EXC.tryOfCatch
     ...
     (\ ex_6 ->
        case ex_6 of
          ...
          ex_7 -> (EXC.raise ex_7)))
erlps__unqualify1__2 [arg_10, arg_11] =
  (EXC.function_clause unit)
  ...
  let   
    pos_4 =
      (BIF.do_remote_fun_call "Aeso.Errors" "erlps__pos__3"
         [file_0, (ErlangInt (DBI.fromInt 0)),
          (ErlangInt (DBI.fromInt 0))])
  in let arg_6 = (H.make_string "Empty contract\n")
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "wrong_type_arguments"),
  ...
  let   
    arg_3 =
      (H.make_string
         "Arity for ~s doesn\'t match. Expected ~p, got ~p\n")
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "unnamed_map_update_with_default"),
  ...
  =
  let   
    msg_1 = (H.make_string "Invalid map update with default\n")
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "cannot_unify"),
  ...
  =
  let   
    arg_3 = (H.make_string "Cannot unify ~s\n         and ~s\n")
  ...
  in let match_expr_17 = (erlps__pp_when__1 [when_2])
  in
    case match_expr_17 of
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "unbound_variable"),
                                  id_0])]
  =
  let    arg_1 = (H.make_string "Unbound variable ~s at ~s\n")
  ...
  in
    case id_0 of
      (ErlangTuple [(ErlangAtom "qid"), _,
        ...
        let   
          cxt_21 =
            (H.make_string "Did you forget to define the event type?")
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "undefined_field"),
                                  id_0])]
  =
  let    arg_1 = (H.make_string "Unbound field ~s at ~s\n")
  in let head_3 = (erlps__pp__1 [id_0])
  in let head_6 = (erlps__pp_loc__1 [id_0])
  in let
    msg_9 =
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "not_a_record_type"),
  ...
  in let arg_5 = (H.make_string "Not a record type: ")
  in let head_4 = (erlps__pp_type__2 [arg_5, type_0])
  in let
    msg_8 =
      (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
         [arg_2, (ErlangCons head_4 ErlangEmptyList)])
  in let match_expr_12 = (erlps__pp_why_record__1 [why_1])
  in
    case match_expr_12 of
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "not_a_contract_type"),
  ...
  let   
    msg_9 =
      case type_0 of
        (ErlangTuple [(ErlangAtom "tvar"), _, _]) ->
          (H.make_string "Unresolved contract type\n")
        _ ->
          let   
            arg_3 = (H.make_string "The type ~s is not a contract type\n")
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "non_linear_pattern"),
  ...
  let   
    arg_2 =
      (H.make_string "Repeated name~s ~s in pattern\n~s (at ~s)\n")
  in let arg_5 = (H.make_string "")
  in let arg_6 = (H.make_string "s")
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "ambiguous_record"),
    ...
    arg_11 =
      (H.flmap
         (\ lc_14 ->
            case lc_14 of
              (ErlangTuple [_, f_13]) ->
                let lc_ret_15 = (erlps__pp__1 [f_13])
                in (ErlangCons lc_ret_15 ErlangEmptyList)
              _ -> ErlangEmptyList)
         fields_1)
  ...
  in let
    head_22 =
      (H.flmap
         (\ lc_25 ->
            let    head_27 = (H.make_string "  - ")
            in let head_29 = (erlps__pp__1 [lc_25])
            in let head_32 = (H.make_string " (at ")
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "missing_field"),
  ...
  let   
    arg_2 =
      (H.make_string "Record type ~s does not have field ~s (at ~s)\n")
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "missing_fields"),
  ...
  in let
    head_10 =
      (BIF.do_remote_fun_call "String" "erlps__join__2"
         [fields_2, arg_12])
  in let arg_15 = (H.make_string "is")
  in let arg_16 = (H.make_string "are")
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "no_records_with_all_fields"),
  ...
  let   
    arg_2 =
      (H.make_string "No record type with field~s ~s (at ~s)\n")
  in let arg_5 = (H.make_string "")
  in let arg_6 = (H.make_string "s")
    ...
    arg_10 =
      (H.flmap
         (\ lc_13 ->
            case lc_13 of
              (ErlangTuple [_, f_12]) ->
                let lc_ret_14 = (erlps__pp__1 [f_12])
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "recursive_types_not_implemented"),
                                  types_0])]
  =
  let    arg_1 = (H.make_string " is")
  in let arg_2 = (H.make_string "s are mutually")
  ...
  in let
    head_9 =
      (H.flmap
         (\ lc_12 ->
            let    arg_14 = (H.make_string "  - ~s (at ~s)\n")
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "event_must_be_variant_type"),
  ...
  let   
    arg_1 =
      (H.make_string "The event type must be a variant type (at ~s)\n")
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "indexed_type_must_be_word"),
  ...
  let   
    arg_2 =
      (H.make_string
         "The indexed type ~s (at ~s) is not a word type\n")
  in let arg_5 = (H.make_string "")
  in let head_4 = (erlps__pp_type__2 [arg_5, type_0])
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "repeated_constructor"),
  ...
  let   
    arg_1 =
      (H.make_string
         "Variant types must have distinct constructor names\n~s")
  in let
    head_3 =
      (H.flmap
         (\ lc_7 ->
            case lc_7 of
              (ErlangTuple [c_5, t_6]) ->
                let    arg_9 = (H.make_string "~s  (at ~s)\n")
                in let arg_12 = (H.make_string "  - ")
  ...
  in let
    arg_22 =
      (BIF.erlang__element__2 [(ErlangInt (DBI.fromInt 1)), arg_24])
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "duplicate_definition"),
  ...
  =
  let   
    arg_2 = (H.make_string "Duplicate definitions of ~s at\n~s")
  in let
    head_6 =
      (H.flmap
         (\ lc_9 ->
            let    head_11 = (H.make_string "  - ")
  ...
  in let
    arg_21 =
      (BIF.do_remote_fun_call "Lists" "erlps__last__1" [locs_1])
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "duplicate_scope"),
  ...
  let   
    arg_4 =
      (H.make_string
         "The ~p ~s (at ~s) has the same name as a ~p at ~s\n")
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "init_depends_on_state"),
      ...
      (ErlangFun 1
         let
           lambda_3 [(ErlangCons (ErlangInt num_5) (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangEmptyList))))]
             | ((ErlangInt num_5) == (ErlangInt (DBI.fromInt 112)))
           ...
           lambda_3 [(ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangCons (ErlangInt num_11) (ErlangCons (ErlangInt num_12) (ErlangEmptyList))))))]
             | ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 115)))
             , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 116)))
             , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 97)))
             , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 116)))
             , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 101))) =
             (H.make_string "")
           lambda_3 [_] = (H.make_string ", which calls")
           lambda_3 [arg_4] = (EXC.function_clause unit)
           lambda_3 args = (EXC.badarity (ErlangFun 1 lambda_3) args)
         in lambda_3)
  in let
  ...
  in let
    head_16 =
      case (ErlangAtom "true") of
        _ | (weakEq which_0 (ErlangAtom "put")) ->
          (H.make_string "write")
        _ -> (H.make_string "read")
  in let
    head_18 =
      (H.flmap
         (\ lc_22 ->
            case lc_22 of
              (ErlangTuple [(ErlangCons _ (ErlangCons fun_20 (ErlangEmptyList))),
                            ann_21]) ->
                let    arg_24 = (H.make_string "  - ~s (at ~s)~s\n")
  ...
  in let
    msg_36 =
      (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
         [arg_14,
          (ErlangCons head_16 (ErlangCons head_18 ErlangEmptyList))])
  in let arg_40 = (BIF.erlang__hd__1 [chain_2])
  in let
    arg_38 =
      (BIF.erlang__element__2 [(ErlangInt (DBI.fromInt 2)), arg_40])
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "missing_body_for_let"),
  ...
  let   
    arg_1 =
      (H.make_string
         "Let binding at ~s must be followed by an expression\n")
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "public_modifier_in_contract"),
  ...
  in let
    arg_7 =
      (BIF.erlang__element__2 [(ErlangInt (DBI.fromInt 3)), decl_0])
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "init_must_be_an_entrypoint"),
  ...
  in let
    arg_3 =
      (H.make_string
         "The init function (at ~s) must be an entrypoint:\n~s\n")
  ...
  in let
    arg_9 =
      (BIF.do_remote_fun_call "Prettypr" "erlps__nest__2"
         [(ErlangInt (DBI.fromInt 2)), arg_11])
  in let
    head_8 =
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "proto_must_be_entrypoint"),
  ...
  in let
    arg_3 =
      (H.make_string
         "Use \'entrypoint\' for declaration of ~s (at ~s):\n~s\n")
  in let arg_6 = (H.make_string "")
  in let
    arg_7 =
      (BIF.erlang__element__2 [(ErlangInt (DBI.fromInt 3)), decl_0])
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "proto_in_namespace"),
  ...
  let   
    arg_1 =
      (H.make_string
         "Namespaces cannot contain function prototypes (at ~s).\n")
  in let head_3 = (erlps__pp_loc__1 [decl_0])
  in let
    msg_6 =
      (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "unbound_type"),
                                  type_0])]
  =
  let    arg_1 = (H.make_string "Unbound type ~s (at ~s).\n")
  in let arg_4 = (H.make_string "")
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "new_tuple_syntax"),
  ...
  in let
    arg_16 = (ErlangTuple [(ErlangAtom "tuple_t"), ann_0, ts_1])
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "map_in_map_key"),
                                  keytype_0])]
  =
  let    arg_1 = (H.make_string "Invalid key type\n~s\n")
  in let arg_4 = (H.make_string "  ")
  ...
  in let
    msg_7 =
      (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
         [arg_1, (ErlangCons head_3 ErlangEmptyList)])
  in let
    cxt_8 = (H.make_string "Map keys cannot contain other maps.\n")
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "contract_treated_as_namespace"),
  ...
  let   
    arg_4 =
      (H.make_string "Invalid call to contract entrypoint \'~s\'.\n")
  ...
  in let
    arg_11 =
      (H.make_string
         "It must be called as \'c.~s\' for some c : ~s.\n")
  in let
    cxt_17 =
      (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "bad_top_level_decl"),
  ...
  let   
    case_1 =
      (BIF.erlang__element__2 [(ErlangInt (DBI.fromInt 1)), decl_0])
  in let
    what_4 =
      case case_1 of
        (ErlangAtom "letval") -> (H.make_string "function or entrypoint")
        _ -> (H.make_string "contract or namespace")
  in let
    id_7 =
      (BIF.erlang__element__2 [(ErlangInt (DBI.fromInt 3)), decl_0])
  in let
    arg_8 =
      (H.make_string
         "The definition of \'~s\' must appear inside a ~s.\n")
  in let arg_11 = (H.make_string "")
  ...
  in let
    msg_16 =
      (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
         [arg_8,
          (ErlangCons head_10 (ErlangCons what_4 ErlangEmptyList))])
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "unknown_byte_length"),
  ...
  =
  let   
    arg_1 = (H.make_string "Cannot resolve length of byte array.\n")
  in let
    msg_3 =
      (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "failed_to_get_compiler_version"),
  ...
  let   
    arg_1 =
      (H.make_string "Failed to get compiler version. Error:\n  ~p\n")
  in let
    msg_5 =
      (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
           ...
           lambda_4 [v_6] =
             let   
               arg_7 =
                 (H.flmap
                    (\ lc_10 ->
                       let lc_ret_11 = (BIF.erlang__integer_to_list__1 [lc_10])
                       in (ErlangCons lc_ret_11 ErlangEmptyList))
                    v_6)
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "empty_record_or_map_update"),
                                  expr_0])]
  =
  let    arg_1 = (H.make_string "Empty record/map update\n~s")
  in let arg_4 = (H.make_string "  ")
...
erlps__mk_error__1 [(ErlangTuple [(ErlangAtom "mixed_record_and_map"),
  ...
  =
  let   
    arg_1 = (H.make_string "Mixed record fields and map keys in\n~s")
  in let arg_4 = (H.make_string "  ")
  in let head_3 = (erlps__pp_expr__2 [arg_4, expr_0])
  in let
    msg_7 =
...
erlps__mk_error__1 [err_0] =
  let    arg_1 = (H.make_string "Unknown error: ~p\n")
  in let
    msg_5 =
      (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
         [arg_1, (ErlangCons err_0 ErlangEmptyList)])
  ...
  in let
    arg_6 =
      (BIF.do_remote_fun_call "Lists" "erlps__keydelete__3"
         [(ErlangAtom "private"), (ErlangInt (DBI.fromInt 1)), arg_9])
  in let
    lop_3 =
      (BIF.do_remote_fun_call "Lists" "erlps__keydelete__3"
         [(ErlangAtom "public"), (ErlangInt (DBI.fromInt 1)), arg_6])
  in let
    tail_2 =
      (BIF.erlang__op_unAppend
         [lop_3,
...
erlps__pp_when__1 [(ErlangTuple [(ErlangAtom "todo"), what_0])] =
  let   
    tup_el_1 =
      (erlps__pos__2
         [(ErlangInt (DBI.fromInt 0)), (ErlangInt (DBI.fromInt 0))])
  in let arg_5 = (H.make_string "[TODO] ~p\n")
  in let
    tup_el_4 =
      (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
...
erlps__pp_when__1 [(ErlangTuple [(ErlangAtom "at"), ann_0])] =
  ...
  in let arg_4 = (H.make_string "at ~s\n")
    ...
    tup_el_9 =
      case fld_2 of
        (ErlangTuple [(ErlangAtom "field"), _ann_11, lv_12, id_13,
          ...
          in let
            head_17 = (erlps__pp_typed__3 [arg_18, arg_19, fieldtype_4])
        ...
        (ErlangTuple [(ErlangAtom "field"), _ann_36, lv_37, e_38]) ->
          let   
            arg_39 =
              (H.make_string
                 "when checking the assignment of the field\n~s (at ~s)\nto the value\n~s\n")
          in let arg_42 = (H.make_string "  ")
          in let
            arg_43 =
              (ErlangTuple [(ErlangAtom "lvalue"), ErlangEmptyList, lv_37])
          in let
            head_41 = (erlps__pp_typed__3 [arg_42, arg_43, fieldtype_4])
          in let head_49 = (erlps__pp_loc__1 [fld_2])
          in let arg_53 = (H.make_string "  ")
          in let
        ...
        (ErlangTuple [(ErlangAtom "proj"), _ann_57, _rec_58, _fld_59]) ->
          ...
          in let arg_66 = (H.make_string "  ")
          in let
            head_65 = (erlps__pp_typed__3 [arg_66, fld_2, fieldtype_4])
          in let arg_71 = (H.make_string "  ")
...
erlps__pp_when__1 [(ErlangTuple [(ErlangAtom "record_constraint"),
  ...
  in let inferredtype_6 = (erlps__instantiate__1 [inferredtype0_1])
  in let match_expr_10 = (erlps__pp_why_record__1 [fld_2])
  in
    case match_expr_10 of
          ...
          (ErlangTuple [(ErlangAtom "field"), _ann_30, _lv_31, _e_32]) ->
            let   
              arg_35 =
                (H.make_string
                   "when checking that the record type\n~s\n~s\nmatches the expected type\n~s\n")
            in let arg_38 = (H.make_string "  ")
            in let head_37 = (erlps__pp_type__2 [arg_38, rectype_4])
            in let arg_44 = (H.make_string "  ")
...
erlps__pp_when__1 [(ErlangTuple [(ErlangAtom "if_branches"),
  ...
  in let match_expr_9 = (erlps__instantiate__1 [arg_4])
  in
    case match_expr_9 of
      (ErlangTuple [thentype_7, elsetype_8]) ->
        let    head_10 = (ErlangTuple [then_0, thentype_7])
        in let lc_src_14 = (erlps__if_branches__1 [else_2])
        in let
          tail_13 =
            (H.flmap
               (\ lc_17 ->
                  let lc_ret_18 = (ErlangTuple [lc_17, elsetype_8])
                  in (ErlangCons lc_ret_18 ErlangEmptyList))
               lc_src_14)
        in let
          arg_25 = (BIF.erlang__hd__1 [(ErlangCons head_10 tail_13)])
        in let
          arg_23 =
            (BIF.erlang__element__2 [(ErlangInt (DBI.fromInt 1)), arg_25])
        in let tup_el_22 = (erlps__pos__1 [arg_23])
        in let
          arg_28 =
            (H.make_string "when comparing the types of the if-branches\n~s")
        in let
          head_30 =
            (H.flmap
               (\ lc_34 ->
                  case lc_34 of
                    (ErlangTuple [b_32, btype_33]) ->
                      let    arg_36 = (H.make_string "~s (at ~s)\n")
                      in let arg_39 = (H.make_string "  - ")
                      in let
...
erlps__pp_when__1 [(ErlangTuple [(ErlangAtom "case_pat"), pat_0,
  ...
  in let match_expr_8 = (erlps__instantiate__1 [arg_3])
  in
    case match_expr_8 of
  ...
  in
    case match_expr_8 of
      (ErlangTuple [inferred_6, expected_7]) ->
        ...
        in let arg_18 = (H.make_string "  ")
        in let
          head_17 = (erlps__pp_typed__3 [arg_18, expr_0, inferred_6])
        in let arg_23 = (H.make_string "  ")
...
erlps__pp_why_record__1 [fld_4@(ErlangTuple [(ErlangAtom "field"),
  ...
  in let
    arg_8 =
      (H.make_string
         "arising from an assignment of the field ~s (at ~s)")
  in let arg_11 = (H.make_string "")
  in let
    arg_12 =
      (ErlangTuple [(ErlangAtom "lvalue"), ErlangEmptyList, lv_1])
...
erlps__pp_why_record__1 [fld_3@(ErlangTuple [(ErlangAtom "field"),
  ...
  in let
    tup_el_6 =
      (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
         [arg_7,
          (ErlangCons head_9 (ErlangCons head_16 ErlangEmptyList))])
...
erlps__pp_why_record__1 [(ErlangTuple [(ErlangAtom "proj"),
  ...
  in let
    arg_6 =
      (H.make_string
         "arising from the projection of the field ~s (at ~s)")
...
erlps__pp_typed__3 [label_0, expr_1, type_2] =
  let
    arg_4 =
      (ErlangTuple
         [(ErlangAtom "typed"), ErlangEmptyList, expr_1, type_2])
...
erlps__line_number__1 [t_0] =
  (BIF.do_remote_fun_call "Aeso.Syntax" "erlps__get_ann__3"
     [(ErlangAtom "line"), t_0, (ErlangInt (DBI.fromInt 0))])
...
erlps__column_number__1 [t_0] =
  (BIF.do_remote_fun_call "Aeso.Syntax" "erlps__get_ann__3"
     [(ErlangAtom "col"), t_0, (ErlangInt (DBI.fromInt 0))])
...
erlps__pp_loc__1 [t_0] =
  let match_expr_4 = (erlps__loc__1 [t_0])
  in
    case match_expr_4 of
      (ErlangTuple [line_2, col_3]) ->
        ...
        in
          case case_5 of
            (ErlangTuple [(ErlangInt num_8),
                          (ErlangInt num_9)]) | ((ErlangInt num_8) ==
                                                   (ErlangInt (DBI.fromInt 0)))
                                              , ((ErlangInt num_9) ==
                                                   (ErlangInt
                                                      (DBI.fromInt 0))) ->
              (H.make_string "(builtin location)")
            _ ->
              let arg_10 = (H.make_string "line ~p, column ~p")
              in
                (BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
                   [arg_10,
                    (ErlangCons line_2 (ErlangCons col_3 ErlangEmptyList))])
      _ -> (EXC.badmatch match_expr_4)
...
erlps__plural__3 [arg_2, arg_3, arg_4] =
  (EXC.function_clause unit)
...
erlps__pp__1 [(ErlangEmptyList)] = (H.make_string "")
...
erlps__pp__1 [(ErlangTuple [(ErlangAtom "uvar"), _, ref_0])] =
  let    head_1 = (H.make_string "?u")
  in let
    arg_3 =
      (BIF.erlang__phash2__2 [ref_0, (ErlangInt (DBI.fromInt 16384))])
...
erlps__pp__1 [(ErlangTuple [(ErlangAtom "bytes_t"), _,
                            (ErlangAtom "any")])]
  =
  (H.make_string "bytes(_)")
erlps__pp__1 [(ErlangTuple [(ErlangAtom "bytes_t"), _, len_0])] =
  let    head_1 = (H.make_string "bytes(")
...
erlps__desugar__1 [(ErlangCons h_0 t_1)] =
  ...
  in (ErlangCons head_2 tail_4)
erlps__desugar__1 [t_0] | (H.isETuple t_0) =
  let    arg_2 = (BIF.erlang__tuple_to_list__1 [t_0])
...
erlps__desugar_updates__1 [(ErlangCons upd_0 updates_1)] =
  let match_expr_6 = (erlps__update_key__1 [upd_0])
  in
    case match_expr_6 of
      (ErlangTuple [key_3, makefield_4, rest_5]) ->
        let match_expr_11 = (erlps__updates_key__2 [key_3, updates_1])
        in
          case match_expr_11 of
            (ErlangTuple [more_9, updates1_10]) ->
              ...
              in let
                _ =
                  case case_12 of
                    n_19 | (weakGt n_19 (ErlangInt (DBI.fromInt 1))) ->
                      let
                        arg_20 =
                          (ErlangTuple
                             [(ErlangAtom "conflicting_updates_for_field"),
                              upd_0, key_3])
  ...
  let   
    tup_el_6 =
      (ErlangFun 1
         let
           lambda_7 [flds_9] =
             let    tup_el_18 = (H.make_string "__x")
             in let
               tup_el_15 =
                 (ErlangTuple [(ErlangAtom "id"), ErlangEmptyList, tup_el_18])
             in let tup_el_25 = (H.make_string "__x")
             in let
               arg_22 =
             ...
             in
               (ErlangTuple
                  [(ErlangAtom "field"), ann_0,
                   (ErlangCons p_2 ErlangEmptyList), tup_el_15, tup_el_19])
  ...
  let   
    tup_el_7 =
      (ErlangFun 1
         let
           lambda_8 [flds_10] =
             let    tup_el_19 = (H.make_string "__x")
             in let
               tup_el_16 =
                 (ErlangTuple [(ErlangAtom "id"), ErlangEmptyList, tup_el_19])
             in let tup_el_26 = (H.make_string "__x")
             in let
               arg_23 =
                 (ErlangTuple [(ErlangAtom "id"), ErlangEmptyList, tup_el_26])
             in let
               arg_21 = (erlps__map_or_record__3 [ann_0, arg_23, flds_10])
             in let tup_el_20 = (erlps__desugar__1 [arg_21])
             in
               (ErlangTuple
                  [(ErlangAtom "field"), ann_0,
                   (ErlangCons p_2 ErlangEmptyList), tup_el_16, tup_el_20])
           lambda_8 [arg_9] = (EXC.function_clause unit)
           lambda_8 args = (EXC.badarity (ErlangFun 1 lambda_8) args)
         in lambda_8)
  in let
    head_29 =
      (ErlangTuple
         [(ErlangAtom "field"), ann_0, rest_3, id_4, value_5])
  in
    (ErlangTuple
  ...
  let   
    tup_el_5 =
      (ErlangFun 1
         let
           lambda_6 [flds_8] =
             let    tup_el_17 = (H.make_string "__x")
             in let
               tup_el_14 =
                 (ErlangTuple [(ErlangAtom "id"), ErlangEmptyList, tup_el_17])
             in let tup_el_24 = (H.make_string "__x")
             in let
               arg_21 =
             ...
             in
               (ErlangTuple
                  [(ErlangAtom "field"), ann_0,
                   (ErlangCons k_1 ErlangEmptyList), tup_el_14, tup_el_18])
           lambda_6 [arg_7] = (EXC.function_clause unit)
           lambda_6 args = (EXC.badarity (ErlangFun 1 lambda_6) args)
         in lambda_6)
  in let
         ...
         let
           lambda_7 [flds_9] =
             ...
             in
               (ErlangTuple
                  [(ErlangAtom "field"), ann_0,
                   (ErlangCons k_1 ErlangEmptyList), tup_el_15, tup_el_19])
           lambda_7 [arg_8] = (EXC.function_clause unit)
           lambda_7 args = (EXC.badarity (ErlangFun 1 lambda_7) args)
         in lambda_7)
  in let
    head_28 =
      (ErlangTuple
         [(ErlangAtom "field"), ann_0, rest_2, id_3, value_4])
  in
    (ErlangTuple
...
erlps__map_or_record__3 [ann_0, val_1,
  ...
  let   
    case_4 =
      (BIF.erlang__element__2 [(ErlangInt (DBI.fromInt 3)), fld_2])
  in let
    kind_7 =
      case case_4 of
                 ...
                 (\ lc_11 ->
                    case lc_11 of
                      (ErlangTuple [name1_9, _, rest_10]) ->
                        ...
                        in let
                          lc_ret_12 = (ErlangTuple [lc_4, tup_el_14, rest_10])
                        in (ErlangCons lc_ret_12 ErlangEmptyList)
                      _ -> ErlangEmptyList)
...
erlps__updates_key__2 [arg_31, arg_32] =
  (EXC.function_clause unit)
