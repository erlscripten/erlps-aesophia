  ...
  let   
    arg_7 =
      (BIF.do_remote_fun_call "Aeso.Icode" "erlps__set_namespace__2"
         [con_1, icode_4])
  in let
    newicode_10 = (erlps__contract_to_icode__2 [code_2, arg_7])
...
erlps__add_default_init_function__2 [icode_4@(ErlangMap map_0),
  ...
  in let tup_el_13 = (H.make_string "init")
  in let
    arg_10 =
        ...
        let
          case_17 =
            (BIF.lists__keymember__3
               [qinit_15, (ErlangInt (DBI.fromInt 1)), funs_2])
        in
          case case_17 of
            (ErlangAtom "true") -> icode_4
            (ErlangAtom "false") | ((ErlangAtom "true") ==
                                      (H.falsifyErrors (\ _ -> nocode_9))) ->
              icode_4
            (ErlangAtom "false") | ((ErlangAtom "true") ==
                                      (H.falsifyErrors
                                         (\ _ ->
              ...
              let
                arg_25 =
                  (ErlangTuple [(ErlangAtom "missing_init_function"), ns_1])
            ...
            (ErlangAtom "false") ->
              ...
              in let
                arg_40 = (ErlangTuple [(ErlangAtom "tuple"), ErlangEmptyList])
              ...
              in (BIF.maps__merge__2 [icode_4, map_ext_60])
...
erlps__contract_to_icode__2 [(ErlangCons decl_5@(ErlangTuple [(ErlangAtom "type_def"),
  ...
  , (DM.Just types_8) <-
      ((Map.lookup (ErlangAtom "types") map_7)) =
  let   
    ...
    newconstructors_49 =
      case def_4 of
        (ErlangTuple [(ErlangAtom "variant_t"), cons_16]) ->
          let    lop_19 = (BIF.erlang__length__1 [cons_16])
          in let
            arg_18 =
          ...
          in let
            tags_22 =
              (BIF.do_remote_fun_call "Lists" "erlps__seq__2"
                 [(ErlangInt (DBI.fromInt 0)), arg_18])
          in let
            getname_26 =
              (ErlangFun 1
                 let
                     ...
                     in let
                       match_expr_35 =
                         (BIF.do_remote_fun_call "Aeso.Icode"
                            "erlps__qualify__2" [arg_30, icode_10])
                     in
                 ...
                 (\ lc_43 ->
                    case lc_43 of
                      (ErlangTuple [tag_41, con_42]) ->
                        ...
                        in let lc_ret_44 = (ErlangTuple [tup_el_45, tag_41])
  ...
  in
    case match_expr_53 of
      (ErlangTuple [_, _, tname_52]) ->
        let   
          map_ext_61 = (ErlangMap (Map.singleton tname_52 typedef_14))
        in let val_57 = (BIF.maps__merge__2 [types_8, map_ext_61])
        in let
          val_63 =
            (BIF.maps__merge__2 [constructors_9, newconstructors_49])
        in let
          map_ext_66 =
            (ErlangMap
               (Map.fromFoldable
                  [(Tup.Tuple (ErlangAtom "types") val_57),
                   (Tup.Tuple (ErlangAtom "constructors") val_63)]))
        in let
          icode1_70 =
            case (H.findMissingKey icode_10
                    [(ErlangAtom "types"), (ErlangAtom "constructors")]) of
              (DM.Nothing) -> (BIF.maps__merge__2 [icode_10, map_ext_66])
          ...
          icode2_115 =
            case name_1 of
                ...
                in
                  case case_77 of
                    (ErlangAtom "true") ->
                      ...
                      in (BIF.maps__merge__2 [icode1_70, map_ext_84])
                    (ErlangAtom "false") ->
                      let
                        arg_86 =
                          (ErlangTuple
                             [(ErlangAtom "higher_order_state"), decl_5])
              ...
              (ErlangCons (ErlangInt num_89) (ErlangCons (ErlangInt num_90) (ErlangCons (ErlangInt num_91) (ErlangCons (ErlangInt num_92) (ErlangCons (ErlangInt num_93) (ErlangEmptyList)))))) | ((ErlangInt
                ...
                let
                  arg_94 =
                    (ErlangTuple [(ErlangAtom "parameterized_state"), id_2])
              ...
              (ErlangCons (ErlangInt num_97) (ErlangCons (ErlangInt num_98) (ErlangCons (ErlangInt num_99) (ErlangCons (ErlangInt num_100) (ErlangCons (ErlangInt num_101) (ErlangEmptyList)))))) | ((ErlangInt
                ...
                in (BIF.maps__merge__2 [icode1_70, map_ext_105])
              (ErlangCons (ErlangInt num_107) (ErlangCons (ErlangInt num_108) (ErlangCons (ErlangInt num_109) (ErlangCons (ErlangInt num_110) (ErlangCons (ErlangInt num_111) (ErlangEmptyList)))))) | ((ErlangInt
                ...
                let
                  arg_112 =
                    (ErlangTuple [(ErlangAtom "parameterized_event"), id_2])
              ...
              in let
                tup_el_50 =
                  (ErlangTuple
                     [(ErlangAtom "tuple"),
                      (ErlangCons head_53
                         (ErlangCons head_56 ErlangEmptyList))])
...
erlps__contract_to_icode__2 [(ErlangCons (ErlangTuple [(ErlangAtom "fun_decl"),
  ...
  in
    case case_9 of
      (ErlangAtom "true") ->
        let
          arg_13 = (ErlangTuple [(ErlangAtom "missing_definition"), id_0])
...
erlps__contract_to_icode__2 [(ErlangCons decl_0 code_1), icode_2]
  =
  let    arg_3 = (H.make_string "Unhandled declaration: ~p\n")
  in let
    _ =
...
erlps__ast_args__3 [(ErlangCons (ErlangTuple [(ErlangAtom "typed"),
  ...
  in
    (erlps__ast_args__3 [rest_2, (ErlangCons head_7 acc_3), icode_4])
...
erlps__ast_body__2 [(ErlangTuple [(ErlangAtom "qid"), _,
  ...
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 100)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 100)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 114)))
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 115)))
  , ((ErlangInt num_14) == (ErlangInt (DBI.fromInt 115))) =
...
erlps__ast_body__2 [(ErlangTuple [(ErlangAtom "qid"), _,
  ...
  , ((ErlangInt num_6) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 116)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 114)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 116)))
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 111)))
  , ((ErlangInt num_14) == (ErlangInt (DBI.fromInt 114))) =
...
erlps__ast_body__2 [(ErlangTuple [(ErlangAtom "qid"), _,
  ...
  , ((ErlangInt num_6) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 116)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 98)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 108)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 110)))
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_14) == (ErlangInt (DBI.fromInt 101))) =
  (ErlangTuple
     [(ErlangAtom "prim_balance"),
      (ErlangAtom "prim_contract_address")])
erlps__ast_body__2 [(ErlangTuple [(ErlangAtom "qid"), _,
  ...
  , ((ErlangInt num_5) == (ErlangInt (DBI.fromInt 114)))
  , ((ErlangInt num_6) == (ErlangInt (DBI.fromInt 105)))
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 103)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 105)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 110))) =
...
erlps__ast_body__2 [(ErlangTuple [(ErlangAtom "qid"), _,
  ...
  , ((ErlangInt num_2) == (ErlangInt (DBI.fromInt 108)))
  , ((ErlangInt num_3) == (ErlangInt (DBI.fromInt 108)))
  , ((ErlangInt num_4) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_5) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_6) == (ErlangInt (DBI.fromInt 108)))
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 108)))
...
erlps__ast_body__2 [(ErlangTuple [(ErlangAtom "qid"), _,
  ...
  , ((ErlangInt num_2) == (ErlangInt (DBI.fromInt 108)))
  , ((ErlangInt num_3) == (ErlangInt (DBI.fromInt 108)))
  , ((ErlangInt num_4) == (ErlangInt (DBI.fromInt 118)))
  , ((ErlangInt num_5) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_6) == (ErlangInt (DBI.fromInt 108)))
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 117)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 101))) =
...
erlps__ast_body__2 [(ErlangTuple [(ErlangAtom "qid"), _,
  ...
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 95)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 112)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 114)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 105)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 101))) =
...
erlps__ast_body__2 [(ErlangTuple [(ErlangAtom "qid"), _,
  ...
  , ((ErlangInt num_5) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_6) == (ErlangInt (DBI.fromInt 111)))
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 105)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 110)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 98)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 115)))
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 101))) =
...
erlps__ast_body__2 [(ErlangTuple [(ErlangAtom "qid"), _,
  ...
  , ((ErlangInt num_6) == (ErlangInt (DBI.fromInt 105)))
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 109)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 115)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 116)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 109)))
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 112))) =
...
erlps__ast_body__2 [(ErlangTuple [(ErlangAtom "qid"), _,
  ...
  , ((ErlangInt num_3) == (ErlangInt (DBI.fromInt 105)))
  , ((ErlangInt num_4) == (ErlangInt (DBI.fromInt 110)))
  , ((ErlangInt num_5) == (ErlangInt (DBI.fromInt 98)))
  , ((ErlangInt num_6) == (ErlangInt (DBI.fromInt 108)))
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 111)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 107)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 95)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 104)))
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 105)))
  , ((ErlangInt num_14) == (ErlangInt (DBI.fromInt 103)))
  , ((ErlangInt num_15) == (ErlangInt (DBI.fromInt 104)))
  , ((ErlangInt num_16) == (ErlangInt (DBI.fromInt 116))) =
  (ErlangAtom "prim_block_height")
erlps__ast_body__2 args = (erlps__ast_body__2__p1 args)

erlps__ast_body__2__p1 :: ErlangFun
erlps__ast_body__2__p1 [(ErlangTuple [(ErlangAtom "qid"), _,
                                      (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangCons (ErlangInt num_4) (ErlangEmptyList)))))) (ErlangCons (ErlangCons (ErlangInt num_5) (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangCons (ErlangInt num_11) (ErlangCons (ErlangInt num_12) (ErlangCons (ErlangInt num_13) (ErlangCons (ErlangInt num_14) (ErlangEmptyList))))))))))) (ErlangEmptyList)))]),
                        _icode_15]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 67)))
  , ((ErlangInt num_1) == (ErlangInt (DBI.fromInt 104)))
  ...
  , ((ErlangInt num_3) == (ErlangInt (DBI.fromInt 105)))
  , ((ErlangInt num_4) == (ErlangInt (DBI.fromInt 110)))
  , ((ErlangInt num_5) == (ErlangInt (DBI.fromInt 100)))
  , ((ErlangInt num_6) == (ErlangInt (DBI.fromInt 105)))
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 102)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 102)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 105)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 117)))
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 108)))
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 116)))
  , ((ErlangInt num_14) == (ErlangInt (DBI.fromInt 121))) =
...
erlps__ast_body__2__p1 [(ErlangTuple [(ErlangAtom "qid"), _,
  ...
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 115)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 95)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 108)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 105)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 109)))
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 105)))
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 116))) =
...
erlps__ast_body__2__p1 [(ErlangTuple [(ErlangAtom "app"), _,
  ...
  , ((ErlangInt num_2) == (ErlangInt (DBI.fromInt 117)))
  , ((ErlangInt num_3) == (ErlangInt (DBI.fromInt 116)))
  , (DM.Just con_6) <-
...
erlps__ast_body__2__p1 [(ErlangTuple [(ErlangAtom "typed"), _,
...
erlps__ast_body__2__p1 [(ErlangTuple [(ErlangAtom "qid"), _,
  ...
  , ((ErlangInt num_4) == (ErlangInt (DBI.fromInt 116)))
  , ((ErlangInt num_5) == (ErlangInt (DBI.fromInt 120)))
  , ((ErlangInt num_6) == (ErlangInt (DBI.fromInt 95)))
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 104)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 115)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 104))) =
  let   
    arg_13 =
      (ErlangTuple
  ...
  in
    (erlps__prim_call__5
       [(ErlangInt (DBI.fromInt 500)), arg_13, ErlangEmptyList,
        ErlangEmptyList, arg_18])
erlps__ast_body__2__p1 [(ErlangTuple [(ErlangAtom "map_get"), _,
                                      map_0, key_1]),
                        icode_2]
  =
  let
    match_expr_6 = (erlps__check_monomorphic_map__2 [map_0, icode_2])
  in
...
erlps__ast_body__2__p1 [(ErlangTuple [(ErlangAtom "map_get"), _,
  ...
  =
  let
    match_expr_7 = (erlps__check_monomorphic_map__2 [map_0, icode_3])
  in
    case match_expr_7 of
      (ErlangTuple [_, valtype_6]) ->
        ...
        in let
          fun_12 =
            (ErlangTuple [(ErlangAtom "map_lookup_default"), tup_el_9])
...
erlps__ast_body__2__p1 [(ErlangTuple [(ErlangAtom "typed"),
                                      ann_0,
...
erlps__ast_body__2__p1 [(ErlangTuple [(ErlangAtom "map"), _,
                                      map_0, (ErlangEmptyList)]),
                        icode_1]
  =
  (erlps__ast_body__2 [map_0, icode_1])
erlps__ast_body__2__p1 args = (erlps__ast_body__2__p2 args)

erlps__ast_body__2__p2 :: ErlangFun
erlps__ast_body__2__p2 [(ErlangTuple [(ErlangAtom "map"), _,
                                      map_0,
  ...
  case upd_1 of
    ...
    something_else -> (EXC.case_clause something_else)
erlps__ast_body__2__p2 [(ErlangTuple [(ErlangAtom "map"), ann_0,
  ...
  in let
    arg_5 =
      (ErlangTuple [(ErlangAtom "map"), ann_0, tup_el_8, upds_3])
  in (erlps__ast_body__2 [arg_5, icode_4])
erlps__ast_body__2__p2 [(ErlangTuple [(ErlangAtom "qid"), _,
  ...
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 101))) =
  (ErlangTuple
     [(ErlangAtom "integer"), (ErlangInt (DBI.fromInt 0))])
erlps__ast_body__2__p2 [(ErlangTuple [(ErlangAtom "qid"), _,
  ...
  , ((ErlangInt num_5) == (ErlangInt (DBI.fromInt 108)))
  , ((ErlangInt num_6) == (ErlangInt (DBI.fromInt 108))) =
  let   
    lop_10 =
      (BIF.erlang__bsl__2
         [(ErlangInt (DBI.fromInt 1)), (ErlangInt (DBI.fromInt 256))])
  in let
    tup_el_9 =
      (BIF.erlang__op_minus [lop_10, (ErlangInt (DBI.fromInt 1))])
  in (ErlangTuple [(ErlangAtom "integer"), tup_el_9])
erlps__ast_body__2__p2 [(ErlangTuple [(ErlangAtom "id"), _,
                                      name_0]),
                        _icode_1]
  =
  (ErlangTuple [(ErlangAtom "var_ref"), name_0])
erlps__ast_body__2__p2 [(ErlangTuple [(ErlangAtom "typed"), _,
                                      id_0@(ErlangTuple [(ErlangAtom "qid"), _,
                                                         _]),
                                      type_1]),
                        icode_2]
  =
...
erlps__ast_body__2__p2 [(ErlangTuple [(ErlangAtom "qid"), _,
  ...
  =
  (ErlangTuple [(ErlangAtom "var_ref"), name_0])
erlps__ast_body__2__p2 [(ErlangTuple [(ErlangAtom "bool"), _,
                                      bool_0]),
                        _icode_1]
  =
  let
    value_2 =
      case (ErlangAtom "true") of
        _ | ((ErlangAtom "true") == (H.falsifyErrors (\ _ -> bool_0))) ->
          (ErlangInt (DBI.fromInt 1))
        _ -> (ErlangInt (DBI.fromInt 0))
  in (ErlangTuple [(ErlangAtom "integer"), value_2])
erlps__ast_body__2__p2 [(ErlangTuple [(ErlangAtom "int"), _,
                                      value_0]),
                        _icode_1]
  =
  (ErlangTuple [(ErlangAtom "integer"), value_0])
erlps__ast_body__2__p2 [(ErlangTuple [(ErlangAtom "char"), _,
                                      value_0]),
                        _icode_1]
  =
  (ErlangTuple [(ErlangAtom "integer"), value_0])
erlps__ast_body__2__p2 args = (erlps__ast_body__2__p3 args)

erlps__ast_body__2__p3 :: ErlangFun
erlps__ast_body__2__p3 [(ErlangTuple [(ErlangAtom "bytes"), _,
                                      bin_0]),
                        _icode_1]
  =
  let
      ...
      words_7 ->
        let
          tup_el_9 =
            (H.flmap
               (\ lc_12 ->
                  let lc_ret_13 = (ErlangTuple [(ErlangAtom "integer"), lc_12])
                  in (ErlangCons lc_ret_13 ErlangEmptyList))
               words_7)
        in (ErlangTuple [(ErlangAtom "tuple"), tup_el_9])
erlps__ast_body__2__p3 [(ErlangTuple [key_0, _, bin_1]),
                        _icode_2]
  | ((ErlangAtom "true") ==
       (H.falsifyErrors
          (\ _ ->
             let   
               lop_12 =
                 (BIF.erlang__op_eq [key_0, (ErlangAtom "account_pubkey")])
             in let
               lop_11 =
                 case lop_12 of
                   (ErlangAtom "true") -> (ErlangAtom "true")
                   (ErlangAtom "false") ->
                     (BIF.erlang__op_eq [key_0, (ErlangAtom "contract_pubkey")])
             ...
             in let
               lop_10 =
                 case lop_11 of
                   (ErlangAtom "true") -> (ErlangAtom "true")
                   (ErlangAtom "false") ->
                     (BIF.erlang__op_eq [key_0, (ErlangAtom "oracle_pubkey")])
                   _ -> (EXC.badarg1 lop_11)
             in
               case lop_10 of
                 (ErlangAtom "true") -> (ErlangAtom "true")
                 (ErlangAtom "false") ->
                   (BIF.erlang__op_eq [key_0, (ErlangAtom "oracle_query_id")])
                 _ -> (EXC.badarg1 lop_10)))) =
  case bin_1 of
...
erlps__ast_body__2__p3 [(ErlangTuple [(ErlangAtom "string"), _,
                                      bin_0]),
                        _icode_1]
  =
  ...
  in let
    tup_el_8 =
      (H.flmap
         (\ lc_11 ->
            let lc_ret_12 = (ErlangTuple [(ErlangAtom "integer"), lc_11])
            in (ErlangCons lc_ret_12 ErlangEmptyList))
         (ErlangCons head_2 tail_4))
  in (ErlangTuple [(ErlangAtom "tuple"), tup_el_8])
erlps__ast_body__2__p3 [(ErlangTuple [(ErlangAtom "tuple"), _,
                                      args_0]),
                        icode_1]
  =
  let
    tup_el_3 =
      (H.flmap
         (\ lc_6 ->
            let lc_ret_7 = (erlps__ast_body__2 [lc_6, icode_1])
            in (ErlangCons lc_ret_7 ErlangEmptyList))
         args_0)
  in (ErlangTuple [(ErlangAtom "tuple"), tup_el_3])
erlps__ast_body__2__p3 [(ErlangTuple [(ErlangAtom "list"), _,
                                      args_0]),
                        icode_1]
  =
  let
...
erlps__ast_body__2__p3 [(ErlangTuple [(ErlangAtom "proj"), _,
                                      (ErlangTuple [(ErlangAtom "typed"), _,
                                                    addr_0,
...
erlps__ast_body__2__p3 [(ErlangTuple [(ErlangAtom "app"), _,
                                      (ErlangTuple [(ErlangAtom "typed"), _,
  ...
  let   
    namedargs_11 =
      (H.flmap
         ...
         args0_5)
  in let
    args_14 = (BIF.erlang__op_unAppend [args0_5, namedargs_11])
  in let
    argopts_24 =
      (H.flmap
         (\ lc_18 ->
            case lc_18 of
              (ErlangTuple [(ErlangAtom "named_arg"), _,
                ...
                in let lc_ret_19 = (ErlangTuple [name_16, tup_el_21])
         ...
         (\ lc_28 ->
            case lc_28 of
              (ErlangTuple [(ErlangAtom "named_arg_t"), _,
                ...
                in let lc_ret_29 = (ErlangTuple [name_26, tup_el_31])
  ...
  in let
    argsi_41 =
      (H.flmap
         (\ lc_37 ->
            let lc_ret_38 = (erlps__ast_body__2 [lc_37, icode_6])
  ...
  in
    case match_expr_68 of
      (ErlangBinary bin_c_64) | size_65 <- ((DBI.fromInt 256))
                              , (BIN.Ok typehash_67 bin_66) <-
                                  ((BIN.chop_int bin_c_64 size_65 1 BIN.Big
                                      BIN.Unsigned))
                              , (BIN.empty bin_66) ->
        let   
          fun_71 = (ErlangTuple [(ErlangAtom "integer"), typehash_67])
        ...
        in
          (ErlangTuple
             [(ErlangAtom "prim_call_contract"), gas_51, tup_el_74, value_56,
              tup_el_78, tup_el_87])
      _ -> (EXC.badmatch match_expr_68)
erlps__ast_body__2__p3 [(ErlangTuple [(ErlangAtom "proj"), _,
                                      con_0@(ErlangTuple [(ErlangAtom "typed"),
                                                          _, _,
                                                          (ErlangTuple [(ErlangAtom "con"),
                                                                        _,
                                                                        _])]),
  ...
  let
    arg_3 =
      (ErlangTuple [(ErlangAtom "unapplied_contract_call"), con_0])
  in (erlps__gen_error__1 [arg_3])
erlps__ast_body__2__p3 [(ErlangTuple [(ErlangAtom "con"), _,
                                      name_0]),
                        icode_1]
  =
  let   
...
erlps__ast_body__2__p3 [(ErlangTuple [(ErlangAtom "qcon"), _,
                                      name_0]),
                        icode_1]
  =
  let   
...
erlps__ast_body__2__p3 args = (erlps__ast_body__2__p4 args)

erlps__ast_body__2__p4 :: ErlangFun
erlps__ast_body__2__p4 [(ErlangTuple [(ErlangAtom "app"), _,
                                      (ErlangTuple [(ErlangAtom "typed"), _,
                                                    (ErlangTuple [(ErlangAtom "con"),
                                                                  _, name_0]),
                                                    _]),
  ...
  in let
    tail_13 =
      (H.flmap
         (\ lc_16 ->
            let lc_ret_17 = (erlps__ast_body__2 [lc_16, icode_2])
            in (ErlangCons lc_ret_17 ErlangEmptyList))
         args_1)
  in
    (ErlangTuple
       [(ErlangAtom "tuple"), (ErlangCons head_10 tail_13)])
erlps__ast_body__2__p4 [(ErlangTuple [(ErlangAtom "app"), _,
                                      (ErlangTuple [(ErlangAtom "typed"), _,
  ...
  in let
    tail_11 =
      (H.flmap
         (\ lc_14 ->
            let lc_ret_15 = (erlps__ast_body__2 [lc_14, icode_2])
            in (ErlangCons lc_ret_15 ErlangEmptyList))
         args_1)
  in
    (ErlangTuple [(ErlangAtom "tuple"), (ErlangCons head_8 tail_11)])
erlps__ast_body__2__p4 [(ErlangTuple [(ErlangAtom "app"), _,
                                      (ErlangTuple [(ErlangAtom ".."), _]),
                                      (ErlangCons a_0 (ErlangCons b_1 (ErlangEmptyList)))]),
                        icode_2]
  =
  let    head_7 = (H.make_string "ListInternal")
  in let head_9 = (H.make_string "from_to")
  in let
    tup_el_4 =
      (ErlangTuple
         [(ErlangAtom "var_ref"),
...
erlps__ast_body__2__p4 [(ErlangTuple [(ErlangAtom "app"), as_0,
                                      fun_1, args_2]),
                        icode_3]
  =
  let
                  ...
                  in let
                    tup_el_43 =
                      (H.flmap
                         (\ lc_46 ->
                            let
                              lc_ret_47 = (erlps__ast_body__2 [lc_46, icode_3])
                            in (ErlangCons lc_ret_47 ErlangEmptyList))
                         args_2)
                  in
                    (ErlangTuple [(ErlangAtom "funcall"), tup_el_40, tup_el_43])
                something_else -> (EXC.case_clause something_else)
          _ -> (EXC.badmatch fun_1)
erlps__ast_body__2__p4 [(ErlangTuple [(ErlangAtom "list_comp"),
                                      _, yield_0, (ErlangEmptyList)]),
                        icode_1]
  =
...
erlps__ast_body__2__p4 [(ErlangTuple [(ErlangAtom "list_comp"),
  ...
  in let
    head_19 =
      (ErlangTuple [(ErlangAtom "case"), as_0, pat_2, tup_el_23])
  in let tup_el_35 = (H.make_string "_")
  in let
    tup_el_32 = (ErlangTuple [(ErlangAtom "id"), as_0, tup_el_35])
  in let
    tup_el_36 =
  ...
  in let head_46 = (H.make_string "ListInternal")
  in let head_48 = (H.make_string "flat_map")
  in let
    tup_el_43 =
      (ErlangTuple
         [(ErlangAtom "var_ref"),
  ...
  in let
    head_54 = (ErlangTuple [(ErlangAtom "arg"), arg_7, tup_el_57])
...
erlps__ast_body__2__p4 [(ErlangTuple [(ErlangAtom "list_comp"),
  ...
  in (erlps__ast_body__2 [arg_5, icode_4])
erlps__ast_body__2__p4 [(ErlangTuple [(ErlangAtom "if"), _,
                                      dec_0, then_1, else_2]),
                        icode_3]
  =
  ...
  in
    (ErlangTuple
       [(ErlangAtom "ifte"), tup_el_5, tup_el_8, tup_el_11])
erlps__ast_body__2__p4 args = (erlps__ast_body__2__p5 args)

erlps__ast_body__2__p5 :: ErlangFun
erlps__ast_body__2__p5 [(ErlangTuple [(ErlangAtom "switch"), _,
                                      a_0, cases_1]),
                        icode_2]
  =
         ...
         (\ lc_11 ->
            case lc_11 of
              (ErlangTuple [(ErlangAtom "case"), _, pat_9, body_10]) ->
                ...
                in let lc_ret_12 = (ErlangTuple [tup_el_13, tup_el_16])
                in (ErlangCons lc_ret_12 ErlangEmptyList)
              _ -> ErlangEmptyList)
         cases_1)
  in (ErlangTuple [(ErlangAtom "switch"), tup_el_4, tup_el_7])
erlps__ast_body__2__p5 [(ErlangTuple [(ErlangAtom "block"), as_0,
...
erlps__ast_body__2__p5 [(ErlangTuple [(ErlangAtom "block"), as_0,
  ...
  in let
    arg_21 =
      (ErlangTuple
         [(ErlangAtom "block"), as_0, (ErlangCons head_25 rest_6)])
  in (erlps__ast_body__2 [arg_21, icode_7])
erlps__ast_body__2__p5 [(ErlangTuple [(ErlangAtom "block"), _,
                                      (ErlangEmptyList)]),
                        _icode_0]
  =
...
erlps__ast_body__2__p5 [(ErlangTuple [(ErlangAtom "block"), as_0,
  ...
  in let tup_el_12 = (H.make_string "_")
  in let
    tup_el_10 = (ErlangTuple [(ErlangAtom "var_ref"), tup_el_12])
  in let
    arg_14 = (ErlangTuple [(ErlangAtom "block"), as_0, rest_2])
...
erlps__ast_body__2__p5 [(ErlangTuple [(ErlangAtom "lam"), _,
                                      args_0, body_1]),
                        icode_2]
  =
  let   
         ...
         (\ lc_8 ->
            case lc_8 of
              (ErlangTuple [(ErlangAtom "arg"), _, p_6, t_7]) ->
                ...
                in let
                  lc_ret_9 =
                    (ErlangTuple [(ErlangAtom "arg"), tup_el_11, tup_el_13])
...
erlps__ast_body__2__p5 [(ErlangTuple [(ErlangAtom "typed"), _,
                                      (ErlangTuple [(ErlangAtom "record"),
                                                    attrs_0, fields_1]),
         ...
         (\ lc_18 ->
            case lc_18 of
              (ErlangTuple [(ErlangAtom "field_t"), _,
                            (ErlangTuple [(ErlangAtom "id"), _, name_17]),
                            _]) ->
                let   
                  case_20 =
                    (BIF.do_remote_fun_call "Proplists" "erlps__get_value__2"
                        ...
                        let   
                          line_25 =
                            (BIF.do_remote_fun_call "Aeso.Syntax"
                               "erlps__get_ann__2"
                               [(ErlangAtom "line"), attrs_0])
                        in let
                          tup_el_27 =
                            (H.make_string
                               "Missing field in record: ~s (on line ~p)\n")
                        in
                          (ErlangTuple
...
erlps__ast_body__2__p5 [(ErlangTuple [(ErlangAtom "proj"), _,
                                      (ErlangTuple [(ErlangAtom "typed"), _,
                                                    record_0,
                                                    (ErlangTuple [(ErlangAtom "record_t"),
                                                                  fields_1])]),
                        ...
                        icode_3]
  =
  let    arg_7 = (BIF.erlang__length__1 [fields_1])
  in let
    arg_5 =
      (BIF.do_remote_fun_call "Lists" "erlps__seq__2"
         [(ErlangInt (DBI.fromInt 1)), arg_7])
  in let
    lc_src_4 =
      (BIF.do_remote_fun_call "Lists" "erlps__zip__2"
         [arg_5, fields_1])
  ...
  in
    case match_expr_18 of
      (ErlangCons index_17 (ErlangEmptyList)) ->
        let   
          rop_25 =
            (BIF.erlang__op_minus [index_17, (ErlangInt (DBI.fromInt 1))])
        in let
          tup_el_23 =
            (BIF.erlang__op_mult [(ErlangInt (DBI.fromInt 32)), rop_25])
        in let
          tup_el_21 = (ErlangTuple [(ErlangAtom "integer"), tup_el_23])
...
erlps__ast_body__2__p5 [(ErlangTuple [(ErlangAtom "record"),
                                      attrs_0,
                                      (ErlangTuple [(ErlangAtom "typed"), _,
                                                    record_1,
  ...
  in let tup_el_19 = (H.make_string "_record")
  in let
    tup_el_16 = (ErlangTuple [(ErlangAtom "id"), attrs_0, tup_el_19])
  in let
    rec_21 =
      (ErlangTuple
         [(ErlangAtom "typed"), attrs_0, tup_el_16, rectype_3])
  in let
    compileupdate_44 =
      (ErlangFun 1
         let
           ...
           lambda_22 [(ErlangTuple [(ErlangAtom "field_upd"), ann_25,
             ...
             let   
               head_38 =
                 (ErlangTuple [(ErlangAtom "proj"), ann1_26, rec_21, p_27])
             in let
               tup_el_33 =
                 (ErlangTuple
  ...
  in let tup_el_53 = (H.make_string "_record")
  in let
    ...
    rop_65 =
      (H.flmap
         (\ lc_68 ->
            case lc_68 of
              (ErlangTuple [(ErlangAtom "field_t"), _,
                            (ErlangTuple [(ErlangAtom "id"), _, name_67]),
                            _]) ->
                let   
                  ...
                  case cond_69 of
                    (ErlangAtom "true") ->
                      ...
                      in let
                        head_77 =
                          (ErlangTuple
                             [(ErlangAtom "proj"), attrs_0, tup_el_80])
                      in let
                        tup_el_89 =
                          (ErlangTuple [(ErlangAtom "id"), attrs_0, name_67])
                      in let
  ...
  in let
    tup_el_58 =
      (ErlangTuple [(ErlangAtom "record"), attrs_0, tup_el_61])
  in let
    arg_55 =
      (ErlangTuple
         [(ErlangAtom "typed"), attrs_0, tup_el_58, rectype_3])
...
erlps__ast_body__2__p5 args = (erlps__ast_body__2__p6 args)

erlps__ast_body__2__p6 :: ErlangFun
erlps__ast_body__2__p6 [(ErlangTuple [(ErlangAtom "typed"), _,
                                      body_0, _]),
                        icode_1]
  =
  (erlps__ast_body__2 [body_0, icode_1])
erlps__ast_body__2__p6 [arg_4, arg_5] =
  (EXC.function_clause unit)
erlps__ast_body__2__p6 args =
  (EXC.badarity
     (ErlangFun 2 (\ _ -> (ErlangAtom "purs_tco_sucks"))) args)
...
erlps__ast_binop__5 [op_0, ann_1,
  ...
  | ((ErlangAtom "true") ==
       (H.falsifyErrors
          (\ _ ->
             let    lop_85 = (BIF.erlang__op_eq [op_0, (ErlangAtom "==")])
             in let
               lop_84 =
                 case lop_85 of
                   (ErlangAtom "true") -> (ErlangAtom "true")
                   (ErlangAtom "false") ->
                     (BIF.erlang__op_eq [op_0, (ErlangAtom "!=")])
    ...
    _ =
      case cond_6 of
        (ErlangAtom "true") ->
          ...
          in let lc_ret_9 = (erlps__gen_error__1 [arg_10])
          in (ErlangCons lc_ret_9 ErlangEmptyList)
        _ -> ErlangEmptyList
  ...
  in
    case case_15 of
      (ErlangAtom "word") ->
        ...
        in
          (ErlangTuple [(ErlangAtom "binop"), op_0, tup_el_20, tup_el_23])
      othertype_26 ->
        let   
          neg_42 =
            case op_0 of
              (ErlangAtom "==") ->
                (ErlangFun 1
                   let
                     ...
                     lambda_28 args =
                       (EXC.badarity (ErlangFun 1 lambda_28) args)
                   in lambda_28)
              (ErlangAtom "!=") ->
                (ErlangFun 1
                   let
                     lambda_31 [x_33] =
                       (ErlangTuple
                          [(ErlangAtom "unop"), (ErlangAtom "!"), x_33])
                     lambda_31 [arg_32] = (EXC.function_clause unit)
                     lambda_31 args =
                       (EXC.badarity (ErlangFun 1 lambda_31) args)
                   in lambda_31)
              _ ->
                let
                  arg_37 =
                ...
                in
                  case case_56 of
                    (ErlangCons (ErlangAtom "word") (ErlangEmptyList)) ->
                      let    rop_64 = (BIF.erlang__length__1 [types_55])
                      in let
                        tup_el_62 =
                          (BIF.erlang__op_mult
                             [(ErlangInt (DBI.fromInt 32)), rop_64])
                      in let
                        head_60 =
                          (ErlangTuple [(ErlangAtom "integer"), tup_el_62])
                      in
                        (erlps__builtin_call__2
                    ...
                    _ ->
                      let
                        arg_67 =
                          (ErlangTuple
                             [(ErlangAtom "cant_compare_type_aevm"), ann_1,
                              op_0, type_3])
...
erlps__is_builtin_fun__2 [(ErlangTuple [(ErlangAtom "qid"), _,
  ...
  , ((ErlangInt num_2) == (ErlangInt (DBI.fromInt 104)))
  , ((ErlangInt num_3) == (ErlangInt (DBI.fromInt 97)))
  ...
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 118)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 110)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 116)))
  , (DM.Just con_12) <-
...
erlps__is_builtin_fun__2 [(ErlangTuple [(ErlangAtom "qid"), _,
  ...
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 110)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 101))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2 [(ErlangTuple [(ErlangAtom "qid"), _,
                                        (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangCons (ErlangInt num_4) (ErlangEmptyList)))))) (ErlangCons (ErlangCons (ErlangInt num_5) (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangCons (ErlangInt num_11) (ErlangCons (ErlangInt num_12) (ErlangCons (ErlangInt num_13) (ErlangCons (ErlangInt num_14) (ErlangEmptyList))))))))))) (ErlangEmptyList)))]),
                          _icode_15]
  ...
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 95)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 104)))
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 115)))
  , ((ErlangInt num_14) == (ErlangInt (DBI.fromInt 104))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2 [(ErlangTuple [(ErlangAtom "qid"), _,
                                        (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangEmptyList))))) (ErlangCons (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangCons (ErlangInt num_11) (ErlangEmptyList))))))))) (ErlangEmptyList)))]),
                          _icode_12]
  ...
  , ((ErlangInt num_6) == (ErlangInt (DBI.fromInt 115)))
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 95)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 108)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 102)))
...
erlps__is_builtin_fun__2 [(ErlangTuple [(ErlangAtom "id"), _,
  ...
  , ((ErlangInt num_1) == (ErlangInt (DBI.fromInt 98)))
...
erlps__is_builtin_fun__2 [(ErlangTuple [(ErlangAtom "id"), _,
  ...
  , ((ErlangInt num_2) == (ErlangInt (DBI.fromInt 113)))
...
erlps__is_builtin_fun__2 [(ErlangTuple [(ErlangAtom "qid"), _,
  ...
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 103)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 105)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 115)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 116)))
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 114))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2 [(ErlangTuple [(ErlangAtom "qid"), _,
                                        (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangEmptyList))))))) (ErlangCons (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangCons (ErlangInt num_11) (ErlangCons (ErlangInt num_12) (ErlangCons (ErlangInt num_13) (ErlangCons (ErlangInt num_14) (ErlangEmptyList)))))))))) (ErlangEmptyList)))]),
                          _icode_15]
  ...
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 114)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 121)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 95)))
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 102)))
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_14) == (ErlangInt (DBI.fromInt 101))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2 [(ErlangTuple [(ErlangAtom "qid"), _,
                                        (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangEmptyList))))))) (ErlangCons (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangEmptyList)))))) (ErlangEmptyList)))]),
...
erlps__is_builtin_fun__2 args =
  (erlps__is_builtin_fun__2__p1 args)

erlps__is_builtin_fun__2__p1 :: ErlangFun
erlps__is_builtin_fun__2__p1 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
                                            (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangEmptyList))))))) (ErlangCons (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangCons (ErlangInt num_11) (ErlangEmptyList))))))) (ErlangEmptyList)))]),
                              _icode_12]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 79)))
  ...
  , ((ErlangInt num_5) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_6) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 120)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 116)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 110)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 100))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p1 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
                                            (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangEmptyList))))))) (ErlangCons (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangCons (ErlangInt num_11) (ErlangCons (ErlangInt num_12) (ErlangEmptyList)))))))) (ErlangEmptyList)))]),
  ...
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 112)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 111)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 110)))
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 100))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p1 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
  ...
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 116)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 95)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 113)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 117)))
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 115)))
  , ((ErlangInt num_14) == (ErlangInt (DBI.fromInt 116)))
  , ((ErlangInt num_15) == (ErlangInt (DBI.fromInt 105)))
  , ((ErlangInt num_16) == (ErlangInt (DBI.fromInt 111)))
  , ((ErlangInt num_17) == (ErlangInt (DBI.fromInt 110))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p1 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
  ...
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 119)))
  , ((ErlangInt num_14) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_15) == (ErlangInt (DBI.fromInt 114))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p1 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
                                            (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangEmptyList))))))) (ErlangCons (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangEmptyList)))))) (ErlangEmptyList)))]),
  ...
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 104)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 107))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p1 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
                                            (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangEmptyList))))))) (ErlangCons (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangCons (ErlangInt num_11) (ErlangCons (ErlangInt num_12) (ErlangCons (ErlangInt num_13) (ErlangCons (ErlangInt num_14) (ErlangCons (ErlangInt num_15) (ErlangCons (ErlangInt num_16) (ErlangEmptyList)))))))))))) (ErlangEmptyList)))]),
  ...
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 107)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 95)))
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 113)))
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 117)))
  , ((ErlangInt num_14) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_15) == (ErlangInt (DBI.fromInt 114)))
  , ((ErlangInt num_16) == (ErlangInt (DBI.fromInt 121))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p1 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
                                            (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangEmptyList))))) (ErlangCons (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangEmptyList)))))))) (ErlangEmptyList)))]),
  ...
  , ((ErlangInt num_2) == (ErlangInt (DBI.fromInt 78)))
  ...
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 111)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 108)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 118)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 101))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p1 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
...
erlps__is_builtin_fun__2__p1 [(ErlangTuple [(ErlangAtom "qid"),
  ...
  , ((ErlangInt num_6) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 105)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 109))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p1 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
                                            (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangEmptyList))))) (ErlangCons (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangCons (ErlangInt num_11) (ErlangEmptyList))))))))) (ErlangEmptyList)))]),
  ...
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 115)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 102)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 114))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p1 args =
  (erlps__is_builtin_fun__2__p2 args)

erlps__is_builtin_fun__2__p2 :: ErlangFun
erlps__is_builtin_fun__2__p2 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
                                            (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangEmptyList))))) (ErlangCons (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangEmptyList))))))) (ErlangEmptyList)))]),
                              _icode_10]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 65)))
  ...
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 111)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 107)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 101))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p2 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
...
erlps__is_builtin_fun__2__p2 [(ErlangTuple [(ErlangAtom "qid"),
  ...
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 102)))
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_14) == (ErlangInt (DBI.fromInt 117)))
  , ((ErlangInt num_15) == (ErlangInt (DBI.fromInt 108)))
  , ((ErlangInt num_16) == (ErlangInt (DBI.fromInt 116))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p2 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
  ...
  , ((ErlangInt num_5) == (ErlangInt (DBI.fromInt 109)))
  , ((ErlangInt num_6) == (ErlangInt (DBI.fromInt 98)))
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 114))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p2 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
  ...
  , ((ErlangInt num_3) == (ErlangInt (DBI.fromInt 115)))
  , ((ErlangInt num_4) == (ErlangInt (DBI.fromInt 105)))
  , ((ErlangInt num_5) == (ErlangInt (DBI.fromInt 122)))
  , ((ErlangInt num_6) == (ErlangInt (DBI.fromInt 101))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p2 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
...
erlps__is_builtin_fun__2__p2 [(ErlangTuple [(ErlangAtom "qid"),
  ...
  , ((ErlangInt num_3) == (ErlangInt (DBI.fromInt 116)))
  , ((ErlangInt num_4) == (ErlangInt (DBI.fromInt 111)))
  , ((ErlangInt num_5) == (ErlangInt (DBI.fromInt 95)))
  , ((ErlangInt num_6) == (ErlangInt (DBI.fromInt 108)))
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 105)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 115)))
...
erlps__is_builtin_fun__2__p2 [(ErlangTuple [(ErlangAtom "qid"),
  ...
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 67)))
  , ((ErlangInt num_1) == (ErlangInt (DBI.fromInt 114)))
  , ((ErlangInt num_2) == (ErlangInt (DBI.fromInt 121)))
  ...
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 95)))
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 115)))
  , ((ErlangInt num_14) == (ErlangInt (DBI.fromInt 105)))
...
erlps__is_builtin_fun__2__p2 [(ErlangTuple [(ErlangAtom "qid"),
  ...
  , ((ErlangInt num_14) == (ErlangInt (DBI.fromInt 105)))
  , ((ErlangInt num_15) == (ErlangInt (DBI.fromInt 103)))
  , ((ErlangInt num_16) == (ErlangInt (DBI.fromInt 95)))
  , ((ErlangInt num_17) == (ErlangInt (DBI.fromInt 115)))
  , ((ErlangInt num_18) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_19) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_20) == (ErlangInt (DBI.fromInt 112)))
  , ((ErlangInt num_21) == (ErlangInt (DBI.fromInt 50)))
  , ((ErlangInt num_22) == (ErlangInt (DBI.fromInt 53)))
  , ((ErlangInt num_23) == (ErlangInt (DBI.fromInt 54)))
  , ((ErlangInt num_24) == (ErlangInt (DBI.fromInt 107)))
  , ((ErlangInt num_25) == (ErlangInt (DBI.fromInt 49))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p2 args =
  (erlps__is_builtin_fun__2__p3 args)

erlps__is_builtin_fun__2__p3 :: ErlangFun
erlps__is_builtin_fun__2__p3 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
  ...
  , ((ErlangInt num_6) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 118)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 114)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 105)))
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 102)))
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 121)))
  , ((ErlangInt num_14) == (ErlangInt (DBI.fromInt 95)))
  , ((ErlangInt num_15) == (ErlangInt (DBI.fromInt 115)))
  , ((ErlangInt num_16) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_17) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_18) == (ErlangInt (DBI.fromInt 112)))
  , ((ErlangInt num_19) == (ErlangInt (DBI.fromInt 50)))
  , ((ErlangInt num_20) == (ErlangInt (DBI.fromInt 53)))
  , ((ErlangInt num_21) == (ErlangInt (DBI.fromInt 54)))
  , ((ErlangInt num_22) == (ErlangInt (DBI.fromInt 107)))
  , ((ErlangInt num_23) == (ErlangInt (DBI.fromInt 49))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p3 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
  ...
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 111)))
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 118)))
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_14) == (ErlangInt (DBI.fromInt 114)))
  , ((ErlangInt num_15) == (ErlangInt (DBI.fromInt 95)))
  , ((ErlangInt num_16) == (ErlangInt (DBI.fromInt 115)))
  , ((ErlangInt num_17) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_18) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_19) == (ErlangInt (DBI.fromInt 112)))
  , ((ErlangInt num_20) == (ErlangInt (DBI.fromInt 50)))
  , ((ErlangInt num_21) == (ErlangInt (DBI.fromInt 53)))
  , ((ErlangInt num_22) == (ErlangInt (DBI.fromInt 54)))
  , ((ErlangInt num_23) == (ErlangInt (DBI.fromInt 107)))
  , ((ErlangInt num_24) == (ErlangInt (DBI.fromInt 49))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p3 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
                                            (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangEmptyList))))))) (ErlangCons (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangEmptyList))))) (ErlangEmptyList)))]),
  ...
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 104)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 51))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p3 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
                                            (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangEmptyList))))))) (ErlangCons (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangCons (ErlangInt num_11) (ErlangEmptyList))))))) (ErlangEmptyList)))]),
  ...
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 104)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 50)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 53)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 54))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p3 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
                                            (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangEmptyList))))))) (ErlangCons (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangCons (ErlangInt num_11) (ErlangCons (ErlangInt num_12) (ErlangEmptyList)))))))) (ErlangEmptyList)))]),
  ...
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 107)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 50)))
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 98))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p3 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
                                            (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangEmptyList))))))) (ErlangCons (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangCons (ErlangInt num_11) (ErlangEmptyList))))))) (ErlangEmptyList)))]),
...
erlps__is_builtin_fun__2__p3 [(ErlangTuple [(ErlangAtom "qid"),
  ...
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 110)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 103)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 116)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 104))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p3 [(ErlangTuple [(ErlangAtom "qid"),
...
erlps__is_builtin_fun__2__p3 [(ErlangTuple [(ErlangAtom "qid"),
  ...
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p3 args =
  (erlps__is_builtin_fun__2__p4 args)

erlps__is_builtin_fun__2__p4 :: ErlangFun
erlps__is_builtin_fun__2__p4 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
                                            (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangEmptyList))))) (ErlangCons (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangEmptyList))))) (ErlangEmptyList)))]),
                              _icode_8]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 66)))
...
erlps__is_builtin_fun__2__p4 [(ErlangTuple [(ErlangAtom "qid"),
  ...
  , ((ErlangInt num_5) == (ErlangInt (DBI.fromInt 108)))
  , ((ErlangInt num_6) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 114))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p4 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
...
erlps__is_builtin_fun__2__p4 [(ErlangTuple [(ErlangAtom "qid"),
  ...
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 116)))
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 105)))
  , ((ErlangInt num_14) == (ErlangInt (DBI.fromInt 111)))
  , ((ErlangInt num_15) == (ErlangInt (DBI.fromInt 110))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p4 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
                                            (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangEmptyList))))) (ErlangCons (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangCons (ErlangInt num_11) (ErlangCons (ErlangInt num_12) (ErlangCons (ErlangInt num_13) (ErlangEmptyList))))))))))) (ErlangEmptyList)))]),
  ...
  , ((ErlangInt num_2) == (ErlangInt (DBI.fromInt 116)))
  , ((ErlangInt num_3) == (ErlangInt (DBI.fromInt 115)))
  , ((ErlangInt num_4) == (ErlangInt (DBI.fromInt 100)))
  ...
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 110)))
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 101))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p4 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
  ...
  , ((ErlangInt num_3) == (ErlangInt (DBI.fromInt 115)))
  , ((ErlangInt num_4) == (ErlangInt (DBI.fromInt 115)))
  , ((ErlangInt num_5) == (ErlangInt (DBI.fromInt 117)))
  , ((ErlangInt num_6) == (ErlangInt (DBI.fromInt 109))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p4 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
...
erlps__is_builtin_fun__2__p4 [(ErlangTuple [(ErlangAtom "qid"),
  ...
  , ((ErlangInt num_6) == (ErlangInt (DBI.fromInt 115)))
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 116)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 111)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 95)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 115)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 116)))
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 114))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p4 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
                                            (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangCons (ErlangInt num_6) (ErlangEmptyList)))))))) (ErlangCons (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangCons (ErlangInt num_11) (ErlangCons (ErlangInt num_12) (ErlangCons (ErlangInt num_13) (ErlangCons (ErlangInt num_14) (ErlangCons (ErlangInt num_15) (ErlangEmptyList)))))))))) (ErlangEmptyList)))]),
  ...
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_14) == (ErlangInt (DBI.fromInt 108)))
  , ((ErlangInt num_15) == (ErlangInt (DBI.fromInt 101))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p4 args =
  (erlps__is_builtin_fun__2__p5 args)

erlps__is_builtin_fun__2__p5 :: ErlangFun
erlps__is_builtin_fun__2__p5 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
                                            (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangCons (ErlangInt num_6) (ErlangEmptyList)))))))) (ErlangCons (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangCons (ErlangInt num_11) (ErlangCons (ErlangInt num_12) (ErlangCons (ErlangInt num_13) (ErlangCons (ErlangInt num_14) (ErlangCons (ErlangInt num_15) (ErlangCons (ErlangInt num_16) (ErlangCons (ErlangInt num_17) (ErlangEmptyList)))))))))))) (ErlangEmptyList)))]),
                              _icode_18]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 65)))
  ...
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 116)))
  , ((ErlangInt num_14) == (ErlangInt (DBI.fromInt 114)))
  , ((ErlangInt num_15) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_16) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_17) == (ErlangInt (DBI.fromInt 116))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p5 [(ErlangTuple [(ErlangAtom "qid"),
                                            _,
                                            (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangCons (ErlangInt num_6) (ErlangEmptyList)))))))) (ErlangCons (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangCons (ErlangInt num_11) (ErlangCons (ErlangInt num_12) (ErlangCons (ErlangInt num_13) (ErlangCons (ErlangInt num_14) (ErlangCons (ErlangInt num_15) (ErlangCons (ErlangInt num_16) (ErlangEmptyList))))))))))) (ErlangEmptyList)))]),
  ...
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 115)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 95)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 112)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 121)))
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_14) == (ErlangInt (DBI.fromInt 98)))
  , ((ErlangInt num_15) == (ErlangInt (DBI.fromInt 108)))
  , ((ErlangInt num_16) == (ErlangInt (DBI.fromInt 101))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p5 [(ErlangTuple [(ErlangAtom "qid"),
...
erlps__is_builtin_fun__2__p5 [(ErlangTuple [(ErlangAtom "qid"),
  ...
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 116))) =
  (ErlangAtom "true")
erlps__is_builtin_fun__2__p5 [_, _] = (ErlangAtom "false")
erlps__is_builtin_fun__2__p5 [arg_0, arg_1] =
  (EXC.function_clause unit)
erlps__is_builtin_fun__2__p5 args =
  (EXC.badarity
     (ErlangFun 2 (\ _ -> (ErlangAtom "purs_tco_sucks"))) args)
...
erlps__builtin_code__6 [_,
  ...
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 110)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 100))) =
  let    arg_14 = (erlps__ast_body__2 [amount_11, icode_12])
...
erlps__builtin_code__6 [_,
  ...
  in let
    tup_el_18 =
      (BIF.maps__get__2 [(ErlangAtom "event_type"), icode_14])
...
erlps__builtin_code__6 [_,
  ...
  , ((ErlangInt num_14) == (ErlangInt (DBI.fromInt 114)))
  , ((ErlangInt num_16) == (ErlangInt (DBI.fromInt 111)))
  , ((ErlangInt num_17) == (ErlangInt (DBI.fromInt 114)))
  , ((ErlangInt num_18) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_19) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_20) == (ErlangInt (DBI.fromInt 108)))
  , ((ErlangInt num_21) == (ErlangInt (DBI.fromInt 101))) =
  let    _ = (erlps__check_oracle_type__2 [ann_0, oracletype_24])
  in let match_expr_33 = (erlps__get_signature_arg__1 [args_15])
  in
    case match_expr_33 of
      (ErlangTuple [sign_29,
        ...
        in
          (erlps__prim_call__5
             [(ErlangInt (DBI.fromInt 100)), arg_35,
              (ErlangCons head_39
                 (ErlangCons head_43
                    (ErlangCons head_47
                       (ErlangCons head_51
...
erlps__builtin_code__6 [_,
  ...
  in
    (erlps__prim_call__5
       [(ErlangInt (DBI.fromInt 106)), arg_18,
...
erlps__builtin_code__6 [_,
  ...
  in
    (erlps__prim_call__5
       [(ErlangInt (DBI.fromInt 101)), arg_23,
        (ErlangCons head_27
           (ErlangCons head_31
        ...
        (ErlangAtom "word")])
erlps__builtin_code__6 args = (erlps__builtin_code__6__p1 args)

erlps__builtin_code__6__p1 :: ErlangFun
erlps__builtin_code__6__p1 [_,
                            (ErlangTuple [(ErlangAtom "qid"), _,
                                          (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangEmptyList))))))) (ErlangCons (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangCons (ErlangInt num_11) (ErlangEmptyList))))))) (ErlangEmptyList)))]),
                            args_12,
  ...
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 110)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 100))) =
  let match_expr_18 = (erlps__get_signature_arg__1 [args_12])
  in
    case match_expr_18 of
      (ErlangTuple [sign_15,
        ...
        in let
          arg_44 = (ErlangTuple [(ErlangAtom "tuple"), ErlangEmptyList])
        in
          (erlps__prim_call__5
             [(ErlangInt (DBI.fromInt 103)), arg_20,
              (ErlangCons head_24
...
erlps__builtin_code__6__p1 [_,
  ...
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 111)))
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 110)))
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 100))) =
  let    _ = (erlps__check_oracle_type__2 [ann_0, oracletype_15])
  in let match_expr_25 = (erlps__get_signature_arg__1 [args_14])
  in
    case match_expr_25 of
      (ErlangTuple [sign_21,
        ...
        in let
          arg_58 = (ErlangTuple [(ErlangAtom "tuple"), ErlangEmptyList])
        in
          (erlps__prim_call__5
             [(ErlangInt (DBI.fromInt 102)), arg_27,
              (ErlangCons head_31
                 (ErlangCons head_35
...
erlps__builtin_code__6__p1 [_,
  ...
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 116)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 95)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 113)))
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 117)))
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_14) == (ErlangInt (DBI.fromInt 115)))
  , ((ErlangInt num_15) == (ErlangInt (DBI.fromInt 116)))
  , ((ErlangInt num_16) == (ErlangInt (DBI.fromInt 105)))
  , ((ErlangInt num_17) == (ErlangInt (DBI.fromInt 111)))
  , ((ErlangInt num_18) == (ErlangInt (DBI.fromInt 110)))
  , ((ErlangInt num_22) == (ErlangInt (DBI.fromInt 111)))
  , ((ErlangInt num_23) == (ErlangInt (DBI.fromInt 114)))
  , ((ErlangInt num_24) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_25) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_26) == (ErlangInt (DBI.fromInt 108)))
  , ((ErlangInt num_27) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_28) == (ErlangInt (DBI.fromInt 95)))
  , ((ErlangInt num_29) == (ErlangInt (DBI.fromInt 113)))
  , ((ErlangInt num_30) == (ErlangInt (DBI.fromInt 117)))
  , ((ErlangInt num_31) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_32) == (ErlangInt (DBI.fromInt 114)))
  , ((ErlangInt num_33) == (ErlangInt (DBI.fromInt 121))) =
  ...
  in
    (erlps__prim_call__5
       [(ErlangInt (DBI.fromInt 105)), arg_39,
        (ErlangCons head_43 (ErlangCons head_47 ErlangEmptyList)),
        (ErlangCons (ErlangAtom "word")
           (ErlangCons (ErlangAtom "word") ErlangEmptyList)),
        arg_56])
erlps__builtin_code__6__p1 [_,
  ...
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 110)))
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 115)))
  , ((ErlangInt num_14) == (ErlangInt (DBI.fromInt 119)))
  , ((ErlangInt num_15) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_16) == (ErlangInt (DBI.fromInt 114)))
  , ((ErlangInt num_20) == (ErlangInt (DBI.fromInt 111)))
  , ((ErlangInt num_21) == (ErlangInt (DBI.fromInt 114)))
  , ((ErlangInt num_22) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_23) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_24) == (ErlangInt (DBI.fromInt 108)))
  , ((ErlangInt num_25) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_26) == (ErlangInt (DBI.fromInt 95)))
  , ((ErlangInt num_27) == (ErlangInt (DBI.fromInt 113)))
  , ((ErlangInt num_28) == (ErlangInt (DBI.fromInt 117)))
  , ((ErlangInt num_29) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_30) == (ErlangInt (DBI.fromInt 114)))
  , ((ErlangInt num_31) == (ErlangInt (DBI.fromInt 121))) =
  ...
  in
    (erlps__prim_call__5
       [(ErlangInt (DBI.fromInt 104)), arg_37,
...
erlps__builtin_code__6__p1 [_,
  ...
  , ((ErlangInt num_6) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 104)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 107)))
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 111)))
  , ((ErlangInt num_14) == (ErlangInt (DBI.fromInt 114)))
  , ((ErlangInt num_15) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_16) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_17) == (ErlangInt (DBI.fromInt 108)))
  , ((ErlangInt num_18) == (ErlangInt (DBI.fromInt 101))) =
  let    _ = (erlps__check_oracle_type__2 [ann_0, oracletype_21])
  in let
    arg_26 =
  ...
  in
    (erlps__prim_call__5
       [(ErlangInt (DBI.fromInt 110)), arg_26,
        (ErlangCons head_30
...
erlps__builtin_code__6__p1 [_,
  ...
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 107)))
  , ((ErlangInt num_12) == (ErlangInt (DBI.fromInt 95)))
  , ((ErlangInt num_13) == (ErlangInt (DBI.fromInt 113)))
  , ((ErlangInt num_14) == (ErlangInt (DBI.fromInt 117)))
  , ((ErlangInt num_15) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_16) == (ErlangInt (DBI.fromInt 114)))
  , ((ErlangInt num_17) == (ErlangInt (DBI.fromInt 121)))
  , ((ErlangInt num_21) == (ErlangInt (DBI.fromInt 111)))
  , ((ErlangInt num_22) == (ErlangInt (DBI.fromInt 114)))
  , ((ErlangInt num_23) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_24) == (ErlangInt (DBI.fromInt 99)))
  , ((ErlangInt num_25) == (ErlangInt (DBI.fromInt 108)))
  , ((ErlangInt num_26) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_27) == (ErlangInt (DBI.fromInt 95)))
  , ((ErlangInt num_28) == (ErlangInt (DBI.fromInt 113)))
  , ((ErlangInt num_29) == (ErlangInt (DBI.fromInt 117)))
  , ((ErlangInt num_30) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_31) == (ErlangInt (DBI.fromInt 114)))
  , ((ErlangInt num_32) == (ErlangInt (DBI.fromInt 121))) =
  ...
  in
    (erlps__prim_call__5
       [(ErlangInt (DBI.fromInt 111)), arg_39,
        (ErlangCons head_43
           (ErlangCons head_47
...
erlps__builtin_code__6__p1 [_,
  ...
  , ((ErlangInt num_2) == (ErlangInt (DBI.fromInt 69)))
  , ((ErlangInt num_3) == (ErlangInt (DBI.fromInt 78)))
  , ((ErlangInt num_4) == (ErlangInt (DBI.fromInt 83)))
  , ((ErlangInt num_5) == (ErlangInt (DBI.fromInt 114)))
  , ((ErlangInt num_6) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 115)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 111)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 108)))
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 118)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_14) == (ErlangInt (DBI.fromInt 111)))
  , ((ErlangInt num_15) == (ErlangInt (DBI.fromInt 112)))
  , ((ErlangInt num_16) == (ErlangInt (DBI.fromInt 116)))
  , ((ErlangInt num_17) == (ErlangInt (DBI.fromInt 105)))
  , ((ErlangInt num_18) == (ErlangInt (DBI.fromInt 111)))
  , ((ErlangInt num_19) == (ErlangInt (DBI.fromInt 110))) =
    ...
    case case_22 of
      (ErlangAtom "true") ->
        ...
        in let
          _ =
            case case_24 of
              t_27 | ((ErlangAtom "true") ==
                        (H.falsifyErrors
                           (\ _ ->
                              let
                                lop_28 =
                                  (BIF.erlang__op_eq
                                     [t_27, (ErlangAtom "word")])
                              in
                                case lop_28 of
                                  (ErlangAtom "true") -> (ErlangAtom "true")
                                  (ErlangAtom "false") ->
                                    (BIF.erlang__op_eq
                                       [t_27, (ErlangAtom "string")])
              ...
              _ ->
                let
                  arg_33 =
                    (ErlangTuple
                       [(ErlangAtom "invalid_aens_resolve_type"), ann_0,
                        type_20])
                in (erlps__gen_error__1 [arg_33])
        in let
          arg_38 =
            (ErlangTuple
               [(ErlangAtom "integer"), (ErlangInt (DBI.fromInt 0))])
        in let head_42 = (erlps__ast_body__2 [name_12, icode_21])
        in let head_46 = (erlps__ast_body__2 [key_13, icode_21])
        in let head_50 = (erlps__ast_type_value__2 [type_20, icode_21])
        in let arg_62 = (erlps__ast_type__2 [type_20, icode_21])
        in let
          arg_61 =
            (BIF.do_remote_fun_call "Aeso.Icode" "erlps__option_typerep__1"
               [arg_62])
        in
          (erlps__prim_call__5
             [(ErlangInt (DBI.fromInt 200)), arg_38,
              (ErlangCons head_42
  ...
  in
    case match_expr_18 of
      (ErlangTuple [sign_15,
        ...
        in let
          arg_43 = (ErlangTuple [(ErlangAtom "tuple"), ErlangEmptyList])
        in
          (erlps__prim_call__5
             [(ErlangInt (DBI.fromInt 201)), arg_20,
              (ErlangCons head_24
                 (ErlangCons head_28 (ErlangCons head_32 ErlangEmptyList))),
              (ErlangCons (ErlangAtom "word")
                 (ErlangCons (ErlangAtom "word")
...
erlps__builtin_code__6__p1 [_,
  ...
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 105)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 109))) =
  let match_expr_17 = (erlps__get_signature_arg__1 [args_9])
  in
    case match_expr_17 of
      (ErlangTuple [sign_12,
        ...
        in let head_52 = (erlps__sign_t__0 [])
        in let
          arg_54 = (ErlangTuple [(ErlangAtom "tuple"), ErlangEmptyList])
        in
          (erlps__prim_call__5
             [(ErlangInt (DBI.fromInt 202)), arg_19,
              (ErlangCons head_23
                 (ErlangCons head_27
                    (ErlangCons head_31
                       (ErlangCons head_35
...
erlps__builtin_code__6__p1 [_,
  ...
  , ((ErlangInt num_10) == (ErlangInt (DBI.fromInt 101)))
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 114))) =
  let match_expr_19 = (erlps__get_signature_arg__1 [args_12])
  in
    case match_expr_19 of
      (ErlangTuple [sign_15,
        ...
        in let
          arg_50 = (ErlangTuple [(ErlangAtom "tuple"), ErlangEmptyList])
        in
          (erlps__prim_call__5
             [(ErlangInt (DBI.fromInt 204)), arg_21,
              (ErlangCons head_25
                 (ErlangCons head_29
...
erlps__builtin_code__6__p1 args =
  (erlps__builtin_code__6__p2 args)

erlps__builtin_code__6__p2 :: ErlangFun
erlps__builtin_code__6__p2 [_,
                            (ErlangTuple [(ErlangAtom "qid"), _,
                                          (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangEmptyList))))) (ErlangCons (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangEmptyList))))))) (ErlangEmptyList)))]),
  ...
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 107)))
  , ((ErlangInt num_9) == (ErlangInt (DBI.fromInt 101))) =
  let match_expr_16 = (erlps__get_signature_arg__1 [args_10])
  in
    case match_expr_16 of
      (ErlangTuple [sign_13,
        ...
        in let head_39 = (erlps__sign_t__0 [])
        in let
          arg_41 = (ErlangTuple [(ErlangAtom "tuple"), ErlangEmptyList])
        in
          (erlps__prim_call__5
             [(ErlangInt (DBI.fromInt 205)), arg_18,
              (ErlangCons head_22
...
erlps__builtin_code__6__p2 [_,
  ...
  let
    match_expr_24 =
      (erlps__check_monomorphic_map__2 [map_18, icode_20])
  in
    case match_expr_24 of
      (ErlangTuple [_, valtype_23]) ->
        ...
        in let
          fun_29 =
            (ErlangTuple [(ErlangAtom "map_lookup_default"), tup_el_26])
...
erlps__builtin_code__6__p2 [_,
                            (ErlangTuple [(ErlangAtom "qid"), ann_0,
                                          (ErlangCons (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangEmptyList)))) (ErlangCons (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangCons (ErlangInt num_11) (ErlangCons (ErlangInt num_12) (ErlangEmptyList)))))))))) (ErlangEmptyList)))]),
                            (ErlangCons list_13 (ErlangEmptyList)), _,
                            maptype_14, icode_15]
  | ((ErlangInt num_1) == (ErlangInt (DBI.fromInt 77)))
  , ((ErlangInt num_2) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_3) == (ErlangInt (DBI.fromInt 112)))
  , ((ErlangInt num_4) == (ErlangInt (DBI.fromInt 102)))
  , ((ErlangInt num_5) == (ErlangInt (DBI.fromInt 114)))
  , ((ErlangInt num_6) == (ErlangInt (DBI.fromInt 111)))
  , ((ErlangInt num_7) == (ErlangInt (DBI.fromInt 109)))
  , ((ErlangInt num_8) == (ErlangInt (DBI.fromInt 95)))
  ...
  in
    case match_expr_21 of
      (ErlangTuple [keytype_19, valtype_20]) ->
        ...
        in let
          head_28 =
            (erlps__map_empty__3 [keytype_19, valtype_20, icode_15])
        in
          (erlps__builtin_call__2
...
erlps__builtin_code__6__p2 [_,
                            (ErlangTuple [(ErlangAtom "qid"), _,
                                          (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangEmptyList)))) (ErlangCons (ErlangCons (ErlangInt num_3) (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangEmptyList)))))))) (ErlangEmptyList)))]),
                            (ErlangCons map_10 (ErlangEmptyList)), _, _,
                            icode_11]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 77)))
  , ((ErlangInt num_1) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_2) == (ErlangInt (DBI.fromInt 112)))
...
erlps__builtin_code__6__p2 [_,
  ...
  in
    (erlps__prim_call__5
       [(ErlangInt (DBI.fromInt 400)), arg_21,
        (ErlangCons head_25
...
erlps__builtin_code__6__p2 [_,
  ...
  in let
    head_48 = (erlps__bytes_t__1 [(ErlangInt (DBI.fromInt 32))])
  in let
    head_51 = (erlps__bytes_t__1 [(ErlangInt (DBI.fromInt 64))])
  in let
    head_54 = (erlps__bytes_t__1 [(ErlangInt (DBI.fromInt 64))])
  in
    (erlps__prim_call__5
       [(ErlangInt (DBI.fromInt 410)), arg_31,
        (ErlangCons head_35
           (ErlangCons head_39 (ErlangCons head_43 ErlangEmptyList))),
        (ErlangCons head_48
        ...
        (ErlangAtom "word")])
erlps__builtin_code__6__p2 args =
  (erlps__builtin_code__6__p3 args)

erlps__builtin_code__6__p3 :: ErlangFun
erlps__builtin_code__6__p3 [_,
                            (ErlangTuple [(ErlangAtom "qid"), _,
                                          (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangEmptyList))))))) (ErlangCons (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangCons (ErlangInt num_11) (ErlangCons (ErlangInt num_12) (ErlangCons (ErlangInt num_13) (ErlangCons (ErlangInt num_14) (ErlangCons (ErlangInt num_15) (ErlangCons (ErlangInt num_16) (ErlangCons (ErlangInt num_17) (ErlangCons (ErlangInt num_18) (ErlangCons (ErlangInt num_19) (ErlangCons (ErlangInt num_20) (ErlangCons (ErlangInt num_21) (ErlangCons (ErlangInt num_22) (ErlangCons (ErlangInt num_23) (ErlangEmptyList))))))))))))))))))) (ErlangEmptyList)))]),
  ...
  in let
    head_48 = (erlps__bytes_t__1 [(ErlangInt (DBI.fromInt 20))])
  in let
    head_51 = (erlps__bytes_t__1 [(ErlangInt (DBI.fromInt 65))])
  in
    (erlps__prim_call__5
       [(ErlangInt (DBI.fromInt 420)), arg_29,
        (ErlangCons head_33
...
erlps__builtin_code__6__p3 [_,
  ...
  in let
    head_44 = (erlps__bytes_t__1 [(ErlangInt (DBI.fromInt 65))])
  in let
    arg_48 = (erlps__bytes_t__1 [(ErlangInt (DBI.fromInt 20))])
  in let
    arg_47 =
      (BIF.do_remote_fun_call "Aeso.Icode" "erlps__option_typerep__1"
         [arg_48])
  in
    (erlps__prim_call__5
       [(ErlangInt (DBI.fromInt 421)), arg_29,
        (ErlangCons head_33 (ErlangCons head_37 ErlangEmptyList)),
        (ErlangCons (ErlangAtom "word")
           (ErlangCons head_44 ErlangEmptyList)),
        arg_47])
          ...
          (\ _ ->
             ...
             in let
               lop_17 =
                 case lop_18 of
                   (ErlangAtom "true") -> (ErlangAtom "true")
                   (ErlangAtom "false") ->
                     let rop_22 = (H.make_string "sha256")
             ...
             in
               case lop_17 of
                 (ErlangAtom "true") -> (ErlangAtom "true")
                 (ErlangAtom "false") ->
                   let rop_24 = (H.make_string "blake2b")
...
erlps__builtin_code__6__p3 [_,
                            (ErlangTuple [(ErlangAtom "qid"), _,
                                          (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangEmptyList))))))) (ErlangCons op_6 (ErlangEmptyList)))]),
                            (ErlangCons string_7 (ErlangEmptyList)), _, _,
                            icode_8]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 83)))
  , ((ErlangInt num_1) == (ErlangInt (DBI.fromInt 116)))
  , ((ErlangInt num_2) == (ErlangInt (DBI.fromInt 114)))
          ...
          (\ _ ->
             ...
             in let
               lop_14 =
                 case lop_15 of
                   (ErlangAtom "true") -> (ErlangAtom "true")
                   (ErlangAtom "false") ->
                     let rop_19 = (H.make_string "sha256")
             ...
             in
               case lop_14 of
                 (ErlangAtom "true") -> (ErlangAtom "true")
                 (ErlangAtom "false") ->
                   let rop_21 = (H.make_string "blake2b")
...
erlps__builtin_code__6__p3 [_,
  ...
  , ((ErlangAtom "true") ==
       (H.falsifyErrors
          (\ _ ->
             let    rop_168 = (H.make_string "test")
             ...
             in let
               lop_164 =
                 case lop_165 of
                   (ErlangAtom "true") -> (ErlangAtom "true")
                   (ErlangAtom "false") ->
                     let rop_172 = (H.make_string "clear")
             ...
             in let
               lop_163 =
                 case lop_164 of
                   (ErlangAtom "true") -> (ErlangAtom "true")
                   (ErlangAtom "false") ->
                     let rop_174 = (H.make_string "union")
             ...
             in let
               lop_162 =
                 case lop_163 of
                   (ErlangAtom "true") -> (ErlangAtom "true")
                   (ErlangAtom "false") ->
                     let rop_176 = (H.make_string "intersection")
             ...
             in
               case lop_162 of
                 (ErlangAtom "true") -> (ErlangAtom "true")
                 (ErlangAtom "false") ->
                   let rop_178 = (H.make_string "difference")
         ...
         let
           lambda_59 [a_61] =
             let
               tup_el_64 =
                 (BIF.erlang__apply__2
                    [c_13, (ErlangCons a_61 ErlangEmptyList)])
             in
               (ErlangTuple
                  [(ErlangAtom "unop"), (ErlangAtom "bnot"), tup_el_64])
  ...
  in let
    tail_70 =
      (H.flmap
         (\ lc_73 ->
            let lc_ret_74 = (erlps__ast_body__2 [lc_73, icode_6])
            in (ErlangCons lc_ret_74 ErlangEmptyList))
         args_5)
  in
    case (ErlangCons fun_4 tail_70) of
      (ErlangCons (ErlangCons (ErlangInt num_77) (ErlangCons (ErlangInt num_78) (ErlangCons (ErlangInt num_79) (ErlangCons (ErlangInt num_80) (ErlangEmptyList))))) (ErlangCons bits_81 (ErlangCons ix_82 (ErlangEmptyList)))) | ((ErlangInt
        ...
        let
          arg_83 =
            (BIF.erlang__apply__2
               [bsr_58,
                (ErlangCons bits_81 (ErlangCons ix_82 ErlangEmptyList))])
        in
          (BIF.erlang__apply__2
             [and_33,
              (ErlangCons arg_83
            ...
            (BIF.erlang__apply__2
               [bsl_47,
                (ErlangCons (ErlangInt (DBI.fromInt 1))
                   (ErlangCons ix_93 ErlangEmptyList))])
        in
          (BIF.erlang__apply__2
             [or_36,
              (ErlangCons bits_92 (ErlangCons arg_95 ErlangEmptyList))])
        ...
        let   
          arg_109 =
            (BIF.erlang__apply__2
               [bsl_47,
                (ErlangCons (ErlangInt (DBI.fromInt 1))
                   (ErlangCons ix_106 ErlangEmptyList))])
        in let
          arg_108 =
            (BIF.erlang__apply__2
               [neg_67, (ErlangCons arg_109 ErlangEmptyList)])
        in
          (BIF.erlang__apply__2
             [and_33,
      ...
      (ErlangCons (ErlangCons (ErlangInt num_142) (ErlangCons (ErlangInt num_143) (ErlangCons (ErlangInt num_144) (ErlangCons (ErlangInt num_145) (ErlangCons (ErlangInt num_146) (ErlangCons (ErlangInt num_147) (ErlangCons (ErlangInt num_148) (ErlangCons (ErlangInt num_149) (ErlangCons (ErlangInt num_150) (ErlangCons (ErlangInt num_151) (ErlangEmptyList))))))))))) (ErlangCons a_152 (ErlangCons b_153 (ErlangEmptyList)))) | ((ErlangInt
        ...
        in let
          arg_155 =
            (BIF.erlang__apply__2
               [neg_67, (ErlangCons arg_156 ErlangEmptyList)])
        in
          (BIF.erlang__apply__2
             [and_33,
              (ErlangCons a_152 (ErlangCons arg_155 ErlangEmptyList))])
      something_else -> (EXC.case_clause something_else)
erlps__builtin_code__6__p3 [_,
                            (ErlangTuple [(ErlangAtom "qid"), _,
                                          (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangEmptyList))))) (ErlangCons (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangCons (ErlangInt num_6) (ErlangEmptyList)))) (ErlangEmptyList)))]),
                            (ErlangCons bits_7 (ErlangEmptyList)), _, _,
                            icode_8]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 66)))
  , ((ErlangInt num_1) == (ErlangInt (DBI.fromInt 105)))
  , ((ErlangInt num_2) == (ErlangInt (DBI.fromInt 116)))
...
erlps__builtin_code__6__p3 [_,
                            (ErlangTuple [(ErlangAtom "qid"), _,
                                          (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangEmptyList)))) (ErlangCons (ErlangCons (ErlangInt num_3) (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangEmptyList))))))) (ErlangEmptyList)))]),
                            (ErlangCons int_9 (ErlangEmptyList)), _, _,
                            icode_10]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 73)))
  , ((ErlangInt num_1) == (ErlangInt (DBI.fromInt 110)))
  , ((ErlangInt num_2) == (ErlangInt (DBI.fromInt 116)))
...
erlps__builtin_code__6__p3 [_,
                            (ErlangTuple [(ErlangAtom "qid"), _,
                                          (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangCons (ErlangInt num_6) (ErlangEmptyList)))))))) (ErlangCons (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangCons (ErlangInt num_11) (ErlangCons (ErlangInt num_12) (ErlangEmptyList))))))) (ErlangEmptyList)))]),
                            (ErlangCons addr_13 (ErlangEmptyList)), _, _,
                            icode_14]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 65)))
  , ((ErlangInt num_1) == (ErlangInt (DBI.fromInt 100)))
  , ((ErlangInt num_2) == (ErlangInt (DBI.fromInt 100)))
...
erlps__builtin_code__6__p3 args =
  (erlps__builtin_code__6__p4 args)

erlps__builtin_code__6__p4 :: ErlangFun
erlps__builtin_code__6__p4 [_,
                            (ErlangTuple [(ErlangAtom "qid"), _,
                                          (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangCons (ErlangInt num_6) (ErlangEmptyList)))))))) (ErlangCons (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangCons (ErlangInt num_11) (ErlangCons (ErlangInt num_12) (ErlangCons (ErlangInt num_13) (ErlangCons (ErlangInt num_14) (ErlangCons (ErlangInt num_15) (ErlangEmptyList)))))))))) (ErlangEmptyList)))]),
                            (ErlangCons addr_16 (ErlangEmptyList)), _, _,
                            icode_17]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 65)))
  , ((ErlangInt num_1) == (ErlangInt (DBI.fromInt 100)))
  , ((ErlangInt num_2) == (ErlangInt (DBI.fromInt 100)))
  ...
  in
    (erlps__prim_call__5
       [(ErlangInt (DBI.fromInt 600)), arg_19,
...
erlps__builtin_code__6__p4 [_,
                            (ErlangTuple [(ErlangAtom "qid"), _,
                                          (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangCons (ErlangInt num_6) (ErlangEmptyList)))))))) (ErlangCons (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangCons (ErlangInt num_11) (ErlangCons (ErlangInt num_12) (ErlangCons (ErlangInt num_13) (ErlangCons (ErlangInt num_14) (ErlangCons (ErlangInt num_15) (ErlangCons (ErlangInt num_16) (ErlangCons (ErlangInt num_17) (ErlangEmptyList)))))))))))) (ErlangEmptyList)))]),
                            (ErlangCons addr_18 (ErlangEmptyList)), _, _,
                            icode_19]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 65)))
  , ((ErlangInt num_1) == (ErlangInt (DBI.fromInt 100)))
  , ((ErlangInt num_2) == (ErlangInt (DBI.fromInt 100)))
  ...
  in
    (erlps__prim_call__5
       [(ErlangInt (DBI.fromInt 601)), arg_21,
        (ErlangCons head_25 ErlangEmptyList),
        (ErlangCons (ErlangAtom "word") ErlangEmptyList),
        (ErlangAtom "word")])
erlps__builtin_code__6__p4 [_,
                            (ErlangTuple [(ErlangAtom "qid"), _,
                                          (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangCons (ErlangInt num_6) (ErlangEmptyList)))))))) (ErlangCons (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangCons (ErlangInt num_11) (ErlangCons (ErlangInt num_12) (ErlangCons (ErlangInt num_13) (ErlangCons (ErlangInt num_14) (ErlangCons (ErlangInt num_15) (ErlangCons (ErlangInt num_16) (ErlangEmptyList))))))))))) (ErlangEmptyList)))]),
                            (ErlangCons addr_17 (ErlangEmptyList)), _, _,
                            icode_18]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 65)))
  , ((ErlangInt num_1) == (ErlangInt (DBI.fromInt 100)))
  , ((ErlangInt num_2) == (ErlangInt (DBI.fromInt 100)))
  ...
  in
    (erlps__prim_call__5
       [(ErlangInt (DBI.fromInt 610)), arg_20,
...
erlps__builtin_code__6__p4 [_,
                            (ErlangTuple [(ErlangAtom "qid"), _,
                                          (ErlangCons (ErlangCons (ErlangInt num_0) (ErlangCons (ErlangInt num_1) (ErlangCons (ErlangInt num_2) (ErlangCons (ErlangInt num_3) (ErlangCons (ErlangInt num_4) (ErlangEmptyList)))))) (ErlangCons (ErlangCons (ErlangInt num_5) (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangCons (ErlangInt num_10) (ErlangEmptyList))))))) (ErlangEmptyList)))]),
                            (ErlangCons bytes_11 (ErlangEmptyList)), _, _,
                            icode_12]
  | ((ErlangInt num_0) == (ErlangInt (DBI.fromInt 66)))
  , ((ErlangInt num_1) == (ErlangInt (DBI.fromInt 121)))
  , ((ErlangInt num_2) == (ErlangInt (DBI.fromInt 116)))
...
erlps__builtin_code__6__p4 [_as_0, fun_1, _args_2, _argst_3,
                            _rett_4, _icode_5]
  =
  let
    arg_6 = (ErlangTuple [(ErlangAtom "missing_code_for"), fun_1])
  in (erlps__gen_error__1 [arg_6])
erlps__builtin_code__6__p4 [arg_9, arg_10, arg_11, arg_12,
                            arg_13, arg_14]
  =
  (EXC.function_clause unit)
erlps__builtin_code__6__p4 args =
...
erlps__eta_expand__3 [id_1@(ErlangTuple [_, ann0_0, _]),
         ...
         (\ lc_18 ->
            case lc_18 of
              (ErlangTuple [i_16, t_17]) ->
                let    lop_26 = (H.make_string "%")
                in let rop_27 = (BIF.erlang__integer_to_list__1 [i_16])
                in let tup_el_25 = (BIF.erlang__op_append [lop_26, rop_27])
                in let
                  tup_el_22 =
                    (ErlangTuple
                       [(ErlangAtom "id"), (ErlangCons head_5 ann0_0),
                        tup_el_25])
                in let
                  lc_ret_19 =
                    (ErlangTuple
                       [(ErlangAtom "arg"), (ErlangCons head_5 ann0_0),
                        tup_el_22, t_17])
                in (ErlangCons lc_ret_19 ErlangEmptyList)
              _ -> ErlangEmptyList)
         lc_src_10)
            ...
            case lc_34 of
              (ErlangTuple [(ErlangAtom "arg"), _, x_32, t_33]) ->
                let
                  lc_ret_35 =
                    (ErlangTuple
                       [(ErlangAtom "typed"), (ErlangCons head_5 ann0_0), x_32,
                        t_33])
  ...
  in let
    tup_el_45 =
      (ErlangTuple
         [(ErlangAtom "app"), (ErlangCons head_5 ann0_0), tup_el_48,
          args_40])
  in let
    arg_41 =
      (ErlangTuple
         [(ErlangAtom "lam"), (ErlangCons head_5 ann0_0), xs_30,
          tup_el_45])
  in (erlps__ast_body__2 [arg_41, icode_4])
erlps__eta_expand__3 [id_0, _type_1, _icode_2] =
  let
    arg_3 = (ErlangTuple [(ErlangAtom "unapplied_builtin"), id_0])
  in (erlps__gen_error__1 [arg_3])
...
erlps__check_monomorphic_map__3 [ann_0,
                                 ...
                                 _icode_6]
  | ((ErlangInt num_1) == (ErlangInt (DBI.fromInt 109)))
  , ((ErlangInt num_2) == (ErlangInt (DBI.fromInt 97)))
  , ((ErlangInt num_3) == (ErlangInt (DBI.fromInt 112))) =
  let   
    err_15 =
         ...
         let
           lambda_7 [why_9] =
             let
               arg_10 =
                 (ErlangTuple
                    [(ErlangAtom "invalid_map_key_type"), why_9, ann_0,
                     keytype_4])
        ...
        (ErlangAtom "true") ->
          let
            lc_ret_19 =
              (BIF.erlang__apply__2
                 [err_15,
                  (ErlangCons (ErlangAtom "polymorphic") ErlangEmptyList)])
          in (ErlangCons lc_ret_19 ErlangEmptyList)
        _ -> ErlangEmptyList
...
erlps__map_empty__3 [keytype_0, valtype_1, icode_2] =
  ...
  in
    (erlps__prim_call__5
       [(ErlangInt (DBI.fromInt 300)), arg_4,
  ...
  in
    case match_expr_11 of
      (ErlangTuple [_keytype_9, valtype_10]) ->
        ...
        in let
          arg_12 = (ErlangTuple [(ErlangAtom "map_lookup"), tup_el_14])
...
erlps__map_del__3 [key_0, map_1, icode_2] =
  ...
  in
    (erlps__prim_call__5
       [(ErlangInt (DBI.fromInt 303)), arg_4,
        (ErlangCons head_8 (ErlangCons head_12 ErlangEmptyList)),
        (ErlangCons (ErlangAtom "word")
           (ErlangCons (ErlangAtom "word") ErlangEmptyList)),
        (ErlangAtom "word")])
...
erlps__map_tolist__2 [map_0, icode_1] =
  let
    match_expr_6 = (erlps__check_monomorphic_map__2 [map_0, icode_1])
  in
    case match_expr_6 of
  ...
  in
    case match_expr_10 of
      (ErlangTuple [_, valtype_9]) ->
        ...
        in let
          funname_15 = (ErlangTuple [(ErlangAtom "map_upd"), tup_el_12])
         ...
         (\ lc_26 ->
            case lc_26 of
              (ErlangTuple [(ErlangAtom "typed"), ann1_23, x_24, t_25]) ->
                let   
                  tup_el_34 =
                    (ErlangTuple [(ErlangAtom "argument"), x_24, t_25])
                in let
                  arg_29 =
                    (ErlangTuple
                       [(ErlangAtom "invalid_entrypoint"),
                        (ErlangAtom "higher_order"), ann1_23, name_1,
                        tup_el_34])
                in let
                  lc_ret_27 =
                    (BIF.erlang__apply__2
         ...
         (\ lc_53 ->
            case lc_53 of
              (ErlangTuple [(ErlangAtom "typed"), ann1_50, x_51, t_52]) ->
                let   
                  tup_el_61 =
                    (ErlangTuple [(ErlangAtom "argument"), x_51, t_52])
                in let
                  arg_56 =
                    (ErlangTuple
                       [(ErlangAtom "invalid_entrypoint"),
                        (ErlangAtom "polymorphic"), ann1_50, name_1, tup_el_61])
                in let
                  lc_ret_54 =
                    (BIF.erlang__apply__2
                       [checkmonomorphic_21,
                            ...
                            case cond_34 of
                              (ErlangAtom "true") ->
                                let   
                                  arg_39 =
                                    (ErlangTuple
                                       [(ErlangAtom "invalid_oracle_type"),
                                        why_19, which_31, ann_0, type_9])
                                in let
                                  lc_ret_38 = (erlps__gen_error__1 [arg_39])
                                in (ErlangCons lc_ret_38 ErlangEmptyList)
                              _ -> ErlangEmptyList
                        _ -> ErlangEmptyList)
...
erlps__is_monomorphic__1 [(ErlangCons h_0 t_1)] =
  ...
  in
    case lop_2 of
      ...
      _ -> (EXC.badarg1 lop_2)
erlps__is_monomorphic__1 [t_0] | (H.isETuple t_0) =
  let arg_1 = (BIF.erlang__tuple_to_list__1 [t_0])
    ...
    typehash_20 =
      case case_5 of
        (ErlangAtom "true") ->
          ...
          in let
            argtype_11 = (ErlangTuple [(ErlangAtom "tuple"), argtypes_3])
          in let
            match_expr_19 =
              (BIF.do_remote_fun_call "Aeb.Aevm.Abi"
          ...
          in
            case match_expr_19 of
              (ErlangBinary bin_c_15) | size_16 <- ((DBI.fromInt 256))
                                      , (BIN.Ok th_18 bin_17) <-
                                          ((BIN.chop_int bin_c_15 size_16 1
...
erlps__generic_hash_primop__4 [op_0, arg_1, type_2, icode_3] =
  let   
    primop_5 =
      case op_0 of
        (ErlangAtom "sha3") -> (ErlangInt (DBI.fromInt 401))
        (ErlangAtom "sha256") -> (ErlangInt (DBI.fromInt 402))
        (ErlangAtom "blake2b") -> (ErlangInt (DBI.fromInt 403))
        something_else -> (EXC.case_clause something_else)
...
erlps__string_hash_primop__2 [(ErlangAtom "sha3"), string_0] =
  (ErlangTuple
     [(ErlangAtom "unop"), (ErlangAtom "sha3"), string_0])
erlps__string_hash_primop__2 [op_0, string_1] =
  let   
    primop_3 =
      case op_0 of
        (ErlangAtom "sha256") -> (ErlangInt (DBI.fromInt 404))
        (ErlangAtom "blake2b") -> (ErlangInt (DBI.fromInt 405))
        something_else -> (EXC.case_clause something_else)
  in let
    arg_5 =
      (ErlangTuple
    ...
    (ErlangFun 1
       let
         lambda_10 [types_12] =
           ...
           in let
             arg_18 =
               case (H.findMissingKey icode_4 [(ErlangAtom "type_vars")]) of
                 (DM.Nothing) -> (BIF.maps__merge__2 [icode_4, map_ext_24])
...
erlps__ast_typerep__2 [type_0, icode_1] =
  ...
  in
    case case_2 of
      (ErlangAtom "false") ->
        let
          arg_4 = (ErlangTuple [(ErlangAtom "not_a_simple_type"), type_0])
        in (erlps__gen_error__1 [arg_4])
      (ErlangAtom "true") -> (erlps__ast_typerep1__2 [type_0, icode_1])
      something_else -> (EXC.case_clause something_else)
erlps__ast_typerep__2 [arg_9, arg_10] =
  (EXC.function_clause unit)
...
erlps__ast_typerep1__2 [(ErlangTuple [(ErlangAtom "app_t"), _,
  ...
  | ((ErlangAtom "true") ==
       (H.falsifyErrors
          (\ _ ->
             let lop_14 = (BIF.erlang__op_exactEq [i_0, (ErlangAtom "id")])
             in
               case lop_14 of
                 (ErlangAtom "true") -> (ErlangAtom "true")
                 (ErlangAtom "false") ->
                   (BIF.erlang__op_exactEq [i_0, (ErlangAtom "qid")])
                 _ -> (EXC.badarg1 lop_14)))) =
  let
    argreps_10 =
      (H.flmap
         (\ lc_6 ->
            let lc_ret_7 = (erlps__ast_typerep1__2 [lc_6, icode_3])
            in (ErlangCons lc_ret_7 ErlangEmptyList))
         args_2)
...
erlps__ast_typerep1__2 [(ErlangTuple [(ErlangAtom "tuple_t"), _,
  ...
  let
    tup_el_3 =
      (H.flmap
         (\ lc_6 ->
            let lc_ret_7 = (erlps__ast_typerep1__2 [lc_6, icode_1])
            in (ErlangCons lc_ret_7 ErlangEmptyList))
         cpts_0)
  in (ErlangTuple [(ErlangAtom "tuple"), tup_el_3])
         ...
         (\ lc_6 ->
            case lc_6 of
              (ErlangTuple [(ErlangAtom "field_t"), _, _, t_8]) ->
                let lc_ret_7 = (erlps__ast_typerep1__2 [t_8, icode_1])
                in (ErlangCons lc_ret_7 ErlangEmptyList)
              _ -> (EXC.badmatch lc_6))
         fields_0)
  in (ErlangTuple [(ErlangAtom "tuple"), tup_el_3])
                  ...
                  lc_ret_7 =
                    (H.flmap
                       (\ lc_12 ->
                          let
                            lc_ret_13 =
                              (erlps__ast_typerep1__2 [lc_12, icode_1])
                          in (ErlangCons lc_ret_13 ErlangEmptyList))
                       args_8)
                in (ErlangCons lc_ret_7 ErlangEmptyList)
              _ -> (EXC.badmatch lc_6))
...
erlps__ttl_t__1 [icode_0] =
  let    head_5 = (H.make_string "Chain")
  in let head_7 = (H.make_string "ttl")
  in let
    arg_1 =
      (ErlangTuple
...
erlps__sign_t__0 [] =
  (erlps__bytes_t__1 [(ErlangInt (DBI.fromInt 64))])
...
erlps__bytes_t__1 [len_0] =
  let   
    lop_4 =
      (BIF.erlang__op_plus [(ErlangInt (DBI.fromInt 31)), len_0])
  in let
    arg_3 =
      (BIF.erlang__op_div_strict [lop_4, (ErlangInt (DBI.fromInt 32))])
  in let
    tup_el_2 =
...
erlps__get_signature_arg__1 [args0_0] =
  ...
  in let
    head_12 =
      (ErlangTuple
         [(ErlangAtom "int"), ErlangEmptyList,
...
erlps__lookup_type_id__3 [name_0, args_1, (ErlangMap map_2)]
  | (DM.Just types_3) <-
      ((Map.lookup (ErlangAtom "types") map_2)) =
  let
    case_4 =
      (BIF.do_remote_fun_call "Maps" "erlps__get__3"
  ...
  in
    case case_4 of
      ...
      tdef_11 ->
        (BIF.erlang__apply__2
           [tdef_11, (ErlangCons args_1 ErlangEmptyList)])
...
erlps__type_value__1 [(ErlangAtom "typerep")] =
  let
    head_2 =
      (ErlangTuple
         [(ErlangAtom "integer"), (ErlangInt (DBI.fromInt 5))])
  in
    (ErlangTuple
       [(ErlangAtom "tuple"), (ErlangCons head_2 ErlangEmptyList)])
erlps__type_value__1 [(ErlangTuple [(ErlangAtom "list"), a_0])] =
  let   
    head_3 =
      (ErlangTuple
         [(ErlangAtom "integer"), (ErlangInt (DBI.fromInt 2))])
...
erlps__type_value__1 [(ErlangTuple [(ErlangAtom "tuple"), as_0])]
  ...
  let   
    head_3 =
      (ErlangTuple
         [(ErlangAtom "integer"), (ErlangInt (DBI.fromInt 3))])
  in let
    tup_el_9 =
      (H.flmap
         (\ lc_12 ->
            let lc_ret_13 = (erlps__type_value__1 [lc_12])
            in (ErlangCons lc_ret_13 ErlangEmptyList))
         as_0)
...
erlps__type_value__1 [(ErlangTuple [(ErlangAtom "variant"),
  ...
  let   
    head_3 =
      (ErlangTuple
         [(ErlangAtom "integer"), (ErlangInt (DBI.fromInt 4))])
  in let
    tup_el_9 =
      (H.flmap
         (\ lc_12 ->
            let   
              tup_el_15 =
                (H.flmap
                   (\ lc_18 ->
                      let lc_ret_19 = (erlps__type_value__1 [lc_18])
                      in (ErlangCons lc_ret_19 ErlangEmptyList))
                   lc_12)
            in let lc_ret_13 = (ErlangTuple [(ErlangAtom "list"), tup_el_15])
            in (ErlangCons lc_ret_13 ErlangEmptyList))
         cs_0)
  in let head_7 = (ErlangTuple [(ErlangAtom "list"), tup_el_9])
  in
...
erlps__type_value__1 [(ErlangTuple [(ErlangAtom "map"), k_0,
  ...
  let   
    head_4 =
      (ErlangTuple
         [(ErlangAtom "integer"), (ErlangInt (DBI.fromInt 6))])
...
erlps__ast_fun_to_icode__6 [name_0, attrs_1, args_2, body_3,
  ...
  let
    head_8 =
      (ErlangTuple [name_0, attrs_1, args_2, body_3, typerep_4])
  in
      ...
      (ErlangTuple [_, _, currentnamespace_5]) ->
        ...
        in
          case lop_7 of
            ...
            _ -> (EXC.badarg1 lop_7)
      _ -> (EXC.badmatch match_expr_6)
erlps__is_private__2 [arg_14, arg_15] =
  (EXC.function_clause unit)
...
erlps__builtin_call__2 [builtin_0, args_1] =
  let   
    tup_el_5 = (ErlangTuple [(ErlangAtom "builtin"), builtin_0])
  in let
    tup_el_3 = (ErlangTuple [(ErlangAtom "var_ref"), tup_el_5])
  in (ErlangTuple [(ErlangAtom "funcall"), tup_el_3, args_1])
erlps__builtin_call__2 [arg_9, arg_10] =
  (EXC.function_clause unit)
...
erlps__add_builtins__1 [icode_2@(ErlangMap map_0)]
  ...
  in
    case (H.findMissingKey icode_2 [(ErlangAtom "functions")]) of
      (DM.Nothing) -> (BIF.maps__merge__2 [icode_2, map_ext_15])
...
erlps__deadcode_elimination__1 [icode_2@(ErlangMap map_0)]
         ...
         (\ lc_6 ->
            case lc_6 of
              (ErlangTuple [name_4, ann_5, _, _, _]) ->
                let   
                  op_arg_8 =
                    (BIF.lists__member__2 [(ErlangAtom "private"), ann_5])
                ...
                (\ lc_18 ->
                   case lc_18 of
                     (ErlangTuple [x_17, _]) ->
                       let
                         lc_ret_19 =
                           (ErlangTuple [(ErlangAtom "var_ref"), x_17])
                       in (ErlangCons lc_ret_19 ErlangEmptyList)
                     _ -> ErlangEmptyList)
                args_15)
         ...
         (\ lc_28 ->
            case lc_28 of
              (ErlangTuple [name_25, _, args_26, body_27, _]) ->
                ...
                in let lc_ret_29 = (ErlangTuple [name_25, tup_el_31])
                in (ErlangCons lc_ret_29 ErlangEmptyList)
              _ -> ErlangEmptyList)
         funs_1)
  ...
  in
    case (H.findMissingKey icode_2 [(ErlangAtom "functions")]) of
      (DM.Nothing) -> (BIF.maps__merge__2 [icode_2, map_ext_54])
  ...
  in
    case case_4 of
      ...
      (ErlangAtom "false") ->
        ...
        in let
          map_ext_28 = (ErlangMap (Map.singleton x_1 (ErlangAtom "true")))
        in let arg_24 = (BIF.maps__merge__2 [used_3, map_ext_28])
    ...
    tail_4 =
      (H.flmap
         (\ lc_8 ->
            case lc_8 of
              (ErlangTuple [p_6, b_7]) ->
                let lc_ret_9 = (ErlangTuple [(ErlangAtom "binder"), p_6, b_7])
                in (ErlangCons lc_ret_9 ErlangEmptyList)
              _ -> ErlangEmptyList)
         cases_1)
...
erlps__free_vars__1 [t_0] | (H.isETuple t_0) =
  let arg_1 = (BIF.erlang__tuple_to_list__1 [t_0])
