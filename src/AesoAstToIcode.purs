  ...
  let
    value_2 =
      case ErlangAtom "true" of
        _ | ((ErlangAtom "true") == (falsifyErrors (\ _ -> bool_0))) ->
          toErl 1
        _ -> toErl 0
...
erlps__ast_body__2__p3 [(ErlangTuple [key_0, _, bin_1]),
  ...
  | ((ErlangAtom "true") ==
       (falsifyErrors
          (\ _ ->
             let   
               lop_12 = BIF.erlang__op_eq [key_0, ErlangAtom "account_pubkey"]
             in let
               lop_11 =
                 case lop_12 of
...
erlps__ast_body__2__p6 [arg_4, arg_5] = EXC.function_clause unit
  ...
  in
    case case_22 of
      (ErlangAtom "true") ->
              ...
              t_27 | ((ErlangAtom "true") ==
                        (falsifyErrors
                           (\ _ ->
                              let
                                lop_28 =
                                  BIF.erlang__op_eq [t_27, ErlangAtom "word"]
                              in
                                case lop_28 of
                                  (ErlangAtom "true") -> ErlangAtom "true"
                                  (ErlangAtom "false") ->
        ...
        in let arg_37 = toErl 200
        in let tup_el_40 = toErl 0
        in let arg_38 = ErlangTuple [ErlangAtom "integer", tup_el_40]
