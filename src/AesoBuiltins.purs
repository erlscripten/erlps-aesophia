...
erlps__used_builtins__1 [(ErlangTuple [(ErlangAtom "funcall"),
  ...
  in
    BIF.do_remote_fun_call "Lists" "erlps__umerge__2" [arg_2, arg_6]
...
erlps__used_builtins__1 [t_0] | isETuple t_0 =
  let arg_1 = BIF.erlang__tuple_to_list__1 [t_0]
  in erlps__used_builtins__1 [arg_1]
erlps__used_builtins__1 [m_0] | isEMap m_0 =
...
erlps__builtin_deps1__1 [(ErlangAtom "map_member")] =
  let
    head_0 = ErlangTuple [ErlangAtom "map_lookup", ErlangAtom "word"]
...
erlps__builtin_deps1__1 [(ErlangTuple [(ErlangAtom "map_upd_default"),
  ...
  =
  let
    head_1 = ErlangTuple [ErlangAtom "map_lookup_default", type_0]
  in
    ErlangCons head_1
      (ErlangCons (ErlangAtom "map_put") ErlangEmptyList)
...
erlps__builtin_deps1__1 [(ErlangAtom "int_to_str")] =
  let    tup_el_2 = toErl 10
  in let head_0 = ErlangTuple [ErlangAtom "baseX_int", tup_el_2]
  in ErlangCons head_0 ErlangEmptyList
erlps__builtin_deps1__1 [(ErlangAtom "addr_to_str")] =
  let    tup_el_2 = toErl 58
  in let head_0 = ErlangTuple [ErlangAtom "baseX_int", tup_el_2]
  in ErlangCons head_0 ErlangEmptyList
...
erlps__builtin_deps1__1 [(ErlangTuple [(ErlangAtom "baseX_int_encode"),
                                       x_0])]
  =
  let    head_1 = ErlangTuple [ErlangAtom "baseX_int_encode_", x_0]
...
erlps__builtin_deps1__1 [(ErlangTuple [(ErlangAtom "bytes_to_str"),
  ...
  ErlangCons (ErlangAtom "bytes_to_str_worker")
    (ErlangCons (ErlangAtom "bytes_to_str_worker_x") ErlangEmptyList)
...
erlps__operand__1 [i_0] | isEInt i_0 =
...
erlps__check_event_type__1 [icode_0] =
  let case_1 = BIF.maps__get__2 [ErlangAtom "event_type", icode_0]
  in
    case case_1 of
      ...
      _ ->
        let
          arg_7 = ErlangTuple [ErlangAtom "event_should_be_variant_type"]
    ...
    (\ lc_6 ->
       case lc_6 of
         (ErlangTuple [(ErlangAtom "constr_t"), ann_3,
           ...
           in let
             lcSrc_7 =
               BIF.do_remote_fun_call "Lists" "erlps__zip__2" [arg_8, types_5]
           in
             flmap
               (\ lc_14 ->
                  case lc_14 of
           ...
           case ex_7 of
             (ErlangTuple [_, _, _]) ->
               let
                 arg_9 =
                   ErlangTuple
                     [evtname_0, ErlangAtom "could_not_resolve_type", type_2]
    ...
    argpats_30 =
      ErlangFun 1
        (let
           lambda_16 [ts_18] =
             let    arg_20 = toErl 0
             in let lop_22 = BIF.erlang__length__1 [ts_18]
             in let rop_24 = toErl 1
             in let arg_21 = BIF.erlang__op_minus [lop_22, rop_24]
             in let
               lcSrc_19 =
                 BIF.do_remote_fun_call "Lists" "erlps__seq__2" [arg_20, arg_21]
             in
               flmap
                 (\ lc_26 ->
                    let
      ...
      ErlangFun 1
        (let
           lambda_31 [(ErlangEmptyList)] =
             ...
             in let
               head_35 =
                 BIF.erlang__apply__2 [a_5, ErlangCons arg_36 ErlangEmptyList]
             in let head_39 = toErl 0
             in let arg_42 = toErl 96
             in let
               head_41 =
                 BIF.erlang__apply__2 [a_5, ErlangCons arg_42 ErlangEmptyList]
             in let head_45 = toErl 0
             in
               ErlangTuple
           ...
           lambda_31 [(ErlangCons (ErlangTuple [(ErlangTuple [(ErlangAtom "id"),
             ...
             in let
               head_61 =
                 BIF.erlang__apply__2 [a_5, ErlangCons arg_62 ErlangEmptyList]
             in let arg_66 = toErl 81
             in let
               head_65 =
                 BIF.erlang__apply__2 [a_5, ErlangCons arg_66 ErlangEmptyList]
             in let arg_70 = toErl 144
             in let
               head_69 =
                 BIF.erlang__apply__2 [a_5, ErlangCons arg_70 ErlangEmptyList]
             in let arg_74 = toErl 96
             in let
               head_73 =
                 BIF.erlang__apply__2 [a_5, ErlangCons arg_74 ErlangEmptyList]
             in let head_77 = toErl 32
             in let arg_80 = toErl 1
             in let
               head_79 =
                 BIF.erlang__apply__2 [a_5, ErlangCons arg_80 ErlangEmptyList]
             in let
               head_58 =
                 ErlangTuple
                   [ErlangAtom "inline_asm",
           ...
           lambda_31 [(ErlangCons (ErlangTuple [(ErlangTuple [(ErlangAtom "bytes_t"),
             ...
             in let arg_97 = toErl 144
             in let
               tup_el_96 =
                 BIF.erlang__apply__2 [a_5, ErlangCons arg_97 ErlangEmptyList]
             in let head_94 = ErlangTuple [ErlangAtom "inline_asm", tup_el_96]
             in
               ErlangTuple
                 [ErlangAtom "seq",
                  ErlangCons v_85
                    (ErlangCons head_90 (ErlangCons head_94 ErlangEmptyList))]
      ...
      ErlangFun 2
        (let
           lambda_101 [(ErlangTuple [(ErlangAtom "bytes_t"), _, n_104]),
                       v_105]
             | weakLt n_104 (toErl 32) =
             let    lop_110 = toErl 32
             in let arg_109 = BIF.erlang__op_minus [lop_110, n_104]
             in let arg_112 = toErl 8
             in let arg_107 = erlps__op__3 [ErlangAtom "*", arg_109, arg_112]
                   ...
                   (\ lc_136 ->
                      case lc_136 of
                        (ErlangTuple [var_134,
                          ...
                          in ErlangCons lcRet_137 ErlangEmptyList
                        _ -> ErlangEmptyList)
                   lcSrc_129
             in let
               arg_143 =
                      ...
                      case lc_149 of
                        (ErlangTuple [var_147,
                                      (ErlangTuple [(ErlangAtom "notindexed"),
                                                    type_148])]) ->
                          let lcRet_150 = ErlangTuple [type_148, var_147]
                          in ErlangCons lcRet_150 ErlangEmptyList
                        _ -> ErlangEmptyList)
                   lcSrc_142
             in let arg_154 = toErl 32
             ...
             in let
               matchExpr_161 =
                 BIF.do_remote_fun_call "Eblake2" "erlps__blake2b__2"
                   [arg_154, arg_155]
             in
               case matchExpr_161 of
                 (ErlangTuple [(ErlangAtom "ok"),
                               (ErlangBinary binSeg_157)]) | (ErlangInt size_158) <-
                                                               (toErl 256)
                   ...
                   in ErlangTuple [ErlangAtom "event", tup_el_166, tup_el_172]
                 _ -> EXC.badmatch matchExpr_161
           lambda_116 [arg_117, arg_118, arg_119] = EXC.function_clause unit
      ...
      ErlangFun 2
        (let
           lambda_176 [tag_179, types_180] =
             ...
             in ErlangTuple [ErlangAtom "tuple", ErlangCons head_183 tail_186]
  ...
  in
    case eventt_0 of
      (ErlangTuple [(ErlangAtom "variant_t"), cons_190]) ->
        let    arg_192 = toErl 0
        in let lop_194 = BIF.erlang__length__1 [cons_190]
        in let rop_196 = toErl 1
        in let arg_193 = BIF.erlang__op_minus [lop_194, rop_196]
        in let
          tags_197 =
            BIF.do_remote_fun_call "Lists" "erlps__seq__2" [arg_192, arg_193]
        in let tup_el_200 = toErl "e"
        in let head_199 = ErlangTuple [tup_el_200, ErlangAtom "event"]
          ...
          tup_el_207 =
            flmap
              (\ lc_215 ->
                 case lc_215 of
                   (ErlangTuple [tag_211,
                                 (ErlangTuple [(ErlangAtom "constr_t"), ann_212,
                                               con_213, types_214])]) ->
                     let   
                       tup_el_217 =
                         BIF.erlang__apply__2
                     ...
                     in let
                       arg_225 =
                         BIF.do_remote_fun_call "Aeso.Syntax"
                           "erlps__get_ann__2" [ErlangAtom "indices", ann_212]
                     in let
                       arg_224 =
                         BIF.do_remote_fun_call "Lists" "erlps__zip__2"
                           [arg_225, types_214]
                     ...
                     in let lcRet_216 = ErlangTuple [tup_el_217, tup_el_221]
                     in ErlangCons lcRet_216 ErlangEmptyList
                   _ -> ErlangEmptyList)
              lcSrc_208
        in let
          tup_el_203 =
        ...
        in let
          tup_el_230 = ErlangTuple [ErlangAtom "tuple", ErlangEmptyList]
        in
          ErlangTuple
    ...
    a_4 =
      ErlangFun 1
        (let
         ...
         in lambda_0)
  in let tup_el_7 = toErl "s"
  in let head_6 = ErlangTuple [tup_el_7, ErlangAtom "string"]
  in let arg_14 = toErl 96
  in let
    head_13 =
      BIF.erlang__apply__2 [a_4, ErlangCons arg_14 ErlangEmptyList]
  in let head_17 = toErl 0
  in let arg_20 = toErl 253
  in let
    head_19 =
      BIF.erlang__apply__2 [a_4, ErlangCons arg_20 ErlangEmptyList]
  in let
    tup_el_10 =
      ErlangTuple
        [ErlangAtom "inline_asm",
...
erlps__builtin_block_hash__0 [] =
  ...
  in let
    tup_el_15 =
      ErlangTuple [ErlangAtom "ifte", tup_el_17, tup_el_21, tup_el_22]
...
erlps__builtin_require__0 [] =
  let    tup_el_2 = toErl "c"
  in let head_1 = ErlangTuple [tup_el_2, ErlangAtom "word"]
  in let tup_el_6 = toErl "msg"
  ...
  in let tup_el_18 = ErlangTuple [ErlangAtom "var_ref", tup_el_20]
  ...
  in let
    tup_el_9 =
      ErlangTuple [ErlangAtom "ifte", tup_el_11, tup_el_13, tup_el_16]
  in let
...
erlps__builtin_map_lookup__1 [type_0] =
  let   
    ret_2 =
      BIF.do_remote_fun_call "Aeso.Icode" "erlps__option_typerep__1"
        [type_0]
  in let tup_el_5 = toErl "m"
  in let head_4 = ErlangTuple [tup_el_5, ErlangAtom "word"]
  in let tup_el_9 = toErl "k"
  in let head_8 = ErlangTuple [tup_el_9, ErlangAtom "word"]
  in let arg_13 = toErl 301
  in let tup_el_16 = toErl 0
  in let arg_14 = ErlangTuple [ErlangAtom "integer", tup_el_16]
  in let tup_el_20 = toErl "m"
  in let head_18 = ErlangTuple [ErlangAtom "var_ref", tup_el_20]
  in let tup_el_24 = toErl "k"
  in let head_22 = ErlangTuple [ErlangAtom "var_ref", tup_el_24]
  in let
    tup_el_12 =
...
erlps__builtin_map_put__0 [] =
  let    tup_el_2 = toErl "m"
  in let head_1 = ErlangTuple [tup_el_2, ErlangAtom "word"]
  in let tup_el_6 = toErl "k"
  in let head_5 = ErlangTuple [tup_el_6, ErlangAtom "word"]
  in let tup_el_10 = toErl "v"
  in let head_9 = ErlangTuple [tup_el_10, ErlangAtom "word"]
  in let arg_14 = toErl 302
  in let tup_el_17 = toErl 0
  in let arg_15 = ErlangTuple [ErlangAtom "integer", tup_el_17]
...
erlps__builtin_map_delete__0 [] =
  ...
  in let tup_el_6 = toErl "k"
  in let head_5 = ErlangTuple [tup_el_6, ErlangAtom "word"]
  in let arg_10 = toErl 303
  in let tup_el_13 = toErl 0
  in let arg_11 = ErlangTuple [ErlangAtom "integer", tup_el_13]
...
erlps__builtin_map_size__0 [] =
  let    tup_el_2 = toErl "m"
  in let head_1 = ErlangTuple [tup_el_2, ErlangAtom "word"]
  in let arg_6 = toErl 304
  in let tup_el_9 = toErl 0
  in let arg_7 = ErlangTuple [ErlangAtom "integer", tup_el_9]
  in let head_11 = erlps__v__1 [ErlangAtom "m"]
  in let
    tup_el_5 =
      BIF.do_remote_fun_call "Aeso.Ast.To.Icode" "erlps__prim_call__5"
        [arg_6, arg_7, ErlangCons head_11 ErlangEmptyList,
         ErlangCons (ErlangAtom "word") ErlangEmptyList,
         ErlangAtom "word"]
  in
    ErlangTuple
...
erlps__builtin_map_get__1 [type_0] =
  let    tup_el_3 = toErl "m"
  in let head_2 = ErlangTuple [tup_el_3, ErlangAtom "word"]
  in let tup_el_7 = toErl "k"
  in let head_6 = ErlangTuple [tup_el_7, ErlangAtom "word"]
  in let tup_el_18 = ErlangTuple [ErlangAtom "map_lookup", type_0]
  in let tup_el_16 = ErlangTuple [ErlangAtom "builtin", tup_el_18]
...
erlps__builtin_map_lookup_default__1 [type_0] =
  ...
  in let tup_el_7 = toErl "k"
  in let head_6 = ErlangTuple [tup_el_7, ErlangAtom "word"]
  in let tup_el_11 = toErl "default"
  in let head_10 = ErlangTuple [tup_el_11, type_0]
  in let tup_el_22 = ErlangTuple [ErlangAtom "map_lookup", type_0]
  in let tup_el_20 = ErlangTuple [ErlangAtom "builtin", tup_el_22]
  in let tup_el_18 = ErlangTuple [ErlangAtom "var_ref", tup_el_20]
...
erlps__builtin_map_member__0 [] =
  ...
  in let tup_el_15 = ErlangTuple [ErlangAtom "builtin", tup_el_17]
  in let tup_el_13 = ErlangTuple [ErlangAtom "var_ref", tup_el_15]
  ...
  in let tup_el_32 = toErl 0
  in let tup_el_30 = ErlangTuple [ErlangAtom "integer", tup_el_32]
  in let head_28 = ErlangTuple [tup_el_29, tup_el_30]
  in let tup_el_37 = toErl "_"
  in let tup_el_35 = ErlangTuple [ErlangAtom "var_ref", tup_el_37]
  in let tup_el_40 = toErl 1
  in let tup_el_38 = ErlangTuple [ErlangAtom "integer", tup_el_40]
...
erlps__builtin_map_upd__1 [type_0] =
  let    tup_el_3 = toErl "map"
  in let head_2 = ErlangTuple [tup_el_3, ErlangAtom "word"]
  in let tup_el_7 = toErl "key"
  in let head_6 = ErlangTuple [tup_el_7, ErlangAtom "word"]
  in let tup_el_11 = toErl "valfun"
  in let head_10 = ErlangTuple [tup_el_11, ErlangAtom "word"]
  in let
    tup_el_18 =
      ErlangTuple [ErlangAtom "builtin", ErlangAtom "map_put"]
  in let tup_el_16 = ErlangTuple [ErlangAtom "var_ref", tup_el_18]
  ...
  in let tup_el_37 = ErlangTuple [ErlangAtom "builtin", tup_el_39]
  in let tup_el_35 = ErlangTuple [ErlangAtom "var_ref", tup_el_37]
...
erlps__builtin_map_upd_default__1 [type_0] =
  ...
  in let tup_el_7 = toErl "key"
  in let head_6 = ErlangTuple [tup_el_7, ErlangAtom "word"]
  in let tup_el_11 = toErl "val"
  in let head_10 = ErlangTuple [tup_el_11, ErlangAtom "word"]
  in let tup_el_15 = toErl "valfun"
  in let head_14 = ErlangTuple [tup_el_15, ErlangAtom "word"]
  in let
    tup_el_22 =
      ErlangTuple [ErlangAtom "builtin", ErlangAtom "map_put"]
  in let tup_el_20 = ErlangTuple [ErlangAtom "var_ref", tup_el_22]
  ...
  in let
    tup_el_43 = ErlangTuple [ErlangAtom "map_lookup_default", type_0]
  in let tup_el_41 = ErlangTuple [ErlangAtom "builtin", tup_el_43]
  in let tup_el_39 = ErlangTuple [ErlangAtom "var_ref", tup_el_41]
...
erlps__builtin_map_from_list__0 [] =
  ...
  in let
    tup_el_48 =
      ErlangTuple [ErlangAtom "builtin", ErlangAtom "map_from_list"]
  in let tup_el_46 = ErlangTuple [ErlangAtom "var_ref", tup_el_48]
  in let head_52 = erlps__v__1 [ErlangAtom "ys"]
  in let
    tup_el_59 =
      ErlangTuple [ErlangAtom "builtin", ErlangAtom "map_put"]
  in let tup_el_57 = ErlangTuple [ErlangAtom "var_ref", tup_el_59]
...
erlps__builtin_list_concat__0 [] =
  let    tup_el_2 = toErl "l1"
  in let
    tup_el_3 = ErlangTuple [ErlangAtom "list", ErlangAtom "word"]
  in let head_1 = ErlangTuple [tup_el_2, tup_el_3]
  in let tup_el_8 = toErl "l2"
  in let
    tup_el_9 = ErlangTuple [ErlangAtom "list", ErlangAtom "word"]
  ...
  in let
    tup_el_42 =
      ErlangTuple [ErlangAtom "builtin", ErlangAtom "list_concat"]
  in let tup_el_40 = ErlangTuple [ErlangAtom "var_ref", tup_el_42]
...
erlps__builtin_string_concat__0 [] =
  let    tup_el_2 = toErl "s1"
  in let head_1 = ErlangTuple [tup_el_2, ErlangAtom "string"]
  in let tup_el_6 = toErl "s2"
  in let head_5 = ErlangTuple [tup_el_6, ErlangAtom "string"]
  ...
  in let arg_38 = toErl 0
  in let
    tup_el_35 =
      erlps__op__3 [ErlangAtom "==", ErlangAtom "n1", arg_38]
  in let tup_el_39 = erlps__v__1 [ErlangAtom "s2"]
  in let arg_46 = toErl 0
  in let
    tup_el_43 =
      erlps__op__3 [ErlangAtom "==", ErlangAtom "n2", arg_46]
  ...
  in let
    tup_el_51 =
      ErlangTuple
        [ErlangAtom "inline_asm", ErlangCons head_54 ErlangEmptyList]
  in let tup_el_59 = erlps__v__1 [ErlangAtom "ret"]
  in let
    head_64 =
      erlps__op__3 [ErlangAtom "+", ErlangAtom "n1", ErlangAtom "n2"]
  in let arg_73 = toErl 89
  in let
    head_72 =
      BIF.do_remote_fun_call "Aeb.Opcodes" "erlps__mnemonic__1"
        [arg_73]
  in let arg_76 = toErl 82
  in let
    head_75 =
      BIF.do_remote_fun_call "Aeb.Opcodes" "erlps__mnemonic__1"
        [arg_76]
  ...
  in let arg_93 = toErl 32
  in let
    head_90 = erlps__op__3 [ErlangAtom "+", ErlangAtom "s1", arg_93]
  in let head_95 = erlps__v__1 [ErlangAtom "n2"]
  in let arg_101 = toErl 32
  in let
    head_98 = erlps__op__3 [ErlangAtom "+", ErlangAtom "s2", arg_101]
  in let
    head_79 =
      ErlangTuple
  ...
  in let
    head_104 =
      ErlangTuple
        [ErlangAtom "inline_asm", ErlangCons head_107 ErlangEmptyList]
      ...
      ErlangTuple
        [ErlangAtom "seq",
         ErlangCons head_64
           (ErlangCons head_69
              (ErlangCons head_79
                 (ErlangCons head_104 (ErlangCons head_111 ErlangEmptyList))))]
  ...
  in let
    tup_el_41 =
      ErlangTuple [ErlangAtom "ifte", tup_el_43, tup_el_47, tup_el_49]
  in let
    tup_el_33 =
      ErlangTuple [ErlangAtom "ifte", tup_el_35, tup_el_39, tup_el_41]
...
erlps__builtin_string_concat_inner1__0 [] =
  let    tup_el_2 = toErl "n1"
  in let head_1 = ErlangTuple [tup_el_2, ErlangAtom "word"]
  in let tup_el_6 = toErl "p1"
  in let head_5 = ErlangTuple [tup_el_6, ErlangAtom "pointer"]
  in let tup_el_10 = toErl "n2"
  in let head_9 = ErlangTuple [tup_el_10, ErlangAtom "word"]
  in let tup_el_14 = toErl "p2"
  in let head_13 = ErlangTuple [tup_el_14, ErlangAtom "pointer"]
  in let
    tup_el_23 =
      ErlangTuple [ErlangAtom "builtin", ErlangAtom "string_copy"]
  in let tup_el_21 = ErlangTuple [ErlangAtom "var_ref", tup_el_23]
  ...
  in let
    tup_el_39 =
      erlps__op__3 [ErlangAtom "mod", ErlangAtom "n1", arg_42]
  in let tup_el_45 = erlps__v__1 [ErlangAtom "nx"]
  in let arg_52 = toErl 0
  in let
    tup_el_49 =
      erlps__op__3 [ErlangAtom "==", ErlangAtom "nx", arg_52]
  in let
    tup_el_59 =
      ErlangTuple [ErlangAtom "builtin", ErlangAtom "string_copy"]
  in let tup_el_57 = ErlangTuple [ErlangAtom "var_ref", tup_el_59]
  ...
  in let arg_83 = toErl 89
  in let
    head_82 =
      BIF.do_remote_fun_call "Aeb.Opcodes" "erlps__mnemonic__1"
        [arg_83]
  in let arg_86 = toErl 82
  in let
    head_85 =
      BIF.do_remote_fun_call "Aeb.Opcodes" "erlps__mnemonic__1"
        [arg_86]
  in let arg_89 = toErl 89
  in let
    head_88 =
      BIF.do_remote_fun_call "Aeb.Opcodes" "erlps__mnemonic__1"
        [arg_89]
  ...
  in let tup_el_95 = ErlangTuple [ErlangAtom "var_ref", tup_el_97]
  ...
  in let
    tup_el_47 =
      ErlangTuple [ErlangAtom "ifte", tup_el_49, tup_el_53, tup_el_93]
...
erlps__builtin_string_copy__0 [] =
  let    tup_el_2 = toErl "n"
  in let head_1 = ErlangTuple [tup_el_2, ErlangAtom "word"]
  in let tup_el_6 = toErl "p"
  in let head_5 = ErlangTuple [tup_el_6, ErlangAtom "pointer"]
  ...
  in let
    tup_el_15 =
      ErlangTuple
        [ErlangAtom "tuple", ErlangCons head_18 ErlangEmptyList]
  in let arg_26 = toErl 31
  in let
    tup_el_23 = erlps__op__3 [ErlangAtom ">", ErlangAtom "n", arg_26]
  in let head_30 = erlps__v__1 [ErlangAtom "w"]
  in let arg_37 = toErl 89
  in let
    head_36 =
      BIF.do_remote_fun_call "Aeb.Opcodes" "erlps__mnemonic__1"
        [arg_37]
  in let arg_40 = toErl 82
  in let
    head_39 =
      BIF.do_remote_fun_call "Aeb.Opcodes" "erlps__mnemonic__1"
        [arg_40]
  ...
  in let
    tup_el_47 =
      ErlangTuple [ErlangAtom "builtin", ErlangAtom "string_copy"]
  in let tup_el_45 = ErlangTuple [ErlangAtom "var_ref", tup_el_47]
  in let arg_54 = toErl 32
  in let
    head_51 = erlps__op__3 [ErlangAtom "-", ErlangAtom "n", arg_54]
  in let arg_59 = toErl 32
  in let
    head_56 = erlps__op__3 [ErlangAtom "+", ErlangAtom "p", arg_59]
  in let
    head_43 =
      ErlangTuple
  ...
  in let
    tup_el_21 =
      ErlangTuple [ErlangAtom "ifte", tup_el_23, tup_el_27, tup_el_62]
  in let head_14 = ErlangTuple [tup_el_15, tup_el_21]
  in let
    tup_el_9 =
      ErlangTuple
...
erlps__builtin_string_shift_copy__0 [] =
  let    tup_el_2 = toErl "off"
  in let head_1 = ErlangTuple [tup_el_2, ErlangAtom "word"]
  in let tup_el_6 = toErl "dst"
  in let head_5 = ErlangTuple [tup_el_6, ErlangAtom "word"]
  in let tup_el_10 = toErl "n"
  in let head_9 = ErlangTuple [tup_el_10, ErlangAtom "word"]
  in let tup_el_14 = toErl "p"
  in let head_13 = ErlangTuple [tup_el_14, ErlangAtom "pointer"]
  ...
  in let arg_40 = toErl 8
  in let
    arg_37 = erlps__op__3 [ErlangAtom "*", ErlangAtom "off", arg_40]
  in let
    arg_35 = erlps__op__3 [ErlangAtom "bsr", arg_37, ErlangAtom "w"]
  in let
    head_32 = erlps__op__3 [ErlangAtom "+", ErlangAtom "dst", arg_35]
  in let arg_47 = toErl 89
  in let
    head_46 =
      BIF.do_remote_fun_call "Aeb.Opcodes" "erlps__mnemonic__1"
        [arg_47]
  in let arg_50 = toErl 82
  in let
    head_49 =
      BIF.do_remote_fun_call "Aeb.Opcodes" "erlps__mnemonic__1"
        [arg_50]
  in let
    head_43 =
      ErlangTuple
        [ErlangAtom "inline_asm",
         ErlangCons head_46 (ErlangCons head_49 ErlangEmptyList)]
  in let arg_60 = toErl 32
  in let
    arg_58 = erlps__op__3 [ErlangAtom "-", arg_60, ErlangAtom "off"]
  in let
    tup_el_55 = erlps__op__3 [ErlangAtom ">", ErlangAtom "n", arg_58]
  in let
    tup_el_66 =
      ErlangTuple
        [ErlangAtom "builtin", ErlangAtom "string_shift_copy"]
  in let tup_el_64 = ErlangTuple [ErlangAtom "var_ref", tup_el_66]
  in let head_70 = erlps__v__1 [ErlangAtom "off"]
  in let arg_79 = toErl 32
  in let
    arg_77 = erlps__op__3 [ErlangAtom "-", arg_79, ErlangAtom "off"]
  in let arg_81 = toErl 8
  in let arg_75 = erlps__op__3 [ErlangAtom "*", arg_77, arg_81]
  in let
    head_73 = erlps__op__3 [ErlangAtom "bsl", arg_75, ErlangAtom "w"]
  in let arg_87 = toErl 32
  in let
    head_84 = erlps__op__3 [ErlangAtom "-", ErlangAtom "n", arg_87]
  in let arg_92 = toErl 32
  in let
    head_89 = erlps__op__3 [ErlangAtom "+", ErlangAtom "p", arg_92]
  in let
    tup_el_62 =
      ErlangTuple
  ...
  in let
    tup_el_94 =
      ErlangTuple
        [ErlangAtom "inline_asm", ErlangCons head_97 ErlangEmptyList]
  in let
    head_53 =
      ErlangTuple [ErlangAtom "ifte", tup_el_55, tup_el_62, tup_el_94]
  in let
    tup_el_29 =
      ErlangTuple
        [ErlangAtom "seq",
...
erlps__builtin_str_equal_p__0 [] =
  ...
  in let tup_el_6 = toErl "p1"
  in let head_5 = ErlangTuple [tup_el_6, ErlangAtom "pointer"]
  in let tup_el_10 = toErl "p2"
  in let head_9 = ErlangTuple [tup_el_10, ErlangAtom "pointer"]
  in let arg_18 = toErl 1
  in let
    tup_el_15 = erlps__op__3 [ErlangAtom "<", ErlangAtom "n", arg_18]
  ...
  in let
    arg_48 =
      erlps__op__3 [ErlangAtom "==", ErlangAtom "w1", ErlangAtom "w2"]
  in let
    tup_el_56 =
      ErlangTuple [ErlangAtom "builtin", ErlangAtom "str_equal_p"]
  in let tup_el_54 = ErlangTuple [ErlangAtom "var_ref", tup_el_56]
  in let arg_63 = toErl 32
  in let
    head_60 = erlps__op__3 [ErlangAtom "-", ErlangAtom "n", arg_63]
  in let arg_68 = toErl 32
  in let
    head_65 = erlps__op__3 [ErlangAtom "+", ErlangAtom "p1", arg_68]
  in let arg_73 = toErl 32
  in let
    head_70 = erlps__op__3 [ErlangAtom "+", ErlangAtom "p2", arg_73]
  in let
    arg_52 =
      ErlangTuple
  ...
  in let tup_el_46 = erlps__op__3 [ErlangAtom "&&", arg_48, arg_52]
  ...
  in let
    tup_el_13 =
      ErlangTuple [ErlangAtom "ifte", tup_el_15, tup_el_19, tup_el_22]
  in
    ErlangTuple
      [ErlangCons head_1
         (ErlangCons head_5 (ErlangCons head_9 ErlangEmptyList)),
...
erlps__builtin_str_equal__0 [] =
  ...
  in let
    tup_el_43 =
      ErlangTuple [ErlangAtom "builtin", ErlangAtom "str_equal_p"]
  in let tup_el_41 = ErlangTuple [ErlangAtom "var_ref", tup_el_43]
  in let head_47 = erlps__v__1 [ErlangAtom "n1"]
  in let arg_53 = toErl 32
  in let
    head_50 = erlps__op__3 [ErlangAtom "+", ErlangAtom "s1", arg_53]
  in let arg_58 = toErl 32
  in let
    head_55 = erlps__op__3 [ErlangAtom "+", ErlangAtom "s2", arg_58]
  in let
    arg_39 =
      ErlangTuple
  ...
  in let tup_el_33 = erlps__op__3 [ErlangAtom "&&", arg_35, arg_39]
  in let head_26 = ErlangTuple [tup_el_27, tup_el_33]
  in let
    tup_el_21 =
      ErlangTuple
...
erlps__builtin_popcount__0 [] =
  let    tup_el_2 = toErl "bits"
  in let head_1 = ErlangTuple [tup_el_2, ErlangAtom "word"]
  in let tup_el_6 = toErl "acc"
  in let head_5 = ErlangTuple [tup_el_6, ErlangAtom "word"]
  in let arg_14 = toErl 0
  in let
    tup_el_11 =
      erlps__op__3 [ErlangAtom "==", ErlangAtom "bits", arg_14]
  in let tup_el_15 = erlps__v__1 [ErlangAtom "acc"]
  in let
    tup_el_21 =
      ErlangTuple [ErlangAtom "builtin", ErlangAtom "popcount"]
  in let tup_el_19 = ErlangTuple [ErlangAtom "var_ref", tup_el_21]
  in let arg_27 = toErl 1
  in let
    head_25 =
      erlps__op__3 [ErlangAtom "bsr", arg_27, ErlangAtom "bits"]
  in let arg_36 = toErl 1
  in let
    arg_33 =
      erlps__op__3 [ErlangAtom "band", ErlangAtom "bits", arg_36]
  in let
    head_30 = erlps__op__3 [ErlangAtom "+", ErlangAtom "acc", arg_33]
  in let
    tup_el_17 =
      ErlangTuple
  ...
  in let
    tup_el_9 =
      ErlangTuple [ErlangAtom "ifte", tup_el_11, tup_el_15, tup_el_17]
  in
    ErlangTuple
      [ErlangCons head_1 (ErlangCons head_5 ErlangEmptyList), tup_el_9,
       ErlangAtom "word"]
...
erlps__builtin_int_to_str__0 [] =
  let    tup_el_2 = toErl "i"
  in let head_1 = ErlangTuple [tup_el_2, ErlangAtom "word"]
  in let tup_el_13 = toErl 10
  in let
    tup_el_11 = ErlangTuple [ErlangAtom "baseX_int", tup_el_13]
  in let tup_el_9 = ErlangTuple [ErlangAtom "builtin", tup_el_11]
  in let tup_el_7 = ErlangTuple [ErlangAtom "var_ref", tup_el_9]
...
erlps__builtin_baseX_tab__1 [_x_1@(ErlangInt num_0)]
  ...
  in let
    tup_el_7 = erlps__op__3 [ErlangAtom "+", arg_9, ErlangAtom "ix"]
  in
    ErlangTuple
...
erlps__builtin_baseX_int__1 [x_0] =
  ...
  in let
    tup_el_8 =
      ErlangTuple
        [ErlangAtom "inline_asm", ErlangCons head_11 ErlangEmptyList]
  in let tup_el_16 = erlps__v__1 [ErlangAtom "ret"]
  in let tup_el_27 = ErlangTuple [ErlangAtom "baseX_int_pad", x_0]
  in let tup_el_25 = ErlangTuple [ErlangAtom "builtin", tup_el_27]
  in let tup_el_23 = ErlangTuple [ErlangAtom "var_ref", tup_el_25]
  in let head_31 = erlps__v__1 [ErlangAtom "w"]
  in let tup_el_36 = toErl 0
  in let head_34 = ErlangTuple [ErlangAtom "integer", tup_el_36]
  in let tup_el_40 = toErl 0
  in let head_38 = ErlangTuple [ErlangAtom "integer", tup_el_40]
  in let
    head_21 =
      ErlangTuple
  ...
  in let
    head_43 =
      ErlangTuple
        [ErlangAtom "inline_asm", ErlangCons head_46 ErlangEmptyList]
...
erlps__builtin_baseX_int_pad__1 [x_1@(ErlangInt num_0)]
  ...
  in let tup_el_12 = toErl "dst"
  in let head_11 = ErlangTuple [tup_el_12, ErlangAtom "word"]
  in let arg_20 = toErl 0
  in let
    tup_el_17 =
      erlps__op__3 [ErlangAtom "<", ErlangAtom "src", arg_20]
  in let
    tup_el_27 = ErlangTuple [ErlangAtom "baseX_int_encode", x_1]
  in let tup_el_25 = ErlangTuple [ErlangAtom "builtin", tup_el_27]
  in let tup_el_23 = ErlangTuple [ErlangAtom "var_ref", tup_el_25]
  in let tup_el_39 = toErl 1
  in let tup_el_37 = ErlangTuple [ErlangAtom "integer", tup_el_39]
  in let
    arg_34 =
      ErlangTuple [ErlangAtom "unop", ErlangAtom "-", tup_el_37]
  in let
    head_31 = erlps__op__3 [ErlangAtom "/", ErlangAtom "src", arg_34]
  in let tup_el_43 = toErl 1
  in let head_41 = ErlangTuple [ErlangAtom "integer", tup_el_43]
  in let arg_49 = toErl 31
  in let arg_50 = toErl 8
  in let arg_47 = erlps__op__3 [ErlangAtom "*", arg_49, arg_50]
  in let arg_51 = toErl 45
  in let head_45 = erlps__op__3 [ErlangAtom "bsl", arg_47, arg_51]
  in let
    tup_el_21 =
      ErlangTuple
        [ErlangAtom "funcall", tup_el_23,
  ...
  in let tup_el_57 = ErlangTuple [ErlangAtom "builtin", tup_el_59]
  in let tup_el_55 = ErlangTuple [ErlangAtom "var_ref", tup_el_57]
  ...
  in let
    tup_el_15 =
      ErlangTuple [ErlangAtom "ifte", tup_el_17, tup_el_21, tup_el_53]
  in
    ErlangTuple
      [ErlangCons head_3
...
erlps__builtin_baseX_int_pad__1 [x_1@(ErlangInt num_0)]
  ...
  in let tup_el_19 = ErlangTuple [ErlangAtom "builtin", tup_el_21]
  in let tup_el_17 = ErlangTuple [ErlangAtom "var_ref", tup_el_19]
...
erlps__builtin_baseX_int_pad__1 [x_1@(ErlangInt num_0)]
  ...
  in let tup_el_12 = toErl "dst"
  in let head_11 = ErlangTuple [tup_el_12, ErlangAtom "word"]
  in let arg_24 = toErl 31
  in let
    arg_21 = erlps__op__3 [ErlangAtom "div", ErlangAtom "ix", arg_24]
  in let
    arg_25 =
      erlps__op__3
        [ErlangAtom "byte", ErlangAtom "ix", ErlangAtom "src"]
  in let arg_19 = erlps__op__3 [ErlangAtom "+", arg_21, arg_25]
  in let arg_29 = toErl 0
  in let tup_el_17 = erlps__op__3 [ErlangAtom ">", arg_19, arg_29]
  in let
    tup_el_36 = ErlangTuple [ErlangAtom "baseX_int_encode", x_1]
  in let tup_el_34 = ErlangTuple [ErlangAtom "builtin", tup_el_36]
  in let tup_el_32 = ErlangTuple [ErlangAtom "var_ref", tup_el_34]
    ...
    tup_el_30 =
      ErlangTuple
        [ErlangAtom "funcall", tup_el_32,
         ErlangCons head_40
           (ErlangCons head_43 (ErlangCons head_46 ErlangEmptyList))]
  in let tup_el_55 = ErlangTuple [ErlangAtom "baseX_int_pad", x_1]
  in let tup_el_53 = ErlangTuple [ErlangAtom "builtin", tup_el_55]
  in let tup_el_51 = ErlangTuple [ErlangAtom "var_ref", tup_el_53]
  in let head_59 = erlps__v__1 [ErlangAtom "src"]
  in let arg_65 = toErl 1
  in let
    head_62 = erlps__op__3 [ErlangAtom "+", ErlangAtom "ix", arg_65]
  in let arg_76 = toErl 31
  in let
    arg_74 = erlps__op__3 [ErlangAtom "-", arg_76, ErlangAtom "ix"]
  in let arg_78 = toErl 8
  in let arg_72 = erlps__op__3 [ErlangAtom "*", arg_74, arg_78]
  in let arg_79 = toErl 49
  in let arg_70 = erlps__op__3 [ErlangAtom "bsl", arg_72, arg_79]
  in let
    head_67 = erlps__op__3 [ErlangAtom "+", ErlangAtom "dst", arg_70]
  in let
    tup_el_49 =
      ErlangTuple
  ...
  in let
    tup_el_15 =
      ErlangTuple [ErlangAtom "ifte", tup_el_17, tup_el_30, tup_el_49]
  in
    ErlangTuple
      [ErlangCons head_3
         (ErlangCons head_7 (ErlangCons head_11 ErlangEmptyList)),
...
erlps__builtin_baseX_int_encode__1 [x_0] =
  let    tup_el_3 = toErl "src"
  in let head_2 = ErlangTuple [tup_el_3, ErlangAtom "word"]
  in let tup_el_7 = toErl "ix"
  in let head_6 = ErlangTuple [tup_el_7, ErlangAtom "word"]
  in let tup_el_11 = toErl "dst"
  in let head_10 = ErlangTuple [tup_el_11, ErlangAtom "word"]
  in let tup_el_22 = ErlangTuple [ErlangAtom "baseX_digits", x_0]
  in let tup_el_20 = ErlangTuple [ErlangAtom "builtin", tup_el_22]
  in let tup_el_18 = ErlangTuple [ErlangAtom "var_ref", tup_el_20]
  in let head_26 = erlps__v__1 [ErlangAtom "src"]
  in let tup_el_31 = toErl 0
  in let head_29 = ErlangTuple [ErlangAtom "integer", tup_el_31]
  in let
    tup_el_16 =
      ErlangTuple
        [ErlangAtom "funcall", tup_el_18,
  ...
  in let
    arg_43 = erlps__op__3 [ErlangAtom "+", ErlangAtom "ix", arg_46]
  in let
    head_40 = erlps__op__3 [ErlangAtom "+", ErlangAtom "n", arg_43]
  in let arg_52 = toErl 89
  in let
    head_51 =
      BIF.do_remote_fun_call "Aeb.Opcodes" "erlps__mnemonic__1"
        [arg_52]
  in let arg_55 = toErl 82
  in let
    head_54 =
      BIF.do_remote_fun_call "Aeb.Opcodes" "erlps__mnemonic__1"
        [arg_55]
  ...
  in let tup_el_62 = ErlangTuple [ErlangAtom "builtin", tup_el_64]
  in let tup_el_60 = ErlangTuple [ErlangAtom "var_ref", tup_el_62]
  in let head_68 = erlps__v__1 [ErlangAtom "src"]
  in let head_71 = erlps__v__1 [ErlangAtom "dst"]
  in let
    head_74 = erlps__op__3 [ErlangAtom "^", x_0, ErlangAtom "n"]
...
erlps__builtin_baseX_int_encode___1 [x_0] =
  let    tup_el_3 = toErl "src"
  in let head_2 = ErlangTuple [tup_el_3, ErlangAtom "word"]
  in let tup_el_7 = toErl "dst"
  in let head_6 = ErlangTuple [tup_el_7, ErlangAtom "word"]
  in let tup_el_11 = toErl "fac"
  in let head_10 = ErlangTuple [tup_el_11, ErlangAtom "word"]
  in let tup_el_15 = toErl "ix"
  in let head_14 = ErlangTuple [tup_el_15, ErlangAtom "word"]
  in let arg_23 = toErl 0
  in let
    tup_el_20 =
      erlps__op__3 [ErlangAtom "==", ErlangAtom "fac", arg_23]
  ...
  in let
    tup_el_24 =
      ErlangTuple
        [ErlangAtom "seq",
         ErlangCons head_27 (ErlangCons head_30 ErlangEmptyList)]
  in let arg_48 = toErl 32
  in let
    tup_el_45 =
      erlps__op__3 [ErlangAtom "==", ErlangAtom "ix", arg_48]
  in let head_52 = erlps__v__1 [ErlangAtom "dst"]
  in let arg_59 = toErl 89
  in let
    head_58 =
      BIF.do_remote_fun_call "Aeb.Opcodes" "erlps__mnemonic__1"
        [arg_59]
  in let arg_62 = toErl 82
  in let
    head_61 =
      BIF.do_remote_fun_call "Aeb.Opcodes" "erlps__mnemonic__1"
        [arg_62]
  ...
  in let tup_el_69 = ErlangTuple [ErlangAtom "builtin", tup_el_71]
  in let tup_el_67 = ErlangTuple [ErlangAtom "var_ref", tup_el_69]
  in let head_75 = erlps__v__1 [ErlangAtom "src"]
  in let tup_el_80 = toErl 0
  in let head_78 = ErlangTuple [ErlangAtom "integer", tup_el_80]
  in let head_82 = erlps__v__1 [ErlangAtom "fac"]
  in let tup_el_87 = toErl 0
  in let head_85 = ErlangTuple [ErlangAtom "integer", tup_el_87]
  in let
    head_65 =
      ErlangTuple
  ...
  in let tup_el_94 = ErlangTuple [ErlangAtom "builtin", tup_el_96]
  in let tup_el_92 = ErlangTuple [ErlangAtom "var_ref", tup_el_94]
  in let
    head_100 =
      erlps__op__3
        [ErlangAtom "mod", ErlangAtom "src", ErlangAtom "fac"]
  in let arg_114 = toErl 31
  in let
    arg_112 = erlps__op__3 [ErlangAtom "-", arg_114, ErlangAtom "ix"]
  in let arg_116 = toErl 8
  in let arg_110 = erlps__op__3 [ErlangAtom "*", arg_112, arg_116]
  ...
  in let
    head_133 = erlps__op__3 [ErlangAtom "div", ErlangAtom "fac", x_0]
  in let arg_141 = toErl 1
  in let
    head_138 =
      erlps__op__3 [ErlangAtom "+", ErlangAtom "ix", arg_141]
  in let
    tup_el_90 =
      ErlangTuple
  ...
  in let
    tup_el_43 =
      ErlangTuple [ErlangAtom "ifte", tup_el_45, tup_el_49, tup_el_90]
  in let
    tup_el_18 =
...
erlps__builtin_baseX_digits__1 [x_0] =
  let    tup_el_3 = toErl "x0"
  in let head_2 = ErlangTuple [tup_el_3, ErlangAtom "word"]
  in let tup_el_7 = toErl "dgts"
  in let head_6 = ErlangTuple [tup_el_7, ErlangAtom "word"]
  in let
    tup_el_12 = erlps__op__3 [ErlangAtom "div", ErlangAtom "x0", x_0]
  in let tup_el_18 = erlps__v__1 [ErlangAtom "x1"]
  in let arg_25 = toErl 0
  in let
    tup_el_22 =
      erlps__op__3 [ErlangAtom "==", ErlangAtom "x1", arg_25]
  in let tup_el_26 = erlps__v__1 [ErlangAtom "dgts"]
  in let tup_el_34 = ErlangTuple [ErlangAtom "baseX_digits", x_0]
  in let tup_el_32 = ErlangTuple [ErlangAtom "builtin", tup_el_34]
  in let tup_el_30 = ErlangTuple [ErlangAtom "var_ref", tup_el_32]
  in let head_38 = erlps__v__1 [ErlangAtom "x1"]
  in let arg_44 = toErl 1
  in let
    head_41 =
      erlps__op__3 [ErlangAtom "+", ErlangAtom "dgts", arg_44]
  in let
    tup_el_28 =
      ErlangTuple
        [ErlangAtom "funcall", tup_el_30,
  ...
  in let
    tup_el_20 =
      ErlangTuple [ErlangAtom "ifte", tup_el_22, tup_el_26, tup_el_28]
...
erlps__builtin_bytes_to_int__1 [(ErlangInt num_0)]
  ...
  in
    ErlangTuple
      [ErlangCons head_2 ErlangEmptyList, tup_el_6, ErlangAtom "word"]
erlps__builtin_bytes_to_int__1 [n_0] | weakLt n_0 (toErl 32) =
  let    tup_el_3 = toErl "w"
  in let head_2 = ErlangTuple [tup_el_3, ErlangAtom "word"]
  in let lop_11 = toErl 32
  in let arg_10 = BIF.erlang__op_minus [lop_11, n_0]
  in let arg_13 = toErl 8
  in let arg_8 = erlps__op__3 [ErlangAtom "*", arg_10, arg_13]
  in let
    tup_el_6 = erlps__op__3 [ErlangAtom "bsr", arg_8, ErlangAtom "w"]
  in
    ErlangTuple
      [ErlangCons head_2 ErlangEmptyList, tup_el_6, ErlangAtom "word"]
erlps__builtin_bytes_to_int__1 [n_0] | weakGt n_0 (toErl 32) =
  let    rop_3 = toErl 32
  in let lop_1 = BIF.erlang__op_div_strict [n_0, rop_3]
  in let rop_4 = toErl 1
  in let lastfullword_5 = BIF.erlang__op_minus [lop_1, rop_4]
  in let rop_8 = toErl 32
  in let case_6 = BIF.erlang__op_rem_strict [n_0, rop_8]
  in let
    body_85 =
      case case_6 of
        (ErlangInt num_9) | ((ErlangInt num_9) == (toErl 0)) ->
          ...
          in let
            arg_12 = erlps__op__3 [ErlangAtom "+", ErlangAtom "b", arg_15]
        ...
        r_29 ->
          let    rop_37 = toErl 32
          in let arg_35 = BIF.erlang__op_mult [lastfullword_5, rop_37]
          in let
            arg_32 = erlps__op__3 [ErlangAtom "+", ErlangAtom "b", arg_35]
          ...
          in let lop_53 = BIF.erlang__op_plus [lastfullword_5, rop_55]
          in let rop_56 = toErl 32
          in let arg_52 = BIF.erlang__op_mult [lop_53, rop_56]
          in let
            arg_49 = erlps__op__3 [ErlangAtom "+", ErlangAtom "b", arg_52]
          ...
          in let lop_72 = toErl 32
          in let arg_71 = BIF.erlang__op_minus [lop_72, r_29]
          in let arg_74 = toErl 8
          in let arg_69 = erlps__op__3 [ErlangAtom "*", arg_71, arg_74]
          in let
            arg_67 = erlps__op__3 [ErlangAtom "bsr", arg_69, ErlangAtom "lo"]
          in let arg_81 = toErl 8
          in let arg_78 = erlps__op__3 [ErlangAtom "*", r_29, arg_81]
          in let
            arg_76 = erlps__op__3 [ErlangAtom "bsl", arg_78, ErlangAtom "hi"]
          in let tup_el_65 = erlps__op__3 [ErlangAtom "+", arg_67, arg_76]
          ...
          in
            ErlangTuple
              [ErlangAtom "switch", tup_el_31,
               ErlangCons head_39 ErlangEmptyList]
  in let tup_el_88 = toErl "b"
  in let head_87 = ErlangTuple [tup_el_88, ErlangAtom "pointer"]
  in
    ErlangTuple
      [ErlangCons head_87 ErlangEmptyList, body_85, ErlangAtom "word"]
...
erlps__builtin_bytes_to_str_body__2 [var_0, n_1]
  ...
  let   
    tup_el_6 =
      ErlangTuple
        [ErlangAtom "builtin", ErlangAtom "bytes_to_str_worker"]
  in let tup_el_4 = ErlangTuple [ErlangAtom "var_ref", tup_el_6]
  in let head_10 = erlps__v__1 [var_0]
  in let tup_el_15 = toErl 0
  in let head_13 = ErlangTuple [ErlangAtom "integer", tup_el_15]
  in let tup_el_19 = toErl 0
  in let head_17 = ErlangTuple [ErlangAtom "integer", tup_el_19]
...
erlps__builtin_bytes_to_str_body__2 [var_0, n_1]
  ...
  in let
    head_7 =
      ErlangTuple
        [ErlangAtom "inline_asm", ErlangCons head_10 ErlangEmptyList]
  in let
    tup_el_19 =
      ErlangTuple
        [ErlangAtom "builtin", ErlangAtom "bytes_to_str_worker"]
  in let tup_el_17 = ErlangTuple [ErlangAtom "var_ref", tup_el_19]
  in let arg_27 = toErl 16
  in let arg_28 = toErl 8
  in let arg_25 = erlps__op__3 [ErlangAtom "*", arg_27, arg_28]
  in let head_23 = erlps__op__3 [ErlangAtom "bsl", arg_25, var_0]
  in let tup_el_33 = toErl 0
  in let head_31 = ErlangTuple [ErlangAtom "integer", tup_el_33]
  in let tup_el_37 = toErl 0
  in let head_35 = ErlangTuple [ErlangAtom "integer", tup_el_37]
  in let rop_43 = toErl 16
  in let tup_el_41 = BIF.erlang__op_minus [n_1, rop_43]
  in let head_39 = ErlangTuple [ErlangAtom "integer", tup_el_41]
  in let
    head_15 =
      ErlangTuple
        [ErlangAtom "funcall", tup_el_17,
...
erlps__builtin_bytes_to_str_body__2 [var_0, n_1]
  | weakGt n_1 (toErl 32) =
  let    rop_5 = toErl 31
  in let lop_3 = BIF.erlang__op_plus [n_1, rop_5]
  in let rop_6 = toErl 32
  in let lop_2 = BIF.erlang__op_div_strict [lop_3, rop_6]
  in let rop_7 = toErl 1
  in let wholewords_8 = BIF.erlang__op_minus [lop_2, rop_7]
  in let arg_12 = toErl 0
  in let rop_15 = toErl 1
  in let arg_13 = BIF.erlang__op_minus [wholewords_8, rop_15]
  in let
    lcSrc_11 =
  ...
  in let
    arg_10 =
      flmap
        (\ lc_17 ->
           let    lop_26 = toErl 32
           in let arg_25 = BIF.erlang__op_mult [lop_26, lc_17]
           ...
           in let arg_40 = toErl 32
           in let
             tup_el_38 =
               erlps__builtin_bytes_to_str_body__2 [ErlangAtom "w", arg_40]
  ...
  in let lop_58 = toErl 32
  in let arg_57 = BIF.erlang__op_mult [lop_58, wholewords_8]
  ...
  in let rop_76 = toErl 32
  in let rop_74 = BIF.erlang__op_mult [wholewords_8, rop_76]
  ...
  in
    BIF.erlang__op_append [lop_9, ErlangCons head_51 ErlangEmptyList]
...
erlps__builtin_bytes_to_str__1 [n_0] | weakLeq n_0 (toErl 32) =
  let    tup_el_3 = toErl "w"
  in let head_2 = ErlangTuple [tup_el_3, ErlangAtom "word"]
  in let arg_12 = toErl 89
  in let
  ...
  in let
    tup_el_8 =
      ErlangTuple
        [ErlangAtom "inline_asm", ErlangCons head_11 ErlangEmptyList]
  in let tup_el_16 = erlps__v__1 [ErlangAtom "ret"]
  in let rop_26 = toErl 2
  in let tup_el_24 = BIF.erlang__op_mult [n_0, rop_26]
  in let head_22 = ErlangTuple [ErlangAtom "integer", tup_el_24]
  in let arg_32 = toErl 89
  in let
    head_31 =
      BIF.do_remote_fun_call "Aeb.Opcodes" "erlps__mnemonic__1"
        [arg_32]
  ...
  in let
    rop_38 =
      BIF.erlang__op_append
        [lop_39, ErlangCons head_43 (ErlangCons head_50 ErlangEmptyList)]
  in let
    tup_el_20 =
      BIF.erlang__op_append
        [ErlangCons head_22 (ErlangCons head_28 ErlangEmptyList), rop_38]
  ...
  in
    ErlangTuple
      [ErlangCons head_2 ErlangEmptyList, tup_el_6,
       ErlangAtom "string"]
erlps__builtin_bytes_to_str__1 [n_0] | weakGt n_0 (toErl 32) =
  let    tup_el_3 = toErl "p"
...
erlps__builtin_string_reverse__0 [] =
  ...
  in let
    tup_el_19 =
      ErlangTuple
        [ErlangAtom "inline_asm", ErlangCons head_22 ErlangEmptyList]
  in let tup_el_27 = erlps__v__1 [ErlangAtom "ret"]
  in let head_32 = erlps__v__1 [ErlangAtom "n"]
  in let arg_39 = toErl 89
  in let
    head_38 =
      BIF.do_remote_fun_call "Aeb.Opcodes" "erlps__mnemonic__1"
        [arg_39]
  in let arg_42 = toErl 82
  in let
    head_41 =
      BIF.do_remote_fun_call "Aeb.Opcodes" "erlps__mnemonic__1"
        [arg_42]
  ...
  in let
    tup_el_49 =
      ErlangTuple [ErlangAtom "builtin", ErlangAtom "string_reverse_"]
  in let tup_el_47 = ErlangTuple [ErlangAtom "var_ref", tup_el_49]
  in let arg_56 = toErl 32
  in let
    head_53 = erlps__op__3 [ErlangAtom "+", ErlangAtom "s", arg_56]
  in let tup_el_60 = toErl 0
  in let head_58 = ErlangTuple [ErlangAtom "integer", tup_el_60]
  in let tup_el_64 = toErl 31
  in let head_62 = ErlangTuple [ErlangAtom "integer", tup_el_64]
  in let arg_68 = erlps__v__1 [ErlangAtom "n"]
  in let arg_70 = toErl 1
  in let head_66 = erlps__op__3 [ErlangAtom "-", arg_68, arg_70]
  in let
    head_45 =
      ErlangTuple
  ...
  in let
    head_73 =
      ErlangTuple
        [ErlangAtom "inline_asm", ErlangCons head_76 ErlangEmptyList]
      ...
      ErlangTuple
        [ErlangAtom "seq",
         ErlangCons head_32
           (ErlangCons head_35
              (ErlangCons head_45
                 (ErlangCons head_73 (ErlangCons head_80 ErlangEmptyList))))]
...
erlps__builtin_string_reverse___0 [] =
  let    tup_el_2 = toErl "p"
  in let head_1 = ErlangTuple [tup_el_2, ErlangAtom "pointer"]
  in let tup_el_6 = toErl "x"
  in let head_5 = ErlangTuple [tup_el_6, ErlangAtom "word"]
  in let tup_el_10 = toErl "i1"
  in let head_9 = ErlangTuple [tup_el_10, ErlangAtom "word"]
  in let tup_el_14 = toErl "i2"
  in let head_13 = ErlangTuple [tup_el_14, ErlangAtom "word"]
  in let arg_22 = toErl 0
  in let
    tup_el_19 =
      erlps__op__3 [ErlangAtom "<", ErlangAtom "i2", arg_22]
  in let head_26 = erlps__v__1 [ErlangAtom "x"]
  in let arg_33 = toErl 89
  in let
    head_32 =
      BIF.do_remote_fun_call "Aeb.Opcodes" "erlps__mnemonic__1"
        [arg_33]
  in let arg_36 = toErl 82
  in let
    head_35 =
      BIF.do_remote_fun_call "Aeb.Opcodes" "erlps__mnemonic__1"
        [arg_36]
  ...
  in let
    tup_el_23 =
      ErlangTuple
        [ErlangAtom "seq",
         ErlangCons head_26 (ErlangCons head_29 ErlangEmptyList)]
  in let arg_52 = toErl 32
  in let
    arg_49 = erlps__op__3 [ErlangAtom "div", ErlangAtom "i2", arg_52]
  in let arg_53 = toErl 32
  in let arg_47 = erlps__op__3 [ErlangAtom "*", arg_49, arg_53]
  in let
    tup_el_44 = erlps__op__3 [ErlangAtom "+", ErlangAtom "p", arg_47]
  ...
  in let arg_77 = toErl 32
  in let
    arg_74 = erlps__op__3 [ErlangAtom "mod", ErlangAtom "i2", arg_77]
  in let
    tup_el_72 =
      erlps__op__3 [ErlangAtom "byte", arg_74, ErlangAtom "w"]
  in let tup_el_81 = erlps__v__1 [ErlangAtom "b"]
  in let arg_88 = toErl 0
  in let
    tup_el_85 =
      erlps__op__3 [ErlangAtom "<", ErlangAtom "i1", arg_88]
  in let head_92 = erlps__v__1 [ErlangAtom "x"]
  in let arg_99 = toErl 89
  in let
    head_98 =
      BIF.do_remote_fun_call "Aeb.Opcodes" "erlps__mnemonic__1"
        [arg_99]
  in let arg_102 = toErl 82
  in let
    head_101 =
      BIF.do_remote_fun_call "Aeb.Opcodes" "erlps__mnemonic__1"
        [arg_102]
  ...
  in let arg_120 = toErl 31
  in let arg_121 = toErl 8
  in let arg_118 = erlps__op__3 [ErlangAtom "*", arg_120, arg_121]
  in let
    head_116 =
      erlps__op__3 [ErlangAtom "bsl", arg_118, ErlangAtom "b"]
  in let tup_el_126 = toErl 30
  in let head_124 = ErlangTuple [ErlangAtom "integer", tup_el_126]
  in let arg_131 = toErl 1
  in let
    head_128 =
      erlps__op__3 [ErlangAtom "-", ErlangAtom "i2", arg_131]
  in let
    head_105 =
      ErlangTuple
  ...
  in let arg_153 = toErl 8
  in let
    arg_150 = erlps__op__3 [ErlangAtom "*", ErlangAtom "i1", arg_153]
  in let
    arg_148 =
      erlps__op__3 [ErlangAtom "bsl", arg_150, ErlangAtom "b"]
  in let
    head_145 = erlps__op__3 [ErlangAtom "+", ErlangAtom "x", arg_148]
  in let arg_159 = toErl 1
  in let
    head_156 =
      erlps__op__3 [ErlangAtom "-", ErlangAtom "i1", arg_159]
  in let arg_164 = toErl 1
  in let
    head_161 =
      erlps__op__3 [ErlangAtom "-", ErlangAtom "i2", arg_164]
  in let
    tup_el_134 =
      ErlangTuple
  ...
  in let
    tup_el_83 =
      ErlangTuple [ErlangAtom "ifte", tup_el_85, tup_el_89, tup_el_134]
  ...
  in let
    tup_el_17 =
      ErlangTuple [ErlangAtom "ifte", tup_el_19, tup_el_23, tup_el_42]
  in
    ErlangTuple
      [ErlangCons head_1
         (ErlangCons head_5
...
erlps__builtin_addr_to_str__0 [] =
  let    tup_el_2 = toErl "a"
  in let head_1 = ErlangTuple [tup_el_2, ErlangAtom "word"]
  in let tup_el_13 = toErl 58
  in let
    tup_el_11 = ErlangTuple [ErlangAtom "baseX_int", tup_el_13]
  in let tup_el_9 = ErlangTuple [ErlangAtom "builtin", tup_el_11]
  in let tup_el_7 = ErlangTuple [ErlangAtom "var_ref", tup_el_9]
...
erlps__bytes_slice__4 [offs_0, len_1, totallen_2, bytes_3]
    ...
    masked_15 =
      case offs_0 of
        ...
        _ ->
          ...
          in let lop_11 = BIF.erlang__op_minus [lop_12, offs_0]
          in let rop_14 = toErl 8
          in let rop_10 = BIF.erlang__op_mult [lop_11, rop_14]
          in let arg_8 = BIF.erlang__bsl__2 [lop_9, rop_10]
          in erlps__op__3 [ErlangAtom "mod", bytes_3, arg_8]
  in let lop_17 = toErl 32
  in let rop_18 = BIF.erlang__op_plus [offs_0, len_1]
  in let case_16 = BIF.erlang__op_minus [lop_17, rop_18]
  in let
    unpadded_29 =
      case case_16 of
  ...
  in
    case len_1 of
      ...
      _ ->
        let    lop_36 = toErl 32
        in let arg_35 = BIF.erlang__op_minus [lop_36, len_1]
        in let arg_38 = toErl 8
        in let arg_33 = erlps__op__3 [ErlangAtom "*", arg_35, arg_38]
        in erlps__op__3 [ErlangAtom "bsl", arg_33, unpadded_29]
erlps__bytes_slice__4 [offs_0, len_1, totallen_2, bytes_3]
  | weakGt totallen_2 (toErl 32) =
  let    word_7 = erlps__op__3 [ErlangAtom "!", offs_0, bytes_3]
  in let rop_10 = toErl 32
  in let case_8 = BIF.erlang__op_eq [len_1, rop_10]
  in
    case case_8 of
      (ErlangAtom "true") -> word_7
      _ ->
        let    lop_15 = toErl 32
        in let arg_14 = BIF.erlang__op_minus [lop_15, len_1]
        in let arg_17 = toErl 8
        in let arg_12 = erlps__op__3 [ErlangAtom "*", arg_14, arg_17]
        in let lop_23 = toErl 32
        in let arg_22 = BIF.erlang__op_minus [lop_23, len_1]
        in let arg_25 = toErl 8
        in let arg_20 = erlps__op__3 [ErlangAtom "*", arg_22, arg_25]
        in let arg_18 = erlps__op__3 [ErlangAtom "bsr", arg_20, word_7]
...
erlps__builtin_bytes_concat__2 [a_0, b_1] =
  let   
    type_5 =
      ErlangFun 1
        (let
           lambda_2 [n_4] | weakLeq n_4 (toErl 32) = ErlangAtom "word"
    ...
    words_20 =
      ErlangFun 1
        (let
           lambda_13 [n_15] =
             let    rop_18 = toErl 31
             in let lop_16 = BIF.erlang__op_plus [n_15, rop_18]
             in let rop_19 = toErl 32
             in BIF.erlang__op_div_strict [lop_16, rop_19]
      ...
      ErlangFun 1
        (let
           ...
           lambda_26 [i_42]
             ...
             in let arg_50 = BIF.erlang__op_mult [lop_51, i_42]
             in let arg_55 = erlps__v__1 [ErlangAtom "a"]
             in let
               hi_57 = erlps__bytes_slice__4 [arg_50, len_49, a_0, arg_55]
             in let arg_58 = toErl 0
             in let lop_61 = toErl 32
             in let arg_60 = BIF.erlang__op_minus [lop_61, len_49]
             in let arg_59 = BIF.erlang__min__2 [arg_60, b_1]
             in let arg_65 = erlps__v__1 [ErlangAtom "b"]
             in let
               lo_67 = erlps__bytes_slice__4 [arg_58, arg_59, b_1, arg_65]
             in let arg_75 = toErl 8
             in let arg_72 = erlps__op__3 [ErlangAtom "*", len_49, arg_75]
             in let arg_70 = erlps__op__3 [ErlangAtom "bsr", arg_72, lo_67]
             in erlps__op__3 [ErlangAtom "+", hi_57, arg_70]
           lambda_26 [i_77] =
             let    lop_79 = toErl 32
             in let lop_78 = BIF.erlang__op_mult [lop_79, i_77]
             in let offs_82 = BIF.erlang__op_minus [lop_78, a_0]
             in let arg_83 = toErl 32
             in let arg_84 = BIF.erlang__op_minus [b_1, offs_82]
             in let len_87 = BIF.erlang__min__2 [arg_83, arg_84]
  ...
  in let
    body_113 =
      case case_94 of
        ...
        _ ->
          let    arg_103 = toErl 0
          in let rop_106 = toErl 1
          in let arg_104 = BIF.erlang__op_minus [wordsres_25, rop_106]
          in let
            lcSrc_102 =
              BIF.do_remote_fun_call "Lists" "erlps__seq__2" [arg_103, arg_104]
          in let
            arg_101 =
              flmap
                (\ lc_108 ->
  ...
  in let
    tup_el_128 =
      BIF.erlang__apply__2 [type_5, ErlangCons arg_129 ErlangEmptyList]
  in
    ErlangTuple
...
erlps__builtin_bytes_split__2 [a_0, b_1] =
      ...
      ErlangFun 2
        (let
           lambda_13 [i_16, max_17] =
             let    arg_20 = toErl 32
             in let arg_21 = BIF.erlang__op_minus [max_17, i_16]
             in let arg_19 = BIF.erlang__min__2 [arg_20, arg_21]
    ...
    body_85 =
      case case_30 of
        ...
        _ ->
          let    arg_52 = toErl 0
          in let rop_55 = toErl 1
          in let arg_53 = BIF.erlang__op_minus [a_0, rop_55]
          in let arg_56 = toErl 32
          in let
            lcSrc_51 =
              BIF.do_remote_fun_call "Lists" "erlps__seq__3"
                [arg_52, arg_53, arg_56]
          in let
            arg_50 =
              flmap
                (\ lc_58 ->
                   let
                     lcRet_59 =
                       BIF.erlang__apply__2
                         [word_29,
                          ErlangCons lc_58 (ErlangCons a_0 ErlangEmptyList)]
          ...
          in let rop_73 = toErl 1
          in let arg_69 = BIF.erlang__op_minus [lop_70, rop_73]
          in let arg_74 = toErl 32
          in let
            lcSrc_67 =
              BIF.do_remote_fun_call "Lists" "erlps__seq__3"
                [a_0, arg_69, arg_74]
                ...
                (\ lc_76 ->
                   ...
                   in let
                     lcRet_77 =
                       BIF.erlang__apply__2
                         [word_29,
                          ErlangCons lc_76 (ErlangCons arg_79 ErlangEmptyList)]
  ...
  in let tup_el_88 = toErl "c"
  in let arg_90 = BIF.erlang__op_plus [a_0, b_1]
  in let
    tup_el_89 =
      BIF.erlang__apply__2 [type_5, ErlangCons arg_90 ErlangEmptyList]
...
erlps__bytes_to_raw_string__2 [n_0, term_1]
    ...
    elem_14 =
      ErlangFun 1
        (let
           lambda_2 [i_4] =
             let    lop_10 = toErl 32
             in let tup_el_9 = BIF.erlang__op_mult [lop_10, i_4]
             in let tup_el_7 = ErlangTuple [ErlangAtom "integer", tup_el_9]
           ...
           lambda_2 args = EXC.badarity (ErlangFun 1 lambda_2) args
         in lambda_2)
  in let rop_17 = toErl 31
  in let lop_15 = BIF.erlang__op_plus [n_0, rop_17]
  in let rop_18 = toErl 32
  in let words_19 = BIF.erlang__op_div_strict [lop_15, rop_18]
  ...
  in let arg_35 = BIF.erlang__op_minus [words_19, rop_37]
  in let
    lcSrc_33 =
      BIF.do_remote_fun_call "Lists" "erlps__seq__2" [arg_34, arg_35]
  in let
    tail_32 =
      flmap
        (\ lc_39 ->
           let
             lcRet_40 =
               BIF.erlang__apply__2 [elem_14, ErlangCons lc_39 ErlangEmptyList]
           in ErlangCons lcRet_40 ErlangEmptyList)
        lcSrc_33
  in let
    tup_el_26 =
      ErlangTuple [ErlangAtom "tuple", ErlangCons head_29 tail_32]
  in let head_23 = ErlangTuple [tup_el_24, tup_el_26]
  in
    ErlangTuple
      [ErlangAtom "switch", term_1, ErlangCons head_23 ErlangEmptyList]
