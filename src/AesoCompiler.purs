...
erlps__version__0 [] =
  ...
  in let
    case_0 =
      BIF.lists__keyfind__3 [ErlangAtom "aesophia", arg_2, arg_3]
  in
    case case_0 of
      (ErlangAtom "false") ->
        let
              ...
              in
                case case_6 of
                  (ErlangTuple [(ErlangAtom "ok"), vsnstring_9]) ->
                    let tup_el_11 = BIF.erlang__list_to_binary__1 [vsnstring_9]
                    in ErlangTuple [ErlangAtom "ok", tup_el_11]
                  (ErlangAtom "undefined") ->
                    ErlangTuple
                      [ErlangAtom "error", ErlangAtom "failed_to_load_aesophia"]
...
erlps__version__0 args =
  EXC.badarity (ErlangFun 0 erlps__version__0) args
  ...
  in
    case case_0 of
      (ErlangTuple [(ErlangAtom "ok"), bin_1]) ->
        ...
        in let matchExpr_5 = BIF.binary__split__2 [bin_1, arg_3]
        in
          case matchExpr_5 of
            (ErlangCons nosuf_4 _) ->
              let   
                arg_7 =
                  ErlangBinary (BIN.fromInts (toErl ".") (toErl 8) 1 BIN.Big)
              in let
              ...
              in let
                tup_el_13 =
                  flmap
                    (\ lc_16 ->
                       let lcRet_17 = BIF.erlang__binary_to_integer__1 [lc_16]
                       in ErlangCons lcRet_17 ErlangEmptyList)
                    numbers_11
              in ErlangTuple [ErlangAtom "ok", tup_el_13]
            _ -> EXC.badmatch matchExpr_5
      err_19@(ErlangTuple [(ErlangAtom "error"), _]) -> err_19
      something_else -> EXC.case_clause something_else
erlps__numeric_version__0 args =
  EXC.badarity (ErlangFun 0 erlps__numeric_version__0) args
  ...
  in
    case case_5 of
      (ErlangTuple [(ErlangAtom "ok"), bin_7]) ->
        ...
        in erlps__from_string__2 [bin_7, ErlangCons head_10 options_4]
      (ErlangTuple [(ErlangAtom "error"), error_14]) ->
        let    head_18 = toErl ": "
        in let
          head_20 =
            BIF.do_remote_fun_call "File" "erlps__format_error__1" [error_14]
        in let
          msg_23 =
...
erlps__add_include_path__2 [file_0, options_1] =
  ...
  in let
    case_2 =
      BIF.lists__keymember__3 [ErlangAtom "include", arg_4, options_1]
  in
    case case_2 of
...
erlps__add_include_path__2 args =
  EXC.badarity (ErlangFun 2 erlps__add_include_path__2) args
...
erlps__from_string__2 args =
  EXC.badarity (ErlangFun 2 erlps__from_string__2) args
...
erlps__from_string__3 [backend_0, contractstring_1, options_2] =
  EXC.tryCatch
    (\ _ ->
       erlps__from_string1__3 [backend_0, contractstring_1, options_2])
    (\ ex_7 ->
       case ex_7 of
...
erlps__from_string__3 args =
  EXC.badarity (ErlangFun 3 erlps__from_string__3) args
  ...
  in
    case matchExpr_7 of
      (ErlangMap map_4) | (DM.Just foldedtypedast_6) <-
        ...
        in let
          bytecodelist_18 = erlps__to_bytecode__2 [assembler_12, options_1]
        in let
          bytecode_24 =
            BIN.concatErl
              (flmap
              ...
              let   
                val_39 =
                  BIF.do_remote_fun_call "Aeb.Aevm.Abi" "erlps__abi_version__0"
                    []
              in let val_40 = BIF.maps__get__2 [ErlangAtom "payable", icode_5]
              in let
                res_43 =
                  ErlangMap
                    (Map.fromFoldable
                       [DT.Tuple (ErlangAtom "byte_code") bytecode_24,
                        DT.Tuple (ErlangAtom "compiler_version") version_27,
                        DT.Tuple (ErlangAtom "contract_source")
                          contractstring_0,
                        DT.Tuple (ErlangAtom "type_info") typeinfo_9,
                        DT.Tuple (ErlangAtom "abi_version") val_39,
                        DT.Tuple (ErlangAtom "payable") val_40])
              in let
                tup_el_45 =
...
erlps__from_string1__3 [(ErlangAtom "fate"), contractstring_0,
  ...
  in
    case matchExpr_9 of
      (ErlangMap map_4) | (DM.Just foldedtypedast_8) <-
                            (Map.lookup (ErlangAtom "folded_typed_ast") map_4)
                        , (DM.Just (ErlangMap map_6)) <-
                            (Map.lookup (ErlangAtom "fcode_env") map_4)
                        , (DM.Just childcontracts_7) <-
                            (Map.lookup (ErlangAtom "child_con_env") map_6)
                        , (DM.Just fcode_5) <-
                            (Map.lookup (ErlangAtom "fcode") map_4) ->
        let   
          fatecode_13 =
            BIF.do_remote_fun_call "Aeso.Fcode.To.Fate" "erlps__compile__3"
              [childcontracts_7, fcode_5, options_1]
        in let
          _ =
            erlps__pp_assembler__3
              [ErlangAtom "fate", fatecode_13, options_1]
        in let
          bytecode_19 =
            BIF.do_remote_fun_call "Aeb.Fate.Code" "erlps__serialize__2"
              [fatecode_13, ErlangEmptyList]
        in let matchExpr_21 = erlps__version__0 []
        in
          case matchExpr_21 of
            (ErlangTuple [(ErlangAtom "ok"), version_20]) ->
              let   
                val_34 =
                  BIF.do_remote_fun_call "Aeb.Fate.Abi" "erlps__abi_version__0"
                    []
              in let val_35 = BIF.maps__get__2 [ErlangAtom "payable", fcode_5]
              in let
                res_38 =
                  ErlangMap
                    (Map.fromFoldable
                       [DT.Tuple (ErlangAtom "byte_code") bytecode_19,
                        DT.Tuple (ErlangAtom "compiler_version") version_20,
                        DT.Tuple (ErlangAtom "contract_source")
                          contractstring_0,
                        DT.Tuple (ErlangAtom "type_info") ErlangEmptyList,
                        DT.Tuple (ErlangAtom "fate_code") fatecode_13,
                        DT.Tuple (ErlangAtom "abi_version") val_34,
                        DT.Tuple (ErlangAtom "payable") val_35])
              in let
                tup_el_40 =
                  erlps__maybe_generate_aci__3
                    [res_38, foldedtypedast_8, options_1]
              in ErlangTuple [ErlangAtom "ok", tup_el_40]
            _ -> EXC.badmatch matchExpr_21
      _ -> EXC.badmatch matchExpr_9
erlps__from_string1__3 [arg_44, arg_45, arg_46] =
  EXC.function_clause unit
erlps__from_string1__3 args =
  EXC.badarity (ErlangFun 3 erlps__from_string1__3) args
...
erlps__maybe_generate_aci__3 args =
  EXC.badarity (ErlangFun 3 erlps__maybe_generate_aci__3) args
          ...
          case case_19 of
            (ErlangAtom "aevm") ->
              ...
              in
                ErlangMap
                  (Map.fromFoldable
                     [DT.Tuple (ErlangAtom "icode") icode_25,
                      DT.Tuple (ErlangAtom "unfolded_typed_ast")
                        unfoldedtypedast_15,
                      DT.Tuple (ErlangAtom "folded_typed_ast")
                        foldedtypedast_14,
                      DT.Tuple (ErlangAtom "type_env") typeenv_13,
                      DT.Tuple (ErlangAtom "ast") ast_4])
            (ErlangAtom "fate") ->
              let   
                head_40 =
                  ErlangTuple [ErlangAtom "original_src", contractstring_0]
              in let
                matchExpr_46 =
                  BIF.do_remote_fun_call "Aeso.Ast.To.Fcode"
                    "erlps__ast_to_fcode__2"
                    [unfoldedtypedast_15, ErlangCons head_40 options_1]
              in
                case matchExpr_46 of
                  (ErlangTuple [env_44, fcode_45]) ->
                    ErlangMap
                      (Map.fromFoldable
                         [DT.Tuple (ErlangAtom "fcode") fcode_45,
                          DT.Tuple (ErlangAtom "fcode_env") env_44,
                          DT.Tuple (ErlangAtom "unfolded_typed_ast")
                            unfoldedtypedast_15,
                          DT.Tuple (ErlangAtom "folded_typed_ast")
                            foldedtypedast_14,
...
erlps__string_to_code__2 [arg_59, arg_60] =
  EXC.function_clause unit
erlps__string_to_code__2 args =
  EXC.badarity (ErlangFun 2 erlps__string_to_code__2) args
...
erlps__check_call__4 args =
  EXC.badarity (ErlangFun 4 erlps__check_call__4) args
               ...
               case matchExpr_12 of
                 (ErlangMap map_10) | (DM.Just ast_11) <-
                                        (Map.lookup (ErlangAtom "ast")
                                           map_10) ->
                   let    arg_15 = toErl "__call"
                   in let
                     contractstring_18 =
                       erlps__insert_call_function__5
                         [ast_11, contractstring0_0, arg_15, funname_1, args_2]
                   in let
                     matchExpr_24 =
                       erlps__string_to_code__2 [contractstring_18, options_3]
                   in
                       ...
                       (ErlangMap map_21) | (DM.Just icode_23) <-
                                          ...
                                          , (DM.Just typedast_22) <-
                                              (Map.lookup
                                                 ...
                                                 map_21) ->
                         let
                           matchExpr_29 = erlps__get_call_type__1 [typedast_22]
                         in
                               ...
                               in
                                 case icode_23 of
                                   (ErlangMap map_42) | (DM.Just funs_43) <-
                                     ...
                                     in
                                       ErlangTuple
                                         [ErlangAtom "ok", funname_1, tup_el_71,
                                          argterms_56]
           ...
           (ErlangAtom "fate") ->
             let
               matchExpr_80 =
                 erlps__string_to_code__2 [contractstring0_0, options_3]
             in
               case matchExpr_80 of
                 (ErlangMap map_77) | (DM.Just ast_79) <-
                                        (Map.lookup (ErlangAtom "ast") map_77)
                                    , (DM.Just orgfcode_78) <-
                   ...
                   in let arg_87 = toErl "__call"
                   in let arg_91 = toErl 49
                   in let arg_92 = toErl 57
                   in let
                     lop_90 =
                       BIF.do_remote_fun_call "Lists" "erlps__seq__2"
                         [arg_91, arg_92]
                   in let arg_95 = toErl 65
                   in let arg_96 = toErl 90
                   in let
                     lop_94 =
                       BIF.do_remote_fun_call "Lists" "erlps__seq__2"
                         [arg_95, arg_96]
                   in let arg_98 = toErl 97
                   in let arg_99 = toErl 122
                   in let
                     rop_97 =
                       BIF.do_remote_fun_call "Lists" "erlps__seq__2"
                         [arg_98, arg_99]
                   ...
                   in let
                     matchExpr_111 =
                       erlps__string_to_code__2 [contractstring_106, options_3]
                   in
                     case matchExpr_111 of
                       ...
                       _ -> EXC.badmatch matchExpr_111
                 _ -> EXC.badmatch matchExpr_80
           something_else -> EXC.case_clause something_else)
    (\ ex_120 ->
       case ex_120 of
         (ErlangTuple [(ErlangAtom "throw"),
...
erlps__check_call1__4 args =
  EXC.badarity (ErlangFun 4 erlps__check_call1__4) args
...
erlps__arguments_of_body__3 [callname_0, _funname_1, fcode_2] =
  ...
  in let arg_3 = ErlangTuple [ErlangAtom "entrypoint", tup_el_5]
  in let arg_7 = BIF.maps__get__2 [ErlangAtom "functions", fcode_2]
  in let matchExpr_12 = BIF.maps__get__2 [arg_3, arg_7]
  in
    case matchExpr_12 of
...
erlps__arguments_of_body__3 args =
  EXC.badarity (ErlangFun 3 erlps__arguments_of_body__3) args
...
erlps__first_none_match__3 [callname_0, hashes_1,
  ...
  in
    case case_4 of
      ...
      (ErlangAtom "false") ->
        let    lop_11 = toErl "__call"
        in let
          arg_10 =
            BIF.erlang__op_append [lop_11, ErlangCons char_2 ErlangEmptyList]
...
erlps__first_none_match__3 args =
  EXC.badarity (ErlangFun 3 erlps__first_none_match__3) args
  ...
  in let
    head_12 =
      BIF.do_remote_fun_call "Lists" "erlps__duplicate__2"
        [ind_6, arg_14]
  in let head_16 = toErl "stateful entrypoint "
  in let head_20 = toErl "() = "
  in let head_24 = toErl "("
  in let arg_28 = toErl ","
  in let
    head_26 =
      BIF.do_remote_fun_call "String" "erlps__join__2" [args_4, arg_28]
...
erlps__insert_call_function__5 args =
  EXC.badarity (ErlangFun 5 erlps__insert_call_function__5) args
...
erlps__insert_init_function__2 [code_0, options_1] =
  ...
  in let
    head_12 =
      BIF.do_remote_fun_call "Lists" "erlps__duplicate__2"
        [ind_6, arg_14]
  in let head_16 = toErl "entrypoint init() = ()\n"
  in
    BIF.do_remote_fun_call "Lists" "erlps__flatten__1"
      [ErlangCons code_0
         (ErlangCons head_10
...
erlps__insert_init_function__2 args =
  EXC.badarity (ErlangFun 2 erlps__insert_init_function__2) args
        ...
        in let
          lop_4 =
            BIF.do_remote_fun_call "Aeso.Syntax" "erlps__get_ann__3"
              [ErlangAtom "col", decl_3, arg_7]
        in let rop_8 = toErl 1
        in BIF.erlang__op_minus [lop_4, rop_8]
      _ -> toErl 0
erlps__last_contract_indent__1 [arg_9] = EXC.function_clause unit
erlps__last_contract_indent__1 args =
  EXC.badarity (ErlangFun 1 erlps__last_contract_indent__1) args
...
erlps__to_sophia_value__4 [contractstring_0, fun_1, restype_2,
  ...
  =
  let
    head_9 = ErlangTuple [ErlangAtom "backend", ErlangAtom "aevm"]
  in
        ...
        in
          case case_6 of
            ...
            (ErlangTuple [(ErlangAtom "error"), _]) ->
              let    msg_24 = toErl "Could not interpret the revert message\n"
              in let
                head_27 =
                  BIF.do_remote_fun_call "Aeso.Errors" "erlps__new__2"
        ...
        EXC.tryOfCatch
          ...
          (\ ex_33 ->
             case ex_33 of
               (ErlangTuple [_, _, _]) ->
                 let   
                   msg_50 = toErl "Could not deserialize the revert message\n"
                 in let
                   head_53 =
                     BIF.do_remote_fun_call "Aeso.Errors" "erlps__new__2"
                 ...
                 in
                   ErlangTuple
                     [ErlangAtom "error", ErlangCons head_53 ErlangEmptyList]
       ...
       let
         code_9 =
           erlps__string_to_code__2
             [contractstring_0, ErlangCons (ErlangAtom "no_code") options0_3]
       in
         case code_9 of
           (ErlangMap map_10) | (DM.Just typeenv_12) <-
                                  (Map.lookup (ErlangAtom "type_env") map_10)
                              , (DM.Just typedast_11) <-
                                  (Map.lookup (ErlangAtom "unfolded_typed_ast")
                                     map_10) ->
             let
               matchExpr_17 = erlps__get_decode_type__2 [funname_1, typedast_11]
             in
                         ...
                         in
                           case case_36 of
                             (ErlangTuple [(ErlangAtom "ok"), vmvalue_39]) ->
                               EXC.tryCatch
                                 (\ _ ->
                                    ...
                                    in ErlangTuple [ErlangAtom "ok", tup_el_41])
                                 (\ ex_46 ->
                                    case ex_46 of
                                      (ErlangTuple [(ErlangAtom "throw"),
                             ...
                             (ErlangTuple [(ErlangAtom "error"), _err_66]) ->
                               let   
                                 arg_67 =
                                   toErl "Failed to decode binary as type ~p\n"
                               in let
                                 msg_71 =
                                   BIF.do_remote_fun_call "Io.Lib"
                                     "erlps__format__2"
                                  ...
                                  in let
                                    msg_110 =
                                      BIF.do_remote_fun_call "Io.Lib"
                                        "erlps__format__2"
                                        [arg_106,
                                         ErlangCons type1_105 ErlangEmptyList]
                                  in let
                                    head_113 =
                                      BIF.do_remote_fun_call "Aeso.Errors"
                                        "erlps__new__2"
...
erlps__to_sophia_value__5 args =
  EXC.badarity (ErlangFun 5 erlps__to_sophia_value__5) args

erlps__create_calldata__3 :: ErlangFun
erlps__create_calldata__3 [code_0, fun_1, args_2] =
  let
    head_7 = ErlangTuple [ErlangAtom "backend", ErlangAtom "aevm"]
  in
...
erlps__create_calldata__3 args =
  EXC.badarity (ErlangFun 3 erlps__create_calldata__3) args
...
erlps__create_calldata__4 [code_0, fun_1, args_2, options0_3] =
  let
    case_7 =
      BIF.do_remote_fun_call "Proplists" "erlps__get_value__3"
        [ErlangAtom "backend",
         ErlangCons (ErlangAtom "no_code") options0_3, ErlangAtom "aevm"]
  in
    case case_7 of
      (ErlangAtom "aevm") ->
        let
        ...
        in
          case case_11 of
            (ErlangTuple [(ErlangAtom "ok"), funname_16,
                          ...
                          vmargs_19]) ->
              BIF.do_remote_fun_call "Aeb.Aevm.Abi" "erlps__create_calldata__4"
        ...
        in
          case case_25 of
            (ErlangTuple [(ErlangAtom "ok"), funname_30, fateargs_31]) ->
              BIF.do_remote_fun_call "Aeb.Fate.Abi" "erlps__create_calldata__2"
                [funname_30, fateargs_31]
...
erlps__create_calldata__4 args =
  EXC.badarity (ErlangFun 4 erlps__create_calldata__4) args
...
erlps__decode_calldata__3 args =
  EXC.badarity (ErlangFun 3 erlps__decode_calldata__3) args
                 ...
                 (ErlangTuple [(ErlangAtom "ok"), args_16, _]) ->
                   let   
                     gettype_22 =
                       ErlangFun 1
                         (let
                            lambda_18 [(ErlangTuple [(ErlangAtom "typed"), _, _,
                                                     t_20])]
                              =
                              t_20
                            lambda_18 [t_21] = t_21
                   ...
                   in let
                     type0_29 =
                       ErlangTuple
                         [ErlangAtom "tuple_t", ErlangEmptyList, argtypes_25]
                   in let
                     type_37 =
                       BIF.do_remote_fun_call "Aeso.Ast.Infer.Types"
                         "erlps__unfold_types_in_type__3"
                                      ...
                                      (ErlangTuple [(ErlangAtom "throw"),
                                        ...
                                        in let
                                          head_83 =
                                            BIF.do_remote_fun_call "Aeso.Errors"
                                              "erlps__new__2"
                                              [ErlangAtom "data_error", msg_80]
                                        in
                                          ErlangTuple
                                            [ErlangAtom "error",
                                             ErlangCons head_83 ErlangEmptyList]
                         ...
                         in
                           case case_99 of
                             ...
                             (ErlangTuple [(ErlangAtom "error"), _]) ->
                               let   
                                 arg_137 =
                                   toErl "Failed to decode calldata binary\n"
                               in let
                                 msg_139 =
                                   BIF.do_remote_fun_call "Io.Lib"
                                     "erlps__format__2"
...
erlps__decode_calldata__4 args =
  EXC.badarity (ErlangFun 4 erlps__decode_calldata__4) args
...
erlps__get_arg_icode__1 args =
  EXC.badarity (ErlangFun 1 erlps__get_arg_icode__1) args

erlps__error_missing_call_function__0 :: ErlangFun
erlps__error_missing_call_function__0 [] =
  let   
    msg_0 = toErl "Internal error: missing \'__call\'-function"
  in let
    arg_1 =
      BIF.do_remote_fun_call "Aeso.Errors" "erlps__new__2"
...
erlps__error_missing_call_function__0 args =
  EXC.badarity (ErlangFun 0 erlps__error_missing_call_function__0)
    args

erlps__get_call_type__1 :: ErlangFun
erlps__get_call_type__1 [(ErlangCons (ErlangTuple [contract_0, _,
                                                   _,
                                                   defs_1]) (ErlangEmptyList))]
        ...
        (\ lc_13 ->
           case lc_13 of
             (ErlangTuple [(ErlangAtom "letfun"), _,
                           (ErlangTuple [(ErlangAtom "id"), _,
                                         (ErlangCons (ErlangInt num_4) (ErlangCons (ErlangInt num_5) (ErlangCons (ErlangInt num_6) (ErlangCons (ErlangInt num_7) (ErlangCons (ErlangInt num_8) (ErlangCons (ErlangInt num_9) (ErlangEmptyList)))))))]),
                           (ErlangEmptyList), _ret_10,
               ...
               let   
                 tup_el_15 =
                   BIF.do_remote_fun_call "Lists" "erlps__last__1" [qfunname_11]
               in let lcRet_14 = ErlangTuple [tup_el_15, funtype_12]
               in ErlangCons lcRet_14 ErlangEmptyList
             _ -> ErlangEmptyList)
        defs_1
  in
    case case_2 of
      (ErlangCons call_18 (ErlangEmptyList)) ->
        ErlangTuple [ErlangAtom "ok", call_18]
      (ErlangEmptyList) -> erlps__error_missing_call_function__0 []
      something_else -> EXC.case_clause something_else
...
erlps__get_call_type__1 args =
  EXC.badarity (ErlangFun 1 erlps__get_call_type__1) args

erlps__get_decode_type__2 :: ErlangFun
erlps__get_decode_type__2 [funname_0,
                           (ErlangCons (ErlangTuple [contract_1, ann_2, _,
                                                     defs_3]) (ErlangEmptyList))]
  ...
  let   
    gettype_20 =
      ErlangFun 1
        (let
           lambda_4 [(ErlangTuple [(ErlangAtom "letfun"), _,
                                   (ErlangTuple [(ErlangAtom "id"), _, name_6]),
                                   args_7, ret_8, _])]
             | weakEq name_6 funname_0 =
             let head_9 = ErlangTuple [args_7, ret_8]
             in ErlangCons head_9 ErlangEmptyList
           lambda_4 [(ErlangTuple [(ErlangAtom "fun_decl"), _,
                                   (ErlangTuple [(ErlangAtom "id"), _,
                                                 name_13]),
                                   (ErlangTuple [(ErlangAtom "fun_t"), _, _,
                                                 args_14, ret_15])])]
             | weakEq name_13 funname_0 =
             let head_16 = ErlangTuple [args_14, ret_15]
             in ErlangCons head_16 ErlangEmptyList
  ...
  in
    case case_21 of
      (ErlangCons (ErlangTuple [args_24, ret_25]) (ErlangEmptyList)) ->
        ErlangTuple [ErlangAtom "ok", args_24, ret_25]
      (ErlangEmptyList) ->
        case funname_0 of
          (ErlangCons (ErlangInt num_30) (ErlangCons (ErlangInt num_31) (ErlangCons (ErlangInt num_32) (ErlangCons (ErlangInt num_33) (ErlangEmptyList))))) | (ErlangInt
                                                                                                                                                                 num_30) ==
                                                                                                                                                                (toErl
                                                                                                                                                                   105)
                                                                                                                                                            , (ErlangInt
            ...
            in ErlangTuple [ErlangAtom "ok", ErlangEmptyList, tup_el_36]
          _ ->
            let    arg_40 = toErl "Function \'~s\' is missing in contract\n"
            in let
              msg_44 =
                BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
                  [arg_40, ErlangCons funname_0 ErlangEmptyList]
            in let
              pos_46 =
            ...
            in let
              arg_47 =
                BIF.do_remote_fun_call "Aeso.Errors" "erlps__new__3"
                  [ErlangAtom "data_error", pos_46, msg_44]
            in
              BIF.do_remote_fun_call "Aeso.Errors" "erlps__throw__1" [arg_47]
      something_else -> EXC.case_clause something_else
...
erlps__get_decode_type__2 args =
  EXC.badarity (ErlangFun 2 erlps__get_decode_type__2) args
           ...
           (\ lc_4 ->
              case lc_4 of
                (ErlangTuple [(ErlangAtom "integer"), w_3]) ->
                  let
                    lcRet_5 =
                      ErlangBinary (BIN.fromInt w_3 (toErl 256) 1 BIN.Big)
                  in ErlangCons lcRet_5 ErlangEmptyList
                _ -> ErlangEmptyList)
           words_1)
  in
    case matchExpr_11 of
      (ErlangBinary binSeg_7) | (ErlangInt size_8) <- (len_0)
                              , (BIN.Ok str_10 bin_9) <-
...
erlps__icode_to_term__2 [(ErlangTuple [(ErlangAtom "list"),
  ...
  flmap
    (\ lc_4 ->
       let lcRet_5 = erlps__icode_to_term__2 [t_0, lc_4]
       in ErlangCons lcRet_5 ErlangEmptyList)
    vs_1
...
erlps__icode_to_term__2 [(ErlangTuple [(ErlangAtom "variant"),
  ...
  =
  let    rop_5 = toErl 1
  in let arg_3 = BIF.erlang__op_plus [tag_1, rop_5]
  in let
    ts_7 =
...
erlps__icode_to_term__2 [t_2@(ErlangTuple [(ErlangAtom "map"),
  ...
  case m_3 of
    (ErlangTuple [(ErlangAtom "funcall"),
      ...
      in let mapExt_20 = ErlangMap (Map.singleton key_13 val_16)
      in BIF.maps__merge__2 [map_10, mapExt_20]
    (ErlangTuple [(ErlangAtom "prim_call_contract"), _,
                  ...
                  _]) | (ErlangInt num_22) == (toErl 0)
                      , (ErlangInt num_23) == (toErl 300) ->
      ErlangMap Map.empty
    _ ->
...
erlps__icode_to_term__2 [(ErlangAtom "word"),
                         (ErlangTuple [(ErlangAtom "unop"), (ErlangAtom "bnot"),
                                       a_0])]
  =
  let op_arg_1 = erlps__icode_to_term__2 [ErlangAtom "word", a_0]
  in BIF.erlang__bnot__1 [op_arg_1]
erlps__icode_to_term__2 [(ErlangAtom "word"),
                         (ErlangTuple [(ErlangAtom "binop"), (ErlangAtom "bor"),
                                       a_0, b_1])]
  =
  let    lop_2 = erlps__icode_to_term__2 [ErlangAtom "word", a_0]
  in let rop_5 = erlps__icode_to_term__2 [ErlangAtom "word", b_1]
  in BIF.erlang__bor__2 [lop_2, rop_5]
erlps__icode_to_term__2 [(ErlangAtom "word"),
                         (ErlangTuple [(ErlangAtom "binop"), (ErlangAtom "bsl"),
                                       a_0, b_1])]
  =
  let    lop_2 = erlps__icode_to_term__2 [ErlangAtom "word", b_1]
  in let rop_5 = erlps__icode_to_term__2 [ErlangAtom "word", a_0]
...
erlps__icode_to_term__2 [(ErlangAtom "typerep"), _] =
  let arg_0 = ErlangTuple [ErlangAtom "todo", ErlangAtom "typerep"]
...
erlps__icode_to_term__2 [arg_6, arg_7] = EXC.function_clause unit
erlps__icode_to_term__2 args =
  EXC.badarity (ErlangFun 2 erlps__icode_to_term__2) args
  ...
  in
    flmap
      (\ lc_7 ->
         case lc_7 of
           (ErlangTuple [t_5, v_6]) ->
             let lcRet_8 = erlps__icode_to_term__2 [t_5, v_6]
...
erlps__icodes_to_terms__2 args =
  EXC.badarity (ErlangFun 2 erlps__icodes_to_terms__2) args

erlps__ast_to_icode__2 :: ErlangFun
erlps__ast_to_icode__2 [typedast_0, options_1] =
  BIF.do_remote_fun_call "Aeso.Ast.To.Icode"
    "erlps__convert_typed__2" [typedast_0, options_1]
erlps__ast_to_icode__2 [arg_4, arg_5] = EXC.function_clause unit
erlps__ast_to_icode__2 args =
  EXC.badarity (ErlangFun 2 erlps__ast_to_icode__2) args
...
erlps__assemble__2 args =
  EXC.badarity (ErlangFun 2 erlps__assemble__2) args
...
erlps__to_bytecode__2 args =
  EXC.badarity (ErlangFun 2 erlps__to_bytecode__2) args
      ...
      flmap
        (\ lc_24 ->
           case lc_24 of
               ...
               in
                 case cond_25 of
                   (ErlangAtom "true") ->
                     let   
                       op_arg_29 =
                         BIF.lists__member__2 [ErlangAtom "private", attrs_20]
             ...
             _ -> ErlangEmptyList)
        functions_1
  in BIF.do_remote_fun_call "Lists" "erlps__sort__1" [typeinfo_43]
erlps__extract_type_info__1 [arg_45] = EXC.function_clause unit
erlps__extract_type_info__1 args =
  EXC.badarity (ErlangFun 1 erlps__extract_type_info__1) args
      ...
      ErlangFun 1
        (let
           lambda_6 [code_8] =
             ...
             in let
               arg_12 =
                 BIF.do_remote_fun_call "Aeso.Pretty" "erlps__decls__1" [code_8]
             in let
               head_11 =
         ...
         in lambda_6)
  in erlps__pp__4 [c_0, opts_1, ErlangAtom "pp_sophia_code", arg_5]
erlps__pp_sophia_code__2 [arg_15, arg_16] =
  EXC.function_clause unit
erlps__pp_sophia_code__2 args =
  EXC.badarity (ErlangFun 2 erlps__pp_sophia_code__2) args
  ...
  in let
    arg_5 =
      BIF.erlang__make_fun__3
        [ErlangAtom "aeso_ast", ErlangAtom "pp", arg_8]
...
erlps__pp_ast__2 args =
  EXC.badarity (ErlangFun 2 erlps__pp_ast__2) args
...
erlps__pp_typed_ast__2 [c_0, opts_1] =
  ...
  in let
    arg_5 =
      BIF.erlang__make_fun__3
        [ErlangAtom "aeso_ast", ErlangAtom "pp_typed", arg_8]
  in erlps__pp__4 [c_0, opts_1, ErlangAtom "pp_typed_ast", arg_5]
erlps__pp_typed_ast__2 [arg_9, arg_10] = EXC.function_clause unit
erlps__pp_typed_ast__2 args =
  EXC.badarity (ErlangFun 2 erlps__pp_typed_ast__2) args
...
erlps__pp_icode__2 [c_0, opts_1] =
  ...
  in let
    arg_5 =
      BIF.erlang__make_fun__3
        [ErlangAtom "aeso_icode", ErlangAtom "pp", arg_8]
...
erlps__pp_icode__2 args =
  EXC.badarity (ErlangFun 2 erlps__pp_icode__2) args
...
erlps__pp_bytecode__2 [c_0, opts_1] =
  ...
  in let
    arg_5 =
      BIF.erlang__make_fun__3
        [ErlangAtom "aeb_disassemble", ErlangAtom "pp", arg_8]
  in erlps__pp__4 [c_0, opts_1, ErlangAtom "pp_bytecode", arg_5]
erlps__pp_bytecode__2 [arg_9, arg_10] = EXC.function_clause unit
erlps__pp_bytecode__2 args =
  EXC.badarity (ErlangFun 2 erlps__pp_bytecode__2) args
...
erlps__pp_assembler__3 [(ErlangAtom "aevm"), c_0, opts_1] =
  ...
  in let
    arg_5 =
      BIF.erlang__make_fun__3
        [ErlangAtom "aeb_asm", ErlangAtom "pp", arg_8]
  in erlps__pp__4 [c_0, opts_1, ErlangAtom "pp_assembler", arg_5]
...
erlps__pp_assembler__3 args =
  EXC.badarity (ErlangFun 3 erlps__pp_assembler__3) args
  ...
  in
    case case_4 of
      (ErlangTuple [option_7, (ErlangAtom "true")]) | option_7 ==
                                                        option_2 ->
        BIF.erlang__apply__2 [ppfun_3, ErlangCons code_0 ErlangEmptyList]
      (ErlangAtom "none") -> ErlangAtom "ok"
      something_else -> EXC.case_clause something_else
erlps__pp__4 [arg_10, arg_11, arg_12, arg_13] =
  EXC.function_clause unit
erlps__pp__4 args = EXC.badarity (ErlangFun 4 erlps__pp__4) args
  ...
  in
    case case_15 of
      b_19 | weakNEq b_19 (ErlangAtom "fate") ->
        let    arg_21 = toErl "Unsupported backend: ~s\n"
        in let
          arg_20 =
            BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
              [arg_21, ErlangCons b_19 ErlangEmptyList]
        in
          BIF.erlang__apply__2 [fail_14, ErlangCons arg_20 ErlangEmptyList]
      (ErlangAtom "fate") ->
        EXC.tryCatch
          (\ _ ->
             let   
               fun_26 =
                 ErlangFun 0
                   (let
                    ...
                    in lambda_27)
             in let fcode1_37 = BIF.erlang__apply__2 [fun_26, ErlangEmptyList]
             in let
               fun_38 =
                 ErlangFun 0
                   (let
                             ...
                             let
                               matchExpr_46 =
                                 erlps__from_string1__3
                                   [ErlangAtom "fate", source_3, options_4]
                             in
                               case matchExpr_46 of
                                 (ErlangTuple [(ErlangAtom "ok"),
                          ...
                          (\ ex_53 ->
                             case ex_53 of
                               (ErlangTuple [_, err1_55, _]) ->
                                 let
                                   arg_56 =
                                     ErlangTuple [ErlangAtom "compile", err1_55]
                                 in BIF.erlang__throw__1 [arg_56]
                               ex_54 -> EXC.raise ex_54)
                      lambda_39 [] = EXC.function_clause unit
                      lambda_39 args = EXC.badarity (ErlangFun 0 lambda_39) args
                    in lambda_39)
             in let
               matchExpr_61 = BIF.erlang__apply__2 [fun_38, ErlangEmptyList]
             in
                   ...
                   in
                     case case_62 of
                       (ErlangAtom "ok") | weakNEq srcpayable_60 payable_2 ->
                         let   
                           not_67 =
                             ErlangFun 1
                               (let
                                  lambda_65 [(ErlangAtom "true")] = toErl ""
                                  lambda_65 [(ErlangAtom "false")] =
                                    toErl " not"
                                  lambda_65 [arg_66] = EXC.function_clause unit
                                  lambda_65 args =
                         ...
                         in let
                           head_71 =
                             BIF.erlang__apply__2
                               [not_67, ErlangCons payable_2 ErlangEmptyList]
                         in let
                           head_75 =
                             BIF.erlang__apply__2
                               [not_67,
                       ...
                       (ErlangTuple [(ErlangAtom "error"), why_80]) ->
                         let   
                           arg_82 =
                             toErl "Byte code does not match source code.\n~s"
                         in let
                           arg_81 =
                             BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
          ...
          (\ ex_88 ->
             case ex_88 of
               (ErlangTuple [(ErlangAtom "throw"),
                             ...
                             _]) ->
                 let arg_90 = toErl "Invalid byte code"
                 in
                   BIF.erlang__apply__2
...
erlps__validate_byte_code__3 args =
  EXC.badarity (ErlangFun 3 erlps__validate_byte_code__3) args
...
erlps__compare_fate_code__2 [fcode1_0, fcode2_1] =
  ...
  in let case_14 = BIF.erlang__op_eq [funhashes1_11, funhashes2_13]
  in
    case case_14 of
      (ErlangAtom "false") ->
        let   
          lcSrc_17 = BIF.erlang__op_unAppend [funhashes1_11, funhashes2_13]
        in let
          inbytecode_26 =
            flmap
              (\ lc_21 ->
                 let    arg_23 = BIF.maps__get__2 [lc_21, syms1_7]
                 in let lcRet_22 = BIF.erlang__binary_to_list__1 [arg_23]
                 in ErlangCons lcRet_22 ErlangEmptyList)
              lcSrc_17
        in let
          lcSrc_27 = BIF.erlang__op_unAppend [funhashes2_13, funhashes1_11]
        in let
          insourcecode_36 =
            flmap
              (\ lc_31 ->
                 let    arg_33 = BIF.maps__get__2 [lc_31, syms2_9]
                 in let lcRet_32 = BIF.erlang__binary_to_list__1 [arg_33]
                 in ErlangCons lcRet_32 ErlangEmptyList)
              lcSrc_27
        in let
              ...
              (\ lc_72 ->
                 case lc_72 of
                   (ErlangTuple [(ErlangTuple [h_69, fun1_70]),
                     ...
                     in let
                       lcRet_73 =
                         erlps__compare_fate_fun__3 [arg_74, fun1_70, fun2_71]
...
erlps__compare_fate_code__2 args =
  EXC.badarity (ErlangFun 2 erlps__compare_fate_code__2) args
...
erlps__compare_fate_fun__3 [name_0,
  ...
  let   
    arg_6 =
      toErl "- The implementation of the function ~s is different.\n"
  in let
    head_5 =
      BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
...
erlps__compare_fate_fun__3 [name_0,
  ...
  in let
    arg_11 =
      flmap
        (\ lc_14 ->
           let lcRet_15 = BIF.erlang__atom_to_list__1 [lc_14]
  ...
  in let
    arg_20 =
      flmap
        (\ lc_23 ->
           let lcRet_24 = BIF.erlang__atom_to_list__1 [lc_23]
           in ErlangCons lcRet_24 ErlangEmptyList)
        attr2_3
  in let arg_26 = toErl ", "
  in let
    head_19 =
      BIF.do_remote_fun_call "String" "erlps__join__2" [arg_20, arg_26]
  in let
    head_5 =
      BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
        [arg_6,
...
erlps__compare_fate_fun__3 args =
  EXC.badarity (ErlangFun 3 erlps__compare_fate_fun__3) args
...
erlps__pp_fate_sig__1 [(ErlangTuple [args_0, res_1])] =
  ...
  in let
    arg_5 =
      flmap
        (\ lc_8 ->
           let lcRet_9 = erlps__pp_fate_type__1 [lc_8]
           in ErlangCons lcRet_9 ErlangEmptyList)
        args_0
  in let arg_11 = toErl ", "
  in let
    head_4 =
      BIF.do_remote_fun_call "String" "erlps__join__2" [arg_5, arg_11]
  in let head_13 = erlps__pp_fate_type__1 [res_1]
  in
    BIF.do_remote_fun_call "Io.Lib" "erlps__format__2"
      [arg_2, ErlangCons head_4 (ErlangCons head_13 ErlangEmptyList)]
erlps__pp_fate_sig__1 [arg_16] = EXC.function_clause unit
erlps__pp_fate_sig__1 args =
  EXC.badarity (ErlangFun 1 erlps__pp_fate_sig__1) args
...
erlps__pp_fate_type__1 args =
  EXC.badarity (ErlangFun 1 erlps__pp_fate_type__1) args

erlps__sophia_type_to_typerep__1 :: ErlangFun
erlps__sophia_type_to_typerep__1 [string_0] =
  let   
    arg_1 = BIF.do_remote_fun_call "Aeso.Parser" "erlps__type__0" []
  in let
    ast_3 =
...
erlps__sophia_type_to_typerep__1 args =
  EXC.badarity (ErlangFun 1 erlps__sophia_type_to_typerep__1) args
...
erlps__parse__3 [arg_6, arg_7, arg_8] = EXC.function_clause unit
erlps__parse__3 args =
  EXC.badarity (ErlangFun 3 erlps__parse__3) args
