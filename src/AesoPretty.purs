...
erlps__options__0 [] =
  let case_0 = BIF.erlang__get__1 [ErlangAtom "aeso_pretty_opts"]
  in
    case case_0 of
      (ErlangAtom "undefined") -> ErlangEmptyList
      opts_2 -> opts_2
erlps__options__0 args =
  EXC.badarity (ErlangFun 0 erlps__options__0) args
...
erlps__option__2 args =
  EXC.badarity (ErlangFun 2 erlps__option__2) args
...
erlps__show_generated__0 args =
  EXC.badarity (ErlangFun 0 erlps__show_generated__0) args

erlps__indent__0 :: ErlangFun
erlps__indent__0 [] =
  let arg_1 = toErl 2
  in erlps__option__2 [ErlangAtom "indent", arg_1]
erlps__indent__0 args =
  EXC.badarity (ErlangFun 0 erlps__indent__0) args

erlps__with_options__2 :: ErlangFun
erlps__with_options__2 [options_0, fun_1] =
  let   
    _ = BIF.erlang__put__2 [ErlangAtom "aeso_pretty_opts", options_0]
  in let res_5 = BIF.erlang__apply__2 [fun_1, ErlangEmptyList]
  in let _ = BIF.erlang__erase__1 [ErlangAtom "aeso_pretty_opts"]
  in res_5
erlps__with_options__2 [arg_7, arg_8] = EXC.function_clause unit
erlps__with_options__2 args =
  EXC.badarity (ErlangFun 2 erlps__with_options__2) args
...
erlps__par__1 args =
  EXC.badarity (ErlangFun 1 erlps__par__1) args
...
erlps__par__2 args =
  EXC.badarity (ErlangFun 2 erlps__par__2) args
...
erlps__follow__3 args =
  EXC.badarity (ErlangFun 3 erlps__follow__3) args
...
erlps__follow__2 args =
  EXC.badarity (ErlangFun 2 erlps__follow__2) args
...
erlps__above__1 args =
  EXC.badarity (ErlangFun 1 erlps__above__1) args
...
erlps__beside__1 args =
  EXC.badarity (ErlangFun 1 erlps__beside__1) args
...
erlps__hsep__1 args =
  EXC.badarity (ErlangFun 1 erlps__hsep__1) args
...
erlps__hsep__2 args =
  EXC.badarity (ErlangFun 2 erlps__hsep__2) args
...
erlps__punctuate__2 [sep_0, (ErlangCons d_1 ds_2)] =
  let   
    head_3 =
      BIF.do_remote_fun_call "Prettypr" "erlps__beside__2" [d_1, sep_0]
...
erlps__punctuate__2 args =
  EXC.badarity (ErlangFun 2 erlps__punctuate__2) args
...
erlps__paren__1 args =
  EXC.badarity (ErlangFun 1 erlps__paren__1) args
...
erlps__paren__2 args =
  EXC.badarity (ErlangFun 2 erlps__paren__2) args
...
erlps__block__2 args =
  EXC.badarity (ErlangFun 2 erlps__block__2) args
...
erlps__comma_brackets__3 [open_0, close_1, ds_2] =
  ...
  in let head_7 = erlps__par__2 [arg_8, arg_12]
  in let
    head_14 =
...
erlps__comma_brackets__3 args =
  EXC.badarity (ErlangFun 3 erlps__comma_brackets__3) args
...
erlps__list__1 args =
  EXC.badarity (ErlangFun 1 erlps__list__1) args
...
erlps__equals__2 args =
  EXC.badarity (ErlangFun 2 erlps__equals__2) args
...
erlps__decls__2 args =
  EXC.badarity (ErlangFun 2 erlps__decls__2) args
...
erlps__decls__1 [ds_0] =
  let
    arg_1 =
      flmap
        (\ lc_4 ->
           let lcRet_5 = erlps__decl__1 [lc_4]
...
erlps__decls__1 args =
  EXC.badarity (ErlangFun 1 erlps__decls__1) args
...
erlps__decl__1 [(ErlangTuple [(ErlangAtom "type_def"), _, t_0,
  ...
  =
  let    arg_3 = toErl 1
  in let kind_5 = BIF.erlang__element__2 [arg_3, def_2]
...
erlps__decl__1 [(ErlangTuple [(ErlangAtom "fun_decl"), ann_0,
  ...
  let   
    mod_8 =
      ErlangFun 1
        (let
           lambda_3 [(ErlangTuple [mod_5, (ErlangAtom "true")])]
             | ((weakEq mod_5 (ErlangAtom "private")) ||
                  (weakEq mod_5 (ErlangAtom "stateful"))) ||
                 (weakEq mod_5 (ErlangAtom "payable")) =
             let arg_6 = BIF.erlang__atom_to_list__1 [mod_5]
             in BIF.do_remote_fun_call "Prettypr" "erlps__text__1" [arg_6]
           lambda_3 [_] =
  ...
  in let
    fun_15 =
      case case_9 of
        (ErlangAtom "true") ->
          let arg_13 = toErl "entrypoint"
          in BIF.do_remote_fun_call "Prettypr" "erlps__text__1" [arg_13]
        (ErlangAtom "false") ->
          let arg_14 = toErl "function"
          in BIF.do_remote_fun_call "Prettypr" "erlps__text__1" [arg_14]
        something_else -> EXC.case_clause something_else
  in let
    lop_17 =
      BIF.do_remote_fun_call "Lists" "erlps__map__2" [mod_8, ann_0]
  in let arg_24 = erlps__name__1 [f_1]
  in let head_23 = erlps__typed__2 [arg_24, t_2]
  in let
    arg_16 =
      BIF.erlang__op_append
        [lop_17, ErlangCons fun_15 (ErlangCons head_23 ErlangEmptyList)]
  in erlps__hsep__1 [arg_16]
erlps__decl__1 [d_1@(ErlangTuple [(ErlangAtom "letfun"), attrs_0,
      ...
      ErlangFun 1
        (let
           lambda_2 [(ErlangTuple [mod_4, (ErlangAtom "true")])]
             | ((weakEq mod_4 (ErlangAtom "private")) ||
                  (weakEq mod_4 (ErlangAtom "stateful"))) ||
                 (weakEq mod_4 (ErlangAtom "payable")) =
             let arg_5 = BIF.erlang__atom_to_list__1 [mod_4]
  ...
  in let
    fun_12 =
      case case_8 of
        (ErlangAtom "true") -> toErl "entrypoint"
        (ErlangAtom "false") -> toErl "function"
        something_else -> EXC.case_clause something_else
  in let
    lop_14 =
      BIF.do_remote_fun_call "Lists" "erlps__map__2" [mod_7, attrs_0]
  in let head_18 = erlps__letdecl__2 [fun_12, d_1]
  in let
    arg_13 =
      BIF.erlang__op_append
        [lop_14, ErlangCons head_18 ErlangEmptyList]
  in erlps__hsep__1 [arg_13]
erlps__decl__1 [(ErlangTuple [(ErlangAtom "fun_clauses"), ann_0,
  ...
  in let
    arg_4 =
      flmap
        (\ lc_13 ->
           let lcRet_14 = erlps__decl__1 [lc_13]
...
erlps__pragma__1 [(ErlangTuple [(ErlangAtom "compiler"), op_0,
  ...
  in let
    arg_10 =
      flmap
        (\ lc_13 ->
           let lcRet_14 = BIF.erlang__integer_to_list__1 [lc_13]
           in ErlangCons lcRet_14 ErlangEmptyList)
        ver_1
  in let arg_16 = toErl "."
  in let
...
erlps__pragma__1 args =
  EXC.badarity (ErlangFun 1 erlps__pragma__1) args
...
erlps__expr__1 [e_0] =
  let arg_1 = toErl 0
  in erlps__expr_p__2 [arg_1, e_0]
erlps__expr__1 [arg_3] = EXC.function_clause unit
erlps__expr__1 args =
  EXC.badarity (ErlangFun 1 erlps__expr__1) args
...
erlps__name__1 [(ErlangTuple [(ErlangAtom "qid"), _, names_0])] =
  ...
  in let
    arg_1 =
      BIF.do_remote_fun_call "String" "erlps__join__2" [names_0, arg_3]
...
erlps__letdecl__2 [let_0,
  ...
  in erlps__block_expr__3 [arg_3, arg_4, e_2]
erlps__letdecl__2 [let_0,
  ...
  in erlps__block_expr__3 [arg_5, arg_6, e_4]
erlps__letdecl__2 [arg_26, arg_27] = EXC.function_clause unit
erlps__letdecl__2 args =
  EXC.badarity (ErlangFun 2 erlps__letdecl__2) args
...
erlps__args__1 args =
  EXC.badarity (ErlangFun 1 erlps__args__1) args
...
erlps__arg__1 args =
  EXC.badarity (ErlangFun 1 erlps__arg__1) args
...
erlps__typedecl__3 args =
  EXC.badarity (ErlangFun 3 erlps__typedecl__3) args
...
erlps__typedef__1 [(ErlangTuple [(ErlangAtom "record_t"),
  ...
  in let
    arg_1 =
      BIF.do_remote_fun_call "Lists" "erlps__map__2" [arg_2, fields_0]
...
erlps__typedef__1 args =
  EXC.badarity (ErlangFun 1 erlps__typedef__1) args
...
erlps__constructor_t__1 args =
  EXC.badarity (ErlangFun 1 erlps__constructor_t__1) args
...
erlps__field_t__1 args =
  EXC.badarity (ErlangFun 1 erlps__field_t__1) args
...
erlps__type__2 args =
  EXC.badarity (ErlangFun 2 erlps__type__2) args
...
erlps__args_type__1 args =
  EXC.badarity (ErlangFun 1 erlps__args_type__1) args

erlps__tuple_type__1 :: ErlangFun
erlps__tuple_type__1 [(ErlangEmptyList)] =
  let arg_0 = toErl "unit"
  in BIF.do_remote_fun_call "Prettypr" "erlps__text__1" [arg_0]
erlps__tuple_type__1 [factors_0] =
  ...
  in let arg_12 = toErl 0
  in let head_5 = erlps__par__2 [arg_6, arg_12]
  in let arg_15 = toErl ")"
  in let
    head_14 =
...
erlps__expr_p__2 [p_0,
  ...
  in let arg_13 = toErl 100
  in let arg_12 = erlps__expr_p__2 [arg_13, e_2]
  ...
  in
    case ErlangAtom "true" of
      _ | weakEq format_8 (ErlangAtom "?:") ->
        let    rop_11 = toErl 100
        in let arg_9 = BIF.erlang__op_greater [p_0, rop_11]
        in let arg_14 = toErl 200
        in let arg_13 = erlps__expr_p__2 [arg_14, cond_2]
        in let arg_19 = toErl "?"
        in let
          arg_18 =
            BIF.do_remote_fun_call "Prettypr" "erlps__text__1" [arg_19]
        in let arg_21 = toErl 100
        in let arg_20 = erlps__expr_p__2 [arg_21, then_3]
        in let arg_17 = erlps__hsep__2 [arg_18, arg_20]
        in let arg_25 = toErl ":"
        in let
          arg_24 =
            BIF.do_remote_fun_call "Prettypr" "erlps__text__1" [arg_25]
        in let arg_27 = toErl 100
        in let arg_26 = erlps__expr_p__2 [arg_27, else_4]
        in let arg_23 = erlps__hsep__2 [arg_24, arg_26]
        in let arg_29 = toErl 0
        in let arg_16 = erlps__follow__3 [arg_17, arg_23, arg_29]
        in let arg_12 = erlps__follow__2 [arg_13, arg_16]
        in erlps__paren__2 [arg_9, arg_12]
      _ ->
        let matchExpr_33 = erlps__get_elifs__1 [else_4]
        in
          case matchExpr_33 of
            (ErlangTuple [elifs_31, else1_32]) ->
              let   
                head_37 = ErlangTuple [ErlangAtom "if", ann_1, cond_2, then_3]
              in let
                lcSrc_35 =
                  BIF.erlang__op_append
              ...
              in let
                arg_34 =
                  flmap
                    (\ lc_47 ->
                       let lcRet_48 = erlps__stmt_p__1 [lc_47]
...
erlps__expr_p__2 [_p_0,
  ...
  in let
    arg_10 =
      BIF.do_remote_fun_call "Lists" "erlps__map__2" [arg_11, cases_2]
...
erlps__expr_p__2 [_,
  ...
  in let
    arg_13 =
      BIF.do_remote_fun_call "Lists" "erlps__map__2" [arg_14, binds_1]
  in let arg_10 = erlps__punctuate__2 [arg_11, arg_13]
  in let arg_16 = toErl 0
  in let arg_9 = erlps__par__2 [arg_10, arg_16]
  in let arg_6 = erlps__hsep__2 [arg_7, arg_9]
  in let arg_17 = toErl 0
  in let head_3 = erlps__follow__3 [arg_4, arg_6, arg_17]
        ...
        (\ lc_6 ->
           case lc_6 of
             (ErlangTuple [k_4, v_5]) ->
               ...
               in let lcRet_7 = erlps__field__1 [arg_8]
...
erlps__expr_p__2 [p_0,
  ...
  =
  let arg_5 = ErlangTuple [ErlangAtom "record", ann_1, e_2, flds_3]
  in erlps__expr_p__2 [p_0, arg_5]
erlps__expr_p__2 [p_0,
                  (ErlangTuple [(ErlangAtom "record"), ann_1, e_2, fs_3])]
  =
  let    rop_6 = toErl 900
  in let arg_4 = BIF.erlang__op_greater [p_0, rop_6]
  in let arg_9 = toErl 900
  in let arg_8 = erlps__expr_p__2 [arg_9, e_2]
  in let arg_12 = ErlangTuple [ErlangAtom "record", ann_1, fs_3]
...
erlps__expr_p__2 [p_0,
  ...
  in let arg_3 = BIF.erlang__op_greater [p_0, rop_5]
  in let arg_9 = toErl 900
  in let head_8 = erlps__expr_p__2 [arg_9, e_1]
  in let arg_13 = toErl "."
  in let
    head_12 =
      BIF.do_remote_fun_call "Prettypr" "erlps__text__1" [arg_13]
...
erlps__expr_p__2 [p_0,
  ...
  =
  let    rop_7 = toErl 900
  in let arg_5 = BIF.erlang__op_greater [p_0, rop_7]
  in let arg_11 = toErl 900
  in let head_10 = erlps__expr_p__2 [arg_11, e_2]
...
erlps__expr_p__2 [p_0,
  ...
  in let arg_7 = erlps__expr_p__2 [arg_8, lv_1]
...
erlps__expr_p__2 [_,
  ...
  let    arg_4 = toErl 0
  in let
    head_3 = erlps__infix__4 [arg_4, ErlangAtom "..", a_0, b_1]
  in erlps__list__1 [ErlangCons head_3 ErlangEmptyList]
erlps__expr_p__2 [p_0,
...
erlps__expr_p__2 [_,
                  (ErlangTuple [(ErlangAtom "app"), _,
                                ...
                                (ErlangEmptyList)])]
  | (weakEq tag_0 (ErlangAtom "con")) ||
      (weakEq tag_0 (ErlangAtom "qcon")) =
  let arg_2 = toErl 0
    ...
    s_10 =
      case case_2 of
        (ErlangAtom "hex") ->
          ...
          in let rop_6 = BIF.erlang__integer_to_list__2 [n_0, arg_8]
...
erlps__expr_p__2 [_,
  ...
  | (ErlangInt size_1) <- (toErl 512)
  , (BIN.Ok n_3 bin_2) <-
      (BIN.chopInt binSeg_0 size_1 1 BIN.Big BIN.Unsigned)
  , BIN.empty bin_2 =
  let    lop_5 = toErl "#"
  in let arg_8 = toErl 16
  in let rop_6 = BIF.erlang__integer_to_list__2 [n_3, arg_8]
  in let arg_4 = BIF.erlang__op_append [lop_5, rop_6]
  in BIF.do_remote_fun_call "Prettypr" "erlps__text__1" [arg_4]
erlps__expr_p__2 [_, (ErlangTuple [type_0, _, bin_1])]
  | (((weakEq type_0 (ErlangAtom "account_pubkey")) ||
        (weakEq type_0 (ErlangAtom "contract_pubkey"))) ||
       (weakEq type_0 (ErlangAtom "oracle_pubkey"))) ||
      (weakEq type_0 (ErlangAtom "oracle_query_id")) =
  let   
    arg_3 =
...
erlps__expr_p__2 [_, (ErlangTuple [(ErlangAtom "char"), _, c_0])]
  ...
  case c_0 of
    ...
    _ ->
      ...
      in let
        s_13 = BIF.do_remote_fun_call "Lists" "erlps__flatten__1" [arg_6]
      in let lop_15 = toErl "\'"
      in let
        arg_18 =
...
erlps__expr_p__2 [_,
  ...
  =
  erlps__name__1 [e_0]
erlps__expr_p__2 [_, (ErlangTuple [op_0, _])] | isEAtom op_0 =
...
erlps__expr_p__2 args =
  EXC.badarity (ErlangFun 2 erlps__expr_p__2) args
...
erlps__stmt_p__1 [(ErlangTuple [(ErlangAtom "if"), _, cond_0,
  ...
  in let
    arg_3 =
      BIF.do_remote_fun_call "Prettypr" "erlps__beside__2"
        [arg_4, arg_6]
  in erlps__block_expr__3 [arg_2, arg_3, then_1]
erlps__stmt_p__1 [(ErlangTuple [(ErlangAtom "elif"), _, cond_0,
                                then_1])]
  =
  let    arg_2 = toErl 200
  in let arg_5 = toErl "elif"
  in let
    arg_4 =
      BIF.do_remote_fun_call "Prettypr" "erlps__text__1" [arg_5]
  in let arg_7 = erlps__expr__1 [cond_0]
...
erlps__stmt_p__1 [(ErlangTuple [(ErlangAtom "else"), else_0])] =
  ...
  in
    case case_3 of
      ...
      _ ->
        let    arg_6 = toErl 200
        in let arg_8 = toErl "else"
        in let
          arg_7 =
            BIF.do_remote_fun_call "Prettypr" "erlps__text__1" [arg_8]
        in erlps__block_expr__3 [arg_6, arg_7, else_0]
erlps__stmt_p__1 [arg_10] = EXC.function_clause unit
erlps__stmt_p__1 args =
  EXC.badarity (ErlangFun 1 erlps__stmt_p__1) args
...
erlps__lc_bind__1 args =
  EXC.badarity (ErlangFun 1 erlps__lc_bind__1) args

erlps__bin_prec__1 :: ErlangFun
erlps__bin_prec__1 [(ErlangAtom "..")] =
  let    tup_el_0 = toErl 0
  in let tup_el_1 = toErl 0
  in let tup_el_2 = toErl 0
  in ErlangTuple [tup_el_0, tup_el_1, tup_el_2]
erlps__bin_prec__1 [(ErlangAtom "=")] =
  let    tup_el_0 = toErl 0
  in let tup_el_1 = toErl 0
  in let tup_el_2 = toErl 0
...
erlps__bin_prec__1 [(ErlangAtom "@")] =
  ...
  in ErlangTuple [tup_el_0, tup_el_1, tup_el_2]
erlps__bin_prec__1 [(ErlangAtom "||")] =
  let    tup_el_0 = toErl 200
  in let tup_el_1 = toErl 300
  in let tup_el_2 = toErl 200
  in ErlangTuple [tup_el_0, tup_el_1, tup_el_2]
erlps__bin_prec__1 [(ErlangAtom "&&")] =
  let    tup_el_0 = toErl 300
  in let tup_el_1 = toErl 400
  in let tup_el_2 = toErl 300
  in ErlangTuple [tup_el_0, tup_el_1, tup_el_2]
erlps__bin_prec__1 [(ErlangAtom "<")] =
  let    tup_el_0 = toErl 400
  in let tup_el_1 = toErl 500
  in let tup_el_2 = toErl 500
  in ErlangTuple [tup_el_0, tup_el_1, tup_el_2]
erlps__bin_prec__1 [(ErlangAtom ">")] =
  let    tup_el_0 = toErl 400
  in let tup_el_1 = toErl 500
...
erlps__bin_prec__1 [(ErlangAtom "!=")] =
  ...
  in ErlangTuple [tup_el_0, tup_el_1, tup_el_2]
erlps__bin_prec__1 [(ErlangAtom "++")] =
  let    tup_el_0 = toErl 500
  in let tup_el_1 = toErl 600
  in let tup_el_2 = toErl 500
  in ErlangTuple [tup_el_0, tup_el_1, tup_el_2]
erlps__bin_prec__1 [(ErlangAtom "::")] =
  let    tup_el_0 = toErl 500
  ...
  in ErlangTuple [tup_el_0, tup_el_1, tup_el_2]
erlps__bin_prec__1 [(ErlangAtom "+")] =
  let    tup_el_0 = toErl 600
  in let tup_el_1 = toErl 600
  in let tup_el_2 = toErl 650
  in ErlangTuple [tup_el_0, tup_el_1, tup_el_2]
erlps__bin_prec__1 [(ErlangAtom "-")] =
  let    tup_el_0 = toErl 600
  in let tup_el_1 = toErl 600
  ...
  in ErlangTuple [tup_el_0, tup_el_1, tup_el_2]
erlps__bin_prec__1 [(ErlangAtom "*")] =
  let    tup_el_0 = toErl 700
  in let tup_el_1 = toErl 700
  in let tup_el_2 = toErl 750
  in ErlangTuple [tup_el_0, tup_el_1, tup_el_2]
erlps__bin_prec__1 [(ErlangAtom "/")] =
  let    tup_el_0 = toErl 700
  in let tup_el_1 = toErl 700
...
erlps__bin_prec__1 [(ErlangAtom "mod")] =
  ...
  in ErlangTuple [tup_el_0, tup_el_1, tup_el_2]
erlps__bin_prec__1 [(ErlangAtom "^")] =
  let    tup_el_0 = toErl 750
  in let tup_el_1 = toErl 750
  in let tup_el_2 = toErl 800
  in ErlangTuple [tup_el_0, tup_el_1, tup_el_2]
erlps__bin_prec__1 [arg_3] = EXC.function_clause unit
erlps__bin_prec__1 args =
  EXC.badarity (ErlangFun 1 erlps__bin_prec__1) args

erlps__un_prec__1 :: ErlangFun
erlps__un_prec__1 [(ErlangAtom "-")] =
  let    tup_el_0 = toErl 650
  in let tup_el_1 = toErl 650
  in ErlangTuple [tup_el_0, tup_el_1]
erlps__un_prec__1 [(ErlangAtom "!")] =
  let    tup_el_0 = toErl 800
  in let tup_el_1 = toErl 800
  in ErlangTuple [tup_el_0, tup_el_1]
erlps__un_prec__1 [arg_2] = EXC.function_clause unit
erlps__un_prec__1 args =
  EXC.badarity (ErlangFun 1 erlps__un_prec__1) args

erlps__equals__3 :: ErlangFun
erlps__equals__3 [ann_0, a_1, b_2] =
  let   
    head_5 = ErlangTuple [ErlangAtom "format", ErlangAtom "infix"]
...
erlps__equals__3 args =
  EXC.badarity (ErlangFun 3 erlps__equals__3) args

erlps__infix__4 :: ErlangFun
erlps__infix__4 [p_0, op_1, a_2, b_3] =
  let matchExpr_8 = erlps__bin_prec__1 [op_1]
  in
    case matchExpr_8 of
...
erlps__infix__4 args =
  EXC.badarity (ErlangFun 4 erlps__infix__4) args

erlps__prefix__3 :: ErlangFun
erlps__prefix__3 [p_0, op_1, a_2] =
  let matchExpr_6 = erlps__un_prec__1 [op_1]
  in
    case matchExpr_6 of
...
erlps__prefix__3 args =
  EXC.badarity (ErlangFun 3 erlps__prefix__3) args
  ...
  in let
    arg_6 =
      BIF.do_remote_fun_call "Prettypr" "erlps__beside__2"
        [arg_7, arg_10]
  in erlps__paren__2 [arg_3, arg_6]
erlps__app__3 [arg_14, arg_15, arg_16] = EXC.function_clause unit
erlps__app__3 args =
  EXC.badarity (ErlangFun 3 erlps__app__3) args
...
erlps__field__1 args =
  EXC.badarity (ErlangFun 1 erlps__field__1) args
...
erlps__lvalue__1 args =
  EXC.badarity (ErlangFun 1 erlps__lvalue__1) args
...
erlps__elim__1 [(ErlangTuple [(ErlangAtom "map_get"), ann_0,
  ...
  in erlps__expr_p__2 [arg_2, arg_3]
erlps__elim__1 [(ErlangTuple [(ErlangAtom "map_get"), ann_0, k_1,
                              v_2])]
  =
  let    arg_3 = toErl 0
  in let head_8 = erlps__equals__3 [ann_0, k_1, v_2]
  in let
    arg_4 =
      ErlangTuple
        [ErlangAtom "list", ann_0, ErlangCons head_8 ErlangEmptyList]
  in erlps__expr_p__2 [arg_3, arg_4]
erlps__elim__1 [arg_13] = EXC.function_clause unit
erlps__elim__1 args =
  EXC.badarity (ErlangFun 1 erlps__elim__1) args
...
erlps__elim1__1 args =
  EXC.badarity (ErlangFun 1 erlps__elim1__1) args
...
erlps__block_expr__3 args =
  EXC.badarity (ErlangFun 3 erlps__block_expr__3) args
...
erlps__statements__1 [stmts_0] =
  let
    arg_1 =
      flmap
        (\ lc_4 ->
           let lcRet_5 = erlps__statement__1 [lc_4]
           in ErlangCons lcRet_5 ErlangEmptyList)
        stmts_0
  in erlps__above__1 [arg_1]
erlps__statements__1 [arg_7] = EXC.function_clause unit
erlps__statements__1 args =
  EXC.badarity (ErlangFun 1 erlps__statements__1) args
...
erlps__statement__1 args =
  EXC.badarity (ErlangFun 1 erlps__statement__1) args
...
erlps__get_elifs__1 args =
  EXC.badarity (ErlangFun 1 erlps__get_elifs__1) args
...
erlps__get_elifs__2 [if_4@(ErlangTuple [(ErlangAtom "if"), ann_0,
  ...
  in
    case case_6 of
      (ErlangAtom "elif") ->
        let
          head_11 = ErlangTuple [ErlangAtom "elif", ann_0, cond_1, then_2]
...
erlps__get_elifs__2 args =
  EXC.badarity (ErlangFun 2 erlps__get_elifs__2) args