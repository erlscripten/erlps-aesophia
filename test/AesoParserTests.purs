...
erlps__simple_contracts_test___0 [] =
  ...
  in let
    tup_el_9 =
      (H.make_string "Parse a contract with an identity function.")
  in let
    tup_el_10 =
      (ErlangFun 0
         let
           lambda_11 [] =
             let   
               text_12 =
                 (H.make_string "contract Identity =\n  function id(x) = x\n")
             in let
               fun_13 =
                 (ErlangFun 0
                    let
                        ...
                        in
                          case case_15 of
                            ...
                            __v_30 ->
                              ...
                              in let
                                tup_el_44 =
                                  (H.make_string "parse_string ( Text )")
                              in let
                                head_42 =
                                  (ErlangTuple
  ...
  in let tup_el_56 = (H.make_string "Operator precedence test.")
  in let
    tup_el_57 =
      (ErlangFun 0
         let
           lambda_58 [] =
               ...
               nopar_92 =
                 (ErlangFun 1
                    let
                      ...
                      nopar_59 args =
                        (EXC.badarity
                           (ErlangFun 1 (\ _ -> (ErlangAtom "purs_tco_sucks")))
                           args)
                    in nopar_59)
             in let
               par_134 =
                 (ErlangFun 1
                    let
                      par_93 [x_95] | (H.isEAtom x_95) =
                        (BIF.erlang__atom_to_list__1 [x_95])
                      par_93 [(ErlangTuple [a_97, op_98, b_99])] =
                        let    head_101 = (H.make_string "(")
                        in let head_103 = (par_93 [a_97])
                        in let head_107 = (H.make_string " ")
                        in let head_111 = (H.make_string " ")
                        in let head_113 = (par_93 [b_99])
                        in let head_117 = (H.make_string ")")
                        in
                          (BIF.do_remote_fun_call "Lists" "erlps__concat__1"
                             [(ErlangCons head_101
                                 (ErlangCons head_103
                      ...
                      par_93 [(ErlangTuple [op_119, a_120])] =
                        let    head_122 = (H.make_string "(")
                        in let head_126 = (H.make_string " ")
                        in let head_128 = (par_93 [a_120])
                        in let head_132 = (H.make_string ")")
                        in
                          (BIF.do_remote_fun_call "Lists" "erlps__concat__1"
                             [(ErlangCons head_122
                                 (ErlangCons op_119
                    ...
                    let
                      lambda_215 [op_217] =
                        let   
                          tup_el_219 =
                            (ErlangTuple
                               [(ErlangAtom "a"), op_217, (ErlangAtom "b")])
                        in let
                          arg_218 =
                    ...
                    let
                      lambda_227 [op_229] =
                        let   
                          tup_el_233 =
                            (ErlangTuple
                               [(ErlangAtom "b"), op_229, (ErlangAtom "c")])
                        in let
                          arg_230 =
                                         ...
                                         in let
                                           head_268 =
                                             (ErlangTuple
                                                [(ErlangAtom "expression"),
                                                 tup_el_270])
                                         in let lop_275 = (H.make_string "{ ")
                                         in let
                                           lop_277 = (H.make_string "throw")
                                         in let lop_279 = (H.make_string " , ")
                                         in let
                                           lop_281 =
                                             (H.make_string "{ error , [ _ ] }")
                                         in let
                                           rop_282 =
                                             (H.make_string " , [...] }")
                                         in let
                                               ...
                                               head_302 =
                                                 (ErlangTuple
                                                    [(ErlangAtom "expression"),
                                                     tup_el_304])
                                             in let
                                               lop_309 = (H.make_string "{ ")
                                             in let
                                               lop_311 = (H.make_string "throw")
                                             in let
                                               lop_313 = (H.make_string " , ")
                                             in let
                                               lop_315 =
                                                 (H.make_string
                                                    "{ error , [ _ ] }")
             ...
             in let
               stronger_347 =
                 (ErlangFun 2
                    let
                      lambda_326 [op1_329, op2_330] =
                        ...
                        in let
                          arg_331 =
                            (ErlangTuple
                               [tup_el_332, op2_330, (ErlangAtom "c")])
                        in let
                          _ =
                            (BIF.erlang__apply__2
                               [checkparens_214,
                        ...
                        in let
                          arg_339 =
                            (ErlangTuple
                               [(ErlangAtom "a"), op2_330, tup_el_342])
                        in
                          (BIF.erlang__apply__2
                             [checkparens_214,
                    ...
                    in lambda_326)
             in let head_349 = (H.make_string "||")
             in let head_353 = (H.make_string "&&")
             in let head_357 = (H.make_string "==")
             in let head_359 = (H.make_string "!=")
             in let head_361 = (H.make_string "<")
             in let head_363 = (H.make_string ">")
             in let head_365 = (H.make_string "=<")
             in let head_367 = (H.make_string ">=")
             in let head_371 = (H.make_string "::")
             in let head_373 = (H.make_string "++")
             in let head_377 = (H.make_string "+")
             in let head_379 = (H.make_string "-")
             in let head_383 = (H.make_string "*")
             in let head_385 = (H.make_string "/")
             in let head_387 = (H.make_string "mod")
             in let head_392 = (H.make_string "||")
             in let head_394 = (H.make_string "&&")
             in let head_396 = (H.make_string "::")
             in let head_398 = (H.make_string "++")
             in let
               _ =
                 (H.flmap
                    (\ lc_401 ->
                       let
                         lc_ret_402 =
                           (BIF.erlang__apply__2
                              [rightassoc_238,
                               (ErlangCons lc_401 ErlangEmptyList)])
                       in (ErlangCons lc_ret_402 ErlangEmptyList))
                    (ErlangCons head_392
                       (ErlangCons head_394
                          (ErlangCons head_396
                             (ErlangCons head_398 ErlangEmptyList)))))
             in let head_406 = (H.make_string "==")
             in let head_408 = (H.make_string "!=")
             in let head_410 = (H.make_string "<")
             in let head_412 = (H.make_string ">")
             in let head_414 = (H.make_string "=<")
             in let head_416 = (H.make_string ">=")
             in let
               _ =
                 (H.flmap
                    (\ lc_419 ->
                       let
                         lc_ret_420 =
                           (BIF.erlang__apply__2
                              [nonassoc_325,
                               (ErlangCons lc_419 ErlangEmptyList)])
                       in (ErlangCons lc_ret_420 ErlangEmptyList))
                    (ErlangCons head_406
                       (ErlangCons head_408
                          (ErlangCons head_410
                             (ErlangCons head_412
             ...
             in let head_424 = (H.make_string "+")
             in let head_426 = (H.make_string "-")
             in let head_428 = (H.make_string "*")
             in let head_430 = (H.make_string "/")
             in let head_432 = (H.make_string "mod")
             in let
               _ =
                 (H.flmap
                    (\ lc_435 ->
                       let
                         lc_ret_436 =
                           (BIF.erlang__apply__2
                              [leftassoc_226,
                               (ErlangCons lc_435 ErlangEmptyList)])
                       in (ErlangCons lc_ret_436 ErlangEmptyList))
                    (ErlangCons head_424
                       (ErlangCons head_426
                          (ErlangCons head_428
                             (ErlangCons head_430
  ...
  in let
    rop_455 =
      (H.flmap
         (\ lc_476 ->
            let    head_480 = (H.make_string "Parse the ")
            in let head_484 = (H.make_string " contract.")
            in let
              tup_el_478 =
                (BIF.do_remote_fun_call "Lists" "erlps__concat__1"
                   [(ErlangCons head_480
                       (ErlangCons lc_476
                          (ErlangCons head_484 ErlangEmptyList)))])
            in let
              tup_el_486 =
                (ErlangFun 0
                   let
                     ...
                     lambda_487 args =
                       (EXC.badarity (ErlangFun 0 lambda_487) args)
                   in lambda_487)
            in let lc_ret_477 = (ErlangTuple [tup_el_478, tup_el_486])
            in (ErlangCons lc_ret_477 ErlangEmptyList))
  ...
  in let
    tup_el_6 =
      (BIF.erlang__op_append
         [(ErlangCons head_8 (ErlangCons head_55 ErlangEmptyList)),
          rop_455])
  in
    (ErlangTuple
       [(ErlangAtom "foreach"), tup_el_1, tup_el_3, tup_el_6])
...
erlps__parse_string__2 [text_0, opts_1] =
  (BIF.do_remote_fun_call "Aeso.Parser" "erlps__string__2"
     [text_0, opts_1])
erlps__parse_string__2 [arg_4, arg_5] =
  (EXC.function_clause unit)
...
erlps__parse_expr__1 [text_0] =
  let    lop_2 = (H.make_string "let _ = ")
  in let arg_1 = (BIF.erlang__op_append [lop_2, text_0])
  in let match_expr_5 = (erlps__parse_string__1 [arg_1])
  in
...
erlps__round_trip__1 [text_0] =
  ...
  in let
    nosrcloc1_12 = (erlps__remove_line_numbers__1 [contract1_8])
  in let
    fun_13 =
      (ErlangFun 0
         let
               ...
               case case_15 of
                 ...
                 __v_19 ->
                   ...
                   in let
                     head_27 =
                       (ErlangTuple
                          [(ErlangAtom "line"), (ErlangInt (DBI.fromInt 91))])
                   in let
                     tup_el_33 = (H.make_string "diff ( NoSrcLoc , NoSrcLoc1 )")
                   in let
                     head_31 =
                       (ErlangTuple [(ErlangAtom "expression"), tup_el_33])
                   in let tup_el_37 = (H.make_string "NoSrcLoc")
                   in let
...
erlps__strip_stdlib__1 [(ErlangCons (ErlangTuple [(ErlangAtom "namespace"),
  ...
  , ((ErlangInt num_4) == (ErlangInt (DBI.fromInt 73)))
  ...
  , ((ErlangInt num_11) == (ErlangInt (DBI.fromInt 108))) =
...
erlps__remove_line_numbers__1 [(ErlangTuple [(ErlangAtom "line"),
                                             _l_0])]
  =
  (ErlangTuple [(ErlangAtom "line"), (ErlangInt (DBI.fromInt 0))])
erlps__remove_line_numbers__1 [(ErlangTuple [(ErlangAtom "col"),
                                             _c_0])]
  =
  (ErlangTuple [(ErlangAtom "col"), (ErlangInt (DBI.fromInt 0))])
...
erlps__remove_line_numbers__1 [t_0] | (H.isETuple t_0) =
